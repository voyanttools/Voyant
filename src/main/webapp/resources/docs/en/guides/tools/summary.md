...
1. The first bullet provides an overview of the corpus, including number of documents in the corpus, number of words in the corpus, and number of unique words in the corpus. The number of words in the corpus is determined by the [tokenization algorithm](./tutorial-corpuscreator.html#processing).

var Spyral = (function () {
	...
	*/module.exports=function(options,source){var TARGET=options.target;var GLOBAL=options.global;var STATIC=options.stat;var PROTO=options.proto;var nativeSource=GLOBAL?global:STATIC?global[TARGET]:(global[TARGET]||{}).prototype;var target=GLOBAL?path:path[TARGET]||(path[TARGET]={});var targetPrototype=target.prototype;var FORCED,USE_NATIVE,VIRTUAL_PROTOTYPE;var key,sourceProperty,targetProperty,nativeProperty,resultProperty,descriptor;for(key in source){FORCED=isForced(GLOBAL?key:TARGET+(STATIC?'.':'#')+key,options.forced);// contains in native
	...
	var regex=/(?!\s*$)\s*(?:'([^'\\]*(?:\\[\S\s][^'\\]*)*)'|"([^"\\]*(?:\\[\S\s][^"\\]*)*)"|([^,'"\s\\]*(?:\s+[^,'"\s\\]+)*))\s*(?:,|$)/g;function parseCsvLine(line){var arr=[];line.replace(regex,function(m0,m1,m2,m3){if(m1!==undefined){arr.push(m1.replace(/\\'/g,'\''));}else if(m2!==undefined){arr.push(m2.replace(/\\"/g,'"'));}else if(m3!==undefined){arr.push(m3);}return '';});if(/,\s*$/.test(line)){arr.push('');}return arr;}var _default=Table;exports["default"]=_default;},{"./chart.js":243,"./util.js":247,"@babel/runtime/helpers/classCallCheck":32,"@babel/runtime/helpers/construct":33,"@babel/runtime/helpers/createClass":34,"@babel/runtime/helpers/interopRequireDefault":36,"@babel/runtime/helpers/typeof":39}],247:[function(require,module,exports){var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=void 0;var _classCallCheck2=_interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2=_interopRequireDefault(require("@babel/runtime/helpers/createClass"));/**
	            ...
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 27:
	                ...
	                if (cellId !== undefined) {
	                  ...
	                  allCells = htmlDoc.querySelectorAll('section.notebook-editor-wrapper');

	                  if (cellIndex !== undefined) {
	                    _cell = allCells[cellIndex];

	                    if (_cell !== undefined) {
	                      importedCode.push(_cell.querySelector('pre').textContent);
	                    }
	                  } else {
	...
	var Storage = /*#__PURE__*/function () {
	  ...
	  _createClass(Storage, null, [{
	    ...
	    value: function getTromboneUrl() {
	      return 'https://beta.voyant-tools.org/trombone'; // return 'http://localhost:8080/voyant/trombone'
	    }
	  }, {
	    key: "_doStore",

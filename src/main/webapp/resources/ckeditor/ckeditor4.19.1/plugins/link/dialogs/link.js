...
*/
/*
Unminified source and modified behaviour so that by default link targets are _blank and anchor targets are notSet
*/
(function () {
	function u() {
					...
					elements: [
						...
						},
						{
							...
							onChange: function () {
								...
								// MODIFIED
								var linkTargetType = a.getContentElement('target', 'linkTargetType');
								if (r == "url") {

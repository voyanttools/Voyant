...
items:[{xtype:"textfield",width:"75%",name:"text",fieldLabel:"",listeners:{change:function(){this.setTable(void 0)},scope:this}}]},{itemId:"variable",items:[{xtype:"combo",name:"variable",fieldLabel:"",triggerAction:"all",queryMode:"local",editable:!1,forceSelection:!0,emptyText:this.localize("notebookVariables"),store:{fields:["text"]},listeners:{change:function(){this.setTable(void 0)},scope:this}}],listeners:{activate:function(){this.populateVariables()},scope:this}},{itemId:"file",xtype:"notebookfileinput",
flex:1,listeners:{change:function(){this.setTable(void 0)},scope:this}}]}]}],listeners:{boxready:function(b){a.type&&b.down("#type").setValue(a.type);if(a.value){var c=b.down("#"+a.type).child();c.setRawValue?c.setRawValue(a.value):c.setValue(a.value)}a.table&&(c=new Spyral.Table(a.table),this.setTable(c));b.up("notebookdatawrapper").results.on("sandboxMessage",function(d){if("result"===d.type){var e=b.up("notebookdatawrapper").getDataName();d=d.variables.find(function(f){return f.name===e});Spyral.Util.blobToString(d.value).then(function(f){var g=
JSON.parse(f),h=new Spyral.Table;["_rows","_headers","_rowKeyColumnIndex"].forEach(function(k){void 0!==g[k]&&(h[k]=g[k])});b.setTable(h)})}});b.up("notebook").on("notebookRun",b.populateVariables,b)}}});this.callParent(arguments)},populateVariables:function(){var a=this.up("notebookdatawrapper"),b=[];null!==a.previousSibling()&&(b=a.up("notebook").getNotebookVariables(a).map(function(e){return[e.name]}));a=this.down("#variable combo");a.getStore().loadRawData(b);var c=!0,d=a.getRawValue();b.forEach(function(e){-1!==
e.indexOf(d)&&(c=!1)});c&&a.setValue(void 0)},updateTable:function(a,b){if(!1!==this.rendered&&((b=this.down("#tableEditor"))&&b.destroy(),void 0!==a)){var c=Ext.create("Ext.form.field.Text",{allowBlank:!1});this.insert(1,{xtype:"gridpanel",height:250,resizable:{handles:"s",pinned:!0},width:"100%",itemId:"tableEditor",plugins:{ptype:"cellediting",pluginId:"cellEditor"},columns:a.headers(!0).map(function(d,e){return{text:d,dataIndex:d,editor:c}}),store:{xtype:"store.array",fields:a.headers(!0),data:a.rows(!0)},
bbar:[{xtype:"button",text:"Add Row",width:125,glyph:"xf067@FontAwesome",handler:function(d){d=d.up("gridpanel");var e=a.headers(!0).map(function(){return""});d.store.loadData([e],!0);e=d.store.getCount();d.getPlugin("cellEditor").startEditByPosition({row:e-1,column:0})}},{xtype:"button",text:"Remove Row",width:135,glyph:"xf068@FontAwesome",handler:function(d){d=d.up("gridpanel");var e=d.getSelection();0<e.length&&d.store.remove(e)}}]})}},gridToSpyralTable:function(){var a=this.down("#tableEditor");
if(a){a=a.getStore();var b=a.getModel().getFields().filter(function(c){return!0!==c.generated}).map(function(c){return c.getName()});return a.getData().items.map(function(c){var d={};b.forEach(function(e){d[e]=c.get(e)});return d})}},getCode:function(a){var b=new Ext.Deferred,c=this.down("#cards").getLayout().getActiveItem(),d=c.getItemId();this.setType(d);if(this.down("#tableEditor"))return c=this.gridToSpyralTable(),c=a+"\x3dnew Spyral.Table("+JSON.stringify(c)+")",b.resolve(c),b.promise;"variable"===
d?(c=c.down("combo").getRawValue(),this.setValue(c),""!==c?b.resolve(a+"\x3dnew Spyral.Table("+c+")"):b.reject("No variable specified!")):"file"===d?(d=c.getFile(),this.setValue(c.getFileName()),Spyral.Util.blobToDataUrl(d).then(function(e){b.resolve(a+"\x3dnew Spyral.Table(Spyral.Util.dataUrlToBlob(`"+e+"`))")},function(){b.reject()})):"text"===d&&(c=c.down("textfield").getValue().replace('"','"'),this.setValue(c),""!==c?b.resolve(a+'\x3dnew Spyral.Table("'+c+'")'):b.reject("No text entered!"));
return b.promise},getTSV:function(){var a=void 0;this.getTable()&&(a=this.getTable().toTsv());return a},getInput:function(){return{table:this.getTSV(),type:this.getType(),value:this.getValue()}},getBlob:function(){var a=new Ext.Deferred;a.resolve(this.getTSV());return a.promise}});Ext.define("Voyant.notebook.editor.DataWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.FileInput","Voyant.notebook.editor.CorpusInput"],alias:"widget.notebookdatawrapper",cls:"notebook-data-wrapper",statics:{i18n:{dataNameAlphanum:"The data name must contain alphanumeric characters only",dataNameAlphastart:"The data name must not begin with a number"}},config:{dataName:void 0},cachedInput:void 0,constructor:function(a){a.mode=
...
//# sourceMappingURL=voyant.18b9cf37b653e61afa0f29870a09d5b1.min.js.map
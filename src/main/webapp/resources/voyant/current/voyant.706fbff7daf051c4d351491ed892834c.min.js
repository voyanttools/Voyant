...
this.getApiParam("rtl")||"ar"==Voyant.util.Localization.LANGUAGE||"he"==Voyant.util.Localization.LANGUAGE,items:[{xtype:"voyantheader",region:"north"},{region:"south",xtype:"voyantfooter"},{region:"center",layout:"card",itemId:"toolsContainer",activeItem:0,items:[{xtype:"container",layout:{type:"vbox",pack:"center",align:"middle"},items:[{xtype:"container",width:800,html:'\x3cdiv id\x3d"voyantCorpusMessage" style\x3d"text-align: center; margin-top: -10px; margin-bottom: 10px;"\x3eAlert: We will be deleting unused corpora on August 15th. Check \x3ca href\x3d"https://ggle.in/VoyantAlert" target\x3d"_blank"\x3ehttps://ggle.in/VoyantAlert\x3c/a\x3e to learn more.\x3c/div\x3e'},
{xtype:"corpuscreator"},{xtype:"container",width:800,html:"\x3cdiv id\x3d'voyantIs' style\x3d'font-style: italic; text-align: center; margin-top: 10px;'\x3e\x3cdiv\x3e"+this.localize("voyantIs")+"\x3c/div\x3e"+(-1==this.localize("translatedBy").indexOf("English")?"\x3cdiv\x3e"+this.localize("translatedBy")+"\x3c/div\x3e":"")+(this.getCorpusCreatorText&&0<this.getCorpusCreatorText().trim().length?"\x3cdiv id\x3d'corpusCreatorText'\x3e"+this.getCorpusCreatorText()+"\x3c/div\x3e":"")+"\x3c/div\x3e"},
{xtype:"container",width:800,html:"\x3cdiv id\x3d'voyantServerMessage' style\x3d'font-style: italic; text-align: center; margin-top: 10px;'\x3e\x3c/div\x3e"}]},{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});"true"===this.getShowServerMessage()&&this.getServerMessage();null===Ext.util.Cookies.get("storageMsg")&&this.showStorageMsg();this.callParent(arguments)},getServerMessage:function(){$.get("trombone",{fetchData:"https://raw.githubusercontent.com/wiki/voyanttools/voyant/Announcements.md"},
function(a){a=(new showdown.Converter).makeHtml(a);a=DOMPurify.sanitize(a);$("#voyantServerMessage").html(a)},"text").fail(function(){console.log("failed to fetch server message")})},showStorageMsg:function(){Ext.toast({html:'\x3cp\x3e\x3cb style\x3d"font-weight: bold"\x3eAlert: Deleting Older Unused Corpora on Voyant Tools\x3c/b\x3e\x3c/p\x3e\n\t\t\x3cp\x3eWe will be deleting all corpora that haven\'t been used in over a year on \x3cb style\x3d"font-weight: bold"\x3eAugust 15th\x3c/b\x3e.\x3c/p\x3e\n\t\t\x3cp\x3eDue to storage constraints on our server we have to delete unused corpora. If you don\'t want an older corpus deleted, load it in Voyant and click a few buttons to update its "last access date".\x3cbr/\x3eFor more information visit: \x3ca href\x3d"https://ggle.in/VoyantAlert" target\x3d"_blank"\x3ehttps://ggle.in/VoyantAlert\x3c/a\x3e\x3c/p\x3e\n\t\t\x3cp\x3e\x3cb style\x3d"font-weight: bold"\x3eWarning: the corpora that we delete will be unrecoverable!\x3c/b\x3e\x3c/p\x3e',
...
//# sourceMappingURL=voyant.706fbff7daf051c4d351491ed892834c.min.js.map
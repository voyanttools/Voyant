...
" "+this.localize("home"));this.down("#overviewBtn").hide();this.down("#methodsBtn").hide();this.down("#configsBtn").hide();this._setHtmlForCard("main",a);this.body.scrollTo("top",0,!1)},handleDocLink:function(a,b){console.log("handleDocLink",a,b);a=a.replace(/^https:\/\/voyant-tools.org\//,"");0===a.indexOf("http")?window.open(a,"_external"):0===a.indexOf("tutorial")||"help"===b?window.open(this.fullDocsUrl+a,"_spyral_docs"):this.loadDocsEntry(a)},openFullDocumentation:function(){var a=this.fullDocsUrl;
...
//# sourceMappingURL=voyant.11955d5d048a747b42810fe5be83f3fc.min.js.map
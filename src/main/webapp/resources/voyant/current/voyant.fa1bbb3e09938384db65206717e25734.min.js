...
d){var e=this.down("combo");e.getStore().add({name:d,value:d});e.setValue(d);this.up("window").panel.setApiParam("categories",d)}},this,{single:!0});var c=this.down("combo").getValue();Voyant.categories.Builder.setCategoriesId(c);Voyant.categories.Builder.show()},scope:this}]});this.callParent(arguments)}});
...
{},b=this.getApiParam("view","CorpusSet"),c=b.toLowerCase();if(!Ext.ClassManager.getByAlias("widget."+c)||a.noskin)Ext.Msg.show({title:this.localize("noViewErrorTitle"),message:(new Ext.Template(this.localize(a.noskin?"noViewKnownErrorTpl":"noViewErrorTpl"))).apply({view:a.noskin?a.noskin:b,additional:a.noskin&&"convert"==a.noskin?this.localize(a.noskin+"SkinMsg"):""}),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}),c="corpusset";a=-1!==this.getBaseUrl().indexOf("voyant-tools.org");this.viewport=Ext.create("Ext.container.Viewport",
{layout:"border",rtl:void 0!==this.getApiParam("rtl")||"ar"==Voyant.util.Localization.LANGUAGE||"he"==Voyant.util.Localization.LANGUAGE,items:[{xtype:"voyantheader",region:"north"},{region:"south",xtype:"voyantfooter"},{region:"center",layout:"card",itemId:"toolsContainer",activeItem:0,items:[{xtype:"container",layout:{type:"vbox",pack:"center",align:"middle"},items:[{xtype:"container",width:800,hidden:!a,html:'\x3cdiv id\x3d"voyantCorpusMessage" style\x3d"text-align: center; margin-top: -10px; margin-bottom: 10px;"\x3eAlert: We will be deleting unused corpora on August 15th. Check \x3ca href\x3d"https://ggle.in/VoyantAlert" target\x3d"_blank"\x3ehttps://ggle.in/VoyantAlert\x3c/a\x3e to learn more.\x3c/div\x3e'},
...
//# sourceMappingURL=voyant.fa1bbb3e09938384db65206717e25734.min.js.map
...
this.on("resize",function(b,c,d){if(b=this.body.down("svg"))d=this.body,c=d.getHeight(),d=d.getWidth(),b.dom.setAttribute("width",d),b.dom.setAttribute("height",c),this.getVisLayout().force("x",d3.forceX(d/2)).force("y",d3.forceY(c/2)),Ext.Function.defer(this.zoomToFit,100,this)},this);this.on("destroy",function(b){console.log("destroyed",b)});this.callParent(arguments)},loadJson:function(a){this.processJson(a);var b={};this.getNodeData().forEach(function(e){b[e.term]=!0},this);var c=[],d=[];a.nodes.forEach(function(e){void 0===
...
function(f){return"translate("+(f.x-.5*f.bbox.width)+","+(f.y-.5*f.bbox.height)+")"});.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("width",b).attr("height",c);var e=a.append("g");b=d3.zoom().scaleExtent(this.getZoomExtent()).on("zoom",function(){e.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);this.setEdgeSelection(e.append("g").attr("class",
...
"\x3c/p\x3e"}))});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"},c=this.getApiParams();this.getCorpus()?Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0}):delete c.corpus;delete c.view;delete c.stopList;Ext.apply(b,c);b.verbose=!0;var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(e,f){d.unmask();f.result&&(f.result.corpus||
f.result.stepEnabledCorpusCreator)?(e={corpus:f.result.corpus?f.result.corpus.metadata.id:f.result.stepEnabledCorpusCreator.storedId},Ext.applyIf(e,c),this.setCorpus(void 0),this.loadCorpus(e)):this.showResponseError("Unable to load corpus.",f.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){if(void 0===
a.optionsWin){var b=["bo"].concat(Object.keys(Voyant.widget.StopListOption.stoplists).filter(function(c){return"mu"!==c})).sort().map(function(c){return[c,a._localizeClass(Voyant.widget.StopListOption,c)]});b.unshift(["",a._localizeClass(Voyant.widget.StopListOption,"auto")]);a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,anchor:"100% 100%",items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-
120,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(c){var d=this.getApiParam("inputFormat");d&&c.setValue(d)},scope:a},change:{fn:function(c,
d,e){c=c.up("form").down("[name\x3ddtocIndexDoc]");"dtoc"===d?c.show():c.hide()},scope:a}}},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/tutorial-corpuscreator.html"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/tutorial-corpuscreator.html#titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",
items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("corpusTitle"),name:"title"},{fieldLabel:a.localize("corpusSubTitle"),name:"subTitle"},{fieldLabel:a.localize("corpusSort"),name:"sort",xtype:"combo",queryMode:"local",store:[["",a.localize("corpusSortAuto")],["TITLEASC",a.localize("corpusSortTitle")],["AUTHORASC",a.localize("corpusSortAuthor")],["PUBDATEASC",a.localize("corpusSortPubDate")],["NOCHANGE",a.localize("corpusSortInitialOrder")]],
...
a.localize("textOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("inputRemoveUntil"),name:"inputRemoveUntil"},{fieldLabel:a.localize("inputRemoveUntilAfter"),name:"inputRemoveUntilAfter"},{fieldLabel:a.localize("inputRemoveFrom"),name:"inputRemoveFrom"},{fieldLabel:a.localize("inputRemoveFromAfter"),name:"inputRemoveFromAfter"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/tutorial-corpuscreator.html#xml' target\x3d'voyantdocs'\x3e"+a.localize("xmlOptions")+
...
itemId:"spacy",checked:!0,handler:this.nerServiceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:this.localize("nerNssi"),itemId:"nssi",checked:!1,handler:this.nerServiceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:this.localize("nerVoyant"),itemId:"stanford",checked:!1,handler:this.nerServiceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:"NER with Voyant (OpenNLP)",itemId:"opennlp",checked:!1,handler:this.nerServiceHandler,scope:this}]}}]}],
listeners:{loadedCorpus:function(d,e){this.getTokensStore().setCorpus(e);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",e.getId());d=e.getDocuments();this.setDocumentsStore(d);this.rendered&&(this.load(),0==this.hasCorpusAccess(e)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(e=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(e)?[e]:e))},termsClicked:function(d,e){var f=[];e.forEach(function(g){Ext.isString(g)?f.push(g):g.term?f.push(g.term):g.getTerm&&
f.push(g.getTerm())});0<f.length&&this.loadQueryTerms(f)},corpusTermsClicked:function(d,e){var f=[];e.forEach(function(g){g.getTerm()&&f.push(g.getTerm())});this.loadQueryTerms(f)},documentTermsClicked:function(d,e){var f=[];e.forEach(function(g){g.getTerm()&&f.push(g.getTerm())});this.loadQueryTerms(f)},documentSelected:function(d,e){d=this.getTokensStore().getCorpus().getDocument(e);this.setApiParams({skipToDocId:d.getId(),start:0});this.load(!0)},documentsClicked:function(d,e,f){0<e.length&&(this.setApiParams({skipToDocId:e[0].getId(),
start:0}),this.load(!0))},termLocationClicked:function(d,e){if(void 0!==e[0]){d=e[0];e=d.get("docIndex");var f=d.get("position");this.showTermLocation(e,f,d)}},documentIndexTermsClicked:function(d,e){void 0!==e[0]&&(d=Ext.create("Voyant.data.model.Token",e[0]),this.fireEvent("termLocationClicked",this,[d]))},entityResults:function(d,e){null!==e&&(this.clearEntityHighlights(),this.setDocumentEntitiesStore(e),this.highlightEntities(),this.getEnableEntitiesList()&&this.down("entitieslist").expand().show())},
entitiesClicked:function(d,e){if(void 0!==e[0]){d=e[0];e=d.get("docIndex");var f=d.get("positions")[0];Array.isArray(f)&&(f=f[0]);this.showTermLocation(e,f,d)}},entityLocationClicked:function(d,e,f){d=e.get("docIndex");f=e.get("positions")[f];Array.isArray(f)&&(f=f[0]);this.showTermLocation(d,f,e)},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){if(a&&0<a.length){var b=this.getApiParam("skipToDocId");if(void 0===b){b=0;var c=this.getLocationInfo();c&&(b=c[0].docIndex);b=this.getCorpus().getDocument(b).getId()}this.getDocumentTermsStore().load({params:{query:a,
docId:b,categories:this.getApiParam("categories"),limit:-1}});this.down("readergraph").loadQueryTerms(a)}},showTermLocation:function(a,b,c){var d=b-this.getApiParam("limit")/2,e=this.getCorpus().getDocument(a);this.setApiParams({skipToDocId:e.getId(),start:0>d?0:d});this.load(!0,{callback:function(){var f=this.body.dom.querySelector("#_"+a+"_"+b);f&&(f.scrollIntoView({block:"center"}),Ext.fly(f).frame("#f80"));c.get("type")?this.highlightEntities():this.highlightKeywords(c,!1)},scope:this})},highlightKeywords:function(a,
b){var c=this.getInnerContainer().first();c.select("span[class*\x3dkeyword]").removeCls("keyword").applyStyles({backgroundColor:"transparent",color:"black"});void 0===a&&0<this.getDocumentTermsStore().getCount()&&(a=this.getDocumentTermsStore().getData().items);void 0!==a&&(Ext.isArray(a)||(a=[a]),a.forEach(function(d){var e=d.get("term"),f=this.getApplication().getColorForTerm(e),g=this.getApplication().getTextColorForBackground(f);f="rgb("+f.join(",")+") !important";g="rgb("+g.join(",")+") !important";
var h="background-color:"+f+";color:"+g+";";if(d.get("positions")){e=d.get("positions");var k=d.get("docIndex");e.forEach(function(m){(m=c.dom.querySelector("#_"+k+"_"+m))&&Ext.fly(m).addCls("keyword").dom.setAttribute("style",h)})}else{var l=new RegExp("^"+e+"$","i");c.select("span.word").each(function(m,n,u){m.dom.firstChild&&m.dom.firstChild.nodeValue.match(l)&&m.addCls("keyword").dom.setAttribute("style",h)})}},this))},nerServiceHandler:function(a){a=a.itemId;var b=[],c=this.getLocationInfo();
if(c)for(var d=c[0].docIndex;d<=c[1].docIndex;d++)b.push(d);else b.push(0);this.clearEntityHighlights();c=this.down("entitieslist");c.clearEntities();c.getEntities(a,b)},clearEntityHighlights:function(){this.getInnerContainer().first().select(".entity").each(function(a){a.removeCls("entity start middle end location person organization misc money time percent date duration set unknown");a.dom.setAttribute("data-qtip",a.dom.getAttribute("data-qtip").replace(/<div class="entity">.*?<\/div>/g,""))})},
highlightEntities:function(){var a=this.getInnerContainer().first(),b=this.getDocumentEntitiesStore(),c=this.localize("entityType");b.forEach(function(d){var e=d.positions;e?e.forEach(function(f){var g=1<f.length;if(g&&2===f.length&&1<f[1]-f[0])for(var h=f[1],k=f[0]+1,l=1;k<h;)f.splice(l,0,k),k++,l++;h=0;for(k=f.length;h<k;h++)if(l=f[h],-1===l)console.warn("missing position for: "+d.term);else if(l=a.selectNode("#_"+d.docIndex+"_"+l,!1)){var m="";g&&(m=0===h?"start ":h===k-1?"end ":"middle ");l.addCls("entity "+
...
b){a&&(this.getInnerContainer().first().destroy(),this.getInnerContainer().setHtml('\x3cdiv class\x3d"readerContainer"\x3e\x3cdiv class\x3d"loading"\x3e'+this.localize("loading")+"\x3c/div\x3e\x3c/div\x3e"),this.getInnerContainer().first().first().mask());a=this.getTokensStore();a.lastOptions&&a.lastOptions.params.skipToDocId&&a.lastOptions.params.skipToDocId!==this.getApiParam("skipToDocId")&&(a=this.getDocumentTermsStore(),a.lastOptions&&this.loadQueryTerms(a.lastOptions.params.query));this.getTokensStore().load(Ext.apply(b||
{},{params:Ext.apply(this.getApiParams(),{stripTags:"blocksOnly",stopList:""})}))},updateText:function(a){var b=this.getInnerContainer().down(".loading");b&&b.destroy();var c=this.getInnerContainer().first().insertHtml(this.getInsertWhere(),a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var d=Ext.get(c.id);d&&d.frame("red")},100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?
1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateLocationMarker:function(a,b){var c=this.getLocationInfo();if(c){var d=c[0],e=c[1];c=this.getCorpus();var f=!1;0!==d.position&&(f=!0);for(var g={},h=0,k=this.getEnableEntitiesList()&&this.getApplication().getEntitiesEnabled?this.getApplication().getEntitiesEnabled():!1,l=d.docIndex;l<=e.docIndex;){var m=c.getDocument(l).get("tokensCount-lexical");m>this.MAX_TOKENS_FOR_NER&&(k=!1);l===e.docIndex&&(m=e.position);l===d.docIndex&&(m-=d.position);
h+=m;g[l]=m;l++}l=this.down("#nerServiceParent");k?l.show():l.hide();h=Math.round(h*a);k=a=0;for(l=d.docIndex;l<=e.docIndex&&!(a=l,k+=g[l],k>=h);l++);e=g[a]-(k-h);f&&a===d.docIndex&&(e+=d.position);d=e/c.getDocument(a).get("tokensCount-lexical");this.down("readergraph").moveLocationMarker(a,d,b)}},getLocationInfo:function(){var a=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",!0)),b=a[0];a=a[a.length-1];return void 0!==b&&void 0!==a?(b=Voyant.data.model.Token.getInfoFromElement(b),
a=Voyant.data.model.Token.getInfoFromElement(a),[b,a]):null}});Ext.define("Voyant.panel.SimpleDocReader",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.simpledocreader",isConsumptive:!0,statics:{i18n:{},api:{docIndex:void 0,docId:void 0},glyph:"xf0f6@FontAwesome"},config:{},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{html:'\x3ciframe style\x3d"width: 100%; height: 100%; border: none;"\x3e\x3c/iframe\x3e',dockedItems:[{dock:"bottom",
...
[];this.getComponent("docsContainer").getComponent("cells").items.each(function(c,d){switch(c.xtype){case "notebookcodeeditorwrapper":d="code";break;case "notebookdatawrapper":d="data";break;default:d="text"}a.push({cellId:c.getCellId(),type:d,content:c.getContent()})});var b={metadata:this.getMetadata(),cells:a};return JSON.stringify(b)},getExtraViewExportItems:function(){return[{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=
...
function(){this.loadFromQueryParams()}.bind(this));this.retrieveAccountInfo()},reset:function(){this.getComponent("notebookContainer").getScrollable().scrollTo(0,0);this.getComponent("notebookContainer").getScrollable().trackingScrollTop=0;this.getComponent("notebookContainer").getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("notebookContainer").getComponent("cells").removeAll()},showSaveDialog:function(a){this.getMetadata().setDateNow("modified");
...
//# sourceMappingURL=voyant.1e4d6c3a2fc0bd912dbc0faae5cb397d.min.js.map
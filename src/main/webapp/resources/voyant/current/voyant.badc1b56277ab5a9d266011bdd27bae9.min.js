...
this.down("#methodsBtn").hide();this.down("#configsBtn").hide();var a="\x3cp\x3e"+this.localize("outlineIntro")+"\x3c/p\x3e";this._setHtmlForCard("main",a);this.up().show().expand();this._resetScrollTop()},handleDocLink:function(a,b){console.log("handleDocLink",a,b);a=a.replace(/^https:\/\/voyant-tools.org\//,"");0===a.indexOf("spyral")?(a=a.replace(/^spyral\//,"").replace(/\/$/,"").replace(/\//,"_"),b=this.findParentByType("notebook"),b.fireEvent("notebookSelected",b,a,null)):0===a.indexOf("http")?
...
//# sourceMappingURL=voyant.badc1b56277ab5a9d266011bdd27bae9.min.js.map
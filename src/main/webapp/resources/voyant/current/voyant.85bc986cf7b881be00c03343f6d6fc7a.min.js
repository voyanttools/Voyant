...
bbar:[{xtype:"button",text:"Add Row",width:125,glyph:"xf067@FontAwesome",handler:function(d){d=d.up("gridpanel");var e=a.headers(!0).map(function(){return""});d.store.loadData([e],!0);e=d.store.getCount();d.getPlugin("cellEditor").startEditByPosition({row:e-1,column:0})}},{xtype:"button",text:"Remove Row",width:135,glyph:"xf068@FontAwesome",handler:function(d){d=d.up("gridpanel");var e=d.getSelection();0<e.length&&d.store.remove(e)}},{xtype:"button",text:"Delete Table",width:135,glyph:"xf1f8@FontAwesome",
handler:function(){this.setTable(void 0)},scope:this}]})}},getRowsFromTable:function(){var a=this.down("#tableEditor");if(a){a=a.getStore();var b=a.getModel().getFields().filter(function(c){return!0!==c.generated}).map(function(c){return c.getName()});return a.getData().items.map(function(c){var d={};b.forEach(function(e){d[e]=c.get(e)});return d})}},getCode:function(a){var b=new Ext.Deferred,c=this.down("#cards").getLayout().getActiveItem(),d=c.getItemId();this.setType(d);if(this.down("#tableEditor"))return c=
this.getRowsFromTable(),c=a+"\x3dnew Spyral.Table("+JSON.stringify(c)+")",b.resolve(c),b.promise;"variable"===d?(c=c.down("combo").getRawValue(),this.setValue(c),""!==c?b.resolve(a+"\x3dnew Spyral.Table("+c+")"):b.reject("No variable specified!")):"file"===d?(d=c.getFile(),this.setValue(c.getFileName()),Spyral.Util.blobToString(d).then(function(e){b.resolve(a+"\x3dnew Spyral.Table(`"+e+"`)")},function(){b.reject()})):"text"===d&&(c=c.down("textfield").getValue().replaceAll('"','"').replaceAll("\t",
...
//# sourceMappingURL=voyant.85bc986cf7b881be00c03343f6d6fc7a.min.js.map
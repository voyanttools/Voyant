...
g=g.createRange(),g.selectNodeContents(f),e.removeAllRanges(),e.addRange(g)):g.body.createTextRange&&(g=g.body.createTextRange(),g.moveToElementText(f),g.select())})})},exportSpyral:function(){var a=Ext.getClassName(this).split(".").pop(),b=this.getApplication().getModifiedApiParams();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),delete b.corpus);var c=b&&"debug"in b;delete b.view;delete b.debug;a="['\x3ch1\x3eSpyral Notebook Imported from Voyant Tools\x3c/h1\x3e','\x3cp\x3eThe proceeding code cells load your corpus, assign it to a variable, and then load your tool. You can use this as a base to create your own notebook.\x3c/p\x3e\x3cp\x3eDon\\'t forget to save your changes by clicking on the cloud icon!\x3c/p\x3e','loadCorpus(\""+
...
//# sourceMappingURL=voyant.96ed78fbd483aa68c79427ddf4c37868.min.js.map
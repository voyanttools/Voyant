...
[];this.getComponent("cells").items.each(function(b,d){switch(b.xtype){case "notebookcodeeditorwrapper":d="code";break;case "notebookdatawrapper":d="data";break;default:d="text"}a.push({cellId:b.getCellId(),type:d,content:b.getContent()})});var b={metadata:this.getMetadata(),cells:a};return JSON.stringify(b)},getExtraExportItems:function(){return[{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=(this.getNotebookId()||
"spyral")+".html",c=this.generateExportHtml(),d={type:"text/html"};try{var e=new File([c],b,d)}catch(f){e=new Blob([c],d)}c=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",b);a.setAttribute("href",c)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]}});Ext.define("Voyant.notebook.Catalogue",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebookcatalogue",statics:{i18n:{title:"Spyral Notebooks Catalogue",browse:"Browse Notebooks",keywords:"Keywords",author:"Author",language:"Language",license:"License",search:"Search within notebooks",noResults:"No matching notebooks",suggested:"Suggested Notebooks",load:"Load Selected Notebook",cancel:"Cancel"}},window:void 0,store:void 0,template:void 0,gettingFacets:!1,constructor:function(){this.store=
...
metadataEditor:"Edit Metadata",metadataReset:"Reset",metadataSave:"Save",metadataCancel:"Cancel",preparingExport:"Preparing Export"},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0}},config:{notebookId:void 0,metadata:void 0,isEdited:!1,version:"3.0",storageSolution:"voyant"},metadataWindow:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0,catalogueWindow:void 0,spyralTernDocs:void 0,ecmaTernDocs:void 0,browserTernDocs:void 0,constructor:function(a){Ext.apply(a,{title:this.localize("title"),
...
notebookWrapperMoveDown:this.notebookWrapperMoveDown,notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,notebookInitialized:this.notebookInitialized,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({listeners:{fileLoaded:function(a){},fileSaved:function(a,
c){this.unmask();null!==c&&((a=this.getNotebookId())&&c==a||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1))},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({listeners:{fileLoaded:function(a,c){a=c.owner;var b=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.loadFromString(c);c=encodeURIComponent(a+"/"+b+"/"+e);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+
"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},fileSaved:function(a,c){a=c.owner;var b=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}});this.catalogueWindow=
new Voyant.notebook.Catalogue({listeners:{notebookSelected:function(a,c){a.hideWindow();this.loadFromId(c);this.setNotebookId(c)},scope:this}})},init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Promise.all([Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/ecmascript.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+
"resources/spyral/docs/browser.json"})]).then(function(a){this.spyralTernDocs=Ext.JSON.decode(a[0].responseText);this.spyralTernDocs.Corpus=this.spyralTernDocs.Spyral.Corpus;this.spyralTernDocs.Table=this.spyralTernDocs.Spyral.Table;this.spyralTernDocs.loadCorpus=this.spyralTernDocs.Spyral.Corpus.load;this.spyralTernDocs.createTable=this.spyralTernDocs.Spyral.Table.create;this.spyralTernDocs.show=this.spyralTernDocs.Spyral.Util.show;this.spyralTernDocs.showError=this.spyralTernDocs.Spyral.Util.showError;
this.ecmaTernDocs=Ext.JSON.decode(a[1].responseText);this.browserTernDocs=Ext.JSON.decode(a[2].responseText);this.loadFromQueryParams()}.bind(this),function(){this.loadFromQueryParams()}.bind(this))},reset:function(){this.getScrollable().scrollTo(0,0);this.getScrollable().trackingScrollTop=0;this.getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));
this.getMetadata().setDateNow("modified");this.updateCachedOutput().then(function(a){},function(a){console.warn("Error updating cached results")}).finally(function(){var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()||void 0===this.voyantStorageDialogs.getAccessCode()?"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookId()):this.voyantStorageDialogs.doSave({notebookId:this.getNotebookId(),
data:b,metadata:c,accessCode:this.voyantStorageDialogs.getAccessCode()})}.bind(this))},updateCachedOutput:function(){return Ext.Promise.all(this.query("notebookrunnableeditorwrapper").map(function(a){return a.results.updateCachedOutput()}))},exportToolClick:function(a){a.mask(a.localize("preparingExport"));a.updateCachedOutput().finally(function(){a.unmask();a.mixins["Voyant.util.Toolable"].exportToolClick.call(this,a)})},getExportUrl:function(a){return location.href},loadFromQueryParams:function(){var a=
Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname),d=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(a,b){0==a.trim().indexOf("\x3c")?0===b?this.setMetadata(new Spyral.Metadata({title:a})):this.addText(a):this.addCode(a)},this):a.input?0===a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?(this.loadFromId(c[1]),this.setStorageSolution("voyant")):
d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),this.setIsEdited(!1));if(b){var e=this;Ext.defer(function(){e.runAll()},100)}},loadFromString:function(a){a=a.trim();if(0===a.indexOf("http"))this.loadFromUrl(a);else if(0===a.indexOf("{"))this.loadFromJson(a);else if(/^[\w-_]+$/.test(a))this.loadFromId(a);else{if(0!==a.indexOf("\x3c")||-1===a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),
buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.importFromHtml(a)},this)}return!0},loadFromJson:function(a){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),
msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setMetadata(new Spyral.Metadata(b.metadata));var a=[];b.cells.forEach(function(b){var c=void 0;switch(b.type){case "text":this.addText(b.content,void 0,b.cellId);break;case "code":c=this.addCode(b.content,void 0,b.cellId);break;case "data":c=this.addData(b.content,void 0,b.cellId)}c&&(c.on("initialized",function(){var b=a.indexOf(c);-1!==b?(a.splice(b,
1),0===a.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",c)}.bind(this)),a.push(c))},this)},this)},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!==b.getNotebookId()&&
b.setNotebookId(a.notebook.id);b.setIsEdited(!1)}).catch(function(a){b.unmask();Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){b.push(c);if(a&&a===c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=
!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(!0,b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}});b=b.concat(e);Ext.defer(d._run,100,d,[a,b])},function(a){})}},notebookInitialized:function(){},getNotebookVariables:function(a){var b=
[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});return b},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e",
language:"English"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");

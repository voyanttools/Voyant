...
this.localize("rawFreqs")+'"\x3e{rawFreq}\x3c/span\x3e)\x3c/span\x3e',e=this.localize(c+"Title");e=="["+c+"Title]"&&(e=c.replace(/^facet\./,"").replace(/^extra./,""));this.localize("matchingDocuments");Ext.applyIf(a,{title:e,collapsible:!0,facet:c,columns:[{renderer:function(g,h,k){return'\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("matchingDocuments")+'"\x3e'+k.getInDocumentsCount()+"\x3c/span\x3e) \x3c/span\x3e"+(k.getLabel?k.getLabel():
k.getTerm()+'\x3cspan style\x3d"font-size: smaller;"\x3e (\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("rawFreqs")+'"\x3e'+k.getRawFreq()+"\x3c/span\x3e)\x3c/span\x3e")},flex:1}],bbar:[{xtype:"querysearchfield",width:"100%",tokenType:c.replace("facet.",""),itemTpl:d}],corpus:this.getCorpus()});var f=b.add(a);f.getSelectionModel().on("selectionchange",function(g,h){var k=[];h.forEach(function(l){k.push({facet:f.facet,label:l.getLabel?l.getLabel():l.getTerm()})});this.getFacets()[c]=k;

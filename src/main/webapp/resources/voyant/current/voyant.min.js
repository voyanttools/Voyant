...
0<e.length&&"string"!==typeof e[0]&&"term"in e[0]&&"docIndex"in e[0]){var g={},h={};e.forEach(function(l){g[l.term]=!0;h[l.docIndex]=!0});f.query=Object.keys(g);f.docIndex=Object.keys(h)}else f.query=e;else if("documentsClicked"==d){var k=[];e.forEach&&e.forEach(function(l){k.push(l.getIndex())});f.docIndex=k}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(l){return l.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=e.map(function(l){return l.getTerm()}),f.docIndex=e.map(function(l){return l.getDocIndex()}));

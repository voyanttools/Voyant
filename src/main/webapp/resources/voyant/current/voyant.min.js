...
docIndex:void 0});this.loadFromApis()},termsClicked:{fn:function(c,d){if(this.getStore().getCorpus()){var e=[];d.forEach(function(f){Ext.isString(f)?e.push(f):f.term?e.push(f.term):f.getTerm&&e.push(f.getTerm())});0<e.length&&(this.setApiParams({docIndex:void 0,docId:void 0,query:e}),this.isVisible()&&this.isVisible()&&this.getStore().clearAndLoad({params:this.getApiParams()}))}},scope:this}}});a.callParent(arguments);a.getStore().getProxy().setExtraParam("withDistributions",!0)}});Ext.define("Voyant.panel.CorpusTerms",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.corpusterms",statics:{i18n:{},api:{stopList:"auto",query:void 0,maxBins:100,termColors:"categories",comparisonCorpus:void 0,columns:void 0},glyph:"xf0ce@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"},{xtype:"termcolorsoption"},{xtype:"corpusselector",name:"comparisonCorpus",fieldLabel:"comparison corpus"}]},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,
...
[];c.forEach(function(e){Ext.isString(e)?d.push(e):e.term?d.push(e.term):e.getTerm&&d.push(e.getTerm())});0<d.length&&(this.setApiParams({docIndex:void 0,docId:void 0,query:d}),this.isVisible()&&this.isVisible()&&this.getStore().load({params:this.getApiParams()}))}},scope:this}}});this.callParent(arguments);this.getStore().getProxy().setExtraParam("withDistributions",!0)}});Ext.define("Voyant.panel.Documents",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel","Voyant.util.Downloadable"],alias:"widget.documents",isConsumptive:!0,statics:{i18n:{newCorpusError:"There was an error creating the new the corpus. You may not have permission to do this."},api:{query:void 0,docIndex:void 0,docId:void 0,columns:void 0},glyph:"xf0ce@FontAwesome"},MODE_EDITING:"editing",MODE_NORMAL:"normal",config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],mode:this.MODE_NORMAL},
constructor:function(a){var b=Ext.create("Voyant.data.store.Documents",{selModel:{pruneRemoved:!1},proxy:{extraParams:{forTool:"documents"}}}),c=[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"}],d=this;a&&a.mode==this.MODE_EDITING||c.push({text:this.localize("modify"),tooltip:this.localize("modifyTip"),glyph:"xf044@FontAwesome",scope:this,itemId:"modifyButton",handler:function(e){Ext.create("Ext.window.Window",{title:this.localize("title"),modal:!0,width:"80%",minWidth:300,minHeight:200,
height:"80%",layout:"fit",frame:!0,border:!0,items:{xtype:"documents",mode:this.MODE_EDITING,corpus:this.getStore().getCorpus(),header:!1,viewConfig:{plugins:{ptype:"gridviewdragdrop"},listeners:{beforedrop:function(f,g,h,k,l){return this.getStore().getCount()<this.getStore().getCorpus().getDocumentsCount()?(f=this.up("panel"),Ext.Msg.show({title:f.localize("error"),message:f.localize("reorderFilteredError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}),!1):!0}}}},buttons:[{text:this.localize("add"),tooltip:this.localize("addTip"),
glyph:"xf067@FontAwesome",handler:function(f){f.up("window").close();Ext.create("Ext.window.Window",{header:!1,modal:!0,layout:"fit",items:{xtype:"corpuscreator",corpus:this.getStore().getCorpus()}}).show()},scope:this},{text:this.localize("remove"),tooltip:this.localize("removeTip"),glyph:"xf05e@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"remove",scope:this},{text:this.localize("keep"),tooltip:this.localize("keepTip"),glyph:"xf00c@FontAwesome",
hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"keep",scope:this},{text:this.localize("reorder"),tooltip:this.localize("reorderTip"),glyph:"xf0dc@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"reorder",scope:this},{text:"Cancel",glyph:"xf00d@FontAwesome",handler:function(f){f.up("window").close()}}]}).show()}},{text:this.localize("downloadButton"),glyph:"xf019@FontAwesome",
itemId:"downloadButton",handler:function(){d.downloadFromCorpusId(d.getStore().getCorpus().getId())}});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),columns:[{xtype:"rownumberer",renderer:function(e,f,g){return g.getIndex()+1},sortable:!1},{text:this.localize("documentTitle"),dataIndex:"title",sortable:!0,renderer:function(e,f,g){return g.getTitle()},flex:3},{text:this.localize("documentAuthor"),dataIndex:"author",sortable:!0,hidden:!0,renderer:function(e,f,g){return g.getAuthor()},
flex:2},{text:this.localize("documentPubDate"),dataIndex:"pubDate",sortable:!0,hidden:!0,renderer:function(e,f,g){return g.getPubDate()},flex:2},{text:this.localize("documentPublisher"),dataIndex:"publisher",sortable:!1,hidden:!0,renderer:function(e,f,g){return g.getPublisher()},flex:2},{text:this.localize("documentPubPlace"),dataIndex:"pubPlace",sortable:!1,hidden:!0,renderer:function(e,f,g){return g.getPubPlace()},flex:2},{text:this.localize("documentKeyword"),dataIndex:"keyword",sortable:!1,hidden:!0,

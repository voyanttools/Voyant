...
n;for(n in k)if(-1!==this.termsFilter.indexOf(n)){var u=k[n];if(u){m++;this.SEPARATE_LINES_FOR_TERMS&&c();var v=0,p=u.color.join(",");this.ctx.strokeStyle="rgba("+p+", 1)";this.ctx.fillStyle="rgba("+p+", 0.35)";this.ctx.lineWidth=.25;h+=u.rawFreq;v+=u.rawFreq;for(var q=l&&this.lastClickedBubbles[b][n],r=0;r<u.pos.length;r++){var w=u.pos[r];if(0<w.radius){var x=!1;q&&this.lastClickedBubbles[b][n]==w.id&&(this.ctx.strokeStyle="rgba(0, 0, 0, 0.75)",this.ctx.fillStyle="rgba("+p+", 0.5)",this.ctx.lineWidth=
1,x=!0);this.ctx.beginPath();this.ctx.arc(w.x+f,this.yIndex,w.radius,0,e,!0);this.ctx.closePath();this.ctx.fill();this.ctx.stroke();x&&(this.ctx.strokeStyle="rgba("+p+", 1)",this.ctx.fillStyle="rgba("+p+", 0.35)",this.ctx.lineWidth=.25)}}a.freqCounts[n]=v;this.SEPARATE_LINES_FOR_TERMS&&(this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",this.ctx.font="10px Verdana",this.ctx.fillText(v,f+d+5,this.yIndex-4),this.yIndex+=this.maxRadius)}}this.SEPARATE_LINES_FOR_TERMS&&0==m&&(c(),this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",
...
this.tx,this.y+this.ty);f.rotate(this.rotation);f.fillText(this.text,0,0);f.restore()}};function WordController(a){function b(r){for(var w=Math.log(10*r.relativeSize)*Math.LOG10E,x=(w+r.relativeSize)/2,z=0,L=0;L<r.text.length;L++){var H=r.text.charAt(L);z="f"==H||"i"==H||"j"==H||"l"==H||"r"==H||"t"==H?z+w/3:"m"==H||"w"==H?z+w/(4/3):z+w/1.9}return x*z}function c(){p.sort(function(r,w){return r.origSize>w.origSize?-1:r.origSize<w.origSize?1:0})}function d(){for(var r=0;r<p.length;r++){var w=p[r];var x=w;var z=f.sizeAdjustment;z*=b(x);x=(Math.sqrt(6)*Math.sqrt(6*Math.pow(x.text.length,
2)+z*x.text.length)-6*x.text.length)/(2*x.text.length);w.fontSize=x>f.minFontSize?x:f.minFontSize;w.fontFamily="Impact";x=w;g.context.save();g.context.textBaseline="alphabetic";g.context.font=x.fontSize+"px "+x.fontFamily;x.width=g.context.measureText(x.text).width;x.height=Math.ceil(1.15*g.context.measureText("m").width);g.context.restore();w.tx=0;w.ty=w.height;x=0;f.getWordOrientation()===f.MIXED&&null==w.text.match(/\s/)&&.66<Math.random()&&(x=w.height,w.height=w.width,w.width=x,0==Math.round(Math.random())?
(x=90,w.ty=0):(x=-90,w.ty=w.height,w.tx=w.width));w.size=Math.max(w.height,w.width);w.rotation=Math.PI/180*x;g.context.fillStyle=g.canvas.style.backgroundColor;g.context.fillRect(0,0,g.canvas.width,g.canvas.height);w.draw(g.context);x=g.context.getImageData(w.x,w.y,w.width,w.height);z=[];for(var L=0;L<w.width;L++){var H=Math.floor(L/f.COARSENESS)*f.COARSENESS;null==z[H]&&(z[H]={});for(var F=0;F<w.height;F++){var I=Math.floor(F/f.COARSENESS)*f.COARSENESS;var E=4*(L+F*x.width);E=[x.data[E],x.data[E+
1],x.data[E+2],x.data[E+3]];"rgb("+E[0]+", "+E[1]+", "+E[2]+")"!=g.canvas.style.backgroundColor&&(z[H][I]=!0);z[H][I]&&(F=I+f.COARSENESS)}}w.mask=z}}function e(){g.clear();for(var r=p.length;r--;){var w=p[r];w.alpha=1;w.live&&w.draw(g.context)}r=$(g.canvas);if(null!=n){r.css("cursor","pointer");g.context.save();g.context.textBaseline="alphabetic";g.context.font="12px Arial";w=g.context.measureText(n.text).width;var x=g.context.measureText(n.value).width;w=(w>x?w:x)+20;x=u+15;var z=v+25,L=r.width();
r=r.height();x+w>=L&&(x-=w);z+40>=r&&(z-=40);g.context.fillStyle="rgba(255,255,255,0.9)";g.context.strokeStyle="rgba(100,100,100,0.9)";g.context.translate(x,z);g.context.fillRect(0,0,w,40);g.context.strokeRect(0,0,w,40);g.context.fillStyle="rgba(0,0,0,0.9)";g.context.fillText(n.text+":",8,18);g.context.fillText(n.value,8,30);g.context.restore()}else r.css("cursor","default")}var f=this,g=a;this.CIRCLE=0;this.ratio=1;var h=this.CIRCLE;this.getLayout=function(){return h};this.setLayout=function(r){h=
r};this.HORIZONTAL=0;var k=this.MIXED=1;this.getWordOrientation=function(){return k};this.setWordOrientation=function(r){k=r};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var n=null,u=0,v=0,p=[];this.getWords=function(){return p};this.setWords=function(r){p=r};this.sizeAdjustment=100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var q={};this.addWords=function(r){for(var w=!1,x=0;x<r.length;x++){var z=r[x];var L=null==
z.color||""==z.color?g.colors[Math.floor(Math.random()*g.colors.length)]:z.color;var H=null==z.size||""==z.size?Math.floor(40*Math.random()):parseFloat(z.size);var F=z.word,I=z.label,E=z.value;z=!1;null==q[F]&&(q[F]=!0,H>f.largestWordSize&&(f.largestWordSize=H,z=!0),H<f.smallestWordSize&&(f.smallestWordSize=.8*H,z=!0),F=new Word(F,H,L,I,E),p.push(F));w=z||w}c();this.setRelativeSizes();this.calculateSizeAdjustment();w?this.resizeWords():d()};this.resetWordCoordinates=function(){g.clear();clearTimeout(m);
for(var r=0;r<p.length;r++){var w=p[r];w.x=0;w.y=0;w.tx=0;w.ty=0}};this.calculateSizeAdjustment=function(){this.ratio=g.canvas.width/g.canvas.height;var r=g.canvas.width*g.canvas.height;this.minFontSize=1E5>r?8:12;for(var w=0,x=0;x<p.length;x++){var z=b(p[x]);w+=z}this.sizeAdjustment=r/w};this.setRelativeSizes=function(){for(var r=0;r<p.length;r++){var w=p[r],x=this.smallestWordSize;w.relativeSize=.1+(w.origSize-x)/(this.largestWordSize-x)*.9}};this.resizeWords=function(){g.clear();d();c()};this.arrangeWords=
function(){clearTimeout(m);g.clear();this.toggleLoadingText();if(0<p.length){var r=function(H,F,I){for(var E=0;E<I.width;E+=this.COARSENESS)for(var D=0;D<I.height;D+=this.COARSENESS)I.mask[E]&&I.mask[E][D]&&(this.grid[E+H]||(this.grid[E+H]=[]),this.grid[E+H][D+F]=I)},w=function(H){H.alpha+=.25;H.draw(g.context)},x=function(H,F,I,E){r(H,F,I);I.x=H;I.y=F;I.live=!0;E&&I.draw(g.context)},z=function(H,F,I,E,D){for(var J=0;J<=E;J+=this.COARSENESS)for(var N=0;N<=I;N+=this.COARSENESS)if(D[J]&&D[J][N]&&null!=
...
N+=O;B+=.05}x(G,K,J);if(g.useFadeEffect)for(G=J.alpha=0;G<l;G++)K=p[G],1>K.alpha&&w(K);else J.alpha=1,J.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(H--)};this.grid=[];l=0;L=L.createDelegate(this);z=z.createDelegate(this);x=x.createDelegate(this);w=w.createDelegate(this);r=r.createDelegate(this);this.doingArrange=!0;m=setInterval(L,50)}else alert("Error: There are no words to arrange.")};this.toggleLoadingText=function(r){g.context.save();
g.context.fillStyle=r?"black":g.canvas.style.backgroundColor;g.context.textBaseline="top";g.context.font="10px Arial";r=g.context.measureText("Loading").width+10;g.context.fillText("Loading",g.canvas.width-r,10);g.context.restore()};this.startUpdates=function(){m=setInterval(e,f.UPDATE_RATE)};this.stopUpdates=function(){null!=n&&(n=null,e());clearTimeout(m)};this.handleMouseMove=function(r){if(!this.doingArrange){for(var w=p.length;w--;)p[w].isOver=!1;var x=$(g.canvas).offset(),z=(r.pageX-x.left)%
this.COARSENESS;w=r.pageX-x.left-z;z=(r.pageY-x.top)%this.COARSENESS;r=r.pageY-x.top-z;n=this.findWordByCoords(w,r);null!=n&&(n.isOver=!0,u=w,v=r)}};this.handleWordClick=function(r){var w=$(g.canvas).offset(),x=(r.pageX-w.left)%this.COARSENESS,z=r.pageX-w.left-x;x=(r.pageY-w.top)%this.COARSENESS;r=this.findWordByCoords(z,r.pageY-w.top-x);if(null!=r)return{text:r.text,value:r.value}};this.findWordByCoords=function(r,w){var x=null;null!=this.grid[r]&&(null!=this.grid[r][w]?x=this.grid[r][w]:null!=this.grid[r][w+
this.COARSENESS]&&(x=this.grid[r][w+this.COARSENESS]));null==x&&null!=this.grid[r+this.COARSENESS]&&(null!=this.grid[r+this.COARSENESS][w]?x=this.grid[r+this.COARSENESS][w]:null!=this.grid[r+this.COARSENESS][w+this.COARSENESS]&&(x=this.grid[r+this.COARSENESS][w+this.COARSENESS]));return x}}
...
g,h,M,!0,v,H,N,n,p,q,r,w,x,z);D=new doubletree.Tree(C.select("g"),g,h,A,!1,v,H,N,n,p,q,r,w,x,z)});E.handleAltPress=m.alt;D.handleAltPress=m.alt;E.handleShiftPress=m.shift;D.handleShiftPress=m.shift;E.handleClick=m.click;D.handleClick=m.click;L=!0;return e};e.setupFromArrays=function(B,O,M,A,G,K,P,Q){void 0==G&&F&&(G=F.caseSensitive());void 0==K&&F&&(K=F.fieldNames());void 0==P&&F&&(P=F.fieldDelim());void 0==Q&&F&&(Q=F.distinguishingFieldsArray());F=new doubletree.Trie(G,K,P,Q);I=new doubletree.Trie(G,
...
function(B){if(!arguments.length)return m;m=B;return e};e.showTokenExtra=function(B){if(!arguments.length)return n;n=B;return e};e.scaleLabels=function(B){if(!arguments.length)return u;u=B;return e};e.succeeded=function(){return L};e.sortFun=function(B){if(!arguments.length)return v;v=B;return e};e.nodeText=function(B){if(!arguments.length)return p;p=B;return e};e.tokenExtraText=function(B){if(!arguments.length)return q;q=B;return e};e.rectColor=function(B){if(!arguments.length)return r;r=B;return e};
e.rectBorderColor=function(B){if(!arguments.length)return w;w=B;return e};e.continuationColor=function(B){if(!arguments.length)return x;x=B;return e};e.basicStyles=function(B){if(!arguments.length)return z;Object.keys(z).forEach(function(O){O in B&&Object.keys(z[O]).forEach(function(M){M in B[O]&&(z[O][M]=B[O][M])})});return e};return e};doubletree.Tree=function(e,f,g,h,k,l,m,n,u,v,p,q,r,w,x){function z(A){A.children&&(A._children=A.children,A._children.forEach(z),A.children=null)}function L(A){A.parent&&
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(q,r,w){this.id=r;this.count=w;this.info={count:w,ids:{}};if(null==q)this.item=k;else{this.item=q;this.info.ids={};this.info.ids[r]=!0;q=q.split(n);for(var x in q)this.info[m[x]]=[q[x]]}this.nodes={};this.addNgram=function(z,L,H){H||(H=1);if(0<z.length){var F=z.shift();var I=F.split(n);var E=v&&this.item==k?"":I.filter(function(N,B){return-1<u.indexOf(m[B])}).map(function(N){return l?N.toLocaleLowerCase():N}).join(n)}else E=F=h;if(E in this.nodes&&
...
D.maxLen=Math.max(F,D.name.length),D.minCount=d3.min(D.children.map(function(O){return O.minCount})));return D}z||(z=[]);var H=JSON.parse(JSON.stringify(this));return L(z,0,H)}}function g(q,r){for(var w in r)q[w]=r[w]}var h=" ",k="_root_",l=!a&&!0;b||(b=["item"]);var m=b;n||(n="\t");var n=c;u||(u=[m[0]]);var u=d,v=e;void 0==v&&(v=!0);var p=new f(k,-1,0);this.addNgram=function(q,r,w){p.addNgram(q,r,w)};this.getUniqRoot=function(){var q=new doubletree.Trie(!l,m,n,u);q.trie(p.getUniqRoot());return q};
...
"black")}).selectAll("text").data(function(b){return b.frequencyArray}).enter().append("text").attr("class",function(b){return a.removeFilteredCharacters(b.wordString)}).attr("x",function(b){var c=.5/b.numInSeries-.5,d=b.posInSeries/b.numInSeries*.8;b=b.counter+a.callOffset()+c+d;return a.xScale(b)}).attr("y",function(b){return a.yScale(b.freq)}).attr("text-anchor","middle").attr("transform",function(b){var c=.5/b.numInSeries-.5,d=b.posInSeries/b.numInSeries*.8;c=b.counter+a.callOffset()+c+d;b=b.freq;
...
-1;a=a=this.removeFilteredCharacters(a);for(var c=this.overlayQueue.length;0<=--c;)a===this.overlayQueue[c].selector&&(b=c);return b},isTermSelected:function(a){return-1!==this.getTermIndex(a)},doTermSelect:function(a,b){var c=c=this.removeFilteredCharacters(a),d=this.parent.getApiParam("selectedWords");d.push(a);this.parent.setApiParams({selectedWords:d});d=this.parent.getApplication().getColorForTerm(a,!0);if(!0===b)b=this.parent.query("[xtype\x3dlegend]")[0],b.getStore().add({name:a,mark:d}),b.refresh();
else{b=this.parent.query("[xtype\x3dlegend]")[0];var e=b.getStore().findRecord("name",a);null!==e&&(e.set("mark",d),b.refresh())}b=this.prepareFullPath(a);a={word:a,selector:c,params:{params:{},type:a},fullPath:b.path,pathMin:b.min,pathMax:b.max,colour:d};c===this.lastSlippery&&(this.isSliderVisible&&this.sliderOverlayOff(c),this.lastSlippery=null);this.chart.select("g[class\x3dfrequency-line-"+c.replace(/'/g,"\\'")+"]").remove();this.overlayQueue.push(a);this.chartOverlayOn(a);this.isSliderVisible&&
this.sliderOverlayOn(a)},doTermDeselect:function(a,b){var c=this.removeFilteredCharacters(a),d=this.getTermIndex(a);!0===b&&(b=this.parent.query("[xtype\x3dlegend]")[0],d=b.getStore().findExact("name",a),b.getStore().removeAt(d),b.refresh());a=this.parent.getApiParam("selectedWords");b=0;for(var e=a.length;b<e;b++)a[b]===c&&(a.splice(b,1),this.parent.setApiParams({selectedWords:a}));this.chartOverlayOff(c);this.overlayQueue.splice(d,1);this.isSliderVisible&&this.sliderOverlayOff(c);this.lastSticky=
...
g),g>d&&(d=g))}return{path:b,min:c,max:d}},updateFullPath:function(){for(var a=this.overlayQueue.length;0<a--;){var b=this.prepareFullPath(this.overlayQueue[a].word);this.overlayQueue[a].fullPath=b.path;this.overlayQueue[a].pathMin=b.min;this.overlayQueue[a].pathMax=b.max}},buildSliderPath:function(a){var b=this;return d3.line().x(function(c){return b.xSliderScale(c.x)}).y(function(c){return b.ySliderScale(c.y)}).curve(d3.curveNatural)(a)},sliderOverlayOn:function(a){this.transitionSliderOverlay(a);
this.chart.append("g").attr("class","slider").attr("id","slider-line-"+a.word).append("path").attr("d",this.buildSliderPath(a.fullPath)).style("stroke",a.colour).style("stroke-width",2).style("fill","none");this.redrawSlider()},sliderOverlayOff:function(a){this.chart.selectAll("g[id\x3dslider-line-"+a.replace(/'/g,"\\'")+"]").remove();this.transitionSliderOverlay()},redrawSliderOverlay:function(){for(var a=0;a<this.overlayQueue.length;a++)this.sliderOverlayOff(this.overlayQueue[a].selector),this.sliderOverlayOn(this.overlayQueue[a])},
transitionSliderOverlay:function(a){this.updateYSliderScale(a||0);for(a=this.overlayQueue.length;0<a--;)this.chart.selectAll("g#slider-line-"+this.overlayQueue[a].selector.replace(/'/g,"\\'")).select("path").transition().duration(300).ease(d3.easeLinear).attr("d",this.buildSliderPath(this.overlayQueue[a].fullPath))},preparePath:function(a){for(var b=[],c,d,e=0;3>e&&0<this.shiftCount-e;e++){for(var f=c=0;f<this.allData[this.shiftCount-(1+e)].allDataInternal.length;f++)for(var g=0;g<this.allData[this.shiftCount-
(1+e)].allDataInternal[f].frequencyArray.length;g++)this.allData[this.shiftCount-(1+e)].allDataInternal[f].frequencyArray[g].wordString===a&&(c=this.yScale(this.allData[this.shiftCount-(1+e)].allDataInternal[f].frequencyArray[g].freq),b.unshift({x:this.shiftCount-(1+e),y:c}),c=1);0===c&&(f=this.yScale(this.minFreq),b.unshift({x:this.shiftCount-(1+e),y:f}))}e=this.shiftCount;for(c=this.numVisPoints+this.shiftCount;e<c;e++){f=d=0;for(var h=this.allData[e].allDataInternal.length;f<h;f++){g=0;for(var k=
this.allData[e].allDataInternal[f].frequencyArray.length;g<k;g++)this.allData[e].allDataInternal[f].frequencyArray[g].wordString===a&&(d=this.yScale(this.allData[e].allDataInternal[f].frequencyArray[g].freq),b.push({x:e,y:d}),d=1)}0===d&&(f=this.yScale(this.minFreq),b.push({x:e,y:f}))}for(e=0;3>e&&this.numVisPoints+this.shiftCount+e<this.numDataPoints;e++){for(f=c=0;f<this.allData[this.numVisPoints+this.shiftCount+e].allDataInternal.length;f++)for(g=0;g<this.allData[this.numVisPoints+this.shiftCount+
e].allDataInternal[f].frequencyArray.length;g++)this.allData[this.numVisPoints+this.shiftCount+e].allDataInternal[f].frequencyArray[g].wordString===a&&(d=this.yScale(this.allData[this.numVisPoints+this.shiftCount+e].allDataInternal[f].frequencyArray[g].freq),b.push({x:this.numVisPoints+this.shiftCount+e,y:d}),c=1);0===c&&(f=this.yScale(this.minFreq),b.push({x:this.numVisPoints+this.shiftCount+e,y:f}))}return b},chartOverlayOn:function(a){var b=this;this.chart.selectAll("g[class\x3dsection]").selectAll("g[class\x3dfrequencies]").selectAll("text[class\x3d"+
a.selector.replace(/'/g,"\\'")+"]").style("fill",a.colour).style("fill-opacity",1);var c=this.preparePath(a.word),d,e=d3.line().x(function(f){d=f.x;return b.xScale(f.x+b.callOffset())}).y(function(f){return f.y}).curve(d3.curveNatural);a=this.chart.select(".overlay").append("g").attr("class","frequency-line-"+a.selector).append("path").attr("d",e(c)).style("stroke",a.colour).style("stroke-width",2).style("fill","none");c=this.xScale(d)-this.xScale(d+this.callOffset());"left"!==this.transitionCall&&
"right"!==this.transitionCall||a.transition().duration(b.getDuration()).ease(d3.easeLinear).attr("transform","translate("+c+")")},chartOverlayOff:function(a){var b=this;this.chart.selectAll("text."+a.replace(/'/g,"\\'")).style("fill","black").style("fill-opacity",function(c){return b.opacityScale(c.freq)});this.chart.select("g.frequency-line-"+a.replace(/'/g,"\\'")).remove()},redrawChartOverlay:function(){for(var a=0;a<this.overlayQueue.length;a++)this.chartOverlayOff(this.overlayQueue[a].selector),
this.chartOverlayOn(this.overlayQueue[a])},manageAllYScales:function(){this.manageFontScale();this.manageOpacityScale();this.manageYScale();this.manageYSliderScale()},manageFontScale:function(){this.fontScale.domain([this.minFreq,this.absMaxFreq*this.valFraction]).range([10,this.maxFont])},manageOpacityScale:function(){this.opacityScale.domain([0,this.absMaxFreq*this.valFraction]).range([.4,.8])},manageYScale:function(){"linear"==this.parent.getApiParam("yAxisScale")&&(this.yScale=d3.scaleLinear());
"log"==this.parent.getApiParam("yAxisScale")&&(this.yScale=d3.scaleLog());this.yScale.domain([this.minFreq,this.absMaxFreq*this.valFraction*1.25]).rangeRound([this.container.getHeight()-this.bPadding,this.tPadding+this.getSliderHeight()])},manageYSliderScale:function(){var a=this.tPadding,b=this.tPadding+this.getSliderHeight();"linear"==this.parent.getApiParam("yAxisScale")&&(this.ySliderScale=d3.scaleLinear());"log"==this.parent.getApiParam("yAxisScale")&&(this.ySliderScale=d3.scaleLog());this.ySliderScale.domain([this.minFreq,
this.absMaxFreq]).rangeRound([b,a])},updateYSliderScale:function(a){a=a||0;for(var b=this.minFreq,c=0,d=this.overlayQueue.length;0<d--;)this.overlayQueue[d].pathMin<b&&(b=this.overlayQueue[d].pathMin),this.overlayQueue[d].pathMax>c&&(c=this.overlayQueue[d].pathMax);0!=a&&a.pathMin<b&&(b=a.pathMin);0!=a&&a.pathMax>c&&(c=a.pathMax);this.ySliderScale.domain([b,c])},manageAllXScales:function(){this.manageXScale();this.manageXSliderScale()},manageXScale:function(){this.xScale.domain([this.shiftCount-.5,
this.numVisPoints+this.shiftCount-.5]).range([this.lPadding,this.container.getWidth()-this.rPadding])},manageXSliderScale:function(){this.xSliderScale.domain([0,this.numDataPoints-1]).range([this.lPadding,this.container.getWidth()-this.rPadding])},getSliderHeight:function(){return this.isSliderVisible?this.sliderHeight+this.sliderBPadding:0},setSliderHeight:function(){this.sliderHeight=Math.max(10,this.container.getHeight()*this.sliderHeightRatio)},hideSlider:function(){this.isSliderVisible=!1;this.removeSlider(!0);
this.doResize()},showSlider:function(){this.isSliderVisible=!0;this.doResize()},setTitleLength:function(){this.titlesArray=[];for(var a=d3.scaleLinear().domain([350,1250]).range([10,40]),b=this.parent.getCorpus(),c=0,d=b.getDocumentsCount();c<d;c++){var e=b.getDocument(c);e=e.getShortTitle();e.length<=a(this.container.getWidth())?this.titlesArray.push(e):(e=e.substring(0,a(this.container.getWidth())-3),this.titlesArray.push(e+"..."))}},callOffset:function(){if("draw"===this.transitionCall||"redraw"===
...
this);this.addColorPalette("d3_cat10",a);this.addColorPalette("d3_cat20a",b);this.addColorPalette("d3_cat20b",c);this.addColorPalette("d3_cat20c",d);this.addColorPalette("d3_set3",e)}a=Ext.create("Ext.chart.theme.Base").getColors().map(function(f){return this.hexToRgb(f)},this);this.addColorPalette("extjs",a)},resetColorTermAssociations:function(){this.setColorTermAssociations(new Ext.util.MixedCollection)},rgbToHex:function(a){return"#"+(16777216+(a[0]<<16)+(a[1]<<8)+a[2]).toString(16).slice(1)},
hexToRgb:function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(b,c,d,e){return c+c+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]:null},addColorPalette:function(a,b){this.getPalettes()[a]=b},getColorPalette:function(a,b){a=a||"default";a=this.getPalettes()[a];void 0===a&&(a=[]);if(b){b=[];for(var c=0;c<a.length;c++)b.push(this.rgbToHex(a[c]));return b}return a},saveCustomColorPalette:function(a){var b=new Ext.Deferred;
Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:Ext.encode(a)},success:function(c,d){c=Ext.util.JSON.decode(c.responseText).storedResource.id;this.addColorPalette(c,a);b.resolve(c,a)},failure:function(c){b.reject()},scope:this});return b.promise},loadCustomColorPalette:function(a){var b=new Ext.Deferred;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a},success:function(c,d){c=Ext.util.JSON.decode(c.responseText).storedResource.resource;
...
h.up("form").getValues();this.setApiParams(k);var l=this.getApplication(),m=[];void 0!==k.stopList&&void 0!==k.stopListGlobal&&k.stopListGlobal&&m.push(["stopList",k.stopList]);void 0!==k.categories&&m.push(["categories",k.categories]);var n=new Ext.Deferred;void 0!==k.palette?(l.resetColorTermAssociations(),0===l.getColorPalette(k.palette).length?l.loadCustomColorPalette(k.palette).then(function(){},function(){k.palette="default"}).always(function(){m.push(["palette",k.palette]);n.resolve()}):(m.push(["palette",
k.palette]),n.resolve())):n.resolve();n.promise.always(function(){var u=l.getCorpus();if(0<m.length){var v=l.getViewport().query("panel,chart");m.forEach(function(p){var q=p[0];p=p[1];l.setApiParam&&l.setApiParam(q,p);for(var r=0;r<v.length;r++)v[r].setApiParam&&v[r].setApiParam(q,p)});u?l.dispatchEvent("loadedCorpus",this,u):l.dispatchEvent("apiParamsUpdated",this,k)}u?this.fireEvent("loadedCorpus",this,u):this.fireEvent("apiParamsUpdated",this,k);h.up("window").close()}.bind(this))},scope:g}]},
bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}};c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var g=this.getHeader();if(g&&"Desktop"==Ext.os.deviceType&&!this.isXType("corpuscreator")&&
!this.isXType("notebook")){var h=g.getEl();h.on("mouseover",function(){this.getHeader().getTools().forEach(function(k){k.show()})},this);h.on("mouseout",function(){this.getHeader().getTools().forEach(function(k){var l=k.config.type||k.type;l&&"help"!=l&&-1==l.indexOf("collapse")&&k.hide()})},this);g.getTools().forEach(function(k,l){"help"!=k.config.type&&k.hide()})}},this)}},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),
{xtype:"menuitem",text:b.title,textAlign:"left",handler:function(){this.replacePanel(b.xtype)},scope:this})},maximizeToolClick:function(a){var b=Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+"tool/"+b[b.length-1]+"/";params=a.getModifiedApiParams();!params.corpus&&a.getCorpus&&a.getCorpus()&&(params.corpus=a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b="beta.voyant-tools.org"==
window.location.hostname?[{html:"\x3cp class\x3d'keyword' style\x3d'text-align: center; font-weight: bold; padding: 4px;'\x3ePlease note that this is the beta server and you should not count on corpora persisting (for bookmarks, embedding, etc.)."}]:[],c=[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")},{xtype:"radio",name:"export",inputValue:"spyral",boxLabel:a.localize("exportViewSpyral")}];
a.isXType("notebook")&&c.splice(2,1);a.getExtraViewExportItems&&a.getExtraViewExportItems().forEach(function(f){Ext.applyIf(f,{xtype:"radio",name:"export"});c.push(f)});b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,
title:a.localize("exportViewFieldset"),items:c});var d=[];a.isXType("grid")&&(d.push({xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}),a.getExportGridAll&&0==a.getExportGridAll()||d.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")}));
a.getExtraDataExportItems&&a.getExtraDataExportItems().forEach(function(f){Ext.applyIf(f,{xtype:"radio",name:"export"});d.push(f)});0<d.length&&b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:d});if((!a.getExportVisualization||a.getExportVisualization())&&0==a.isXType("grid")&&(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))){var e=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},
{xtype:"slider",width:200,value:1,minValue:.5,maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),listeners:{change:function(f,g){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([g]))},changecomplete:function(f){f.previousSibling().setValue(!0)}}}];a.getTargetEl().dom.querySelector("svg")&&e.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")});b.push({xtype:"fieldset",
collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:e})}Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(f){var g=f.up("form"),h="export"+Ext.String.capitalize(g.getValues()["export"]);Ext.isFunction(a[h])?a[h].call(a,a,g):Ext.Msg.show({title:a.localize("exportError"),message:a.localize("exportNoFunction"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});
...
(a=b.queryById("scale"))&&a.getValue&&(c=a.getValue()));var d=this.down("draw")||this.down("chart");if(d&&(d.isChart||d.isCanvas)){var e=d.innerElement.getSize();a=Array.prototype.slice.call(d.items.items);var f=d.surfaceZIndexes,g;for(g=1;g<a.length;g++){var h=a[g];var k=f[h.type];for(d=g-1;0<=d&&f[a[d].type]>k;)a[d+1]=a[d],d--;a[d+1]=h}var l=document.createElement("canvas");f=Ext.getClassName(a[0]);c*=a[0].devicePixelRatio;var m=l.getContext("2d");l.width=Math.ceil(e.width*c);l.height=Math.ceil(e.height*
c);for(d=0;d<a.length;d++)if(h=a[d],Ext.getClassName(h)===f)for(e=h.getRect(),surfaceSize=h.el.getSize(),g=0;g<h.canvases.length;g++){var n=h.canvases[g];k=n.getOffsetsTo(n.getParent());m.drawImage(n.dom,(e[0]+k[0])*c,(e[1]+k[1])*c,surfaceSize.width*c,surfaceSize.height*c)}b&&b.isVisible()&&b.unmask();return this.exportPngData(l.toDataURL())}d=this.getTargetEl().dom;if(n=d.querySelector("canvas")){if(1==c)return c=n.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);l=document.createElement("canvas");
...
delete b.debug;a="['\x3ch1\x3eSpyral Notebook Imported from Voyant Tools\x3c/h1\x3e','\x3cp\x3eThe proceeding code loads your corpus and tool. You can use this as a base to create your own notebook. Don\\'t forget to save your changes by clicking on the cloud icon!\x3c/p\x3e','loadCorpus(\""+this.getApplication().getCorpus().getAliasOrId()+'").tool("'+("VoyantHeader"==a?"":a)+'"'+(0<Object.keys(b).length?","+Ext.encode(b):"")+");']";this.openUrl(this.getApplication().getBaseUrl()+"spyral/?run\x3dtrue\x26"+
(c?"debug\x3dtrue\x26":"")+"inputJsonArrayOfEncodedBase64\x3d"+btoa(encodeURIComponent(a)).replace(/=/g,"%3D"))},exportGridCurrentJson:function(a,b){function c(e){var f={};d.forEach(function(g){f[g.text]=e.get(g.dataIndex)});values.push(f)}b=a.getStore();b.getFields();var d=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(e){return e.dataIndex&&0<e.dataIndex.trim().length});values=[];b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataJsonMessage"),
buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(g){var h=[];d.forEach(function(k){k=g.get(k.dataIndex);Ext.isString(k)&&(k=k.replace(/\s+/g," "));h.push(k)});f+=h.join("\t")+"\n"}b=a.getStore();var d=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(g){return g.dataIndex&&0<g.dataIndex.trim().length}),e=[];d.forEach(function(g){e.push(g.text)});var f=e.join("\t")+"\n";b.buffered?b.data.forEach(c):
b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:f})},exportGridCurrentHtml:function(a,b){function c(f){d+="\t\t\x3ctr\x3e\n";e.forEach(function(g){g=f.get(g.dataIndex);Ext.isString(g)&&(g=g.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/>/g,"\x26lg;"));d+="\t\t\t\x3ctd\x3e"+g+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n"}b=a.getStore();b.getFields();var d="\x3ctable\x3e\n\t\x3cthead\x3e\n\t\t\x3ctr\x3e\n",
e=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(f){return f.dataIndex&&0<f.dataIndex.trim().length});e.forEach(function(f){d+="\t\t\t\x3ctd\x3e"+f.text+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";b.buffered?b.data.forEach(c):b.each(c);d+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d})},exportGridAllJson:function(a,
b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllJsonWarning"),function(c){"yes"==c&&(c={start:0},Ext.applyIf(c,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(c)))},this)},exportGridAllTsv:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllTsvWarning"),function(c){"yes"==c&&(c={start:0,template:this.getXType()+"2tsv",outputFormat:"text"},Ext.applyIf(c,a.getStore().getProxy().getExtraParams()),
...
e&&e.target.id==b&&e.source.id==a&&c.push(e)}return c}});Ext.define("Voyant.data.util.DocumentEntities",{extend:"Ext.Base",mixins:["Voyant.util.Localization"],statics:{i18n:{identifyingDocEnts:"Identifying Document Entities",error:"Error Identifying Document Entities",retry:"Retry Failed Documents",done:"Done",statusDone:"Done",statusFailed:"Failed",statusQueued:"Queued",statusStarted:"Started",status413:"Your document is too large for this service"}},config:{progressWindow:void 0,updateDelay:5E3,timeoutId:void 0},constructor:function(a,b){this.mixins["Voyant.util.Localization"].constructor.apply(this,
arguments);this.initConfig();this.callParent();return this.load(a,b)},load:function(a,b){a=Ext.apply({tool:"corpus.DocumentEntities",corpus:Voyant.application.getCorpus().getId(),noCache:!0},a||{});this.doLoad(a,b,!0)},doLoad:function(a,b,c){var d=this;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a}).then(function(e){e=Ext.decode(e.responseText).documentEntities;var f=d._getProgressFromStatus(e.status),g=f[0]===f[1],h=f[2],k=-1!==f[3].indexOf("413");c&&g&&!h?((f=d.getProgressWindow())&&
f.close(),b.call(d,e.entities)):(d.updateProgress(e.status,f),g?(f=d.getProgressWindow(),f.down("#identifyingMessage").getEl().down("div.x-mask-msg-text").setStyle("backgroundImage","none"),f.down("#doneButton").setHidden(!1),h&&!k?f.down("#retryButton").setHidden(!1).setDisabled(!1).setHandler(function(l){d.load(Ext.apply({retryFailures:!0},a),b);l.setDisabled(!0)},d):(f.down("#retryButton").setHidden(!0),c&&f.close()),b.call(d,e.entities)):(delete a.retryFailures,d.setTimeoutId(Ext.defer(d.doLoad,
d.getUpdateDelay(),d,[a,b,!1]))))},function(e){Voyant.application.showError(d.localize("error"));console.warn(e);b.call(d,null)})},_getProgressFromStatus:function(a){var b=a.length,c=0,d=!1,e=[];a.forEach(function(f){"done"===f[1]?c++:0===f[1].indexOf("failed")&&(c++,d=!0,f=f[1].match(/\d\d\d$/),null!==f&&e.push(f[0]))});return[c,b,d,e]},updateProgress:function(a,b){void 0===this.getProgressWindow()&&this.setProgressWindow(Ext.create("Ext.window.Window",{title:this.localize("identifyingDocEnts"),
...
{fields:["docTitle","statusIcon","statusText"]}),itemSelector:".doc",tpl:'\x3ctpl for\x3d"."\x3e,\x3cdiv class\x3d"doc"\x3e,\x3ci class\x3d"fa {statusIcon}" style\x3d"margin-right: 5px;"\x3e\x3c/i\x3e,\x3cspan class\x3d"" style\x3d""\x3e{docTitle}\x3c/span\x3e,\x3cspan style\x3d"float: right"\x3e{statusText}\x3c/span\x3e,\x3c/div\x3e,\x3c/tpl\x3e'.split(",")}],tools:[{type:"restore",itemId:"restoreButton",hidden:!0,handler:function(f,g,h,k){f=h.up("window");f.expand();f.anchorTo(Ext.getBody(),"c-c",
[0,-f.getBox().height],{duration:250});k.hide()}}],buttons:[{itemId:"retryButton",xtype:"button",text:this.localize("retry"),hidden:!0},{itemId:"doneButton",xtype:"button",text:this.localize("done"),hidden:!0,handler:function(f){f.up("window").close()}}],listeners:{minimize:function(f){f.collapse(Ext.Component.DIRECTION_BOTTOM,!1);f.anchorTo(Ext.getBody(),"br-br",[0,0],{duration:250});f.down("#restoreButton").show()},destroy:function(f){clearTimeout(this.getTimeoutId());this.setProgressWindow(void 0)},
scope:this}}));var c=b[0];b=b[1];var d=this.getProgressWindow();d.down("#progressBar").updateProgress(c/b,c+" / "+b);var e=Voyant.application.getCorpus().getDocuments();a=a.map(function(f,g){g=e.getById(f[0]).getShortTitle();f=f[1];var h="fa-spinner",k="";0===f.indexOf("failed")?(h="fa-exclamation-triangle",k=-1!==f.indexOf("413")?this.localize("status413"):this.localize("statusFailed"),console.log("ner: "+g+", "+f)):"done"===f?(h="fa-check",k=""):"queued"===f&&(h="fa-clock-o",k="");return[g,h,k]},
this);d.down("#documentStatus").getStore().loadData(a);d.setTitle(this.localize("identifyingDocEnts")+" "+c+" / "+b);d.show()}});Ext.define("Voyant.data.model.Corpus",{alternateClassName:["Corpus"],mixins:["Voyant.util.Transferable","Voyant.util.Localization"],transferable:"loadCorpusTerms loadTokens getPlainText getText getWords getString getLemmasArray".split(" "),requires:["Voyant.util.ResponseError","Voyant.data.store.CorpusTerms","Voyant.data.store.Documents"],extend:"Ext.data.Model",config:{documentsStore:void 0},statics:{i18n:{}},fields:[{name:"documentsCount",type:"int"},{name:"lexicalTokensCount",type:"int"},{name:"lexicalTypesCount",
...
eu:"stop.eu.basque-lucene.txt",fa:"stop.fa.farsi-lucene.txt",fr:"stop.fr.veronis.txt",ga:"stop.ga-irish-lucene.txt",gl:"stop.ga.galician-lucene.txt",grc:"stop.grc.ancient-greek.txt",he:"stop.he.hebrew.txt",hi:"stop.hi.hindi-lucene.txt",hu:"stop.hu.hungarian.txt",hy:"stop.hy.armenian-lucene.txt",id:"stop.id.indonesian-lucene.txt",it:"stop.it.italian.txt",ja:"stop.ja.japanese-lucene.txt",la:"stop.la.latin.txt",lv:"stop.lv.latvian-lucene.txt",lt:"stop.lt.lithuanian-lucene.txt",mu:"stop.mu.multi.txt",
nl:"stop.nl.dutch.txt",no:"stop.no.norwegian.txt",pt:"stop.pt.brazilian.txt",ro:"stop.ro.romanian-lucene.txt",ru:"stop.ru.russian.txt",se:"stop.se.swedish-long.txt",th:"stop.th.thai-lucene.txt",tr:"stop.tr.turkish-lucene.txt"},i18n:{}},initComponent:function(a){var b=this.up("window").panel.getApiParam("stopList"),c=[];for(id in Voyant.widget.StopListOption.stoplists)c.push({name:this.localize(id),value:Voyant.widget.StopListOption.stoplists[id]});c.sort(function(d,e){return d.name<e.name?-1:1});
c.splice(0,0,{name:this.localize("auto"),value:"auto"},{name:this.localize("none"),value:""},{name:this.localize("new"),value:"new"});Ext.apply(this,{items:[{xtype:"combo",queryMode:"local",value:b,triggerAction:"all",editable:!0,fieldLabel:this.localize("label"),labelAlign:"right",name:"stopList",displayField:"name",valueField:"value",store:{fields:["name","value"],data:c}},{width:10},{xtype:"tbspacer"},{xtype:"button",text:this.localize("editList"),ui:"default-toolbar",handler:this.editList,scope:this},
...
Ext.Msg.show({title:this.localize("editStopListTitle"),message:this.localize("editStopListMessage"),buttons:Ext.Msg.OKCANCEL,buttonText:{ok:this.localize("ok"),cancel:this.localize("cancel")},icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d,original:d,fn:function(e,f,g){f=f.toLowerCase();"ok"==e&&g.original!=f&&(e=this.down("combo"),0==Ext.String.trim(f).length?e.setValue("empty"):Ext.Ajax.request({url:a.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:f,corpus:c},combo:e,success:function(h,
k){var l=Ext.util.JSON.decode(h.responseText);h=k.combo.getStore();l="keywords-"+l.storedResource.id;h.add({name:l,value:l});k.combo.setValue(l);k.combo.updateLayout()},scope:this}))},scope:this})},scope:this}):Ext.Msg.show({title:this.localize("noEditAutoTitle"),message:this.localize("noEditAutoMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}});Ext.define("Voyant.widget.QuerySearchField",{extend:"Ext.form.field.Tag",mixins:["Voyant.util.Localization"],alias:"widget.querysearchfield",statics:{i18n:{}},config:{corpus:void 0,tokenType:"lexical",isDocsMode:!1,inDocumentsCountOnly:void 0,stopList:void 0,showAggregateInDocumentsCount:!1,clearOnQuery:!1,parentPanel:void 0,currentOriginalRawQueryPlan:void 0},hasCorpusLoadedListener:!1,isClearing:!1,constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,maxWidth:200,matchFieldWidth:!1,minChars:2,
...
items:[]});this.callParent(arguments);var a=this.findParentBy(function(b){return b.mixins["Voyant.panel.Panel"]});if(null!=a)if(this.setParentPanel(a),a.getCorpus&&a.getCorpus())this.on("afterrender",function(b){this.setCorpus(a.getCorpus())},this);else a.on("loadedCorpus",function(b,c){this.setCorpus(c)},this),this.hasCorpusLoadedListener=!0;this.setSeriesToolTip(Ext.create("Ext.tip.ToolTip",{style:"background: #fff",dismissDelay:0}));this.on("boxready",function(){void 0==this.getLocationMarker()&&
this.setLocationMarker(Ext.DomHelper.append(this.getEl(),{tag:"div",style:"background-color: "+this.locationMarkerColor+"; height: 100%; width: 2px; position: absolute; top: 0; left: 0;"}))})},updateCorpus:function(a){a=a.getDocuments();this.setDocumentsStore(a);this.setIsDetailedGraph(a.getTotalCount()<this.DETAILED_GRAPH_DOC_LIMIT);this.generateChart()},populateChart:function(a){var b={},c=0;a.forEach(function(m){var n=[],u=m.get("distributions"),v=m.get("docId"),p=m.get("docIndex");m=m.get("term");
for(var q=0;q<u.length;q++){var r=q,w=u[q];w>c&&(c=w);n.push([v,p,r,w,m])}void 0===b[p]&&(b[p]={});b[p][m]=n});if(this.getIsDetailedGraph()){a=this.query("cartesian");for(var d=0;d<a.length;d++){var e=a[d],f=b[d];if(void 0!==f){var g=[],h;for(h in f){var k=f[h],l=this.getParentPanel().getApplication().getColorForTerm(h,!0);this.getCorpus();g.push({type:"line",xField:"bin",yField:"distribution",style:{lineWidth:1,strokeStyle:l},store:Ext.create("Ext.data.ArrayStore",{fields:["docId","docIndex","bin",
"distribution","term"],data:k})})}e.getAxes()[0].setMaximum(c);e.setSeries(g)}}}},getColor:function(a,b){return"rgba("+this.getParentPanel().getApplication().getColor(a).join(",")+","+b+")"},generateChart:function(){function a(m){var n=m.fraction,u=m.relativeHeight;m=this.getColor(m.index,.3);n=b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:n,height:"100%",insetPadding:0,background:{type:"linear",degrees:90,stops:[{offset:0,color:m},{offset:u,color:m},{offset:u,color:"white"},{offset:1,
color:"white"}]},axes:[{type:"numeric",position:"left",fields:"distribution",hidden:!0},{type:"category",position:"bottom",fields:"bin",hidden:!0}],listeners:{itemmouseover:function(v,p,q){var r=this.getCorpus().getDocument(p.record.get("docIndex")).getTitle();v.getSeries().forEach(function(w){var x=w.getItemByIndex(p.index);w=x.record.get("term");x=x.record.get("distribution");r+="\x3cbr\x3e"+w+": "+x},this);this.getSeriesToolTip().setHtml(r);v=q.getXY();v[0]+=15;v[1]+=18;this.getSeriesToolTip().showAt(v)},
scope:this}});n.body.on("mouseleave",function(v,p){this.getSeriesToolTip().hide()},this);n.body.on("click",function(v,p){p=Ext.get(p);v=v.getX();var q=p.getBox();v=(v-q.x)/q.width;p=p.parent(".x-panel");q=p.parent();p=Ext.toArray(q.dom.children).indexOf(p.dom);this.fireEvent("documentRelativePositionSelected",this,{docIndex:p,fraction:v})},this)}var b=this;b.removeAll();for(var c=b.getCorpus().getDocuments(),d=b.getCorpus().getWordTokensCount(),e=[],f=Number.MAX_VALUE,g=-1,h=0;h<c.getCount();h++){var k=
c.getAt(h),l=k.get("index");k=k.get("tokensCount-lexical");k<f&&(f=k);k>g&&(g=k);e.push({index:l,count:k,fraction:k/d})}if(this.getIsDetailedGraph())for(h=0;h<e.length;h++)k=e[h],k.relativeHeight=k.count==g?1:.25+(k.count-f)/(g-f)*.75,a.call(this,k);else b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:1,height:"100%",insetPadding:0,axes:[{type:"numeric",position:"left",fields:"count",hidden:!0},{type:"category",position:"bottom",fields:"index",hidden:!0}],series:[{type:"bar",xField:"index",
yField:"count",style:{minGapWidth:0,minBarWidth:1,lineWidth:0,strokeStyle:"none"},renderer:function(m,n,u,v){return{fillStyle:this.getColor.call(this,v,.3)}}.bind(this)}],store:Ext.create("Ext.data.JsonStore",{fields:[{name:"index",type:"int"},{name:"count",type:"int"},{name:"fraction",type:"float"}],data:e}),listeners:{itemclick:function(m,n,u){m=Ext.get(u.getTarget());u=u.getX();m=m.getBox();var v=m.width/this.getCorpus().getDocuments().getCount();u=(u-m.x)%v/v;n=n.record.data;n=this.getDocumentsStore().getAt(n.index).getIndex();
this.fireEvent("documentRelativePositionSelected",this,{docIndex:n,fraction:u})},scope:this}})},moveLocationMarker:function(a,b,c){var d=Ext.get(this.getLocationMarker()),e=d.getX();if(this.getIsDetailedGraph()){var f=this.query("cartesian")[a];f&&(e=f.getX()+f.getWidth()*b)}else f=this.down("cartesian"),e=f.getWidth()/this.getCorpus().getDocuments().getCount(),e=f.getX()+e*a+e*b;null!=c&&(a=d.getX(),c==this.SCROLL_DOWN&&a>e||c==this.SCROLL_UP&&a<e)&&(e=a);d.setX(e)}});Ext.define("Voyant.panel.Panel",{mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Toolable","Voyant.util.DetailedError"],requires:["Voyant.widget.QuerySearchField","Voyant.widget.StopListOption","Voyant.widget.CategoriesOption","Voyant.widget.TotalPropertyStatus"],alias:"widget.voyantpanel",statics:{i18n:{},config:{corpusValidated:!1},api:{corpus:void 0,input:void 0,inputFormat:void 0,subtitle:void 0}},config:{corpus:void 0},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,
arguments);this.mixins["Voyant.util.Toolable"].constructor.apply(this,arguments);this.glyph||(this.glyph=Ext.ClassManager.getClass(this).glyph);this.on("afterrender",function(){"facet"!=this.getXType()&&this.getApiParam("subtitle")&&this.getTitle()&&this.setTitle(this.getTitle()+" \x3ci style\x3d'font-size: smaller;'\x3e"+this.getApiParam("subtitle")+"\x3c/i\x3e");this.isXType("grid")&&(this.getSelectionModel().on("selectionchange",function(b,c){},this),this.getStore().on("beforeload",function(){this.selectedRecordsToRemember=
...
" \x3cspan class\x3d'subtitle'\x3e"+b.getFullLabel()+"\x3c/span\x3e");b.loadDocumentTerms(Ext.apply(this.getApiParams(["stopList"]),{limit:100})).then(function(c){a.terms={};c.each(function(d){a.terms[d.getTerm()]=d.getRawFreq()});c=Object.keys(a.terms).map(function(d){return a.terms[d]});a.minFreq=Ext.Array.min(c);a.maxFreq=Ext.Array.max(c);a.getCorpus().loadTokens({whitelist:Object.keys(a.terms),noOthers:!0,limit:0,docIndex:a.getApiParam("docIndex")}).then(function(d){var e=[];d.each(function(f){e.push(f.getTerm().toLowerCase())});
...
e=this.localize(c+"Title");e=="["+c+"Title]"&&(e=c.replace(/^facet\./,"").replace(/^extra./,""));this.localize("matchingDocuments");Ext.applyIf(a,{title:e,collapsible:!0,facet:c,columns:[{renderer:function(g,h,k){return'\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("matchingDocuments")+'"\x3e'+k.getInDocumentsCount()+"\x3c/span\x3e) \x3c/span\x3e"+(k.getLabel?k.getLabel():k.getTerm()+'\x3cspan style\x3d"font-size: smaller;"\x3e (\x3cspan class\x3d"info-tip" data-qtip\x3d"'+
...
this.queryById("sendToVoyant").setDisabled(!0);this.queryById("export").setDisabled(!0);if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(e,f,g){this.unmask();if(e&&0<e.length){this.queryById("status").setHtml(e.length);var h="\x3cul\x3e",k=[];e.forEach(function(m){m.getDocIds().forEach(function(n){k.push(n);var u=d.getCorpus().getDocument(n),v="\x3cli id\x3d'"+c.getId()+"_"+n+"' class\x3d'cataloguedoc'\x3e";
v+="\x3ca href\x3d'#' class\x3d'cataloguedoctitle' data\x3d'"+n+"'\x3e"+u.getTitle()+"\x3c/a\x3e";for(facet in b)if(0!=b[facet].length){var p="";if("facet.title"!=facet){var q=facet.replace(/^.+?\./,"");if(n=u.get(q)){var r=Ext.isArray(n);r?p+="\x3cli\x3e"+q+"\x3cul\x3e":n=[n];n.forEach(function(w){var x=!1;b[facet].forEach(function(z){z.label==w?x=!0:-1==z.facet.indexOf("facet")&&z.label.split(/\W+/).forEach(function(L){0<L.trim().length&&-1<w.toLowerCase().indexOf(L.toLowerCase())&&(x=!0)})});p+=
"\x3cli\x3e"+(r?"":q.replace("extra.","")+": ")+(x?'\x3cspan class\x3d"keyword"\x3e'+w+"\x3c/span\x3e":w)+"\x3c/li\x3e"});r&&(p+="\x3c/ul\x3e\x3c/li\x3e")}}p&&(v+="\x3cul\x3e"+p+"\x3c/ul\x3e")}h+=v+"\x3c/li\x3e"})});h+="\x3c/ul\x3e";c.update(h);var l=this;e=c.query(".cataloguedoctitle");e.forEach(function(m){Ext.get(m).on("click",function(n,u){this.dispatchEvent("documentSelected",l,u.getAttribute("data"))},l)});1==e.length&&this.dispatchEvent("documentSelected",l,e[0].getAttribute("data"));this.queryById("status").update((new Ext.XTemplate(this.localize("queryMatches"))).apply([k.length,
...
b){var c=this;this.getLayout().getRenderTarget();var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1];b=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1;var f=d3.transition().duration(1E3);a=this.getVis().selectAll("text").data(a,function(h){return h.text});a.exit().transition(f).style("font-size","1px").remove();var g=a.enter().append("text").text(function(h){return h.text}).attr("text-anchor","middle").attr("data-freq",function(h){return h.rawFreq}).attr("transform",
function(h){return"translate("+[h.x,h.y]+")rotate("+h.rotate+")"}).style("font-family",function(h){return c.getApplication().getCategoriesManager().getFeatureForTerm("font",h.text)}).style("fill",function(h){return c.getApplication().getColorForTerm(h.text,!0)}).style("font-size","1px").on("click",function(h){c.dispatchEvent("termsClicked",c,[h.text])}).on("mouseover",function(h){this.getTip().show()}.bind(this)).on("mousemove",function(h){var k=this.getTip();k.update(h.text+": "+h.rawFreq);h=Ext.get(this.getCirrusId()).dom;
h=d3.mouse(h);h[1]+=30;k.setPosition(h)}.bind(this)).on("mouseout",function(h){this.getTip().hide()}.bind(this));a.merge(g).transition(f).style("font-family",function(h){return c.getApplication().getCategoriesManager().getFeatureForTerm("font",h.text)}).style("fill",function(h){return c.getApplication().getColorForTerm(h.text,!0)}).attr("transform",function(h){return"translate("+[h.x,h.y]+")rotate("+h.rotate+")"}).style("font-size",function(h){return h.fontSize+"px"});this.getVis().transition(f).attr("transform",
...
b),this.getVisLayout().force("x",d3.forceX(c/2)).force("y",d3.forceY(b/2)),Ext.Function.defer(this.zoomToFit,100,this)},this);this.on("beforedestroy",function(a){this.getVisLayout()&&this.getVisLayout().stop()},this);this.callParent(arguments)},initLoad:function(){this.initGraph();this.setNetworkMode(this.DEFAULT_MODE);if(this.getApiParam("centralize")){this.setNetworkMode(this.CENTRALIZED_MODE);var a=this.getApiParam("centralize");this.doCentralize(a)}else{a=3;var b=this.getApiParam("query");void 0!==
b&&(a=0===b.indexOf("^@")?20:Ext.isArray(b)?b.length:b.split(",").length);this.getCorpus().getCorpusTerms({autoLoad:!1}).load({params:{limit:a,query:b,stopList:this.getApiParam("stopList"),categories:this.getApiParam("categories")},callback:function(c,d,e){e&&this.loadFromCorpusTermRecords(c)},scope:this})}},loadFromQuery:function(a){if(Ext.isArray(a)&&0==a.length)this.setApiParam("query",void 0),this.resetGraph();else{this.setApiParams({mode:"corpus",query:a});var b=this.getApiParams();b.noCache=
!0;(Ext.isString(a)?[a]:a).forEach(function(c){this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(Ext.clone(b),{query:c}),callback:function(d,e,f){f&&this.loadFromCorpusCollocateRecords(d)},scope:this})},this)}},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(c){b.push(c.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getLayout().getRenderTarget(),
e=d.getWidth()/2,f=d.getHeight()/2,g={};this.getNodeData().forEach(function(l){g[l.id]=!0},this);var h=[],k=[];a.forEach(function(l,m){var n=l.getTerm(),u=l.getContextTerm(),v=l.getKeywordRawFreq(),p=l.getContextTermRawFreq(),q=v,r=p;this.getNetworkMode()===this.CENTRALIZED_MODE&&(q=0,r=Math.log(p));0==m&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+v+")",type:"keyword",value:q}):(g[b]=!0,m={id:b,term:n,title:n+" ("+v+")",type:"keyword",value:q,start:c,fixed:!1,
x:e,y:f},h.push(m)));if(n!=u){n=this.idGet(u);void 0===g[n]&&(g[n]=!0,u={id:n,term:u,title:u+" ("+p+")",type:"context",value:r,start:0,fixed:!1,x:e,y:f},h.push(u));u=null;p=this.getLinkData();for(r=0;r<p.length;r++)if(m=p[r],m.source.id==b&&m.target.id==n||m.source.id==n&&m.target.id==b){u=m;break}l=l.getContextTermRawFreq();null===u&&k.push({source:b,target:n,value:l,id:b+"-"+n})}},this);this.setNodeData(this.getNodeData().concat(h));this.setLinkData(this.getLinkData().concat(k));this.refresh()}},
idGet:function(a){return"links_"+a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},removeNode:function(a,b){b=this.getNodeData();for(var c=0;c<b.length;c++)if(b[c].id===a){b.splice(c,1);break}b=this.getLinkData();for(c=b.length-1;0<=c;c--)b[c].source.id!==a&&b[c].target.id!==a||b.splice(c,1);this.setApiParam("query",Ext.Array.remove(Ext.Array.from(this.getApiParam("query")),a));this.refresh()},doCentralize:function(a){this.setApiParam("centralize",
...
jsonKeywordsPointer:void 0,jsonCollectionPointer:void 0,jsonExtraMetadataPointer:void 0,tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0,sort:void 0,dtocIndexDoc:-1}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,
...
icon:Ext.Msg.ERROR})},flex:1},{text:a.localize("cancel"),glyph:"xf00d@FontAwesome",flex:1,handler:function(b){b.up("window").close()}}]}}).show()}},{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:a.localize("Upload"),listeners:{render:function(b){b.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},beforedestroy:function(b){Ext.tip.QuickTipManager.unregister(b.getEl())},
change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){c=b.fileInputEl.dom.files;for(var e=/\.(png|gif|jpe?g|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,f=/\.(txt|pdf|html?|xml|docx?|rtf|pages|epub|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,g=[],h=[],k=0,l=c.length;k<l;k++){var m=c[k].name;e.test(m)?g.push(m.split("/").pop()):f.test(m)||h.push(m.split("/").pop())}0<g.length||0<h.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),
icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<g.length?"\x3cli\x3e"+a.localize("badFiles")+g.slice(0,5).join(", ")+(5<g.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<h.length?"\x3cli\x3e"+a.localize("unknownFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(n){"yes"===n?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},
...
a.localize("errorNotXmlContinue"),function(e){"yes"==e&&a.loadCorpus(Ext.apply(d,{input:c}))},a):a.loadCorpus(Ext.apply(d,{input:c}))}else Ext.Msg.show({title:a.localize("noTextProvided"),message:a.localize("pleaseProvideText"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:[{html:this.getInitialConfig().addTextLabel,hidden:void 0==this.getInitialConfig().addTextLabel},{height:100,xtype:"textareafield",itemId:"input",emptyText:this.localize("emptyInput")}]});a.on("boxready",function(b){var c=
this.getApplication();c.getAllowInput&&"false"==c.getAllowInput()&&(b.getDockedItems().forEach(function(d){b.removeDocked(d)}),b.removeAll(),b.add({xtype:"container",html:"\x3cp\x3e"+b.localize("noAllowInputMessage")+"\x3c/p\x3e"}))});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,
c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(e,f){d.unmask();f.result&&(f.result.corpus||f.result.stepEnabledCorpusCreator)?(e={corpus:f.result.corpus?f.result.corpus.metadata.id:f.result.stepEnabledCorpusCreator.storedId},Ext.applyIf(e,c),this.setCorpus(void 0),this.loadCorpus(e)):this.showResponseError("Unable to load corpus.",f.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&
...
"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"jsonContentPointer"},{fieldLabel:a.localize("xpathTitle"),name:"jsonTitlePointer"},{fieldLabel:a.localize("xpathAuthor"),name:"jsonAuthorPointer"},{fieldLabel:a.localize("xpathDocuments"),name:"jsonDocumentsPointer"},{xtype:"fieldset",title:a.localize("xmlAdditionalOptions"),collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{fieldLabel:a.localize("xpathPubDate"),name:"jsonPubDatePointer"},{fieldLabel:a.localize("xpathPublisher"),
name:"jsonPublisherPointer"},{fieldLabel:a.localize("xpathPubPlace"),name:"jsonPubPlacePointer"},{fieldLabel:a.localize("xpathKeywords"),name:"jsonKeywordsPointer"},{fieldLabel:a.localize("xpathCollection"),name:"jsonCollectionPointer"},{xtype:"textareafield",grow:!0,fieldLabel:a.localize("xpathExtra"),name:"jsonExtraMetadataPointer"}]}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables' target\x3d'voyantdocs'\x3e"+a.localize("tableOptions")+"\x3c/a\x3e",
...
b.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("watercolor"),itemId:"watercolor",cls:["map-menu-item","watercolor"],checked:!0},{boxLabel:this.localize("wms4326"),cls:["map-menu-item","wms4326"],itemId:"wms4326"},{boxLabel:this.localize("osm"),cls:["map-menu-item","osm"],itemId:"osm"},{boxLabel:this.localize("arcGIS"),cls:["map-menu-item","arcGIS"],itemId:"arcGIS"}]}]}},{xtype:"menuitem",text:this.localize("projection"),tooltip:this.localize("projectionTip"),
glyph:"xf0ac@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{handler:function(b,c){if(c){var d=this;id=b.getItemId();"webMercatorProjection"===id?this.setProjection(ol.proj.get("EPSG:3857")):"mercatorProjection"===id?this.setProjection(ol.proj.get("EPSG:4326")):"gallPetersProjection"===id?(proj4.defs("cea","+proj\x3dcea +lon_0\x3d0 +lat_ts\x3d45 +x_0\x3d0 +y_0\x3d0 +ellps\x3dWGS84 +units\x3dm +no_defs"),b=ol.proj.get("cea"),this.setProjection(b)):"sphereMollweideProjection"===
id&&(proj4.defs("ESRI:54009","+proj\x3dmoll +lon_0\x3d0 +x_0\x3d0 +y_0\x3d0 +datum\x3dWGS84 +units\x3dm +no_defs"),b=ol.proj.get("ESRI:54009"),b.setExtent([-18E6,-9E6,18E6,9E6]),this.setProjection(b));b=this.getProjection().getExtent();c=this.getProjection()==ol.proj.get("EPSG:4326")?360:4.007501668557849E7;b=new ol.View({projection:this.getProjection(),center:ol.extent.getCenter(b||[0,0,0,0]),maxResolution:c/d.body.dom.offsetWidth,zoom:0});var e=this.getMap();e.getLayers().forEach(function(f){f.getSource().getFeatures&&
f.getSource().getFeatures().forEach(function(g){var h=g.getGeometry().transform(e.getView().getProjection(),d.getProjection());g.setGeometry(h)})});e.setView(b)}},listeners:{afterrender:function(b){Ext.create("Ext.tip.ToolTip",{target:b,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+b.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("webMercatorProjection"),itemId:"webMercatorProjection",cls:["map-menu-item","webMercatorProjection"],checked:!0},{boxLabel:this.localize("mercatorProjection"),
...
var d=new ol.Map({layers:[c.watercolor,new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,layer:"toner-hybrid",projection:"EPSG:3857"}),id:"overlayLayer"})],target:a.getId(),loadTilesWhileInteracting:!0,view:new ol.View({center:[0,0],maxResolution:4.007501668557849E7/b.body.dom.offsetWidth,zoom:0})});d.on("singleclick",this.handleSingleClick,this);d.on("singleclicking",function(g){var h=d.getFeaturesAtPixel(g.pixel);if(h){for(var k=0;k<h.length;k++){var l=h[k];"city"==
l.get("type")&&this.handleLocationClick(l)}l=h[0];debugger}if(h){var m=!1;h.forEach(function(n){"city"===n.get("type")&&n.get("selected")?(b.dispatchEvent("termsClicked",b,[n.get("forms").join("|")]),m=!0):"connection"===n.get("type")&&n.get("selected")&&!m&&(b.getFilterWidgets().each(function(u){u=u.getGeonames();if(null!=u){var v="\x3cul\x3e",p=-1;u.getAllConnectionOccurrences(n.get("source"),n.get("target")).forEach(function(q){q.docIndex!=p&&(p=q.docIndex,v+="\x3ch4\x3e"+b.getCorpus().getDocument(p).getFullLabel()+
":\x3c/h4\x3e");v+="\x3cli\x3e"+q.source.left+'\x3ca href\x3d"http://www.geonames.org/'+q.source.id+'" target\x3d"_blank" docIndex\x3d'+q.docIndex+" offset\x3d"+q.source.position+" location\x3d"+q.source.form+" cityId\x3d"+q.source.id+" coordinates\x3d"+JSON.stringify(sourceCoordinates)+' class\x3d"termLocationLink"\x3e'+q.source.form+"\x3c/a\x3e "+q.source.right+" [...] "+q.target.left+'\x3ca href\x3d"http://www.geonames.org/'+q.target.id+'" target\x3d"_blank" docIndex\x3d'+q.docIndex+" offset\x3d"+
q.target.position+" location\x3d"+q.target.form+" cityId\x3d"+q.target.id+" coordinates\x3d"+JSON.stringify(targetCoordinates)+' class\x3d"termLocationLink"\x3e'+q.target.form+"\x3c/a\x3e "+q.target.right+"\x3c/li\x3e"});u=n.get("text");v+="\x3c/ul\x3e";b.getContentEl().setHtml("\x3ch3\x3e"+u+"\x3c/h3\x3e"+v);b.getOverlay().setPosition(g.coordinate);Ext.select(".termLocationLink").elements.forEach(function(q){q.onmouseover=function(){b.showTermInCorpus(q.getAttribute("docIndex"),q.getAttribute("offset"),
q.getAttribute("location"))}})}}),m=!0)},this)}});var e=new ol.layer.Vector({map:d,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),zIndex:10,selected:!0,style:function(g){if("city"===g.get("type"))return b.cityStyleFunction(g,d.getView().getResolution());if("connection"===g.get("type"))return b.travelStyleFunction(g,d.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0});a=new ol.layer.Vector({map:d,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),preview:!0,
zIndex:15,id:"preview",style:function(g){if("city"===g.get("type"))return b.cityStyleFunction(g,d.getView().getResolution());if("connection"===g.get("type"))return b.travelStyleFunction(g,d.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0});d.addLayer(a);d.on("pointermove",function(g){var h=d.getEventPixel(g.originalEvent);h=d.hasFeatureAtPixel(h);d.getViewport().style.cursor=h?"pointer":"";if(!b.getDrawMode()&&(e.getSource().clear(),h=g.pixel,h=d.getFeaturesAtPixel(h))){for(var k=
0;h[k].get("selected")&&(k++,k!==h.length););if(k<h.length){var l=h[k];h={font:"12px Calibri,sans-serif",textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};h.text=l.get("text");h=new ol.style.Style({text:new ol.style.Text(h),zIndex:1});"annotation"!==l.get("type")&&(k=new ol.Feature({text:l.get("text"),geometry:l.getGeometry(),forms:l.get("forms"),selected:!0,coordinates:l.get("coordinates"),width:l.get("width"),visible:l.get("visible"),
color:l.get("color"),type:l.get("type"),confidence:l.get("confidence"),source:l.get("source"),target:l.get("target"),cityId:l.get("cityId")}),e.getSource().addFeature(k));l.getGeometry();g=new ol.Feature({geometry:new ol.geom.Point(g.coordinate),selected:!0});g.setStyle(h);e.getSource().addFeature(g);"city"===l.get("type")&&b.getMap().getLayers().forEach(function(m){var n=m.get("id");n&&-1!==n.indexOf("connections")&&(connections=m.getSource().getFeatures(),connections.forEach(function(u){u.get("target")!==
l.get("cityId")&&u.get("source")!==l.get("cityId")||e.getSource().addFeature(new ol.Feature({geometry:u.getGeometry(),selected:!0,coordinates:u.get("coordinates"),width:u.get("width"),visible:u.get("visible"),color:u.get("color"),type:u.get("type")}))}))})}}});a=new ol.source.Vector({wrapX:!1});c=new ol.layer.Vector({source:a,id:"annotations"});var f=this.getAnnotations();f&&(f=(new ol.format.GeoJSON).readFeatures(f),a.addFeatures(f));d.addLayer(c);this.setDrawInteraction(new ol.interaction.Draw({source:a,
...
this)},filterUpdate:function(a){var b=this;a.clearAnimation();var c=this.getMap(),d=a.getColor(),e=parseInt(this.getApiParam("citiesMaxCount")),f=0;a.getGeonames().eachCity(function(p){p.rawFreq>f&&(f=p.rawFreq)},this,e);var g=c.getLayer(a.getId()+"-cities").getSource(),h=Ext.Array.from(this.getApiParam("hide"));g.clear();var k=parseInt(this.getApiParam("minPopulation")),l=parseInt(this.getApiParam("citiesMinFreq")),m={};a.getGeonames().eachCity(function(p){if((!k||p.population>=k)&&(!l||p.rawFreq>=
l)){m[p.id]=!0;var q=[parseFloat(p.lng),parseFloat(p.lat)];p=new ol.Feature({geometry:(new ol.geom.Point(q)).transform(ol.proj.get("EPSG:4326"),b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857")),text:p.label+" ("+p.rawFreq+")",description:p.label,color:d,selected:!1,width:3+20*Math.sqrt(p.rawFreq/f),visible:!0,coordinates:q,forms:p.forms,cityId:p.id,type:"city",confidence:p.confidence?100*p.confidence:void 0});g.addFeature(p)}},this,e);0<g.getFeatures().length&&c.getView().fit(g.getExtent());
c.getLayer(a.getId()+"-cities").setVisible(0==Ext.Array.contains(h,"cities"));g=c.getLayer(a.getId()+"-connections").getSource();g.clear();0==Object.keys(m).length&&this.toastInfo("No cities available for current criteria.");f=0;a.getGeonames().eachConnection(function(p){p.rawFreq>f&&(f=p.rawFreq)},this);var n=0,u=parseInt(this.getApiParam("connectionsMaxCount")),v=parseInt(this.getApiParam("connectionsMinFreq"));a.getGeonames().eachConnection(function(p){if((!v||p.rawFreq>=v)&&(!u||n<u)&&p.source.id in
m&&p.target.id in m&&(!k||p.source.population>=k&&p.target.population>=k)){var q=(new arc.GreatCircle({x:p.source.lng,y:p.source.lat},{x:p.target.lng,y:p.target.lat})).Arc(100,{offset:100}),r=p.source.label+" -\x3e "+p.target.label+" ("+p.rawFreq+")";q.geometries.forEach(function(w){w=new ol.geom.LineString(w.coords);w.transform(ol.proj.get("EPSG:4326"),b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857"));w=new ol.Feature({geometry:w,text:r,color:d,width:3+10*Math.sqrt(p.rawFreq/f),source:p.source.id,
target:p.target.id,type:"connection"});g.addFeature(w)},this);n++}},this);c.getLayer(a.getId()+"-connections").setVisible(0==Ext.Array.contains(h,"connections"));a.animate()},handleSingleClick:function(a){var b=this.getMap().getFeaturesAtPixel(a.pixel);if(b)for(var c=0;c<b.length;c++){var d=b[c],e=d.get("type");if("city"==e){this.handleLocationClick(a,d);break}else if("connection"==e){this.handleConnectionClick(d,a.pixel[0],a.pixel[1]);break}else if("annotation"==e){this.editAnnotation(d);break}}},
handleConnectionClick:function(a,b,c){Ext.create("Ext.menu.Menu",{items:[{text:this.localize("viewConnections"),tooltip:this.localize("viewConnectionsTip"),glyph:"xf02d@FontAwesome",handler:function(){this.mask("loadingConnections");var d=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"corpus.Dreamscape",corpus:this.getCorpus().getId(),suppressLocations:!0,suppressConnections:!0,sourceId:a.get("source"),targetId:a.get("target"),context:2,limit:25},scope:this}).then(function(e){d.unmask();
if((e=Ext.JSON.decode(e.responseText))&&e.dreamscape&&e.dreamscape.connectionOccurrences){var f="\x3ctable style\x3d'font-size:smaller'\x3e";e.dreamscape.connectionOccurrences.connectionOccurrences.forEach(function(g){f+="\x3ctr\x3e\x3ctd style\x3d'text-align: right'\x3e"+g.source.left+"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+g.source.term+"\x3c/td\x3e\x3ctd\x3e"+g.source.right+"\x3c/td\x3e\x3ctd\x3e\u2026\x3c/td\x3e\x3ctd style\x3d'text-align: right'\x3e"+g.target.left+
"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+g.target.term+"\x3c/td\x3e\x3ctd\x3e"+g.target.right+"\x3c/td\x3e\x3c/tr\x3e"});f+="\x3c/table\x3e";Ext.Msg.alert(d.localize("occurrences"),f)}},function(e){d.unmask();return d.showError(d.localize("occurrencesNotLoaded"))})},scope:this}]}).showAt(b,c)},handleLocationClick:function(a,b){var c=b.get("cityId");Ext.create("Ext.menu.Menu",{items:[{text:this.localize("viewOccurrences"),tooltip:this.localize("viewOccurrencesTip"),
glyph:"xf02d@FontAwesome",handler:function(){this.mask("loadingOccurrences");var d=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"corpus.Dreamscape",corpus:this.getCorpus().getId(),suppressLocations:!0,suppressConnections:!0,suppressConnectionOccurrences:!0,locationId:c,limit:25},scope:this}).then(function(e){d.unmask();if((e=Ext.JSON.decode(e.responseText))&&e.dreamscape&&e.dreamscape.occurrences){var f="\x3ctable style\x3d'font-size:smaller'\x3e";e.dreamscape.occurrences.occurrences.forEach(function(g){f+=
"\x3ctr\x3e\x3ctd style\x3d'text-align: right'\x3e"+g.left+"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+g.term+"\x3c/td\x3e\x3ctd\x3e"+g.right+"\x3c/td\x3e\x3c/tr\x3e"});f+="\x3c/table\x3e";Ext.Msg.alert(d.localize("occurrences"),f)}},function(e){d.unmask();return d.showError(d.localize("occurrencesNotLoaded"))})},scope:this},{text:this.localize("openInVoyant"),tooltip:this.localize("openInVoyantTip"),glyph:"xf08e@FontAwesome",handler:function(){this.dispatchEvent("termsClicked",
...
store:a,selModel:Ext.create("Ext.selection.CheckboxModel",{listeners:{selectionchange:{fn:function(b,c){this.getApplication().dispatchEvent("documentTermsClicked",this,c)},scope:this}},pruneRemoved:!1,mode:"SIMPLE"}),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},{xtype:"corpusdocumentselector"}]}],columns:[{text:"#",width:30,dataIndex:"docIndex",sortable:!0,renderer:function(b){return b+1}},{text:this.localize("term"),
dataIndex:"term",tooltip:this.localize("termTip"),sortable:!0,flex:1},{text:this.localize("rawFreq"),dataIndex:"rawFreq",tooltip:this.localize("rawFreqTip"),width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),tooltip:this.localize("relativeFreqTip"),dataIndex:"relativeFreq",width:"autoSize",sortable:!0,renderer:Ext.util.Format.numberRenderer("0,000")},{text:this.localize("tfidf"),tooltip:this.localize("tfidfTip"),dataIndex:"tfidf",width:"autoSize",sortable:!0,hidden:!0,renderer:Ext.util.Format.numberRenderer("0,000.000")},
{text:this.localize("zscore"),tooltip:this.localize("zscoreTip"),dataIndex:"zscore",width:"autoSize",sortable:!0,hidden:!0,renderer:Ext.util.Format.numberRenderer("0,000.000")},{xtype:"widgetcolumn",text:this.localize("trend"),tooltip:this.localize("trendTip"),flex:1,dataIndex:"distributions",widget:{xtype:"sparklineline"}}],listeners:{termsClicked:{fn:function(b,c){if(this.getStore().getCorpus()){var d=[];c.forEach(function(e){Ext.isString(e)?d.push(e):e.term?d.push(e.term):e.getTerm&&d.push(e.getTerm())});
0<d.length&&(this.setApiParams({docIndex:void 0,docId:void 0,query:d}),this.isVisible()&&this.isVisible()&&this.getStore().load({params:this.getApiParams()}))}},scope:this}}});this.callParent(arguments);this.getStore().getProxy().setExtraParam("withDistributions",!0)}});Ext.define("Voyant.panel.Documents",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel","Voyant.util.Downloadable"],alias:"widget.documents",isConsumptive:!0,statics:{i18n:{newCorpusError:"There was an error creating the new the corpus. You may not have permission to do this."},api:{query:void 0,docIndex:void 0,docId:void 0},glyph:"xf0ce@FontAwesome"},MODE_EDITING:"editing",MODE_NORMAL:"normal",config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],mode:this.MODE_NORMAL},constructor:function(a){var b=
Ext.create("Voyant.data.store.Documents",{selModel:{pruneRemoved:!1},proxy:{extraParams:{forTool:"documents"}}}),c=[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"}],d=this;a&&a.mode==this.MODE_EDITING||c.push({text:this.localize("modify"),tooltip:this.localize("modifyTip"),glyph:"xf044@FontAwesome",scope:this,itemId:"modifyButton",handler:function(e){Ext.create("Ext.window.Window",{title:this.localize("title"),modal:!0,width:"80%",minWidth:300,minHeight:200,height:"80%",layout:"fit",frame:!0,
border:!0,items:{xtype:"documents",mode:this.MODE_EDITING,corpus:this.getStore().getCorpus(),header:!1,viewConfig:{plugins:{ptype:"gridviewdragdrop"},listeners:{beforedrop:function(f,g,h,k,l){return this.getStore().getCount()<this.getStore().getCorpus().getDocumentsCount()?(f=this.up("panel"),Ext.Msg.show({title:f.localize("error"),message:f.localize("reorderFilteredError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}),!1):!0}}}},buttons:[{text:this.localize("add"),tooltip:this.localize("addTip"),glyph:"xf067@FontAwesome",
handler:function(f){f.up("window").close();Ext.create("Ext.window.Window",{header:!1,modal:!0,layout:"fit",items:{xtype:"corpuscreator",corpus:this.getStore().getCorpus()}}).show()},scope:this},{text:this.localize("remove"),tooltip:this.localize("removeTip"),glyph:"xf05e@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"remove",scope:this},{text:this.localize("keep"),tooltip:this.localize("keepTip"),glyph:"xf00c@FontAwesome",hidden:1==
this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"keep",scope:this},{text:this.localize("reorder"),tooltip:this.localize("reorderTip"),glyph:"xf0dc@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"reorder",scope:this},{text:"Cancel",glyph:"xf00d@FontAwesome",handler:function(f){f.up("window").close()}}]}).show()}},{text:this.localize("downloadButton"),glyph:"xf019@FontAwesome",itemId:"downloadButton",
handler:function(){d.downloadFromCorpusId(d.getStore().getCorpus().getId())}});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),columns:[{xtype:"rownumberer",renderer:function(e,f,g){return g.getIndex()+1},sortable:!1},{text:this.localize("documentTitle"),dataIndex:"title",sortable:!0,renderer:function(e,f,g){return g.getTitle()},flex:3},{text:this.localize("documentAuthor"),dataIndex:"author",sortable:!0,hidden:!0,renderer:function(e,f,g){return g.getAuthor()},flex:2},
{text:this.localize("documentPubDate"),dataIndex:"pubDate",sortable:!0,hidden:!0,renderer:function(e,f,g){return g.getPubDate()},flex:2},{text:this.localize("documentPublisher"),dataIndex:"publisher",sortable:!1,hidden:!0,renderer:function(e,f,g){return g.getPublisher()},flex:2},{text:this.localize("documentPubPlace"),dataIndex:"pubPlace",sortable:!1,hidden:!0,renderer:function(e,f,g){return g.getPubPlace()},flex:2},{text:this.localize("documentKeyword"),dataIndex:"keyword",sortable:!1,hidden:!0,
renderer:function(e,f,g){return g.getKeyword()},flex:2},{text:this.localize("documentCollection"),dataIndex:"collection",sortable:!1,hidden:!0,renderer:function(e,f,g){return g.getCollection()},flex:2},{text:this.localize("tokensCountLexical"),dataIndex:"tokensCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),sortable:!0,width:"autoSize"},{text:this.localize("typesCountLexical"),dataIndex:"typesCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),width:"autoSize"},{text:this.localize("typeTokenRatioLexical"),
dataIndex:"typeTokenRatio-lexical",renderer:function(e){return Ext.util.Format.percent(e)},width:"autoSize"},{text:this.localize("averageWordsPerSentence"),dataIndex:"averageWordsPerSentence",renderer:Ext.util.Format.numberRenderer("0,000.0"),tooltip:this.localize("averageWordsPerSentenceTip"),width:"autoSize"},{text:this.localize("language"),dataIndex:"language",hidden:!0,renderer:function(e,f,g,h,k,l,m){return m.ownerCt.getLanguage(e)},width:"autoSize"}],store:b,selModel:{type:"rowmodel",mode:"MULTI",
listeners:{selectionchange:{fn:function(e,f){this.getApplication().dispatchEvent("documentsClicked",this,f,this.getStore().getCorpus())},scope:this}}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:c}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(e,f){this.store.setCorpus(f);if(this.isVisible())this.store.load({params:this.getApiParams()});else this.on("afterrender",function(){this.store.load({params:this.getApiParams()})},
this);e=this.getApplication();if(!1===this.hasCorpusAccess(f)||e.getAllowDownload&&"false"===e.getAllowDownload())this.queryById("modifyButton").hide(),this.queryById("downloadButton").hide()});this.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load({params:this.getApiParams()})},this);this.on("query",function(e,f){this.setApiParam("query",f);this.store.load({params:this.getApiParams()})});a.embedded&&("Voyant.data.model.Corpus"==Ext.getClass(a.embedded).getName()?a.corpus=
...
b);f<d;)e.push(a.slice(f,f+=c));else if(c)for(;f<d;)c=Math.ceil((d-f)/b--),e.push(a.slice(f,f+=c));else{b--;c=Math.floor(d/b);for(0===d%c&&c--;f<c*b;)e.push(a.slice(f,f+=c));e.push(a.slice(c*b))}return e},initComponent:function(){this.callParent(arguments)}});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.rezoviz",statics:{i18n:{timedOut:"The entities call took too long and has timed out. Retry?",maxLinks:"Max. Links",nerService:"Entity Identification Service"},api:{query:void 0,mode:void 0,limit:50,type:["organization","location","person"],minEdgeCount:2,terms:void 0,stopList:"auto",docId:void 0,nerService:"nssi"},glyph:"xf1e0@FontAwesome"},config:{graphStyle:{link:{normal:{stroke:"#000000",strokeOpacity:.1},
highlight:{stroke:"#000000",strokeOpacity:.5}}},options:[{xtype:"stoplistoption"}]},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this,b={};["person","location","organization"].forEach(function(c){var d=a.getApplication().getColorForEntityType(c,!0),e=d3.hsl(d);e.s*=.85;e.l*=1.15;var f=d3.hsl(d);f.s*=.85;var g=d3.hsl(d);d=d3.hsl(d);d.l*=.75;b[c+"Node"]={normal:{fill:e.toString(),stroke:f.toString()},
highlight:{fill:g.toString(),stroke:d.toString()}}});this.setGraphStyle(Ext.apply(this.getGraphStyle(),b));Ext.apply(a,{title:this.localize("title"),layout:"fit",items:{xtype:"voyantnetworkgraph",applyNodeStyle:function(c,d){var e=void 0===d?"normal":d;this.getGraphStyle();c.selectAll("rect").style("fill",function(f){f=f.type+"Node";return a.getGraphStyle()[f][e].fill}).style("stroke",function(f){f=f.type+"Node";return a.getGraphStyle()[f][e].stroke})},listeners:{nodeclicked:function(c,d){a.dispatchEvent("termsClicked",
...
0===this.down("voyantnetworkgraph").getNodeData().length&&Ext.Function.defer(this.preloadEntities,100,this)},this);this.on("query",function(c,d){this.loadFromQuery(d)},this);a.callParent(arguments)},categoriesHandler:function(a){var b=[];a.up("menu").items.each(function(c){c.checked&&b.push(c.itemId)});this.setApiParam("type",b);this.preloadEntities()},serviceHandler:function(a){this.setApiParam("nerService",a.itemId);this.preloadEntities()},preloadEntities:function(){var a=this;new Voyant.data.util.DocumentEntities({annotator:this.getApiParam("nerService")},
function(){a.getEntities()})},getEntities:function(){this.down("voyantnetworkgraph").resetGraph();this.getCorpus().getId();var a=this.getLayout().getRenderTarget();a.mask(this.localize("loadingEntities"));Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),method:"POST",params:{tool:"corpus.EntityCollocationsGraph",annotator:this.getApiParam("nerService"),type:this.getApiParam("type"),limit:this.getApiParam("limit"),minEdgeCount:this.getApiParam("minEdgeCount"),corpus:this.getCorpus().getId(),
docId:this.getApiParam("docId"),stopList:this.getApiParam("stopList"),noCache:!0},timeout:12E4,success:function(b){a.unmask();b=Ext.decode(b.responseText);if(0==b.entityCollocationsGraph.edges.length){this.showError({msg:this.localize("noEntities")});var c=this.getApiParam("minEdgeCount");1<c&&Ext.Msg.confirm(this.localize("error"),this.localize("noEntitiesForEdgeCount"),function(d){"yes"===d&&(d=Math.max(1,c-1),this.queryById("minEdgeCount").setRawValue(d),this.setApiParam("minEdgeCount",d),this.preloadEntities())},
this)}else this.processEntities(b.entityCollocationsGraph)},failure:function(b){a.unmask();Ext.Msg.confirm(this.localize("error"),this.localize("timedOut"),function(c){"yes"===c&&this.preloadEntities()},this)},scope:this})},processEntities:function(a){var b=a.nodes;a=a.edges;var c=this.getLayout().getRenderTarget(),d=c.getWidth()/2,e=c.getHeight()/2;c=[];for(var f=0;f<b.length;f++){var g=b[f];c.push({term:g.term,title:g.term+" ("+g.rawFreq+")",type:g.type,value:g.rawFreq,fixed:!1,x:d,y:e})}d=[];for(f=
0;f<a.length;f++)e=a[f].nodes,d.push({source:b[e[0]].term,target:b[e[1]].term,rawFreq:b[e[1]].rawFreq});this.down("voyantnetworkgraph").loadJson({nodes:c,edges:d})}});Ext.define("Voyant.panel.Loom",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.loom",statics:{i18n:{title:"Loom",controls:"Controls",frequenciesGroup:"Frequencies",coverageGroup:"Coverage",distributionsGroup:"Distribution",termsGroup:"Terms",inDocumentsLabel:"in documents",inDocumentsLabelTip:"each term must be present in the number of documents defined by this range",spanSomeLabel:"some documents",spanSomeLabelTip:"each term must be present in at least one document defined by this range",
...
h+"]")){var k=function(l,m){opacity=l.getAttribute("opacity");0<opacity&&(opacity-=.01,l.setAttribute("opacity",opacity),m/=2,Ext.defer(k,m,this,[l,m]))};g.setAttribute("opacity",1);k(g,1E3)}})}},items:[{itemId:"terms",width:100,layout:"fit",listeners:{filterchange:function(e){var f=this.getTargetEl(),g=f.getWidth(),h=f.getHeight(),k=e.getCount();f.setHtml(" ");terms=e.getRange().map(function(v,p){return{term:v.getTerm(),col:Voyant.application.getColorForTerm(v.getTerm(),!0),x:g/2,y:p*h/k}});terms.sort(function(v,
p){return v.term.localeCompare(p.term)});e=d3.select(f.dom).append("svg").attr("width",g).attr("height",h).append("g").attr("transform","translate(-.5,-.5)");var l=Math.ceil(h/terms.length),m=e.selectAll("ytext").data(terms).enter().append("text").text(function(v,p){return v.term}).attr("class","ytext").attr("text-anchor","middle").attr("x",g/2).attr("y",function(v,p){return l*p}).attr("fill",function(v){return Voyant.application.getColorForTerm(v.term,!0)});l=Math.ceil(h/terms.length);var n=d3.fisheye.circular().radius(50).distortion(2);
yFisheye=d3.fisheye.scale(d3.scaleIdentity).domain([0,h]);var u=this;e.on("mousemove",function(){var v=d3.mouse(this);currentItem=Math.round(v[1]*terms.length/h);currentItem=Math.min(currentItem,terms.length-1);n.focus(v[1]);yFisheye.focus(v[1]);var p=m.nodes();p[currentItem]&&u.fireEvent("termHovered",u,p[currentItem].textContent);var q=14,r=Math.max(v[1],q),w=1;d3.select(p[currentItem]).attr("y",function(L){return r}).attr("font-size",q).attr("fill-opacity",w);for(var x=void 0,z=currentItem-1;-1<
z;z--)8<=q?(r-=q,q-=.5):(void 0==x&&(x=r/z),r-=x),.1<w&&(w-=.05),d3.select(p[z]).attr("y",function(L){return r}).attr("font-size",q).attr("fill-opacity",w);q=14;r=Math.max(v[1],q);w=1;x=void 0;z=currentItem+1;for(v=terms.length;z<v;z++)8<=q?(r+=q,q-=.5):(void 0==x&&(x=(h-r)/(v-z)),r+=x),.1<w&&(w-=.05),d3.select(p[z]).attr("y",function(L){return r}).attr("font-size",q).attr("fill-opacity",w)})}}},{itemId:"threads",layout:"fit",flex:1,listeners:{filterchange:function(e){var f=this.getTargetEl(),g=f.getWidth(),
...
Math.max(1E-6,Ext.Array.max(terms.map(function(q){return Ext.Array.max(q.vals)})))]).range([1E-6,h-2]),n=d3.line().curve(d3.curveCardinal).x(function(q,r){return l/2+l*r}).y(function(q){return h-1-m(q)}),u=k.append("g").attr("opacity",0),v=u.append("rect").attr("fill","white").attr("text-anchor","middle").attr("alignment-baseline","middle").attr("stroke","rgba(0,0,0,.05)").attr("class","rect").attr("x",100).attr("y",100).attr("width",70).attr("height",16).attr("opacity",1),p=u.append("text").attr("text-anchor",
...
q.term).attr("d",n).on("mouseover",function(){d3.select(this).attr("opacity",1);var w=d3.mouse(this);u.attr("opacity",1);v.attr("x",w[0]-35).attr("y",w[1]-8+(w[1]>h/2?-18:18));p.text(q.term).attr("fill",r).attr("x",w[0]).attr("y",w[1]+(w[1]>h/2?-18:18))}).on("mouseout",function(){d3.select(this).attr("opacity",0);u.attr("opacity",0)});u.raise()},this)}}}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[d[0],d[2],d[3],d[4],d[5],{fieldLabel:this.localize("visibleTerms"),
...
{}),function(p){return!this.magnets[p].isHovering},this));var g={};hoveringDocs=[];this.documents.forEach(function(p,q){p.matches.forEach(function(r,w){b.beginPath();b.moveTo(p.x,p.y);b.lineTo(this.magnets[r].x,this.magnets[r].y);!0===f?b.strokeStyle="rgba("+this.magnets[r].colour.join(",")+",.1)":p.isHovering||this.magnets[r].isHovering?(hoveringDocs[q]=!0,g[r]=!0,b.strokeStyle="rgba("+this.magnets[r].colour.join(",")+",.5)"):b.strokeStyle="rgba(0,0,0,.02)";b.stroke()},this)},this);var h=parseInt(this.textFont)/
...
")",b.arc(this.magnets[l].x,this.magnets[l].y,12,0,2*Math.PI),b.fill(),b.stroke())}if(e){var m=this;setTimeout(function(){m.draw()},100)}else if(this.documents){c=Math.max(c/this.documents.length,50);a=0;for(l=this.documents.length;a<l;a++)for(var n=0;n<l;n++)if(a<n){var u=this.documents[a].x-this.documents[n].x,v=this.documents[a].y-this.documents[n].y;Math.sqrt(u*u+v*v)<c&&(u*=.1,v*=.1,this.documents[a].targetX+=u,this.documents[n].targetX-=u,this.documents[a].targetY+=v,this.documents[n].targetY-=
v,e=!0)}e&&(m=this,setTimeout(function(){m.draw()},100))}}});Ext.define("Voyant.panel.MicroOcp",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.microocp",statics:{i18n:{title:"MicroOCP"},api:{config:void 0,stopList:"auto",uri:void 0},glyph:"xf1ea@FontAwesome"},config:{editor:void 0},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);var b=Ext.create("Ext.data.Store",{fields:[{name:"cocoa",type:"string"}]});Ext.apply(this,{title:this.localize("title"),layout:"border",dockedItems:[{dock:"bottom",
...
text:n[l]})}else for(h in f)f[h].forEach(function(p,q){var r=d.substring(p.start,p.end).replace(/<\/?\w+(\s+\w)*>/g,"").trim();r&&m.push({title:p.tag+(p.attr?" "+p.attr:"")+" "+(q+1),text:r})});if(0==m.length)return this.showError({title:"Error",msg:"No documents found."});this.mask();var u=Ext.Msg.progress("Creating","Creating new corpus."),v=this;(new Corpus({inputFormat:"json",input:Ext.JSON.encode({documents:m}),jsonDocumentsPointer:"/documents",jsonTitlePointer:"/title",jsonContentPointer:"/text"})).then(function(p){u.close();
v.unmask();var q=v.getApplication();v.openUrl(q.getBaseUrl()+"?corpus\x3d"+p.getAliasOrId())})},scope:this},{xtype:"checkbox",boxLabel:"Combine documents with the same tag attribute.",checked:!0}]}],items:[{xtype:"panel",autoScroll:!0,flex:1,height:"100%",align:"stretch",header:!1,region:"center",listeners:{boxready:function(){}}},{xtype:"grid",region:"east",height:"100%",align:"stretch",scrollable:!0,header:!1,width:200,selModel:Ext.create("Ext.selection.CheckboxModel",{mode:"SIMPLE"}),store:b,columns:[{text:"COCOA",
flex:1,dataIndex:"cocoa"}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(c,d){this.getApiParam("uri")||d.getPlainText().then(function(e){e.replace(/(\r\n|\r|\n)(\r\n|\r|\n)(\r\n|\r|\n)+/g,"\n\n")})},this);this.on("afterrender",function(c){Ext.Msg.alert("MicroOCP","MicroOCP is an experimental prototype that is intended to give a taste of working with the COCOA markup format (COunt and COncordance on the Atlas). Cocoa tags are like switches, you can place one and that tag remains in effect until the next instance of the tag, which can have an optional attribute (single word). As an enhancement to COCOA, you can also close a tag.\x3cpre\x3e\x26lt;speaker jack\x26gt;I'm falling \x26lt;speaker jill\x26gt;down the hill.\x26lt;/speaker\x26gt;\x3c/pre\x3e")})}});Ext.define("Voyant.panel.Reader",{extend:"Ext.panel.Panel",requires:["Voyant.data.store.Tokens"],mixins:["Voyant.panel.Panel"],alias:"widget.reader",isConsumptive:!0,statics:{i18n:{highlightEntities:"Highlight Entities",entityType:"entity type",nerVoyant:"Entity Identification with Voyant",nerNssi:"Entity Identification with NSSI"},api:{start:0,limit:1E3,skipToDocId:void 0,query:void 0},glyph:"xf0f6@FontAwesome"},config:{innerContainer:void 0,tokensStore:void 0,documentsStore:void 0,documentTermsStore:void 0,
documentEntitiesStore:void 0,exportVisualization:!1,lastScrollTop:0,scrollIntoView:!1,insertWhere:"beforeEnd",lastLocationUpdate:new Date,options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}]},SCROLL_UP:-1,SCROLL_EQ:0,SCROLL_DOWN:1,LOCATION_UPDATE_FREQ:100,INITIAL_LIMIT:1E3,MAX_TOKENS_FOR_NER:1E5,HIGHLIGHT_ALPHA:.25,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=Ext.create("Voyant.data.store.Tokens",
{parentTool:this,proxy:{extraParams:{forTool:"reader"}}}),c=this;b.on("beforeload",function(d){return c.hasCorpusAccess(d.getCorpus())});b.on("load",function(d,e,f){if(f){var g="",h=this.localize("documentFrequency"),k=!1,l=-1,m=!1;e.forEach(function(n){0==n.getPosition()&&(g+="\x3ch3\x3e"+this.getDocumentsStore().getById(n.getDocId()).getFullLabel()+"\x3c/h3\x3e");n.getDocIndex()!=l&&(k=this.getDocumentsStore().getById(n.getDocId()).isPlainText(),l=n.getDocIndex());if(n.isWord())m=!1,g+="\x3cspan class\x3d'word' id\x3d'"+
n.getId()+"' data-qtip\x3d'\x3cdiv class\x3d\"freq\"\x3e"+h+" "+n.getDocumentRawFreq()+"\x3c/div\x3e'\x3e"+n.getTerm()+"\x3c/span\x3e";else{n=n.getTermWithLineSpacing(k);var u=0==n.indexOf("\x3cbr /\x3e");if(!m||!u&&0!=n.trim().length)g+=n,m=u}},this);this.updateText(g);this.down("querysearchfield").getValue();void 0!==this.getDocumentEntitiesStore()&&this.highlightEntities()}},this);this.setTokensStore(b);this.on("query",function(d,e){this.loadQueryTerms(e)},this);this.setDocumentTermsStore(Ext.create("Ext.data.Store",
{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",withDistributions:!0,withPositions:!0,bins:25,forTool:"reader"},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(d,e,f,g){this.highlightKeywords(e);this.down("readergraph").populateChart(e)},scope:this}}));this.on("afterrender",function(){var d=this.down('panel[region\x3d"center"]');
...
var e=this.getApiParam("query");e&&this.loadQueryTerms(Ext.isString(e)?[e]:e)},this)},this);Ext.apply(this,{title:this.localize("title"),cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{xtype:"readergraph",region:"south",height:40,split:{size:2},splitterResize:!0,border:!1,listeners:{documentRelativePositionSelected:function(d,e){d=this.getDocumentsStore().getAt(e.docIndex);
var f=d.get("tokensCount-lexical");e=Math.floor(f*e.fraction)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:d.getId(),start:0>e?0:e});this.load(!0)},scope:this}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"},"-\x3e",{glyph:"xf0eb@FontAwesome",tooltip:this.localize("highlightEntities"),
itemId:"nerServiceParent",hidden:!0,menu:{items:[{xtype:"menucheckitem",group:"nerService",text:this.localize("nerNssi"),itemId:"nssi",checked:!0,handler:this.nerSeviceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:this.localize("nerVoyant"),itemId:"stanford",checked:!1,handler:this.nerSeviceHandler,scope:this}]}}]}],listeners:{loadedCorpus:function(d,e){this.getTokensStore().setCorpus(e);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",e.getId());d=e.getDocuments();
this.setDocumentsStore(d);this.rendered&&(this.load(),0==this.hasCorpusAccess(e)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(e=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(e)?[e]:e))},termsClicked:function(d,e){var f=[];e.forEach(function(g){Ext.isString(g)?f.push(g):g.term?f.push(g.term):g.getTerm&&f.push(g.getTerm())});0<f.length&&this.loadQueryTerms(f)},corpusTermsClicked:function(d,e){var f=[];e.forEach(function(g){g.getTerm()&&f.push(g.getTerm())});this.loadQueryTerms(f)},
documentTermsClicked:function(d,e){var f=[];e.forEach(function(g){g.getTerm()&&f.push(g.getTerm())});this.loadQueryTerms(f)},documentSelected:function(d,e){d=this.getTokensStore().getCorpus().getDocument(e);this.setApiParams({skipToDocId:d.getId(),start:0});this.load(!0)},documentsClicked:function(d,e,f){0<e.length&&(this.setApiParams({skipToDocId:e[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(d,e){if(void 0!==e[0]){var f=e[0],g=f.get("docIndex"),h=f.get("position");d=h-this.getApiParam("limit")/
2;e=this.getCorpus().getDocument(g);this.setApiParams({skipToDocId:e.getId(),start:0>d?0:d});this.load(!0,{callback:function(){var k=this.body.dom.querySelector("#_"+g+"_"+h);k&&k.scrollIntoView();this.highlightKeywords(f,!1)},scope:this})}},documentIndexTermsClicked:function(d,e){void 0!==e[0]&&(d=Ext.create("Voyant.data.model.Token",e[0]),this.fireEvent("termLocationClicked",this,[d]))},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&this.getDocumentTermsStore().load({params:{query:a,
categories:this.getApiParam("categories")}})},highlightKeywords:function(a,b){var c=this.getInnerContainer().first();c.select("span[class*\x3dkeyword]").removeCls("keyword").applyStyles({backgroundColor:"transparent"});Ext.isArray(a)||(a=[a]);a.forEach(function(d){var e=d.get("term"),f=this.getApplication().getColorForTerm(e);f="rgba("+f.join(",")+","+this.HIGHLIGHT_ALPHA+")";if(d.get("positions")){e=d.get("positions");var g=d.get("docIndex");e.forEach(function(k){(k=c.dom.querySelector("#_"+g+"_"+
k))&&Ext.fly(k).addCls("keyword").applyStyles({backgroundColor:f})})}else{var h=new RegExp("^"+e+"$","i");c.select("span.word").each(function(k,l,m){k.dom.firstChild&&k.dom.firstChild.nodeValue.match(h)&&k.addCls("keyword").applyStyles({backgroundColor:f})})}},this)},nerSeviceHandler:function(a){a=a.itemId;var b=[],c=this.getLocationInfo();if(c)for(var d=c[0].docIndex;d<=c[1].docIndex;d++)b.push(d);else b.push(0);this.clearEntityHighlights();var e=this;new Voyant.data.util.DocumentEntities({annotator:a,
includeEntities:!0,docIndex:b},function(f){f&&(e.clearEntityHighlights(),e.setDocumentEntitiesStore(f),e.highlightEntities())})},clearEntityHighlights:function(){this.getInnerContainer().first().select(".entity").each(function(a){a.removeCls("entity start middle end location person organization misc money time percent date duration set unknown");a.dom.setAttribute("data-qtip",a.dom.getAttribute("data-qtip").replace(/<div class="entity">.*?<\/div>/g,""))})},highlightEntities:function(){var a=this.getInnerContainer().first(),
b=this.getDocumentEntitiesStore(),c=this.localize("entityType");b.forEach(function(d){var e=d.positions;e?e.forEach(function(f){var g=2===f.length;if(g&&1<f[1]-f[0])for(var h=f[1],k=f[0]+1,l=1;k<h;)f.splice(l,0,k),k++,l++;h=0;for(k=f.length;h<k;h++)if(l=f[h],-1===l)console.warn("missing position for: "+d.term);else if(l=a.selectNode("#_"+d.docIndex+"_"+l,!1)){var m="";g&&(m=0===h?"start ":h===k-1?"end ":"middle ");l.addCls("entity "+m+d.type);l.dom.setAttribute("data-qtip",l.dom.getAttribute("data-qtip")+
'\x3cdiv class\x3d"entity"\x3e'+c+": "+d.type+"\x3c/div\x3e")}}):console.warn("no positions for: "+d.term)})},fetchPrevious:function(a){var b=this.getInnerContainer().first(),c=b.first(".word");if(null!=c&&!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){b=Voyant.data.model.Token.getInfoFromElement(c);var d=b.docIndex;b=b.position;var e=this.getDocumentsStore().getAt(d),f=this.getApiParam("limit"),g=!1;if(0===d&&0===b){a=this.down('panel[region\x3d"center"]').body;0!=c.getScrollIntoViewXY(a,
a.dom.scrollTop,a.dom.scrollLeft).y&&c.dom.scrollIntoView();c.frame("red");break}0<d&&0===b?(g=!0,d--,e=this.getDocumentsStore().getAt(d),d=e.get("tokensCount-lexical"),b=d-f,0>b&&(b=0,this.setApiParam("limit",d))):(f--,b-=f);0>b&&(b=0);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+this.localize("loading")+"\x3c/div\x3e","before",!1).mask();g||c.destroy();c=e.getId();this.setApiParams({skipToDocId:c,start:b});this.setInsertWhere("afterBegin");this.setScrollIntoView(a);this.load();this.setApiParam("limit",
this.INITIAL_LIMIT);break}c.destroy();c=b.first()}},fetchNext:function(a){var b=this.getInnerContainer().first(),c=b.last();if(!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){b=Voyant.data.model.Token.getInfoFromElement(c);var d=b.docIndex,e=b.position,f=this.getDocumentsStore().getAt(b.docIndex),g=f.getId();f=f.get("tokensCount-lexical");if(e+this.getApiParam("limit")>=f&&d==this.getCorpus().getDocumentsCount()-1)if(d=f-e,1>=d){c.dom.scrollIntoView();c.frame("red");break}else this.setApiParam("limit",
d);for(d=c.dom.nextSibling;d;)e=d,d=d.nextSibling,e.parentNode.removeChild(e);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+this.localize("loading")+"\x3c/div\x3e","after",!1).mask();c.destroy();this.setApiParams({skipToDocId:g,start:b.position});this.setInsertWhere("beforeEnd");this.setScrollIntoView(a);this.load();this.setApiParam("limit",this.INITIAL_LIMIT);break}c.destroy();c=b.last()}},load:function(a,b){a&&(this.getInnerContainer().first().destroy(),this.getInnerContainer().setHtml('\x3cdiv class\x3d"readerContainer"\x3e\x3cdiv class\x3d"loading"\x3e'+
...
100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateLocationMarker:function(a,b){var c=this.getLocationInfo();if(c){var d=c[0],e=c[1];c=this.getCorpus();var f=!1;0!==d.position&&(f=!0);for(var g={},h=0,k=this.getApplication().getEntitiesEnabled?this.getApplication().getEntitiesEnabled():!1,l=d.docIndex;l<=e.docIndex;){var m=c.getDocument(l).get("tokensCount-lexical");
m>this.MAX_TOKENS_FOR_NER&&(k=!1);l===e.docIndex&&(m=e.position);l===d.docIndex&&(m-=d.position);h+=m;g[l]=m;l++}l=this.down("#nerServiceParent");k?l.show():l.hide();h=Math.round(h*a);k=a=0;for(l=d.docIndex;l<=e.docIndex&&!(a=l,k+=g[l],k>=h);l++);e=g[a]-(k-h);f&&a===d.docIndex&&(e+=d.position);d=e/c.getDocument(a).get("tokensCount-lexical");this.down("readergraph").moveLocationMarker(a,d,b)}},updateChart:function(){},getLocationInfo:function(){var a=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",
!0)),b=a[0];a=a[a.length-1];return void 0!==b&&void 0!==a?(b=Voyant.data.model.Token.getInfoFromElement(b),a=Voyant.data.model.Token.getInfoFromElement(a),[b,a]):null}});Ext.define("Voyant.panel.SimpleDocReader",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.simpledocreader",isConsumptive:!0,statics:{i18n:{},api:{docIndex:void 0,docId:void 0},glyph:"xf0f6@FontAwesome"},config:{},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{html:'\x3ciframe style\x3d"width: 100%; height: 100%; border: none;"\x3e\x3c/iframe\x3e',dockedItems:[{dock:"bottom",
...
renderer:function(q,r,w){q.setHtml(b.tokenFreqTipTemplate.apply([r.get("term"),r.get("rawFreq"),r.get("relativeFreq")]))}},marker:{type:"circle"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(q,r,w,x){q=w.store.getAt(x);if(null!==q){var z=q.get("cluster");-1===z&&(z=0);w=.65;x=1;!0===q.get("disabled")?x=w=.1:3===d&&q.get("z")&&(w=b.interpolate(q.get("z"),u,n,0,1));z=b.getApplication().getColor(z);r.fillStyle="rgba("+z.join(",")+","+w+")";r.strokeStyle="rgba("+z.join(",")+","+
x+")";q=q.get("rawFreq");q=b.interpolate(q,m,l,2,20);r.radius=q}},scope:this},{type:"customScatter",xField:"x",yField:"y",store:g,label:{font:"14px Helvetica",field:"term",display:"over",color:this.getDefaultDocColor(!0)},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(q,r,w){q.setHtml(b.docFreqTipTemplate.apply([r.get("title"),r.get("rawFreq")]))}},marker:{type:"diamond"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(q,r,w,x){q=w.store.getAt(x);null!==q&&
(w=q.get("cluster"),w=-1===w||"docSim"!==b.getApiParam("analysis")?b.getDefaultDocColor():b.getApplication().getColor(w),x=.65,3===d&&q.get("z")&&(x=b.interpolate(q.get("z"),u,n,0,1)),r.fillStyle="rgba("+w.join(",")+","+x+")",r.strokeStyle="rgba("+w.join(",")+",1)",r.radius=5)},scope:this}],listeners:{itemclick:function(q,r,w){q=r.record.data;"doc"===q.category?(q=this.getCorpus().getDocument(q.docIndex),this.getApplication().dispatchEvent("documentsClicked",this,[q])):"term"===q.category&&(q=Ext.create("Voyant.data.model.CorpusTerm",
q),this.getApplication().dispatchEvent("corpusTermsClicked",this,[q]))},render:function(q){q.body.on("contextmenu",function(r,w){r.preventDefault();r=r.getXY();var x=Ext.fly(w).getXY();w=r[0]-x[0];x=r[1]-x[1];var z=this.down("#chart").getItemForPoint(w,x);null!=z&&"term"===z.record.get("category")&&(w=this.down("#chart").getSeries(),w[0].disableToolTips(),w[1].disableToolTips(),x=z.record.get("term"),w=(new Ext.Template(this.localize("removeTerm"))).apply([x]),this.getChartMenu().queryById("remove").setText(w),
w=(new Ext.Template(this.localize("nearbyTerm"))).apply([x]),x=this.getChartMenu().queryById("nearby"),x.setText(w),x.setDisabled("tsne"===this.getApiParam("analysis")),this.getChartMenu().on("click",function(L,H){void 0!==H&&(L=z.record.get("term"),"nearby"===H.getItemId()?this.getNearbyForTerm(L):this.removeTerm(L))},this,{single:!0}),this.getChartMenu().showAt(r))},this)},scope:this}};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);this.queryById("chartParent").unmask();
...
this.getCorpus().map(function(d){return d.getTinyTitle()});var c=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,callback:function(d,e,f){var g=[],h=[],k=this.getApiParam("chartType");c||d.sort(function(m,n){return m.getTerm()==n.getTerm()?m.getDocIndex()-n.getDocIndex():m.getTerm().localeCompare(n.getTerm())});d.forEach(function(m,
n){var u=m.get("term"),v=m.get("docIndex"),p=c?this.getApplication().getColorForTerm(u,!0):this.getApplication().getColor(v,!0);v=m.get("docIndex");m.get("distributions").forEach(function(q,r){g[r]||(g[r]={docIndex:v,index:r+1});g[r]["_"+n+"_"+v]="relative"==b?q.toFixed(7):q;g[r]["term"+n]=u},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(q){h.push({type:"stacked"==q?"bar":q,title:c?u:v+1+") "+u,xField:"index",yField:"_"+n+"_"+v,term:u,colors:[p],label:"barline"==k&&"bar"==q?{display:"none"}:
{field:"term"+n}})},this)},this);if("bar"==k){var l=Ext.Array.unique(d.map(function(m){return m.getTerm()})).length;e=d.map(function(m){return 1+m.get("docIndex")+") "+m.getTerm()});d=d.map(function(m){return l?this.getApplication().getColor(m.get("docIndex"),!0):this.getApplication().getColorForTerm(m.getTerm(),!0)},this);h.push({type:"bar",title:0<e.length?e:this.localize("noResults"),colors:d,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(m){return"_"==m.charAt(0)}):void 0,
label:{field:e}})}d=Ext.create("Ext.data.JsonStore",{fields:0<g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:d,series:h,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+(c?" ("+c.getShortTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:2>this.getCorpus().getDocumentsCount()?5:2,stopList:this.getApiParam("stopList")},
callback:function(d,e,f){this.setApiParam("query",d.map(function(g){return g.getTerm()}));this.loadDocumentTerms()},scope:this})},buildChart:function(a){var b=this.getApiParam("chartType"),c=!1;if(!0===this.getApiParam("labels")||"true"==this.getApiParam("labels"))c=!0;Ext.applyIf(a,{cls:this.getApiParam("mode")});a.series.forEach(function(e){Ext.applyIf(e,{stacked:"bar"==e.type?!1:!0,showInLegend:"barline"==b&&"line"==e.type?!1:!0,smooth:!0,showMarkers:"bar"==e.type?!1:!0,marker:"barline"==b&&"line"==
e.type?null:{type:"circle",radius:2},style:{lineWidth:1,fillOpacity:"barline"==b&&"bar"==e.type?.01:1,strokeOpacity:"barline"==b&&"bar"==e.type?.1:1},highlight:!0,highlightCfg:{scaling:"bar"==e.type?1.1:2},label:{},tooltip:{trackMouse:!0,renderer:this.getItemToolTip,scope:this},listeners:{itemclick:function(f,g,h,k){this.clickTimer&&clearTimeout(this.clickTimer);if(!this.blockClick)if(this.blockClick=!0,Ext.defer(function(){this.blockClick=!1},1E3,this),"document"==this.getApiParam("mode"))f=g.field.split("_"),
h=f[2],h=this.getCorpus().getDocument(h).get("tokensCount-lexical"),h=parseInt(g.index*h/parseInt(this.getApiParam("bins"))),this.dispatchEvent("documentIndexTermsClicked",this,[{term:g.series.term,docIndex:f[2],position:h}]);else{this.clickTimer&&clearTimeout(this.clickTimer);var l=this;this.clickTimer=setTimeout(function(){l.dispatchEvent("documentIndexTermsClicked",l,[{term:g.series.term,docIndex:g.index}])},300)}},itemdblclick:function(f,g,h,k){this.clickTimer&&clearTimeout(this.clickTimer);this.blockClick=
!0;Ext.defer(function(){this.blockClick=!1},1E3,this);"document"!=this.getApiParam("mode")&&Ext.create("Ext.menu.Menu",{items:[{text:this.localize("drillTerm"),tooltip:this.localize("drillTermTip"),handler:function(){this.setApiParams({mode:"document",query:g.series.term});this.loadDocumentTerms()},scope:this},{text:this.localize("drillDocument"),tooltip:this.localize("drillDocumentTip"),handler:function(){this.setApiParams({mode:"document",docIndex:g.index});this.loadDocumentTerms()},scope:this}],
listeners:{hide:function(l){Ext.defer(function(){this.destroy()},200,l)},scope:this}}).showAt(h.pageX,h.pageY)},scope:this}});Ext.applyIf(e.label,{display:"over",field:"index",fontSize:11,translateY:"line"==b?9:void 0});c||(e.label.display="none")},this);Ext.applyIf(a,{animation:!0,plugins:{ptype:"chartitemevents",moveEvents:!0},legend:{docked:"top",listeners:{itemclick:function(e,f,g,h){if(e.getStore().getCount()<e.chart.series.length&&"barline"==this.getApiParam("chartType")){var k=f.get("name"),
l=f.get("disabled");e.chart.series.forEach(function(m){m.getTitle()==k&&m.setHidden(l)});e.chart.redraw()}},scope:this}},interactions:["itemhighlight","crosszoom"],listeners:{}});Ext.applyIf(a.listeners,{itemhighlightchange:function(e,f){e.el.dom.style.cursor=f?"pointer":""},afterrender:function(){},scope:this});a.axes.forEach(function(e){Ext.applyIf(e,{title:{},label:{}});Ext.applyIf(e.title,{scaling:.75});Ext.applyIf(e.label,{scaling:.75});if("category"==e.type){var f="";a.store.each(function(g){f+=
...
{},d=this.getTargetEl().down(".x-table-layout"),e=d.getSize(!1);d=d.dom.rows;for(var f=0;f<d.length;f++)for(var g=d[f].cells,h=0;h<g.length;h++){var k=Ext.get(g[h]),l=k.down(".x-panel"),m=l.id;if(void 0!==a&&void 0!==b)k=l.getSize(!1),k.width*=a,k.height*=b;else{l=k.getSize(!1);var n=Ext.getCmp(m),u=n.initialConfig.cellWidth;n=n.initialConfig.cellHeight;void 0!==u&&(l.width=u/100*e.width,k.setWidth(l.width));void 0!==n&&(l.height=n/100*e.height,k.setHeight(l.height));k=l}c[m]=k}for(var v in c)k=c[v],
Ext.getCmp(v).setSize(k);this.updateLayout()}});Ext.define("Voyant.panel.Veliza",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],xtype:"veliza",autoScroll:!0,statics:{i18n:{},api:{script:"",message:void 0},glyph:"xf0e6@FontAwesome"},config:{previous:[]},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);var a=this;Ext.apply(this,{title:this.localize("title"),glyph:"xf0e6@FontAwesome",layout:{type:"border",align:"stretch"},items:[{itemId:"chat",html:"\x3cform class\x3d'chat'\x3e\x3c/form\x3e",
...
"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(b){b.setValue(parseInt(this.getApiParam("limit")))},changecomplete:function(b,c){this.setApiParams({limit:c});this.postSweep()},scope:this}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("numTopicsTip")+'"\x3e'+this.localize("numTopics")+"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:200,listeners:{afterrender:function(b){b.setValue(parseInt(this.getApiParam("numTopics")))},
...
this.loadStopwords()},parseLine:function(a){var b=this.getStopwords(),c=this.getVocabularyCounts(),d=this.getTokensPerTopic(),e=this.getVocabularySize();c=this.getVocabularyCounts();var f=this.getDocuments(),g=parseInt(this.getApiParam("numTopics")),h=this.getWordTopicCounts();if(""!=a){var k=f.length,l="",m=a.split("\t");a=m[0];3==m.length&&(k=m[0],l=m[1],a=m[2]);var n=[];m=a.toLowerCase().split(" ");if(null!=m){var u=this.zeros(g);m.forEach(function(v){if(""!==v){var p=Math.floor(Math.random()*
g);2>=v.length&&(b[v]=1);var q=b[v];q?c[v]=c[v]?c[v]+1:1:(d[p]++,h[v]||(h[v]={},e++,c[v]=0),h[v][p]||(h[v][p]=0),h[v][p]+=1,c[v]+=1,u[p]+=1);n.push({word:v,topic:p,isStopword:q})}});this.setVocabularySize(e);f.push({originalOrder:f.length,id:k,date:l,originalText:a,tokens:n,topicCounts:u})}}}});Ext.define("Voyant.panel.Via",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.via",statics:{i18n:{},api:{stopList:"auto",limit:100,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"listeditor",name:"whiteList"},{xtype:"categoriesoption"}]},layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),
...
var c=this.getApiParams();a.loadRelatedWords(c).then(function(d){b.unmask();d=d.map(function(f){return{source:f.getSource(),target:f.getTarget()}});var e=b.down("voyantnetworkgraph");e?e.loadJson({edges:d}):(e=Ext.create("Voyant.widget.VoyantNetworkGraph",{edges:d,listeners:{nodeclicked:function(f,g){b.dispatchEvent("termsClicked",b,[g.term])}}}),b.add(e))},function(d){b.unmask();d.timedout?b.showError(b.localize("timedout")):b.showError(d)})}});Ext.define("Voyant.panel.NSSI",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.nssi",statics:{i18n:{title:"NSSI Results",entity:"Entity",lemma:"Lemma",classification:"Classification",document:"Document",start:"Start",end:"End"}},config:{},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=Ext.create("Ext.data.JsonStore",
{fields:[{name:"entity"},{name:"lemma"},{name:"classification"},{name:"docId"},{name:"start",type:"int"},{name:"end",type:"int"}]});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:a,columns:[{text:this.localize("document"),dataIndex:"docIndex",width:"autoSize",sortable:!0},{text:this.localize("classification"),dataIndex:"classification",flex:.5,sortable:!0},{text:this.localize("entity"),dataIndex:"entity",flex:1,sortable:!0},{text:this.localize("lemma"),dataIndex:"lemma",
flex:1,sortable:!0},{text:this.localize("start"),dataIndex:"start",width:"autoSize",sortable:!1},{text:this.localize("end"),dataIndex:"end",width:"autoSize",sortable:!1}]});this.on("loadedCorpus",function(){var b=this;this.isVisible()&&this.load().then(function(c){var d=[];c.documents.forEach(function(e){var f=b.getCorpus().getDocument(e.id).getIndex();e.entities.forEach(function(g){d.push(Object.assign({docIndex:f},g))})});a.loadRawData(d)},function(c){console.log(c)})},this);this.callParent(arguments)},
load:function(a,b){b=b||new Ext.Deferred;var c=this;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{corpus:this.getCorpus().getAliasOrId(),tool:"corpus.NSSI",useCache:!1,noCache:!0},scope:this}).then(function(d){(d=Ext.JSON.decode(d.responseText))&&d.nssi&&d.nssi.progress&&new Voyant.widget.ProgressMonitor({progress:d.nssi.progress,delay:1E4,maxMillisSinceStart:36E5,success:function(){console.log("NSSI progress monitor success");c.load.call(c,a,b)},failure:function(e){Voyant.application.showResponseError(c.localize("failedToFetchGeonames"),
e)},scope:c});d&&d.nssi&&!d.nssi.progress&&b.resolve(d.nssi)},function(d){Voyant.application.showResponseError(c.localize("failedToFetchGeonames"),d)});return b.promise}});Ext.define("Voyant.notebook.editor.button.Add",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperadd",statics:{i18n:{}},constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)},glyph:"xf067@FontAwesome",handler:function(a,b){a=Voyant.notebook.editor.EditorWrapper.currentEditor;a.findParentByType("notebook").fireEvent("notebookWrapperAdd",a,b)}});Ext.define("Voyant.notebook.editor.button.CodeConfig",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookcodeconfig",statics:{i18n:{tip:"Configuration Options",title:"Cell Mode",modeCode:"Code",modeJavascript:"Javascript (default)",modeData:"Data",modeFile:"File",modeJson:"JSON",modeText:"Text",modeXml:"XML",modeHtml:"HTML",ok:"OK",cancel:"Cancel"},configWin:void 0,initWindow:function(a){void 0===Voyant.notebook.editor.button.CodeConfig.configWin&&(Voyant.notebook.editor.button.CodeConfig.configWin=
new Ext.Window({title:a.localize("title"),closeAction:"hide",layout:"fit",width:240,items:[{xtype:"form",layout:{type:"vbox",align:"stretch"},bodyPadding:10,items:[{xtype:"fieldset",title:a.localize("modeCode"),items:[{xtype:"radiofield",boxLabel:a.localize("modeJavascript"),name:"codeMode",inputValue:"javascript",flex:1}]},{xtype:"fieldset",title:a.localize("modeData"),items:[{xtype:"radiofield",boxLabel:a.localize("modeFile"),name:"codeMode",inputValue:"file",flex:1},{xtype:"radiofield",boxLabel:a.localize("modeJson"),
name:"codeMode",inputValue:"json",flex:1},{xtype:"radiofield",boxLabel:a.localize("modeText"),name:"codeMode",inputValue:"text",flex:1},{xtype:"radiofield",boxLabel:a.localize("modeXml"),name:"codeMode",inputValue:"xml",flex:1},{xtype:"radiofield",boxLabel:a.localize("modeHtml"),name:"codeMode",inputValue:"html",flex:1}]}]}],buttons:[{text:a.localize("ok"),itemId:"ok"},{text:a.localize("cancel"),handler:function(b){b.up("window").close()}}]}))},showConfigWindow:function(a){Voyant.notebook.editor.button.CodeConfig.configWin.down('radiofield[name\x3dcodeMode][inputValue\x3d"'+
a.getMode()+'"]').setValue(!0);Voyant.notebook.editor.button.CodeConfig.configWin.down("button#ok").setHandler(function(b){b=b.up("window");var c=b.down("form");c.isDirty()&&(a.up("notebook").setIsEdited(!0),c=c.getValues(),a.switchModes(c.codeMode));b.close()});Voyant.notebook.editor.button.CodeConfig.configWin.show()}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});Voyant.notebook.editor.button.CodeConfig.initWindow(this);this.callParent(arguments)},glyph:"xf013@FontAwesome",
listeners:{click:function(a,b){Voyant.notebook.editor.button.CodeConfig.showConfigWindow(Voyant.notebook.editor.EditorWrapper.currentEditor)}}});Ext.define("Voyant.notebook.editor.button.Export",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperexport",statics:{i18n:{tip:"Export",exportTitle:"Export",exportOpen:"Export content into new window",exportDownload:"Download file to your machine",exportCorpus:"Open Corpus in Voyant Tools",cancelTitle:"Cancel"},exportWin:void 0,getExportWindow:function(a){void 0===this.exportWin&&(this.exportWin=Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),
closeAction:"hide",modal:!0,width:250,bodyPadding:5,layout:{type:"vbox",align:"stretch"},defaults:{xtype:"button"},items:[{itemId:"corpus",text:a.localize("exportCorpus"),glyph:"xf08e@FontAwesome",margin:"0 0 5 0",hidden:!0},{itemId:"open",text:a.localize("exportOpen"),glyph:"xf08e@FontAwesome",margin:"0 0 5 0"},{itemId:"download",preventDefault:!1,text:a.localize("exportDownload"),glyph:"xf019@FontAwesome",handler:function(f){f.up("window").close()}}],buttons:[{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",
handler:function(f){f.up("window").close()}}]}));var b=Voyant.notebook.editor.EditorWrapper.currentEditor,c=b.up("notebook").getNotebookId()||"spyral",d=b.getMode(),e=new Ext.Deferred;a=null;a="file"===d?b.fileInput.getBlob():b.results.updateCachedOutput().then(function(){return Ext.Promise.resolve(b.getOutput())});a.then(function(f){var g=b.getInput(),h=this.exportWin.down("#corpus"),k=this.exportWin.down("#open");h.setHidden(!0);k.setHidden(!1);if("file"===d){k.setHidden(!0);var l=g.fileName;h=
f.type;var m=f}else"javascript"===d?(Spyral.Util.isObject(f)&&f.hasOwnProperty("corpusid")&&Spyral.Util.isString(f.corpusid)&&(h.setHidden(!1),h.setHandler(function(u){u=Voyant.application.getBaseUrlFull()+"?corpus\x3d"+f.corpusid;window.open(u)})),Spyral.Util.isUndefined(f)&&(f=b.getContent().output),Spyral.Util.isObject(f)||Spyral.Util.isArray(f)?(l=c+"_"+b.getCellId()+".json",h="application/json",m=JSON.stringify(f)):Spyral.Util.isNode(f)||Spyral.Util.isString(f)&&null!==f.match(/<\/?\w+.*?>/g)?
(l=c+"_"+b.getCellId()+".html",h="text/html",m=Spyral.Util.isString(f)?f:(new XMLSerializer).serializeToString(f)):(l=c+"_"+b.getCellId()+".txt",h="text/plain",m=f)):(l=c+"_"+b.getDataName()+"."+d,h="text/"+d,m=g,"json"===d?h="application/json":"text"===d&&(l=c+"_"+b.getDataName()+".txt",h="text/plain"));var n=new File([m],l,{lastModified:(new Date).getTime(),type:h});this.exportWin.down("#open").setHandler(function(u){var v=window.open();v.document.write(m);v.document.close();v.focus();u.up("window").close()});
this.exportWin.addListener("show",function(){var u=URL.createObjectURL(n);this.exportWin.down("#download").getEl().set({download:l,href:u})},this,{single:!0});e.resolve(this.exportWin)}.bind(this),function(f){e.reject(f)});return e.promise}},constructor:function(a){Ext.apply(a,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf08e@FontAwesome",listeners:{click:function(a){Voyant.notebook.editor.button.Export.getExportWindow(a).then(function(b){b.show()},function(b){Ext.Msg.show({title:"Export Error",
msg:"There was an error exporting the cell contents.\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+b+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})}}});Ext.define("Voyant.notebook.editor.button.Counter",{extend:"Ext.toolbar.TextItem",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappercounter",statics:{i18n:{}},config:{order:0,name:void 0},cls:"notebookwrappercounter",constructor:function(a){Ext.apply(this,{toolTip:this.localize("tip")});this.callParent(arguments)},setOrder:function(a){this.callParent(arguments);this.updateHtml()},updateHtml:function(){var a=this.getOrder()+1,b=this.getName();this.setHtml('\x3ca name\x3d"'+b+'" href\x3d"#'+
b+'"\x3e'+a+"\x3c/a\x3e")}});Ext.define("Voyant.notebook.editor.button.MoveDown",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappermovedown",statics:{i18n:{}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf063@FontAwesome",textAlign:"left",listeners:{click:function(a){var b=Voyant.notebook.editor.EditorWrapper.currentEditor;b.findParentByType("notebook").fireEvent("notebookWrapperMoveDown",b);Voyant.notebook.editor.EditorWrapper.hideToolbars(a,
...
!0)}}});Ext.define("Voyant.notebook.editor.button.Remove",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperremove",statics:{i18n:{}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf014@FontAwesome",textAlign:"left",listeners:{click:function(a){var b=Voyant.notebook.editor.EditorWrapper.currentEditor;Ext.Msg.show({buttons:Ext.Msg.OKCANCEL,icon:Ext.MessageBox.QUESTION,msg:this.localize("confirmRemove"),title:this.localize("confirmRemoveTitle"),
fn:function(c){"ok"===c&&(b.findParentByType("notebook").fireEvent("notebookWrapperRemove",b),Voyant.notebook.editor.EditorWrapper.hideToolbars(a,!0))},scope:this})}}});Ext.define("Voyant.notebook.editor.button.Run",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrun",statics:{i18n:{}},glyph:"xf04b@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)},listeners:{click:function(a,b){a=Voyant.notebook.editor.EditorWrapper.currentEditor;a.run.call(a)}}});Ext.define("Voyant.notebook.editor.button.RunAll",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrunall",statics:{i18n:{}},glyph:"xf04e@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)}});Ext.define("Voyant.notebook.editor.button.RunUntil",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrununtil",statics:{i18n:{tip:"Run multiple cells",runUntil:"Run up to here",runUntilTip:"Run previous code cells and this one.",runFrom:"Run from here onwards",runFromTip:"Run this and following code cells."}},glyph:"xf050@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");var b=this;this.runMenu=Ext.create("Ext.menu.Menu",{items:[{text:this.localize("runUntil"),
tooltip:this.localize("runUntilTip"),glyph:"xf049@FontAwesome",handler:function(){b.runMenu.editor.up("notebook").runUntil(b.runMenu.editor)}},{text:this.localize("runFrom"),tooltip:this.localize("runFromTip"),glyph:"xf050@FontAwesome",handler:function(){b.runMenu.editor.up("notebook").runFrom(b.runMenu.editor)}}]});this.callParent(arguments)},handler:function(a,b){a.runMenu.editor=Voyant.notebook.editor.EditorWrapper.currentEditor;a.runMenu.showAt(b.pageX,b.pageY)}});Ext.define("Voyant.notebook.editor.EditorWrapper",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization"],alias:"widget.notebookeditorwrapper",cls:"notebook-editor-wrapper",config:{cellId:void 0,index:void 0,content:"",isEditing:!1},statics:{currentEditor:void 0,toolbarLeft:void 0,toolbarRight:void 0,showToolbars:function(a){Voyant.notebook.editor.EditorWrapper.currentEditor=a;Voyant.notebook.editor.EditorWrapper.currentEditor.body.addCls("notebook-editor-wrapper-hover");void 0===Voyant.notebook.editor.EditorWrapper.toolbarLeft&&
(Voyant.notebook.editor.EditorWrapper.toolbarLeft=Ext.create("Ext.container.Container",{floating:!0,shadow:!1,layout:{type:"vbox",align:"middle",pack:"start"},defaults:{margin:3,cls:"x-btn x-btn-default-toolbar-small",iconCls:"x-btn-icon-el-default-toolbar-small"},items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun"},{xtype:"notebookwrapperrununtil"},{xtype:"notebookcodeconfig"},{xtype:"notebookwrapperexport"}],listeners:{boxready:function(d){d.getEl().on("mouseleave",Voyant.notebook.editor.EditorWrapper.hideToolbars,
this)}}}));void 0===Voyant.notebook.editor.EditorWrapper.toolbarRight&&(Voyant.notebook.editor.EditorWrapper.toolbarRight=Ext.create("Ext.container.Container",{floating:!0,shadow:!1,layout:{type:"vbox",align:"middle",pack:"start"},defaults:{margin:3,cls:"x-btn x-btn-default-toolbar-small",iconCls:"x-btn-icon-el-default-toolbar-small"},items:[{xtype:"notebookwrappercounter"},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}],listeners:{boxready:function(d){d.getEl().on("mouseleave",
Voyant.notebook.editor.EditorWrapper.hideToolbars,this)}}}));var b=[];b="notebookcodeeditorwrapper"===a.xtype?["notebookwrapperadd","notebookwrapperrun","notebookwrapperrununtil","notebookcodeconfig"]:"notebookdatawrapper"===a.xtype?["notebookwrapperadd","notebookwrapperrun","notebookwrapperrununtil","notebookcodeconfig","notebookwrapperexport"]:["notebookwrapperadd"];Voyant.notebook.editor.EditorWrapper.toolbarLeft.query("button").forEach(function(d){d.setVisible(-1!==b.indexOf(d.xtype))});var c=
Voyant.notebook.editor.EditorWrapper.toolbarRight.down("notebookwrappercounter");c.setName(a.getCellId());c.setOrder(a.getIndex());a=a.body.getBox();Voyant.notebook.editor.EditorWrapper.toolbarLeft.showAt(a.x-33,a.y,!1);Voyant.notebook.editor.EditorWrapper.toolbarRight.showAt(a.x+a.width+3,a.y,!1)},hideToolbars:function(a,b){Voyant.notebook.editor.EditorWrapper.currentEditor&&(b=b?!0:!1,b||(b=Voyant.notebook.editor.EditorWrapper.currentEditor.body.getBox(),b=a.pageX<b.x-33||a.pageX>=b.x+b.width+33||
a.pageY<b.y||a.pageY>=b.y+b.height),b&&(Voyant.notebook.editor.EditorWrapper.currentEditor.body.removeCls("notebook-editor-wrapper-hover"),Voyant.notebook.editor.EditorWrapper.currentEditor=void 0,void 0!==Voyant.notebook.editor.EditorWrapper.toolbarLeft&&Voyant.notebook.editor.EditorWrapper.toolbarLeft.hide(),void 0!==Voyant.notebook.editor.EditorWrapper.toolbarRight&&Voyant.notebook.editor.EditorWrapper.toolbarRight.hide()))}},border:!1,bodyBorder:!1,initComponent:function(){this.setCellId(this.config.cellId);
this.on("afterrender",function(){this.mon(this.getEl(),"mouseover",function(){Voyant.notebook.editor.EditorWrapper.showToolbars(this)},this);this.mon(this.getEl(),"mouseleave",function(a){Voyant.notebook.editor.EditorWrapper.hideToolbars(a)},this)},this);this.callParent(arguments)},getContent:function(){throw Error("Subclass must override!");},applyIsEditing:function(a){this.rendered&&(a?this.body.addCls("notebook-editor-wrapper-editing"):this.body.removeCls("notebook-editor-wrapper-editing"));return a}});Ext.define("Voyant.notebook.editor.RunnableEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",mixins:["Voyant.util.Localization"],alias:"widget.notebookrunnableeditorwrapper",config:{isRun:!1,mode:"javascript"},editor:void 0,results:void 0,constructor:function(a){this.results.addListener("initialized",this.updateLayout,this);this.callParent(arguments)},run:function(a,b){return this.results.getIsInitialized()?(void 0===b&&(console.log("fetching prior vars"),b=this.up("notebook").getNotebookVariables(this)),
this._run(b)):Ext.Promise.reject("Editor is not initialized")},_run:function(a){this.results.clear();this.editor.clearMarkers();var b=this.editor.getValue();this.setIsRun(!0);a=this.results.run(b,a);a.otherwise(function(c){void 0!==c.error&&(c=c.error.location,void 0!==c&&(this.editor.addMarker(c,"error"),this.editor.addLineMarker(c,"error")))},this);return a},getInput:function(){return this.editor.getValue()},getVariables:function(){return this.results.getHasRunError()?[]:this.results.getVariables()},
...
'\x3cspan class\x3d"spyral-dv-content"\x3e...\x3c/span\x3e')}};c(b,10);return b.outerHTML.replace(/spyral-dv-collapsed/g,"spyral-dv-expanded")}return a},getContent:function(){var a=this._reduceDataViewerOutput(this.results.getOutput());return{input:this.getInput(),output:a,mode:this.getMode(),expandResults:this.results.getExpandResults()}}});Ext.define("Voyant.notebook.editor.SandboxWrapper",{extend:"Ext.Container",mixins:["Voyant.util.Localization"],alias:"widget.sandboxwrapper",statics:{i18n:{}},config:{isInitialized:!1,cachedPaddingHeight:void 0,cachedResultsHeight:void 0,cachedResultsValue:void 0,cachedResultsOutput:"",cachedResultsVariables:[],runPromise:void 0,hasRunError:!1,initIntervalID:void 0,maskTimeoutId:void 0,emptyResultsHeight:40,minimumResultsHeight:120,expandResults:!0},constructor:function(a){a.expandResults=void 0!==
a.expandResults?a.expandResults:!0;var b=a.expandResults,c=a.sandboxSrcUrl;Ext.apply(this,{itemId:"parent",cls:"notebook-code-results",height:this.getEmptyResultsHeight(),layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",flex:1,layout:{type:"absolute"},items:[{xtype:"uxiframe",itemId:"resultsFrame",x:0,y:0,anchor:"100%",height:"100%",src:c,renderTpl:['\x3ciframe allow\x3d"midi; geolocation; microphone; camera; display-capture; encrypted-media;" sandbox\x3d"allow-same-origin allow-scripts allow-modals allow-popups allow-forms allow-top-navigation-by-user-activation allow-downloads" src\x3d"{src}" id\x3d"{id}-iframeEl" data-ref\x3d"iframeEl" name\x3d"{frameName}" width\x3d"100%" height\x3d"100%" frameborder\x3d"0"\x3e\x3c/iframe\x3e']},
{xtype:"toolbar",itemId:"buttons",hidden:!0,x:0,y:0,style:{background:"none",paddingTop:"6px",pointerEvents:"none"},defaults:{style:{pointerEvents:"auto"}},items:["-\x3e",{itemId:"expandButton",glyph:b?"xf066@FontAwesome":"xf065@FontAwesome",tooltip:b?"Contract Results":"Expand Results",handler:function(){this._doExpandContract()},scope:this},{xtype:"notebookwrapperexport"},{glyph:"xf014@FontAwesome",tooltip:"Remove Results",handler:function(){this.resetResults();this.clear()},scope:this}]}]},{xtype:"component",
itemId:"expandWidget",height:20,hidden:b?!0:!1,style:{textAlign:"center",fontSize:"26px",cursor:"pointer",borderTop:"1px solid #DDD",color:"#000"},html:"\x26#8943;",listeners:{afterrender:function(d){var e=this;d.getEl().on("click",function(){e._doExpandContract()})},scope:this}}]});this.callParent(arguments)},initComponent:function(){var a=this._handleResults.bind(this);this.on("afterrender",function(b){b.getEl().on("mouseover",function(d,e){b.down("#buttons").setVisible(!0)});b.getEl().on("mouseout",
function(d,e){b.down("#buttons").setVisible(!1)});window.addEventListener("message",a);var c=this;this.setInitIntervalID(setInterval(function(){c._sendMessage({type:"command",command:"init"})},100))},this);this.on("removed",function(){window.removeEventListener("message",a)},this);this.callParent(arguments)},clear:function(){!1===this.isVisible()&&(console.log("clearing but not visible!",this),this.show());this._sendMessage({type:"command",command:"clear"})},resetResults:function(){this.setCachedResultsValue(void 0);
this.setCachedResultsOutput("");this.setCachedResultsVariables([])},run:function(a,b){void 0===b&&(b=[]);this.resetResults();this.setHasRunError(!1);this.getEl().removeCls(["error","success"]);this.setRunPromise(new Ext.Deferred);var c=this.getRunPromise().promise;c.then(function(){this.getEl().addCls("success")},function(){this.setHasRunError(!0);this.getEl().addCls("error")},void 0,this);this.mask("Running code...");this._sendMessage({type:"code",value:a,variables:b});return c},mask:function(a){var b=
this;this.setMaskTimeoutId(setTimeout(function(){b.superclass.mask.call(b,a,"spyral-code-mask")},250))},unmask:function(){clearTimeout(this.getMaskTimeoutId());this.superclass.unmask.call(this)},updateHtml:function(a){this._sendMessage({type:"command",command:"update",html:a})},updateValue:function(a,b){this._sendMessage({type:"command",command:"update",name:a,value:b})},getValue:function(){return this.getCachedResultsValue()},updateCachedOutput:function(){var a=this;return new Ext.Promise(function(b,
c){a._sendMessage({type:"command",command:"getContents"});a.on("sandboxMessage",function(d){"getContents"===d.command?a.setCachedResultsOutput(d.value):console.warn("getOutput: received unexpected message",d);b(a.getCachedResultsOutput())},a,{single:!0})})},getOutput:function(){return this.getCachedResultsOutput()},getVariables:function(){return this.getCachedResultsVariables()},applyCachedResultsVariables:function(a,b){var c=this.up("notebook");c&&c.updateTernServerVariables(a,b);return a},getResultsEl:function(){var a=
this.down("#resultsFrame");return a?a:null},_sendMessage:function(a){this.down("#resultsFrame").getWin().postMessage(a,"*")},_handleResults:function(a){var b=this.down("#resultsFrame").getFrame();if(a.source===b.contentWindow)if(b=a.data,b.type){switch(b.type){case "error":console.log("iframe error:",b);this.unmask();this.getRunPromise().reject(b);break;case "command":switch(b.command){case "init":!1===this.getIsInitialized()&&(this.setIsInitialized(!0),clearInterval(this.getInitIntervalID()),this.fireEvent("initialized",
this));break;case "clear":this._setHeight(0)}break;case "result":console.log("iframe result:",b),this.unmask(),this.getRunPromise().resolve(b)}"getContents"!==b.command&&(b.value&&this.setCachedResultsValue(b.value),this.setCachedResultsVariables(b.variables));b.output&&this.setCachedResultsOutput(b.output);0<b.height&&this._setHeight(b.height);this.fireEvent("sandboxMessage",b)}else console.warn("unrecognized message!",a)},_doExpandContract:function(){var a=this.down("#expandButton");this.getExpandResults()?
(this.setExpandResults(!1),a.setTooltip("Expand Results"),a.setGlyph("xf065@FontAwesome")):(this.setExpandResults(!0),a.setTooltip("Contract Results"),a.setGlyph("xf066@FontAwesome"));this._setHeight()},_setHeight:function(a){if(void 0===this.getCachedPaddingHeight()){var b=window.getComputedStyle(this.getEl().dom);this.setCachedPaddingHeight(parseFloat(b.getPropertyValue("padding-top"))+parseFloat(b.getPropertyValue("padding-bottom"))+2)}void 0!==a?this.setCachedResultsHeight(a):(a=this.getCachedResultsHeight(),
void 0===a&&(a=(b=this.getResultsEl())?b.getHeight():this.getEmptyResultsHeight(),this.setCachedResultsHeight(a)));a+=this.getCachedPaddingHeight();if(b=this.getResultsEl())b=this.down("#expandWidget"),this.getExpandResults()?(b.hide(),this.setHeight(Math.max(a,this.getEmptyResultsHeight()))):(a=Math.min(Math.max(a,this.getEmptyResultsHeight()),this.getMinimumResultsHeight()),a<this.getMinimumResultsHeight()?b.hide():b.show(),this.setHeight(a))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization"],cls:"notebook-code-editor",config:{mode:"javascript",content:"",docs:void 0,isChangeRegistered:!1,editor:void 0,editedTimeout:void 0,lines:1,markers:[],parentWrapper:void 0},statics:{i18n:{},api:{content:void 0},ternServer:void 0},MIN_LINES:2,constructor:function(a){this.callParent(arguments)},listeners:{render:function(){var a=this,b=Ext.getDom(this.getEl()),
c=CodeMirror(b,{mode:this._getModeConfig(this.getMode()),value:this.getContent(),lineNumbers:!0,lineWrapping:!0,styleActiveLine:!0,viewportMargin:50,extraKeys:{"Shift-Enter":function(){a.up("notebookrunnableeditorwrapper").run()},"Shift-Ctrl-Enter":function(){var e=a.up("notebookrunnableeditorwrapper");e.up("notebook").runUntil(e)},"Shift-Cmd-Enter":function(){var e=a.up("notebookrunnableeditorwrapper");e.up("notebook").runUntil(e)},"Ctrl-/":function(){c.toggleComment()},"Cmd-/":function(){c.toggleComment()}}});
b=(this.MIN_LINES+1)*c.defaultTextHeight()+"px";var d=c.getWrapperElement();d.style.height="auto";d.style.minHeight=b;c.getScrollerElement().style.minHeight=b;c.on("focus",function(e,f){a.getParentWrapper().setIsEditing(!0)});c.on("blur",function(e,f){a.getParentWrapper().setIsEditing(!1)});c.on("change",function(e,f){a.clearMarkers();f=e.lineCount();f!==a.getLines()&&(a.setLines(f),setTimeout(function(){var g=e.getWrapperElement().offsetHeight;a.setSize({height:g})},0));!1===a.getIsChangeRegistered()?
(a.setIsChangeRegistered(!0),f=a.up("notebookrunnableeditorwrapper"),f.setIsRun(!1),f.up("notebook").setIsEdited(!0)):a.getEditedTimeout()||a.setEditedTimeout(setTimeout(function(){a.setIsChangeRegistered(!1)},3E4))});"javascript"===this.getMode()&&(void 0===Voyant.notebook.editor.CodeEditor.ternServer&&(b=this.getDocs(),d=Voyant.application.getBaseUrlFull(),Voyant.notebook.editor.CodeEditor.ternServer=new CodeMirror.TernServer({defs:b,useWorker:!0,workerScript:d+"resources/spyral/tern/worker.js",
workerDeps:["tern_worker_deps.js"],hintDelay:5E3})),c.on("keypress",function(e,f){"."===f.key?Voyant.notebook.editor.CodeEditor.ternServer.complete(e):"{"===f.key&&(f=e.getCursor(),e.getRange({line:f.line,ch:0},f).match(/\(\s*$/)&&setTimeout(function(){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},50))}),Object.assign(c.getOption("extraKeys"),{"Ctrl-Space":function(e){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},"Ctrl-D":function(e){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(e,
void 0,a._showDocsCallback.bind(a))},"Cmd-Space":function(e){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},"Cmd-D":function(e){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(e,void 0,a._showDocsCallback.bind(a))}}),c.on("cursorActivity",function(e){Voyant.notebook.editor.CodeEditor.ternServer.updateArgHints(e)}));this.setEditor(c);this._setModeOptions(this.getMode());a.fireEvent("resize",a)},removed:function(a,b){a.getEditor()&&a.setEditor(void 0)}},_getModeConfig:function(a){switch(a){case "json":a=
{name:"javascript",json:!0};break;case "xml":a="xml";break;default:a="javascript"}return a},_setModeOptions:function(a){var b={};switch(a){case "json":case "javascript":b.autoCloseBrackets=!0;b.matchBrackets=!0;break;default:b.autoCloseBrackets=!1,b.matchBrackets=!1}for(var c in b)this.getEditor().setOption(c,b[c])},switchModes:function(a){console.log("mode",a);this.setMode(a);this.rendered&&(this.getEditor().setOption("mode",this._getModeConfig(a)),this._setModeOptions(a))},getValue:function(){return this.getEditor().getValue()},
addMarker:function(a,b){b="spyral-editor-"+(void 0===b?"error":b);var c=a[0];a=a[1];a--;c--;a=this.getEditor().getDoc().markText({line:c,ch:a},{line:c,ch:a+1},{className:b});this.getMarkers().push(a)},addLineMarker:function(a,b){b="spyral-editor-"+(void 0===b?"error":b);a=a[0];a--;a=this.getEditor().getDoc().addLineClass(a,"gutter",b);this.getMarkers().push({marker:a,where:"gutter",cls:b})},clearMarkers:function(){var a=this.getEditor();this.getMarkers().forEach(function(b){b.marker?a.getDoc().removeLineClass(b.marker,
b.where,b.cls):b.clear()});this.setMarkers([])},_showDocsCallback:function(){var a=this.getEditor().state.ternTooltip.querySelector("a");a&&a.addEventListener("click",function(b){b.preventDefault();b.stopPropagation();b=a.getAttribute("href");this.up("notebook").handleDocLink(b)}.bind(this))}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run","Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{}},constructor:function(a){a.mode="javascript";this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode,parentWrapper:this});
this.results=Ext.create("Voyant.notebook.editor.SandboxWrapper",{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,listeners:{initialized:function(){this.fireEvent("initialized",this);void 0!==a.output&&this.results.updateHtml(a.output)},scope:this}});Ext.apply(this,{border:!1,layout:"anchor",defaults:{anchor:"100%"},items:[this.editor,this.results]});this.callParent(arguments)},switchModes:function(a){if("javascript"!==a){var b=this.up("notebook");b.addData("",
this.getIndex(),void 0,{mode:a});b.notebookWrapperRemove(this)}else console.log("unhandled mode switch:",a)}});Ext.define("Voyant.notebook.editor.TextEditor",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebooktexteditor",cls:"notebook-text-editor",config:{editor:void 0,isEditRegistered:!1,currentHeight:0,isFresh:void 0,parentWrapper:void 0},statics:{i18n:{}},border:!1,constructor:function(a){a.isFresh=a.content?!1:!0;Ext.apply(this,{html:a.content?a.content:'\x3cp style\x3d"text-align: center;"\x3e'+this.localize("emptyText")+"\x3c/p\x3e"});this.callParent(arguments)},listeners:{boxready:function(a){this.ownerCt.getTargetEl().on("click",
...
var c=b.editable();c.attachListener(c,"click",function(d){d.stop()},null,null,0)},this);b.on("focus",function(c){this.getIsFresh()&&(this.setIsFresh(!1),this.getTargetEl().update("\x3cp\x3e\x3c/p\x3e"))},this);b.on("blur",function(c){this._disable()},this);b.on("change",function(){b.container.$.scrollIntoView();var c=b.container.$.clientHeight;c!==this.getCurrentHeight()&&(this.findParentByType("notebookeditorwrapper").setHeight(c),this.setCurrentHeight(b.container.$.clientHeight));if(this.getIsEditRegistered()){var d=
this;setTimeout(function(){d.setIsEditRegistered(!1)},3E4)}else this.findParentByType("notebook").setIsEdited(!0),this.setIsEditRegistered(!0)},this);this.setEditor(b)},_enable:function(){var a=this.getEditor();a.setReadOnly(!1);setTimeout(function(){a.focus();this.getParentWrapper().setIsEditing(!0)}.bind(this),0)},_disable:function(){this.getEditor().setReadOnly(!0);this.getParentWrapper().setIsEditing(!1)}});Ext.define("Voyant.notebook.editor.TextEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",requires:["Voyant.notebook.editor.TextEditor"],alias:"widget.notebooktexteditorwrapper",cls:"notebook-text-wrapper",config:{},minHeight:50,constructor:function(a){Ext.apply(this,{items:[{xtype:"notebooktexteditor",content:Ext.Array.from(a.input).join(""),parentWrapper:this}]});this.callParent(arguments)},getContent:function(){return this.items.get(0).getContent()}});Ext.define("Voyant.notebook.editor.FileInput",{extend:"Ext.container.Container",alias:"widget.notebookfileinput",mixins:["Voyant.util.Localization"],cls:"notebook-file-input",config:{dataUrl:void 0,resourceId:void 0,file:void 0,fileName:void 0},statics:{i18n:{fileUpload:"File Upload",buttonLabel:"Choose a file...",deleteMsg:"The previously added file has been deleted. You will need to add a new file."}},serverStorage:void 0,constructor:function(a){Ext.apply(this,{height:125,width:"100%",layout:"center",
items:[{xtype:"voyantfilefield",itemId:"file",fieldLabel:this.localize("fileUpload"),labelAlign:"right",buttonText:this.localize("buttonLabel"),width:350,listeners:{render:function(b){a.fileName&&(b.inputEl.dom.value=a.fileName)},change:function(b,c){this.setFile(b.fileInputEl.dom.files[0]);this.setFileName(c);this.setDataUrl(void 0);this.setResourceId(void 0)},scope:this}}]});"undefined"===typeof Voyant.util.ServerStorage&&Ext.define("Voyant.util.ServerStorage",{extend:"Voyant.util.Storage",getTromboneUrl:function(){return Voyant.application.getTromboneUrl()}});
this.serverStorage=Ext.create("Voyant.util.ServerStorage");this.callParent(arguments)},getDataUrl:function(){var a=new Ext.Deferred,b=this.callParent();void 0===b?this.getResourceId()?this.loadStoredFile().then(function(c){a.resolve(c)},function(){a.reject()}):this.getFile()?this.storeFile().then(function(c){a.resolve(c[1])},function(){a.reject()}):a.reject():a.resolve(b);return a.promise},getBlob:function(){var a=new Ext.Deferred;this.getDataUrl().then(function(b){a.resolve(Spyral.Util.dataUrlToBlob(b))},
function(b){a.reject(b)});return a.promise},storeFile:function(){var a=new Ext.Deferred,b=this.getFile();if(void 0===b)a.reject();else{var c=this;Spyral.Util.blobToDataUrl(b).then(function(d){var e=Spyral.Util.id(32);c.serverStorage.storeResource(e,d).then(function(){c.setResourceId(e);c.setDataUrl(d);a.resolve([e,d])},function(){a.reject()})},function(d){a.reject(d)})}return a.promise},loadStoredFile:function(){var a=new Ext.Deferred,b=this.getResourceId();if(void 0===b)a.reject();else{var c=this;
this.serverStorage.getStoredResource(b).then(function(d){void 0!==d?(c.setDataUrl(d),a.resolve(d)):a.reject()},function(){a.reject()})}return a.promise}});Ext.define("Voyant.form.field.File",{extend:"Ext.form.field.File",alias:"widget.voyantfilefield",onFileChange:function(a,b,c){c=c.replace(/^.*(\\|\/|:)/,"");return this.callParent([a,b,c])}});Ext.define("Voyant.notebook.editor.DataWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.FileInput"],alias:"widget.notebookdatawrapper",cls:"notebook-data-wrapper",statics:{i18n:{dataNameAlphanum:"The data name must contain alphanumeric characters only",dataNameAlphastart:"The data name must not begin with a number"}},config:{dataName:void 0},constructor:function(a){a.mode=void 0!==a.mode?a.mode:"json";var b="file"===
a.mode,c=void 0,d=void 0;b&&(c=a.input.resourceId,d=a.input.fileName);this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode,hidden:b,parentWrapper:this});this.fileInput=Ext.create("Voyant.notebook.editor.FileInput",{resourceId:c,fileName:d,hidden:!b});this.results=Ext.create("Voyant.notebook.editor.SandboxWrapper",{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,listeners:{initialized:function(){this.fireEvent("initialized",
this);void 0!==a.output&&this.results.updateHtml(a.output)},scope:this}});Ext.apply(this,{border:!1,layout:"anchor",defaults:{anchor:"100%"},items:[this.editor,this.fileInput,{xtype:"form",cls:"notebook-data-input",bodyPadding:6,bodyStyle:"background-color: rgb(252, 252, 252);",layout:{type:"hbox",pack:"center"},items:[{width:350,xtype:"textfield",fieldLabel:"Data Name",labelAlign:"right",name:"dataName",value:a.dataName,validator:function(e){return/^[a-zA-Z0-9_]+$/.test(e)?/^\D/.test(e)?!0:this.localize("dataNameAlphastart"):
this.localize("dataNameAlphanum")}.bind(this),allowBlank:!1,listeners:{change:function(e,f,g){e.isValid()?this.setDataName(f):this.setDataName(void 0)},scope:this}},{width:100,margin:"0 0 0 6",xtype:"button",text:"Assign",handler:function(e){this.up("notebook").setIsEdited(!0);this.run()},scope:this}]},this.results]});this.callParent(arguments)},switchModes:function(a){"javascript"===a?(a=this.up("notebook"),a.addCode("",this.getIndex(),void 0,{mode:"javascript"}),a.notebookWrapperRemove(this)):(this.setMode(a),
"file"===a?(this.editor.hide(),this.fileInput.show()):(this.fileInput.hide(),this.editor.switchModes(a),this.editor.show()),this.updateLayout())},_getCode:function(){var a=new Ext.Deferred,b=this.getDataName();void 0===b&&a.reject();var c=this.getMode();if("file"===c)this.fileInput.getDataUrl().then(function(e){a.resolve(b+"\x3d Spyral.Util.dataUrlToBlob(`"+e+"`)")},function(){a.reject()});else{var d=this.editor.getValue();switch(c){case "text":d=b+"\x3d`"+d+"`";break;case "json":d=b+"\x3d JSON.parse(`"+
d+"`)";break;case "xml":d=b+"\x3d new DOMParser().parseFromString(`"+d+'`, "application/xml")';break;case "html":d=b+"\x3d new DOMParser().parseFromString(`"+d+'`, "application/xml")'}a.resolve(d)}return a.promise},_run:function(a){var b=new Ext.Deferred,c=this;this._getCode().then(function(d){c.results.clear();"file"!==c.getMode()&&c.editor.clearMarkers();c.setIsRun(!0);c.results.run(d,a).then(function(e){b.resolve(e)},function(e){if(void 0!==e.error){var f=e.error.location;void 0!==f&&(c.editor.addMarker(f,
"error"),c.editor.addLineMarker(f,"error"))}b.reject(e)})},function(){b.reject("Error handling data")});return b.promise},getInput:function(){return"file"!==this.getMode()?this.editor.getValue():{resourceId:this.fileInput.getResourceId(),fileName:this.fileInput.getFileName()}},getContent:function(){var a=this.callParent(arguments);a.dataName=this.getDataName();return a}});Ext.define("Voyant.notebook.github.OctokitWrapper",{extend:"Ext.Base",alias:"octokitwrapper",octokit:void 0,constructor:function(a){this.octokit=new Octokit({auth:a.authToken,userAgent:"https://github.com/voyanttools/Voyant"})},getInfoForAuthenticatedUser:function(){return this.octokit.users.getAuthenticated()},getReposForAuthenticatedUser:function(a,b,c){return this.octokit.repos.listForAuthenticatedUser({affiliation:void 0===a?"owner":a,page:void 0===b?0:b,per_page:void 0===c?10:c})},getReposForUser:function(a,
...
l,m,n,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){if(1==v.nextAddress)return c=a,d=c.owner,e=c.repo,f=c.branch,g=c.path,v.yield(b.octokit.request({method:"POST",url:"/graphql",query:'{\n\t\t\t\trepository(owner: "'+d+'", name: "'+e+'") {\n\t\t\t\t\tobject(expression: "'+f+":"+g+'") {\n\t\t\t\t\t\t... on Blob {\n\t\t\t\t\t\t\toid\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}'}).catch(function(p){console.log(p)}),2);h=v.yieldResult;k=h.data;l=k.data;m=l.repository;u=(n=m.object)?
n.oid:void 0;return v.return(u)})},unflattenContents:function(a){var b={type:"folder",name:"",path:"",contents:[]},c=function(d,e){return d.contents.find(function(f){return"folder"===f.type&&f.name===e})};a.filter(function(d){return"blob"===d.type}).forEach(function(d){var e=d.path.split("/");e.reduce(function(f,g,h){var k=c(f,g);if(k)return k;if(e.length-1==h)f.contents.push({type:"file",name:g,path:f.path+"/"+g});else return g={type:"folder",name:g,path:f.path+"/"+g,contents:[]},f.contents.push(g),
...
void 0!==c?(b=this.getPathComponents(c.path),a.setValues(Object.assign({},{owner:c.owner,repo:c.repo},b))):a.setValues({owner:b})}.bind(this))},getPathComponents:function(a){a=a.split("/");var b=a[a.length-1],c="";2<a.length&&(c=a.slice(0,-1).join("/"));return{folder:c,file:b}},doSave:function(a){var b=this,c,d,e,f,g,h,k,l,m,n,u,v,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){switch(q.nextAddress){case 1:c=b.queryById("saveForm").getForm();if(!c.isValid()){b.setStatus("Form is not valid",
"error");q.jumpTo(0);break}d=c.getValues();e=d.owner;f=d.repo;g=d.folder;k=h=d.file;""!==g&&(k=g+"/"+h);b.setStatus("Checking repository");return q.yield(b.octokit.doesRepoExist(e,f),3);case 3:l=q.yieldResult;if(!l){b.setStatus("The specified repository does not exist","error");q.jumpTo(0);break}b.setStatus("Checking permissions");return q.yield(b.octokit.getPermissionsForUser(e,f,b.getUsername()),5);case 5:m=q.yieldResult;if("none"===m||"read"===m){b.setStatus("You don't have permission to write to this repository",
"error");q.jumpTo(0);break}b.setStatus("Checking file");n="master";u=b.saveData;v={owner:e,repo:f,branch:n,path:k};return q.yield(b.octokit.getLatestFileSHA(v),7);case 7:p=q.yieldResult,void 0!==p?b.octokit.saveFile(e,f,k,u,n,"File updated by Spyral",p).then(function(r){this.setStatus("File updated");setTimeout(function(){this.fireEvent("fileSaved",this,v)}.bind(this),500)}.bind(b),function(r){this.setStatus("Error: "+r.message,"error")}):b.octokit.saveFile(e,f,k,u,n,"File created by Spyral").then(function(r){this.setStatus("File created");
setTimeout(function(){this.fireEvent("fileSaved",this,v)}.bind(this),500)}.bind(b),function(r){this.setStatus("Error: "+r.message,"error")}),q.jumpToEnd()}})},setStatus:function(a,b){var c="";b&&"error"===b&&(c="x-form-invalid-under-default");this.queryById("status").setHtml('\x3cspan class\x3d"'+c+'"\x3e'+a+"\x3c/span\x3e")}});Ext.define("Voyant.notebook.github.GitHubDialogs",{extend:"Ext.Component",requires:["Voyant.notebook.github.OctokitWrapper","Voyant.notebook.github.ReposBrowser","Voyant.notebook.github.FileSaver"],alias:"widget.githubdialogs",config:{repoType:"owner",currentFile:void 0},octokitWrapper:void 0,currentWindow:void 0,parent:void 0,constructor:function(a){a=a||{};this.parent=a.parent;this.callParent(arguments)},initComponent:function(){this.callParent(arguments)},close:function(){void 0!==this.currentWindow&&
(this.currentWindow.close(),this.currentWindow=void 0)},showLoad:function(){var a=this;if(this.parent.isAuthenticated){void 0===this.octokitWrapper&&this.initOctokitWrapper(this.parent.githubAuthToken);var b=void 0;b=Ext.create("Ext.window.Window",{title:"Load from GitHub",width:750,height:550,closable:!1,maximizable:!0,layout:"fit",items:{xtype:"githubreposbrowser",octokit:this.octokitWrapper,itemId:"repoBrowser",listeners:{nodeSelected:function(c,d,e){"file"===d?b.queryById("load").setDisabled(!1):
...
this.initOctokitWrapper(this.parent.githubAuthToken);var c=void 0;c=Ext.create("Ext.window.Window",{title:"Save to GitHub",width:750,height:650,closable:!1,maximizable:!0,layout:"fit",items:{xtype:"githubfilesaver",octokit:this.octokitWrapper,currentFile:this.getCurrentFile(),saveData:a,itemId:"fileSaver",listeners:{formValidityChange:function(d,e){c.queryById("save").setDisabled(!e)},fileSaved:function(d,e){b.fireEvent("fileSaved",b,e)}}},buttons:[{text:"Save",itemId:"save",disabled:!0,handler:function(){c.queryById("fileSaver").doSave()},
scope:this},{text:"Cancel",handler:function(){b.close();b.fireEvent("saveCancelled",b)}}]});c.show();this.currentWindow=c}else this.parent.showGitHubAuthentication(this.showSave.bind(this))},initOctokitWrapper:function(a){this.octokitWrapper=new Voyant.notebook.github.OctokitWrapper({authToken:a})},loadFileFromId:function(a){var b=decodeURIComponent(a).split("/");3<=b.length&&(a=b[0]+"/"+b[1],b=b.slice(2).join("/"),this.loadFile(a,b))},loadFile:function(a,b){var c=this;this.parent.isAuthenticated?
(void 0===this.octokitWrapper&&this.initOctokitWrapper(this.parent.githubAuthToken),this.octokitWrapper.loadFile(a,b).then(function(d){c.setCurrentFile(d);c.fireEvent("fileLoaded",c,d)})):this.parent.showGitHubAuthentication(this.loadFile.bind(this))}});Ext.define("Voyant.notebook.StorageDialogs",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"",statics:{i18n:{saveNewNotebook:"Save New Notebook",overwriteNotebook:"Overwrite Existing Notebook",open:"Open",notebookFile:"Notebook File",selectFile:"Select File",openFile:"Open File",cancel:"Cancel",mustSelect:"You must select a file."}},notebookParent:void 0,constructor:function(a){a=a||{};this.callParent(arguments);this.notebookParent=a.notebookParent},initComponent:function(){this.callParent(arguments)},
showSave:function(a,b,c){c=void 0===c?"":c;var d=this,e=""===c,f=e?this.localize("saveNewNotebook"):this.localize("overwriteNotebook");Ext.create("Ext.window.Window",{title:f,items:[{xtype:"form",width:450,bodyPadding:5,plugins:["datatip"],listeners:{beforeshowtip:function(g,h,k){return!h.currentTarget.el.hasCls("x-form-invalid")}},layout:"anchor",defaults:{labelAlign:"right",labelWidth:160,width:360,inputAttrTpl:'spellcheck\x3d"false"',xtype:"textfield"},items:[{fieldLabel:"Notebook ID"+(e?" (optional)":
""),name:"notebookName",value:c,allowBlank:!0,readOnly:!e,tooltip:"An ID used to identify this notebook. If left blank, one will be generated for you.",validator:function(g){return""==g?!0:null===g.match(/^[A-Za-z0-9-]{4,32}$/)?"The ID must be between 4 and 32 characters. You may use alphanumeric characters and dash.":!0}}]}],buttons:[{text:"Cancel",ui:"default-toolbar",handler:function(){this.up("window").close();d.fireEvent("saveCancelled",d)}}," ",{text:"Save",handler:function(g){var h=g.up("window"),
k=h.down("form").getForm();if(k.isValid()){var l=k.getValues();l.data=a;l.metadata=b;e&&""!==l.notebookName?d.doesNotebookExist(d.notebookParent.accountInfo.id,l.notebookName).then(function(m){m?k.findField("notebookName").markInvalid("That Notebook ID already exists."):(d.doSave(l),h.close())}):(g.setDisabled(!0),d.doSave(l).then(function(m){g.setDisabled(!1);m&&h.close()}))}}}],listeners:{close:function(){d.fireEvent("close",d)}}}).show()},showLoad:function(){var a=this;Ext.create("Ext.window.Window",
{title:a.localize("open"),items:[{xtype:"form",width:450,bodyPadding:5,layout:"anchor",defaults:{labelAlign:"right",labelWidth:160,width:360},items:[{xtype:"voyantfilefield",name:"file",fieldLabel:a.localize("notebookFile"),allowBlank:!1,buttonText:a.localize("selectFile"),accept:"text/html"}],buttons:[{text:a.localize("cancel"),ui:"default-toolbar",handler:function(){this.up("window").close()}},{text:a.localize("openFile"),handler:function(b){var c=b.up("window");b=c.down("form").getForm();var d=
b.findField("file");b.isValid()?(b=d.fileInputEl.dom.files[0],d=new FileReader,d.onload=function(e){a.fireEvent("fileLoaded",e.target.result);c.close()},d.readAsText(b)):d.markInvalid(a.localize("mustSelect"))}}]}]}).show()},doesNotebookExist:function(a,b){var c=new Ext.Deferred;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"exists",id:a+this.notebookParent.NOTEBOOK_ID_SEPARATOR+b,noCache:1}).then(function(d){d.notebook.success?c.resolve("true"===d.notebook.data):(console.warn(d.notebook.error),
c.resolve(!1))}).catch(function(d){console.warn(d)});return c.promise},doSave:function(a){var b=a.notebookName,c=a.data;a=a.metadata;var d=this,e=new Ext.Deferred;-1!==b.indexOf(this.notebookParent.NOTEBOOK_ID_SEPARATOR)&&(console.warn("doSave: was sent notebookId instead of name"),b=b.split(this.notebookParent.NOTEBOOK_ID_SEPARATOR)[1]);Ext.Ajax.request({method:"POST",url:Voyant.application.getBaseUrlFull()+"spyral/account/save",params:{name:b,data:c,metadata:JSON.stringify(a)},success:function(f){f=
JSON.parse(f.responseText);f.notebook.success?(d.fireEvent("fileSaved",d,f.notebook.id),e.resolve(!0)):(d.fireEvent("fileSaved",d,null,f.notebook.error),e.reject(!1))},failure:function(f){d.fireEvent("fileSaved",d,null,f.responseText);e.reject(!1)}});return e.promise},reset:function(){}});Ext.define("Voyant.notebook.metadata.MetadataEditor",{extend:"Ext.form.Panel",mixins:["Voyant.util.Localization"],alias:"widget.metadataeditor",statics:{i18n:{metadataAuthor:"Author(s)",metadataTitle:"Title",metadataTip:"Edit notebook metadata.",metadataKeywords:"Keywords",metadataDescription:"Description",metadataLicense:"Licence",metadataLanguage:"Language",metadataCatalogue:"Catalogue",metadataCatalogueInclude:"Include this notebook in the public Catalogue?"}},constructor:function(a){Ext.apply(this,
...
k=!1===f.querySelector(".notebook-code-results").classList.contains("collapsed");if("javascript"===g){var n=b.addCode({input:input,output:h,expandResults:k,mode:g},void 0,f.id);e.push(n);n.on("initialized",function(){var v=e.indexOf(n);-1!==v?(e.splice(v,1),0===e.length&&b.fireEvent("notebookInitialized")):console.error("unknown cell initialized",n)})}else{l=f.querySelector(".notebook-code-results .spyral-dv-left").firstChild.data;l=l.split(":")[0];var u=b.addData({input:input,output:h,expandResults:k,
dataName:l,mode:g},void 0,f.id);e.push(u);u.on("initialized",function(){var v=e.indexOf(u);-1!==v?(e.splice(v,1),0===e.length&&b.fireEvent("notebookInitialized")):console.error("unknown cell initialized",u)})}}});d&&b.showError(b.localize("errorParsingDomInput"))},getInnerHeaderHtml:function(){var a="";this.getMetadata().title&&(a+="\x3cdiv class\x3d'title'\x3e"+this.getMetadata().title+"\x3c/div\x3e");this.getMetadata().author&&(a+="\x3cdiv class\x3d'author'\x3e"+this.getMetadata().author+"\x3c/div\x3e");
...
a+="\x3c/head\x3e\n\x3cbody class\x3d'exported-notebook'\x3e\n\x3cheader class\x3d'spyral-header'\x3e"+this.getInnerHeaderHtml()+"\x3c/header\x3e\n\x3carticle class\x3d'spyralArticle'\x3e\n";this.getComponent("cells").items.each(function(c,d){a+="\x3csection id\x3d'"+c.getCellId()+"' class\x3d'notebook-editor-wrapper "+c.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e"+(c.getIndex()+1)+"\x3c/div\x3e";d=c.getContent();if(c.isXType("notebooktexteditorwrapper"))a+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+
d+"\x3c/div\x3e\n";else{var e=c.getTargetEl().query(".CodeMirror-wrap")[0].cloneNode(!0);a+="\x3cdiv class\x3d'notebook-code-editor'\x3e\n"+e.outerHTML+"\n\x3c/div\x3e\n\x3cpre class\x3d'notebook-code-editor-raw editor-mode-"+d.mode+"'\x3e"+d.input+"\x3c/pre\x3e\n";""===d.output&&c.results.getResultsEl();a+="\x3cdiv class\x3d'notebook-code-results"+(d.expandResults?"":" collapsed")+"'\x3e\n"+d.output+"\n\x3c/div\x3e\n"}a+="\x3c/section\x3e\n"});return a+="\x3c/article\x3e\n\x3cfooter class\x3d'spyral-footer'\x3e"+
this.getInnerFooterHtml()+"\x3c/footer\x3e\n\x3c/body\x3e\n\x3c/html\x3e"},generateExportMetadata:function(a){a=a.clone();a.title&&(a.title=a.title.replace(/<\/?\w+.*?>/g,""));a.description&&(a.description=a.description.replace(/<\/?\w+.*?>/g,""));a.keywords&&(!1===Array.isArray(a.keywords)&&(a.keywords=a.keywords.split(/[\s,]+/)),a.keywords=a.keywords.reduce(function(b,c){0<c.length&&b.push(c.toLowerCase());return b},[]));return a},generateExportJson:function(){var a=[];this.getComponent("cells").items.each(function(c,
d){switch(c.xtype){case "notebookcodeeditorwrapper":d="code";break;case "notebookdatawrapper":d="data";break;default:d="text"}a.push({cellId:c.getCellId(),type:d,content:c.getContent()})});var b={metadata:this.getMetadata(),cells:a};return JSON.stringify(b)},getExtraViewExportItems:function(){return[{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=(this.getNotebookId()||"spyral")+".html",c=this.generateExportHtml(),
d={type:"text/html"};try{var e=new File([c],b,d)}catch(f){e=new Blob([c],d)}c=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",b);a.setAttribute("href",c)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]}});Ext.define("Voyant.notebook.util.NotebooksList",{extend:"Ext.view.View",alias:"widget.notebookslist",constructor:function(a){Ext.apply(a,{width:"100%",padding:10,scrollable:"vertical",store:Ext.create("Ext.data.JsonStore",{fields:[{name:"id"},{name:"author"},{name:"title"},{name:"description"},{name:"keywords"},{name:"language"},{name:"license"},{name:"created",type:"date"},{name:"modified",type:"date"},{name:"catalogue",type:"boolean"},{name:"version"}]}),tpl:new Ext.XTemplate('\x3ctpl for\x3d"."\x3e',
...
selectedItemCls:"catalogue-notebook-selected"});this.callParent(arguments)}});Ext.define("Voyant.notebook.util.DocsWindow",{extend:"Ext.window.Window",mixins:["Voyant.util.Localization"],statics:{i18n:{home:"Home",overview:"Overview",configs:"Configs",methods:"Methods",docs:"Docs",openFull:"Open Full Documentation",outlineIntro:'This is an inline version of the API documentation for \x3ca href\x3d"#!/guide/notebook"\x3eSpyral Notebooks\x3c/a\x3e. You can also \x3ca href\x3d"#!/api"\x3eview the full documentation\x3c/a\x3e in a new window.',outlineApi:"Here is a list of the Spyral classes that can be used in your notebook:",
loadingDocs:"Loading Docs"}},lastDocEntryClass:void 0,lastDocEntryMethod:void 0,outlineTemplate:new Ext.XTemplate("\x3cul\x3e",'\x3ctpl for\x3d"groups"\x3e','\x3ctpl for\x3d"classes"\x3e','\x3cli\x3e\x3ca href\x3d"#!/api/{.}"\x3e{.}\x3c/a\x3e\x3c/li\x3e',"\x3c/tpl\x3e","\x3c/tpl\x3e","\x3c/ul\x3e"),membersTemplate:new Ext.XTemplate('\x3cdiv class\x3d"members"\x3e','\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"member"\x3e','\x3ctpl if\x3d"meta.static"\x3e','\x3cspan class\x3d"static" title\x3d"static"\x3es\x3c/span\x3e',
"\x3c/tpl\x3e",'\x3ca href\x3d"#!/api/{owner}-{id}"\x3e{name}\x3c/a\x3e',"\x3c/div\x3e","\x3c/tpl\x3e","\x3c/div\x3e"),constructor:function(a){this.mixins["Voyant.util.Localization"].constructor.apply(this,arguments);a=a||{};Ext.apply(a,{title:this.localize("docs"),width:500,height:500,minimizable:!0,closeAction:"hide",tbar:[{text:this.localize("home"),itemId:"homeBtn",glyph:"xf015@FontAwesome",handler:function(b){this.showDocs()}.bind(this)},{text:this.localize("overview"),itemId:"overviewBtn",glyph:"xf05a@FontAwesome",
handler:function(b){this._showDocEntry()}.bind(this)},{text:this.localize("configs"),itemId:"configsBtn",glyph:"xf013@FontAwesome",handler:function(b){b.up("window").getLayout().setActiveItem(1)}},{text:this.localize("methods"),itemId:"methodsBtn",glyph:"xf1b2@FontAwesome",handler:function(b){b.up("window").getLayout().setActiveItem(2)}}],layout:"card",items:[{itemId:"main",cls:"docsWindowContent",scrollable:"y",html:""},{itemId:"configs",cls:"docsWindowContent",scrollable:"x",layout:"fit",html:""},
{itemId:"methods",cls:"docsWindowContent",scrollable:"x",layout:"fit",html:""}],tools:[{type:"help",tooltip:this.localize("openFull"),callback:function(b,c,d){b="";this.lastDocEntryClass&&(b+="/"+this.lastDocEntryClass);this.lastDocEntryMethod&&(b+="-"+this.lastDocEntryMethod);window.open(Voyant.application.getBaseUrlFull()+"docs/#!/api"+b,"_spyral_docs")}.bind(this)},{type:"restore",itemId:"restoreButton",hidden:!0,handler:function(b,c,d,e){e.hide();var f=d.up("window");f.expand(!1);setTimeout(function(){f.anchorTo(Ext.getBody(),
"br-br")},10)}}],listeners:{boxready:function(b){b.body.addListener("click",function(c){"a"===c.target.tagName.toLowerCase()&&(c.preventDefault(),c.stopPropagation(),c=c.target.getAttribute("href"),this.handleDocLink(c))},this)},minimize:function(b){b.collapse(Ext.Component.DIRECTION_BOTTOM,!1).anchorTo(Ext.getBody(),"br-br");b.down("#restoreButton").show()},scope:this}});this.callParent([a])},showDocs:function(){this.show().anchorTo(Ext.getBody(),"br-br");this.getLayout().getRenderTarget().mask(this.localize("loadingDocs"));
Ext.Ajax.request({url:Voyant.application.getBaseUrlFull()+"resources/docs/en/categories.json"}).then(function(a){try{var b=JSON.parse(a.responseText)}catch(c){console.warn("error parsing api doc json",c)}b&&this._loadExtOutline(b[0])}.bind(this),function(){this._loadExtOutline({name:"Spyral",groups:[{name:"Base",classes:"Spyral.Corpus Spyral.Table Spyral.Chart Spyral.Load Spyral.Util Spyral.Categories".split(" ")},{name:"Notebook",classes:["Spyral.Metadata","Spyral.Notebook","Spyral.Util.Storage"]},
{name:"Global",classes:["window"]}]})}.bind(this)).always(function(){this.getLayout().setActiveItem(0);this.getLayout().getRenderTarget().unmask()}.bind(this))},handleDocLink:function(a){var b=a.match(/.*?\/api\/([\w.]+)-?(.*)?/);b?(a=b[1],b=b[2],a!==this.lastDocEntryClass?this.showDocsForClassMethod(a,b):this._showDocEntry(b)):0===a.indexOf("#!")?window.open(Voyant.application.getBaseUrlFull()+"docs/"+a,"_spyral_docs"):window.open(a,"_external")},showDocsForClassMethod:function(a,b){this.show().anchorTo(Ext.getBody(),
"br-br");this.getLayout().getRenderTarget().mask(this.localize("loadingDocs"));Ext.Ajax.request({url:Voyant.application.getBaseUrlFull()+"docs/output/"+a+".js"}).then(function(c){c=c.responseText;try{var d=JSON.parse(c.substring(c.indexOf("{"),c.length-2))}catch(e){console.warn("error parsing api doc json",e)}d&&this._loadExtDocs(d,a,b)}.bind(this)).always(function(){this.getLayout().getRenderTarget().unmask()}.bind(this))},_showDocEntry:function(a){this.isHidden()&&this.show().anchorTo(Ext.getBody(),
"br-br");var b=this.down("#main").getEl().dom;b.querySelectorAll(".doc-contents, .members-section \x3e .subsection \x3e div").forEach(function(c){c.hidden=!0});(this.lastDocEntryMethod=a)?b.querySelector("#"+a).hidden=!1:b.querySelector(".doc-contents").hidden=!1;this.getLayout().setActiveItem(0);setTimeout(function(){this.down("#main").body.scrollTo("top",0,!1)}.bind(this),0)},_loadExtOutline:function(a){this.lastDocEntryMethod=this.lastDocEntryClass=void 0;this.setTitle(this.localize("docs")+" "+
this.localize("home"));this.down("#restoreButton").hide();this.down("#overviewBtn").hide();this.down("#configsBtn").hide();this.down("#methodsBtn").hide();var b="\x3cp\x3e"+this.localize("outlineIntro")+"\x3c/p\x3e\x3cp\x3e"+this.localize("outlineApi")+"\x3c/p\x3e";b+=this.outlineTemplate.apply(a);this._setHtmlForCard("main",b);this.body.scrollTo("top",0,!1);this.getCollapsed()&&(this.expand(!1),setTimeout(function(){this.anchorTo(Ext.getBody(),"br-br")}.bind(this),10))},_loadExtDocs:function(a,b,
c){this.lastDocEntryClass=b;this.lastDocEntryMethod=c;this.setTitle(this.localize("docs")+": "+a.name);this.down("#restoreButton").hide();this._setHtmlForCard("main",a.html);this._showDocEntry(c);this.down("#overviewBtn").show();var d=[],e=[];a.members.forEach(function(f){"cfg"===f.tagname?d.push(f):"method"===f.tagname&&e.push(f)});this._setHtmlForCard("configs",this.membersTemplate.apply(d));this.down("#configsBtn").setVisible(0<d.length);this._setHtmlForCard("methods",this.membersTemplate.apply(e));
this.down("#methodsBtn").setVisible(0<e.length);this.getCollapsed()&&(this.expand(!1),setTimeout(function(){this.anchorTo(Ext.getBody(),"br-br")}.bind(this),10))},_setHtmlForCard:function(a,b){this.down("#"+a).setHtml(b);a=this.down("#"+a).getEl().dom;Ext.fly(a).selectable()}});Ext.define("Voyant.notebook.Catalogue",{extend:"Ext.Component",mixins:["Voyant.util.Localization","Voyant.notebook.util.NotebooksList"],alias:"widget.notebookcatalogue",statics:{i18n:{title:"Spyral Notebooks Catalogue",browse:"Browse Notebooks",keywords:"Keywords",author:"Author",language:"Language",license:"License",search:"Search within notebooks",noResults:"No matching notebooks",suggested:"Suggested Notebooks",load:"Open Selected Notebook",close:"Close"}},window:void 0,gettingFacets:!1,constructor:function(){this.suggestedStore=
Ext.create("Ext.data.JsonStore",{fields:[{name:"id"},{name:"author"},{name:"title"},{name:"description"},{name:"keywords"},{name:"language"},{name:"license"},{name:"created",type:"date"},{name:"modified",type:"date"},{name:"version"}]});this.suggestedTemplate=new Ext.XTemplate('\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"catalogue-notebook"\x3e','\x3cdiv class\x3d"title" title\x3d"{title}"\x3e{title}\x3c/div\x3e','\x3cdiv class\x3d"description"\x3e{description}\x3c/div\x3e',"\x3c/div\x3e","\x3c/tpl\x3e");
this.callParent(arguments)},initComponent:function(a){this.callParent(arguments)},showWindow:function(){void 0===this.window?(this.window=Ext.create("Ext.window.Window",{title:this.localize("title"),width:"80%",height:"80%",maximizable:!0,modal:!0,cls:"catalogue",layout:"border",items:[{xtype:"panel",region:"center",flex:2,border:!0,layout:{type:"vbox",align:"stretch"},items:[{xtype:"toolbar",height:30,layout:{type:"hbox",pack:"center"},items:[{xtype:"tbspacer",flex:.1},{xtype:"textfield",itemId:"queryfield",
emptyText:this.localize("search"),flex:.8,enableKeyEvents:!0,triggers:{cancel:{hidden:!0,cls:"fa-trigger form-fa-clear-trigger",handler:function(a){a.setValue("");a.getTriggers().cancel.hide();this.getNotebooks()},scope:this},search:{cls:"fa-trigger form-fa-search-trigger",handler:function(a){this.getNotebooks()},scope:this}},listeners:{keyup:function(a,b){13===b.getCharCode()&&this.getNotebooks();0<a.getValue().trim().length?a.getTriggers().cancel.show():a.getTriggers().cancel.hide()},scope:this}},
{xtype:"tbspacer",flex:.1}]},{xtype:"notebookslist",itemId:"notebookslist",cls:"catalogue-window",flex:1,listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"),this.hideWindow)},scope:this}}]},{xtype:"panel",region:"west",collapsible:!0,title:this.localize("browse"),flex:1,itemId:"facets",cls:"facets",layout:{type:"accordion",animate:!1,multi:!0,fill:!1,align:"stretch",titleCollapse:!0,hideCollapseTool:!0},defaults:{xtype:"grid",rowLines:!1,hideHeaders:!0,selType:"checkboxmodel",
columns:[{renderer:function(a,b,c){return"("+c.get("count")+") "+c.get("label")},flex:1}],store:{xtype:"store.json",fields:[{name:"label"},{name:"count",type:"integer"}]}},items:[{title:this.localize("keywords"),facet:"facet.keywords",flex:3},{title:this.localize("author"),facet:"facet.author",flex:2},{title:this.localize("language"),facet:"facet.language",flex:1},{title:this.localize("license"),facet:"facet.license",flex:1}]},{xtype:"panel",region:"east",collapsible:!0,collapsed:!1,title:this.localize("suggested"),
width:250,layout:"fit",items:[{xtype:"dataview",padding:10,scrollable:"vertical",itemId:"suggestedNotebooks",store:this.suggestedStore,tpl:this.suggestedTemplate,itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected",listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"),this.hideWindow)},scope:this}}]}],closeAction:"hide",buttons:[{text:this.localize("close"),ui:"default-toolbar",handler:function(a){this.window.close()},
scope:this},{text:this.localize("load"),glyph:"xf115@FontAwesome",handler:function(a){a=this.window.down("#notebookslist").getSelection()[0];void 0===a&&(a=this.window.down("#suggestedNotebooks").getSelection()[0]);a&&this.fireEvent("notebookSelected",this,a.get("id"),this.hideWindow)},scope:this}]}),this.window.query("#facets \x3e grid").forEach(function(a){a.getSelectionModel().on("selectionchange",this._loadFacets,this)},this)):(this.window.query("#facets \x3e grid").forEach(function(a){a.getStore().clearFilter();
a.getSelectionModel().deselectAll()}),this.window.down("#queryfield").setValue(""),this.window.down("#notebookslist").getSelectionModel().deselectAll(),this.window.down("#suggestedNotebooks").getSelectionModel().deselectAll(),this.window.down("#notebookslist").getStore().removeAll());!1===this.suggestedStore.isLoaded()&&this.getSuggestedNotebooks();this.window.show();this._loadFacets()},hideWindow:function(){void 0!==this.window&&this.window.close()},_getSelectedFacets:function(){var a=[];this.window.query("#facets \x3e grid").forEach(function(b){b.getSelection().forEach(function(c){a.push([b.facet,
c.get("label")])})});return a},_loadFacets:function(){if(!1===this.gettingFacets){this.window.down("#facets").mask("Loading");this.gettingFacets=!0;var a=this._getSelectedFacets().map(function(c){return c.join("\x3d")}),b=this;Spyral.Load.trombone({tool:"notebook.CatalogueFacets",query:a,noCache:1}).then(function(c){c.catalogue.facets.forEach(function(d){var e=b.window.query("#facets \x3e grid[facet\x3d"+d.facet+"]")[0];if(e)if(e=e.getStore(),e.clearFilter(),0===e.getCount())e.loadRawData(d.results);
else{var f=[];e.each(function(g){for(var h=g.get("label"),k=0;k<d.results.length;k++){var l=d.results[k];if(l.label===h){g.set("count",l.count);f.push(h);break}}});e.filterBy(function(g){return-1!==f.indexOf(g.get("label"))})}});b.window.down("#facets").unmask();b.gettingFacets=!1;b.getNotebooks()}).catch(function(c){b.window.down("#facets").unmask();b.gettingFacets=!1})}},getNotebooks:function(a){if(!a){a=[];this._getSelectedFacets().forEach(function(d){a.push(d.join(":"))});var b=this.window.down("#queryfield").getValue();
0<b.trim().length&&a.push(b);return this.getNotebooks(a)}if(0===a.length)this.window.down("#notebookslist").getSelectionModel().deselectAll(),this.window.down("#notebookslist").getStore().removeAll();else{a.push("facet.catalogue:true");this.window.down("#notebookslist").mask("Loading");this.window.down("#notebookslist").getSelectionModel().deselectAll();var c=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:a,noCache:1}).then(function(d){c.window.down("#notebookslist").unmask();c.window.down("#notebookslist").getStore().loadRawData(d.catalogue.notebooks);
c.window.down("#notebookslist").getStore().sort("modified","DESC")}).catch(function(d){c.window.unmask()})}},getSuggestedNotebooks:function(){var a=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:"id:Tutorials|id:aboutspyral|id:DialogicaWelcome",parse:!1,noCache:1}).then(function(b){a.suggestedStore.loadRawData(b.catalogue.notebooks);a.suggestedStore.sort("modified","DESC")}).catch(function(b){})}});Ext.define("Voyant.notebook.Authenticator",{mixins:["Voyant.util.Localization","Voyant.notebook.util.NotebooksList"],statics:{i18n:{account:"Account",signInWithGithub:"Sign in with GitHub",signInWithGoogle:"Sign in with Google",logout:"Logout",yourNotebooks:"Your Notebooks",authenticateWithGithub:"Authenticate with GitHub",authorizeSpyralGithub:"You must authorize Spyral to use GitHub on your behalf.",signInSuccess:"Sign in successful!",close:"Close",openSelected:"Open Selected Notebook",deleteSelected:"Delete Selected Notebook",
notebookDeleted:"Notebook deleted",errorDeletingNotebook:"Error deleting notebook"}},accountInfo:void 0,getGitHubAuthButton:function(a){var b=this;return{xtype:"button",glyph:"xf09b@FontAwesome",text:b.localize("signInWithGithub"),margin:"5 15",handler:function(c){function d(e){e.origin===window.location.origin&&"oauth_cookie_set"===e.data?(window.removeEventListener("message",d,!1),e.source.close(),b.retrieveAccountInfo().then(function(f){a.call(b,f)})):console.warn("Error authenticating with GitHub")}
window.open(Voyant.application.getBaseUrlFull()+"spyral/oauth","_blank");window.addEventListener("message",d,!1)}}},getGoogleAuthButton:function(a){google.accounts.id.initialize({client_id:"foobar",ux_mode:"redirect",login_uri:"http://localhost:8080/voyant/spyral/oauth/callback"});return{xtype:"component",html:'\x3cdiv id\x3d"signInWithGoogleButton"\x3e\x3c/div\x3e',margin:5,listeners:{afterrender:function(){google.accounts.id.renderButton(document.getElementById("signInWithGoogleButton"),{theme:"outline",
size:"medium"})}}}},showGitHubAuthentication:function(a){var b=this;Ext.create("Ext.window.Window",{title:b.localize("authenticateWithGithub"),width:750,height:550,closable:!1,layout:{type:"vbox",align:"middle",pack:"center"},items:[{html:'\x3cdiv style\x3d"margin-bottom: 10px;"\x3e'+b.localize("authorizeSpyralGithub")+"\x3c/div\x3e"},b.getGitHubAuthButton(a)],buttons:[{text:"Cancel",handler:function(){b.close()}}]}).show()},showAccountWindow:function(){var a=this;if(this.isAuthenticated()){var b=
...
itemId:"notebookslist",xtype:"notebookslist",listeners:{itemdblclick:function(d,e,f){e=e.get("id");a.fireEvent("notebookSelected",a,e,function(){d.up("window").close()})}}}]}],buttons:[{text:a.localize("close"),ui:"default-toolbar",handler:function(d){d.up("window").close()}},{text:a.localize("deleteSelected"),ui:"default-toolbar",glyph:"xf1f8@FontAwesome",handler:function(d){var e=d.up("window"),f=e.down("#notebookslist").getSelection();f[0]&&Ext.Msg.confirm("Delete","Are you sure you want to permanently delete the selected notebook?",
function(g){"yes"===g&&(g=f[0].get("id"),a.deleteNotebook(g).then(function(){e.down("#notebookslist").getStore().remove(f[0]);a.toastInfo({html:a.localize("notebookDeleted"),anchor:"tr"})},function(h){Ext.Msg.show({title:a.localize("errorDeletingNotebook"),msg:h,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}))},a)}},{text:a.localize("openSelected"),glyph:"xf115@FontAwesome",handler:function(d){var e=d.up("window");d=e.down("#notebookslist").getSelection();d[0]&&(d=d[0].get("id"),a.fireEvent("notebookSelected",
a,d,function(){e.close()}))}}]});c.show();this.populateNotebookList(c)}},retrieveAccountInfo:function(){var a=this,b=new Ext.Deferred;Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"spyral/account",success:function(c){""===c.responseText?b.resolve(void 0):(c=JSON.parse(c.responseText),a.accountInfo=c,b.resolve(c))},failure:function(){b.reject()}});return b.promise},isAuthenticated:function(a){return a?this.retrieveAccountInfo().then(function(b){return void 0!==b},function(){return!1}):
void 0!==this.accountInfo},populateNotebookList:function(a){a.down("#notebookslist").mask("Loading");Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:"facet.userId:"+this.accountInfo.id,noCache:1}).then(function(b){a.down("#notebookslist").unmask();a.down("#notebookslist").getStore().loadRawData(b.catalogue.notebooks);a.down("#notebookslist").getStore().sort("modified","DESC")}).catch(function(b){a.unmask()})},deleteNotebook:function(a){var b=this,c=new Ext.Deferred;Ext.Ajax.request({method:"POST",
url:Voyant.application.getBaseUrlFull()+"spyral/account/delete",params:{id:a},success:function(d){d=JSON.parse(d.responseText);d.notebook.success?(b.fireEvent("fileDeleted",b,a),c.resolve(!0)):(b.fireEvent("fileDeleted",b,null,d.notebook.error),c.reject(d.notebook.error))},failure:function(d){b.fireEvent("fileDeleted",b,null,d.responseText);c.reject(d.responseText)}});return c.promise},getCookie:function(a){var b=(" "+document.cookie).match(new RegExp("[; ]"+a+"\x3d([^\\s;]*)"));return a&&b?unescape(b[1]):
...
metadataTip:"View and Edit the notebook metadata.",metadataEditor:"Edit Metadata",metadataReset:"Reset",metadataSave:"Save Metadata",metadataCancel:"Cancel",catalogueTip:"Search a catalogue of available notebooks.",preparingExport:"Preparing Export",notSavedWarning:"Changes to your notebook have not been saved. Are you sure you want to continue?"},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0}},config:{notebookId:void 0,notebookName:void 0,metadata:void 0,isEdited:!1,version:"3.0",storageSolution:"voyant"},
NOTEBOOK_ID_SEPARATOR:"_",SPYRAL_ID_REGEX:/\/spyral\/(.*?@[a-z]{2})[\/_]([A-Za-z0-9-]+)\/?$/,SPYRAL_ID_REGEX_OLD:/\/spyral\/([\w-]+)\/?$/,metadataWindow:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0,catalogueWindow:void 0,docsWindow:void 0,spyralTernDocs:void 0,ecmaTernDocs:void 0,browserTernDocs:void 0,constructor:function(a){Ext.apply(a,{title:this.localize("title"),includeTools:{help:!0,gear:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",
callback:function(b,c){c.toolMenu&&c.toolMenu.destroy();c.items=[];b.isAuthenticated(!0).then(function(d){c.items=d?[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:b.showSaveDialog.bind(b,!1),scope:b},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:b.showSaveDialog.bind(b,!0),scope:b}]:[{xtype:"component",padding:5,html:"Please sign in to save"}]},function(){c.items=[{xtype:"component",padding:5,html:"Please sign in to save"}]}).always(function(){c.showToolMenu()})}},
"new":{tooltip:this.localize("newTip"),callback:function(){var b=this.getBaseUrl()+"spyral/";this.getApplication().openUrl(b)},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),xtype:"toolmenu",glyph:"xf115@FontAwesome",callback:function(b,c){b=this.getStorageSolution();void 0!==b&&("github"===b?this.githubDialogs.showLoad():this.voyantStorageDialogs.showLoad())},scope:this},runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",
glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),callback:this.showMetadataEditor,xtype:"toolmenu",glyph:"xf02c@FontAwesome",scope:this},catalogue:{tooltip:this.localize("catalogueTip"),callback:function(){this.catalogueWindow.showWindow()},xtype:"toolmenu",glyph:"xf00b@FontAwesome",scope:this},account:{xtype:"toolmenu",glyph:"xf007@FontAwesome",callback:function(b,c){c.toolMenu&&c.toolMenu.destroy();c.items=[];var d=function(){b.setMetadata(b.getMetadata().clone());
b.setIsEdited(!1);b.toastInfo({html:b.localize("signInSuccess"),anchor:"tr"})};b.isAuthenticated(!0).then(function(e){e?b.showAccountWindow():c.items=[b.getGitHubAuthButton(d)]},function(){c.items=[b.getGitHubAuthButton(d)]}).always(function(){c.showToolMenu()})}}},scrollable:!0,layout:{type:"vbox",align:"middle",padding:"50 0"},defaults:{width:"100%",maxWidth:1100},items:[{itemId:"spyralHeader",cls:"spyral-header",listeners:{afterrender:function(b){Ext.tip.QuickTipManager.register({target:b.getId(),
text:this.localize("clickToEdit")});b.getTargetEl().on("click",function(c){this.showMetadataEditor();b.removeCls("editable")},this);b.mon(b.getEl(),"mouseover",function(){b.addCls("editable")});b.mon(b.getEl(),"mouseout",function(){b.removeCls("editable")})},scope:this}},{xtype:"container",itemId:"cells",defaults:{margin:"10 0 10 0",padding:"0 50 0 50"}},{itemId:"spyralFooter",cls:"spyral-footer",listeners:{afterrender:function(b){Ext.tip.QuickTipManager.register({target:b.getId(),text:this.localize("clickToEdit")});
b.getTargetEl().on("click",function(c){this.showMetadataEditor();b.removeCls("editable")},this);b.mon(b.getEl(),"mouseover",function(){b.addCls("editable")});b.mon(b.getEl(),"mouseout",function(){b.removeCls("editable")})},scope:this}}],helpToolClick:this.showDocs.bind(this),listeners:{afterrender:this.init,notebookWrapperMoveUp:this.notebookWrapperMoveUp,notebookWrapperMoveDown:this.notebookWrapperMoveDown,notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,
notebookInitialized:this.notebookInitialized,notebookSelected:this.handleNotebookSelected,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({notebookParent:this,listeners:{fileLoaded:function(b){this.checkIsEditedAndDoCallback(this,function(){this.loadFromString(b)})},fileSaved:function(b,c,d){this.unmask();
null!==c?((b=this.getNotebookId())&&c==b||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1)):this.showError("There was an error saving your notebook:\n"+d)},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({parent:this,listeners:{fileLoaded:function(b,c){b=c.owner;var d=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.loadFromString(c);c=encodeURIComponent(b+
"/"+d+"/"+e);-1===location.search.indexOf(c)&&(b=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:b},"Spyral Notebook: "+c,b))},fileSaved:function(b,c){b=c.owner;var d=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(b+"/"+d+"/"+c);-1===location.search.indexOf(c)&&(b=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:b},"Spyral Notebook: "+c,b))},
saveCancelled:function(b){this.unmask()},scope:this}});this.catalogueWindow=new Voyant.notebook.Catalogue({listeners:{notebookSelected:this.handleNotebookSelected,scope:this}})},init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Promise.all([Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/ecmascript.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+
"resources/spyral/docs/browser.json"})]).then(function(a){this.spyralTernDocs=Ext.JSON.decode(a[0].responseText);this.ecmaTernDocs=Ext.JSON.decode(a[1].responseText);this.browserTernDocs=Ext.JSON.decode(a[2].responseText);this.loadFromQueryParams()}.bind(this),function(){this.loadFromQueryParams()}.bind(this));this.retrieveAccountInfo()},reset:function(){this.getScrollable().scrollTo(0,0);this.getScrollable().trackingScrollTop=0;this.getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);
this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");this.getMetadata().set({userId:this.accountInfo.id});this.updateCachedOutput().then(function(b){},function(b){console.warn("Error updating cached results")}).finally(function(){var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()?
"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookName()):this.voyantStorageDialogs.doSave({notebookName:this.getNotebookName(),data:b,metadata:c})}.bind(this))},updateCachedOutput:function(){return Ext.Promise.all(this.query("notebookrunnableeditorwrapper").map(function(a){return a.results.updateCachedOutput()}))},exportToolClick:function(a){a.mask(a.localize("preparingExport"));a.updateCachedOutput().finally(function(){a.unmask();a.mixins["Voyant.util.Toolable"].exportToolClick.call(this,
a)})},getExportUrl:function(a){return location.href},loadFromQueryParams:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=this.SPYRAL_ID_REGEX.exec(location.pathname),d=this.SPYRAL_ID_REGEX_OLD.exec(location.pathname),e=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(g,h){0==g.trim().indexOf("\x3c")?0===h?this.setMetadata(new Spyral.Metadata({title:g})):
this.addText(g):this.addCode(g)},this):c?(this.loadFromId(c[1]+this.NOTEBOOK_ID_SEPARATOR+c[2]),this.setStorageSolution("voyant")):d?(this.loadFromId(d[1]),this.setStorageSolution("voyant")):e?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),this.setIsEdited(!1));if(b){var f=this;Ext.defer(function(){f.runAll()},100)}},loadFromString:function(a){a=a.trim();if(0===a.indexOf("{"))this.loadFromJson(a);else if(this.SPYRAL_ID_REGEX.test("/spyral/"+a)){var b=
this.SPYRAL_ID_REGEX.exec("/spyral/"+a);this.loadFromId(b[1]+this.NOTEBOOK_ID_SEPARATOR+b[2])}else{if(0!==a.indexOf("\x3c")||-1===a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setNotebookId(void 0);try{this.importFromHtml(a)}catch(c){Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),
buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}},this)}return!0},loadFromJson:function(a){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,
icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setMetadata(new Spyral.Metadata(b.metadata));var c=[];b.cells.forEach(function(d){var e=void 0;switch(d.type){case "text":this.addText(d.content,void 0,d.cellId);break;case "code":e=this.addCode(d.content,void 0,d.cellId);break;case "data":e=this.addData(d.content,void 0,d.cellId)}e&&(e.on("initialized",function(){var f=c.indexOf(e);-1!==f?(c.splice(f,1),0===c.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",
e)}.bind(this)),c.push(e))},this)},this)},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(c){b.unmask();c.notebook.success?(b.loadFromString(c.notebook.data),c.notebook.id&&c.notebook.id!==b.getNotebookId()&&b.setNotebookId(c.notebook.id),b.setIsEdited(!1)):Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:c.notebook.error,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}).catch(function(c){b.unmask();
Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},checkIsEditedAndDoCallback:function(a,b){this.getIsEdited()?Ext.Msg.show({title:this.localize("openTitle"),message:this.localize("notSavedWarning"),buttons:Ext.Msg.YESNO,icon:Ext.Msg.QUESTION,fn:function(c){"yes"===c&&b.call(a)},scope:this}):b.call(a)},handleNotebookSelected:function(a,b,c){this.checkIsEditedAndDoCallback(a,function(){c.call(a);this.loadFromId(b)}.bind(this))},
runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){b.push(c);if(a&&a===c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(!0,
b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(f){for(var g=0;g<b.length;g++)if(f.name===b[g].name){b.splice(g,1);break}});b=b.concat(e);Ext.defer(d._run,100,d,[a,b])},function(e){})}else this.updateTernServerVariables(this.getNotebookVariables()),this.fireEvent("notebookRun",this)},notebookInitialized:function(){},updateTernServerVariables:function(a,b){Voyant.notebook.editor.CodeEditor.ternServer&&(b&&b.forEach(function(c){Voyant.notebook.editor.CodeEditor.ternServer.server.delFile(c.name)}),
void 0===a?console.warn("updateTernServerVariables: no varsToAdd!"):a.forEach(function(c){c.isSpyralClass&&Voyant.notebook.editor.CodeEditor.ternServer.server.addFile(c.name,"var "+c.name+" \x3d new "+c.isSpyralClass+"()")}))},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(d){for(var e=0;e<b.length;e++)if(d.name===b[e].name){b.splice(e,1);break}}),b=b.concat(c))});
return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});return b},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"Spyral Notebook",language:"English"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text cells (like this one) and code cells (like the one below). You can click on the cells to edit them and add new cells by clicking add icon that appears in the left column when hovering over a cell.\x3c/p\x3e");
this.addCode("")},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){d=d||{};d.docs=[this.ecmaTernDocs,this.browserTernDocs,this.spyralTernDocs];return this._add(a,b,"notebookcodeeditorwrapper",c,d)},addData:function(a,b,c,d){return this._add(a,b,"notebookdatawrapper",c,d)},_add:function(a,b,c,d,e){Ext.isString(a)&&(a={input:a});var f=this.getComponent("cells");b="undefined"===typeof b?f.items.length:b;d="undefined"===typeof d?Spyral.Util.id():d;
return f.insert(b,Ext.apply(a,{xtype:c,index:b,cellId:d},e))},notebookWrapperMoveUp:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);a==b.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),
msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){var b=this.getComponent("cells");b.remove(a);0==b.items.length&&this.addText("(Click to edit).");this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=-1!==a.getXTypes(a).indexOf("notebookrunnableeditorwrapper");(!a&&!b.hasModifier()||a&&b.hasModifier()?this.addCode("",c+1):this.addText("",
c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookeditorwrapper").forEach(function(a,b){a.setIndex(b)});this.setIsEdited(!0)},applyIsEdited:function(a){this.rendered&&!a&&(this.query("notebookcodeeditor").forEach(function(b){b.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(b){b.setIsEditRegistered(!1)}));return a},applyNotebookId:function(a){if(!1===this.isConfiguring){var b=this.getBaseUrl()+
"spyral/";if(a){if(-1===a.indexOf(this.NOTEBOOK_ID_SEPARATOR))this.setNotebookName(a);else{var c=a.split(this.NOTEBOOK_ID_SEPARATOR)[1];this.setNotebookName(c)}b+=a.replace(this.NOTEBOOK_ID_SEPARATOR,"/")+"/"}window.history.pushState({url:b},"",b)}return a},applyMetadata:function(a){void 0!==a&&(a.title=a.title.replace(/<\/?\w+.*?>/g,""),a.description=a.description.replace(/<\/?\w+.*?>/g,""),this.isAuthenticated()&&""===a.userId&&""===a.author&&(a.userId=this.accountInfo.id,a.author=this.accountInfo.name));
return a},updateMetadata:function(){var a=this.getMetadata();document.title=a.title+" - Spyral";this.getComponent("spyralHeader").update(this.getInnerHeaderHtml());this.getComponent("spyralFooter").update(this.getInnerFooterHtml());this.metadataEditor&&this.metadataEditor.loadMetadata(a);this.setIsEdited(!0)},showMetadataEditor:function(){if(void 0===this.metadataWindow){var a=this;this.metadataEditor=Ext.create("widget.metadataeditor",{anchor:"100%"});this.metadataWindow=Ext.create("Ext.window.Window",
{title:this.localize("metadataEditor"),autoScroll:!0,width:600,closeAction:"hide",layout:"anchor",items:this.metadataEditor,buttons:[{text:this.localize("metadataCancel"),ui:"default-toolbar",handler:function(){this.up("window").close()}},{text:this.localize("metadataReset"),ui:"default-toolbar",handler:function(){a.metadataEditor.reset()}},{text:this.localize("metadataSave"),handler:function(){var c=a.metadataEditor.getForm().getValues();c.catalogue="true"===c.catalogue;a.getMetadata().set(c);a.updateMetadata();
this.up("window").close()}}]})}var b=this.getMetadata();void 0===b&&(b=new Spyral.Metadata,this.setMetadata(b));this.metadataEditor.loadMetadata(b);this.metadataWindow.show()},showDocs:function(){void 0===this.docsWindow&&(this.docsWindow=Ext.create("Voyant.notebook.util.DocsWindow"));this.docsWindow.showDocs()},showDocsForClassMethod:function(a,b){void 0===this.docsWindow&&(this.docsWindow=Ext.create("Voyant.notebook.util.DocsWindow"));this.docsWindow.showDocsForClassMethod(a,b)},handleDocLink:function(a){void 0===
this.docsWindow&&(this.docsWindow=Ext.create("Voyant.notebook.util.DocsWindow"));this.docsWindow.handleDocLink(a)}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Colors"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",categories:"auto",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0,categoriesManager:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,
arguments);this.mixins["Voyant.util.Colors"].constructor.apply(this,arguments);this.setCategoriesManager(new Spyral.Categories);this.getCategoriesManager().addFeature("color");this.getCategoriesManager().addFeature("font",'"Palatino Linotype", "Book Antiqua", Palatino, serif');var b=this.getColor;this.getColor=function(d,e){return b.apply(this,[this.getApiParam("palette"),d,e])};var c=this.getColorForTerm;this.getColorForTerm=function(d,e){return 0===d.indexOf("@")?(d=this.getCategoriesManager().getCategoryFeature(d.substring(1),
"color"),e?d:this.hexToRgb(d)):c.apply(this,[this.getApiParam("palette"),d,e])};this.callParent(arguments)},getBaseUrl:function(){var a=this.callParent();return 0==a.indexOf("//")?location.protocol+a:a},getBaseUrlFull:function(){return window.location.origin+this.getBaseUrl()},getRelativeUrl:function(){for(var a="",b=0,c=window.location.pathname.substring(this.getBaseUrl().length).split("/").length-1;b<c;b++)a+="../";return a},getTools:function(){return[{type:"maximize"},{type:"help"}]},launch:function(){Ext.tip.QuickTipManager.init();
...
{i18n:"moreToolsTypeOther",glyph:"xf035@FontAwesome",items:["reader","summary","veliza","embedder"]}]},launch:function(a){this.callParent(arguments);if(this.hasQueryToLoad()){var b=Ext.Object.fromQueryString(document.location.search);!b.corpus&&this.getCorpusId&&this.getCorpusId()&&(b.corpus=this.getCorpusId());a&&a.useCache&&(b.useCache=a.useCache);this.loadCorpusFromParams(b);if(b.palette)if(-1<b.palette.indexOf(",")){var c=Ext.decode(b.palette);this.addColorPalette(b.palette,c)}else this.loadCustomColorPalette(b.palette)}else(b=
this.getViewport())&&(b=b.down("corpuscreator"))&&b.toastInfo({html:this.localize("didYouKnowText"),title:this.localize("didYouKnow"),anchor:b.down("textareafield"),align:"tr",listeners:{beforeclose:{fn:function(){this.getHeader().getTools().forEach(function(d){"gear"!=d.type&&"help"!=d.type||d.getEl().frame("#ff0000",1,{duration:3E3})})},scope:b}}})},loadCorpusFromParams:function(a){var b=this;this.errorLoadingCorpus&&(delete a.corpus,delete this.errorLoadingCorpus);var c=b.getViewport();c.mask(this.localize("fetchingCorpus"));
a.archive&&(Ext.isString(a.archive)&&(a.archive=[a.archive]),a.archive=a.archive.map(function(d){return d.replace("/blogs.sub.uni-hamburg.de/hup/lhn/","/wikis.sub.uni-hamburg.de/lhn/index.php/").replace("/hup.sub.uni-hamburg.de/","/wikis.sub.uni-hamburg.de/")}));this.validateCorpusLoadParams(a);(new Voyant.data.model.Corpus(a)).then(function(d){c.unmask();b.setCorpus(d);b.validateCorpusAccess()&&b.dispatchEvent("loadedCorpus",this,d)}).otherwise(function(){b.errorLoadingCorpus=!0;c.unmask()})},validateCorpusLoadParams:function(a){},
...
b.unmask(),a.setCorpusAccess(g),a.dispatchEvent("loadedCorpus",this,c)):a.showError({message:a.localize("badPassword")})},failure:function(g,h){e.unmask();a.showError({message:a.localize("passwordValidationError")})}}))}},{text:a.localize("nonConsumptiveButton"),hidden:"NONE"==c.getNoPasswordAccess(),handler:function(){e.mask();Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSessionRemove:!0},method:"POST",callback:function(f,g){e.unmask();e.close();b.unmask();a.dispatchEvent("loadedCorpus",
a,c)}})}}]}}}).show();return!1}return!0},hasQueryToLoad:function(a){a||(a=Ext.Object.fromQueryString(document.location.search));return a.corpus||a.input||this.getCorpusId&&this.getCorpusId()},loadCategoryData:function(a){return this.getCategoriesManager().load(a,{trombone:Voyant.application.getTromboneUrl()})},saveCategoryData:function(a){return this.getCategoriesManager().save({},{trombone:Voyant.application.getTromboneUrl()})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.getApiParam("categories")&&
this.loadCategoryData(this.getApiParam("categories")).then(function(){for(var c in this.getCategoriesManager().getCategories()){var d=this.getCategoriesManager().getCategoryFeature(c,"color");if(void 0!==d){d=this.hexToRgb(d);for(var e=this.getCategoriesManager().getCategoryTerms(c),f=0;f<e.length;f++)this.setColorForTerm(e[f],d)}}}.bind(this));this.on("unhandledEvent",function(c,d,e){c=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var f=this.getModifiedApiParams()||{};delete f.view;if("termsClicked"==
d)if(Ext.isArray(e)&&"string"!==typeof e[0]&&"term"in e[0]&&"docIndex"in e[0]){var g={},h={};e.forEach(function(l){g[l.term]=!0;h[l.docIndex]=!0});f.query=Object.keys(g);f.docIndex=Object.keys(h)}else f.query=e;else if("documentsClicked"==d){var k=[];e.forEach&&e.forEach(function(l){k.push(l.getIndex())});f.docIndex=k}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(l){return l.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=e.map(function(l){return l.getTerm()}),f.docIndex=
e.map(function(l){return l.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}f.toolFlow&&(d=Ext.Array.from(f.toolFlow.split(",")),f.view=d.shift(),0<d.length?f.toolFlow=d.join(","):delete f.toolFlow);c+="\x26"+Ext.Object.toQueryString(f);this.openUrl(c)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});
...
this.getCorpusId():void 0;if(window.history.pushState&&!a){a=b.getAliasOrId();b=Ext.Object.fromQueryString(document.location.search);var c=this.getBaseUrl()+"?corpus\x3d"+a,d;for(d in b)if("corpus"!==d){var e=Ext.isString(b[d])?[b[d]]:b[d];Ext.isArray(e)&&e.forEach(function(f){c+="\x26"+d+"\x3d"+f})}window.history.pushState({corpus:a},"Corpus: "+a,c)}}},getViewComponent:function(){return this.viewport.down("#toolsContainer-main")},launch:function(){var a=Ext.Object.fromQueryString(document.location.search)||
...
this.localize("voyantIs")+"\x3c/div\x3e"+(-1==this.localize("translatedBy").indexOf("English")?"\x3cdiv\x3e"+this.localize("translatedBy")+"\x3c/div\x3e":"")+(this.getCorpusCreatorText&&0<this.getCorpusCreatorText().trim().length?"\x3cdiv id\x3d'corpusCreatorText'\x3e"+this.getCorpusCreatorText()+"\x3c/div\x3e":"")+"\x3c/div\x3e"},{xtype:"container",width:"auto",html:"\x3cdiv style\x3d'font-style: italic; text-align: center; margin-top: 10px;'\x3e\x3cdiv\x3e"+this.localize("serverMessage")+"\x3c/div\x3e\x3c/div\x3e"}]},
{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.callParent(arguments)}});Ext.define("Voyant.panel.MoreLikeThis",{extend:"Ext.panel.Panel",alias:"widget.morelikethis",title:"More Like this"});

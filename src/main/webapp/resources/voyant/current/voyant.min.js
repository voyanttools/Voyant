...
scope:this}},{xtype:"tbspacer",flex:.1}]},{xtype:"notebookslist",itemId:"notebookslist",cls:"catalogue-window",flex:1,listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"),this.hideWindow)},scope:this}}]},{xtype:"panel",region:"west",collapsible:!0,title:this.localize("browse"),flex:1,itemId:"facets",cls:"facets",layout:{type:"accordion",animate:!1,multi:!0,fill:!1,align:"stretch",titleCollapse:!0,hideCollapseTool:!0},defaults:{xtype:"grid",rowLines:!1,hideHeaders:!0,
selType:"checkboxmodel",columns:[{renderer:function(a,b,c){return"("+c.get("count")+") "+c.get("label")},flex:1}],store:{xtype:"store.json",fields:[{name:"label"},{name:"count",type:"integer"}]}},items:[{title:this.localize("keywords"),facet:"facet.keywords",flex:3},{title:this.localize("author"),facet:"facet.author",flex:2},{title:this.localize("language"),facet:"facet.language",flex:1},{title:this.localize("license"),facet:"facet.license",flex:1}]},{xtype:"panel",region:"east",collapsible:!0,collapsed:!1,
title:this.localize("suggested"),width:250,layout:"fit",items:[{xtype:"dataview",padding:10,scrollable:"vertical",itemId:"suggestedNotebooks",store:this.suggestedStore,tpl:this.suggestedTemplate,itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected",listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"),this.hideWindow)},scope:this}}]}],closeAction:"hide",buttons:[{text:this.localize("close"),ui:"default-toolbar",
handler:function(a){this.window.close()},scope:this},{text:this.localize("new"),glyph:"xf067@FontAwesome",handler:function(a){a=Voyant.application.getBaseUrl()+"spyral/";Voyant.application.openUrl(a)}},{text:this.localize("load"),glyph:"xf115@FontAwesome",handler:function(a){a=this.window.down("#notebookslist").getSelection()[0];void 0===a&&(a=this.window.down("#suggestedNotebooks").getSelection()[0]);a&&this.fireEvent("notebookSelected",this,a.get("id"),this.hideWindow)},scope:this}]}),this.window.query("#facets \x3e grid").forEach(function(a){a.getSelectionModel().on("selectionchange",
this._loadFacets,this)},this)):(this.window.query("#facets \x3e grid").forEach(function(a){a.getStore().clearFilter();a.getSelectionModel().deselectAll()}),this.window.down("#queryfield").setValue(""),this.window.down("#notebookslist").getSelectionModel().deselectAll(),this.window.down("#suggestedNotebooks").getSelectionModel().deselectAll(),this.window.down("#notebookslist").getStore().removeAll());!1===this.suggestedStore.isLoaded()&&this.getSuggestedNotebooks();this.window.show();this._loadFacets()},
hideWindow:function(){void 0!==this.window&&this.window.close()},_getSelectedFacets:function(){var a=[];this.window.query("#facets \x3e grid").forEach(function(b){b.getSelection().forEach(function(c){a.push([b.facet,c.get("label")])})});return a},_loadFacets:function(){if(!1===this.gettingFacets){this.window.down("#facets").mask("Loading");this.gettingFacets=!0;var a=this._getSelectedFacets().map(function(c){return c.join("\x3d")}),b=this;Spyral.Load.trombone({tool:"notebook.CatalogueFacets",query:a,
noCache:1}).then(function(c){c.catalogue.facets.forEach(function(d){var e=b.window.query("#facets \x3e grid[facet\x3d"+d.facet+"]")[0];if(e)if(e=e.getStore(),e.clearFilter(),0===e.getCount())e.loadRawData(d.results);else{var f=[];e.each(function(g){for(var h=g.get("label"),k=0;k<d.results.length;k++){var l=d.results[k];if(l.label===h){g.set("count",l.count);f.push(h);break}}});e.filterBy(function(g){return-1!==f.indexOf(g.get("label"))})}});b.window.down("#facets").unmask();b.gettingFacets=!1;b.getNotebooks()}).catch(function(c){b.window.down("#facets").unmask();
b.gettingFacets=!1})}},getNotebooks:function(a){if(!a){a=[];this._getSelectedFacets().forEach(function(d){a.push(d.join(":"))});var b=this.window.down("#queryfield").getValue();0<b.trim().length&&a.push(b);return this.getNotebooks(a)}if(0===a.length)this.window.down("#notebookslist").getSelectionModel().deselectAll(),this.window.down("#notebookslist").getStore().removeAll();else{a.push("facet.catalogue:true");this.window.down("#notebookslist").mask("Loading");this.window.down("#notebookslist").getSelectionModel().deselectAll();
var c=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:a,noCache:1}).then(function(d){c.window.down("#notebookslist").unmask();c.window.down("#notebookslist").getStore().loadRawData(d.catalogue.notebooks);c.window.down("#notebookslist").getStore().sort("modified","DESC")}).catch(function(d){c.window.unmask()})}},getSuggestedNotebooks:function(){var a=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:"id:Tutorials|id:aboutspyral|id:DialogicaWelcome",parse:!1,noCache:1}).then(function(b){a.suggestedStore.loadRawData(b.catalogue.notebooks);
a.suggestedStore.sort("modified","DESC")}).catch(function(b){})}});Ext.define("Voyant.notebook.Authenticator",{mixins:["Voyant.util.Localization","Voyant.notebook.util.NotebooksList"],statics:{i18n:{account:"Account",signInWithGithub:"Sign in with GitHub",signInWithGoogle:"Sign in with Google",logout:"Logout",yourNotebooks:"Your Notebooks",authenticateWithGithub:"Authenticate with GitHub",authorizeSpyralGithub:"You must authorize Spyral to use GitHub on your behalf.",signInSuccess:"Sign in successful!",close:"Close",openSelected:"Open Selected Notebook",deleteSelected:"Delete Selected Notebook",

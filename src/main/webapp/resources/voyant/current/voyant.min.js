...
metadataTip:"View and Edit the notebook metadata.",metadataEditor:"Edit Metadata",metadataReset:"Reset",metadataSave:"Save Metadata",metadataCancel:"Cancel",catalogueTip:"Search a catalogue of available notebooks.",preparingExport:"Preparing Export",notSavedWarning:"Changes to your notebook have not been saved. Are you sure you want to continue?",accountTip:"View your account",openTip:"Open a Spyral Notebook (by uploading a file)"},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0}},config:{notebookId:void 0,
notebookName:void 0,metadata:void 0,isEdited:!1,version:"3.0",storageSolution:"voyant"},NOTEBOOK_ID_SEPARATOR:"_",SPYRAL_ID_REGEX:/\/spyral\/(.*?@[a-z]{2})[\/_]([A-Za-z0-9-]+)\/?$/,SPYRAL_ID_REGEX_OLD:/\/spyral\/([\w-]+)\/?$/,metadataWindow:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0,catalogueWindow:void 0,docsWindow:void 0,spyralTernDocs:void 0,ecmaTernDocs:void 0,browserTernDocs:void 0,constructor:function(a){var b=function(){parent.setMetadata(parent.getMetadata().clone());parent.setIsEdited(!1);
parent.toastInfo({html:parent.localize("signInSuccess"),anchor:"tr"})};Ext.apply(a,{title:this.localize("title"),includeTools:{help:!0,gear:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",callback:function(c,d){d.toolMenu&&d.toolMenu.destroy();d.items=[];c.isAuthenticated(!0).then(function(e){d.items=e?[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:c.showSaveDialog.bind(c,!1),scope:c},{text:"Save As...",xtype:"menuitem",

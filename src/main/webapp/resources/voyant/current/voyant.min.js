...
icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d})},exportGridAllJson:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllJsonWarning"),function(b){"yes"==b&&(b={limit:0,start:0},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},exportGridAllTsv:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllTsvWarning"),function(b){"yes"==b&&(b={limit:0,start:0,
template:this.getXType()+"2tsv"},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},getExportUrl:function(a){var b=this.getApplication().getModifiedApiParams(),c=Ext.getClassName(this).split(".").pop();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),a||(b.view=c));b.corpus||(b.corpus=this.getApplication().getCorpus().getAliasOrId());return this.getApplication().getBaseUrl()+

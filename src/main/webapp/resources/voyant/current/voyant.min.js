...
m){var n=l.getTerm(),u=l.getContextTerm(),v=l.getKeywordRawFreq(),p=l.getContextTermRawFreq(),q=v,r=p;this.getNetworkMode()===this.CENTRALIZED_MODE&&(q=0,r=Math.log(p));0==m&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+v+")",type:"keyword",value:q}):(g[b]=!0,m={id:b,term:n,title:n+" ("+v+")",type:"keyword",value:q,start:c,fixed:!1,x:e,y:f},h.push(m)));if(n!=u){n=this.idGet(u);void 0===g[n]&&(g[n]=!0,u={id:n,term:u,title:u+" ("+p+")",type:"context",value:r,start:0,

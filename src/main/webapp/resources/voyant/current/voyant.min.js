...
this.getColorTermAssociations().get(b);if(null==a){var e=this.lastUsedPaletteIndex+1;e%=d.length;a=d[e];this.getColorTermAssociations().add(b,a);this.lastUsedPaletteIndex=e}c&&(a=this.rgbToHex(a));return a},setColorForTerm:function(a,b){!1===Array.isArray(b)&&(b=this.hexToRgb(b));a=a.toLowerCase();this.getColorTermAssociations().replace(a,b)},getColorForEntityType:function(a,b){switch(a){case "person":a=5;break;case "location":a=6;break;case "organization":a=2;break;case "misc":a=0;break;case "time":case "date":case "duration":a=
...
h.up("form").getValues();this.setApiParams(k);var l=this.getApplication(),m=[];void 0!==k.stopList&&void 0!==k.stopListGlobal&&k.stopListGlobal&&m.push(["stopList",k.stopList]);var n=new Ext.Deferred;k.categories&&""!==k.categories?l.loadCategoryData(k.categories).then(function(){},function(){k.categories=void 0}).finally(function(){m.push(["categories",k.categories]);n.resolve()}):n.resolve();var u=new Ext.Deferred;void 0!==k.palette?(l.resetColorTermAssociations(),0===l.getColorPalette(k.palette).length?
l.loadCustomColorPalette(k.palette).then(function(){},function(){k.palette="default"}).always(function(){m.push(["palette",k.palette]);u.resolve()}):(m.push(["palette",k.palette]),u.resolve())):u.resolve();Ext.Promise.all([n,u]).then(function(){var v=l.getCorpus();if(0<m.length){var p=l.getViewport().query("panel,chart");m.forEach(function(q){var r=q[0];q=q[1];l.setApiParam&&l.setApiParam(r,q);for(var w=0;w<p.length;w++)p[w].setApiParam&&p[w].setApiParam(r,q)});v?l.dispatchEvent("loadedCorpus",this,
v):l.dispatchEvent("apiParamsUpdated",this,k)}v?this.fireEvent("loadedCorpus",this,v):this.fireEvent("apiParamsUpdated",this,k);h.up("window").close()}.bind(this))},scope:g}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}};c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",
...
boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")},{xtype:"radio",name:"export",inputValue:"spyral",boxLabel:a.localize("exportViewSpyral")}];a.isXType("notebook")&&c.splice(2,1);a.getExtraViewExportItems&&a.getExtraViewExportItems().forEach(function(f){Ext.applyIf(f,{xtype:"radio",name:"export"});c.push(f)});b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+
a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:c});var d=[];a.isXType("grid")&&(d.push({xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}),a.getExportGridAll&&
0==a.getExportGridAll()||d.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")}));a.getExtraDataExportItems&&a.getExtraDataExportItems().forEach(function(f){Ext.applyIf(f,{xtype:"radio",name:"export"});d.push(f)});0<d.length&&b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:d});if((!a.getExportVisualization||a.getExportVisualization())&&
0==a.isXType("grid")&&(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))){var e=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},{xtype:"slider",width:200,value:1,minValue:.5,maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),listeners:{change:function(f,g){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([g]))},
changecomplete:function(f){f.previousSibling().setValue(!0)}}}];a.getTargetEl().dom.querySelector("svg")&&e.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:e})}Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(f){var g=
f.up("form"),h="export"+Ext.String.capitalize(g.getValues()["export"]);Ext.isFunction(a[h])?a[h].call(a,a,g):Ext.Msg.show({title:a.localize("exportError"),message:a.localize("exportNoFunction"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});f.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(f){f.up("window").close()}}]},bodyPadding:5}).show()},exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",
...
a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(a,b){var c=1;b&&(b.mask(a.localize("loading")),(a=b.queryById("scale"))&&a.getValue&&(c=a.getValue()));var d=this.down("draw")||this.down("chart");if(d&&(d.isChart||d.isCanvas)){var e=d.innerElement.getSize();a=Array.prototype.slice.call(d.items.items);
var f=d.surfaceZIndexes,g;for(g=1;g<a.length;g++){var h=a[g];var k=f[h.type];for(d=g-1;0<=d&&f[a[d].type]>k;)a[d+1]=a[d],d--;a[d+1]=h}var l=document.createElement("canvas");f=Ext.getClassName(a[0]);c*=a[0].devicePixelRatio;var m=l.getContext("2d");l.width=Math.ceil(e.width*c);l.height=Math.ceil(e.height*c);for(d=0;d<a.length;d++)if(h=a[d],Ext.getClassName(h)===f)for(e=h.getRect(),surfaceSize=h.el.getSize(),g=0;g<h.canvases.length;g++){var n=h.canvases[g];k=n.getOffsetsTo(n.getParent());m.drawImage(n.dom,
...
0,l.width,l.height);p=l.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,p)}}else if(g=d.querySelector("svg")){a=d.offsetWidth*c;d=d.offsetHeight*c;g=g.cloneNode(!0);g.setAttribute("version",1.1);g.setAttribute("xmlns","http://www.w3.org/2000/svg");g.setAttribute("width",a);g.setAttribute("height",d);for(h=[];0<g.children.length;)h.push(g.removeChild(g.children[0]));var v=document.createElement("g");v.setAttribute("style","transform-box: fill-box;");v.setAttribute("transform",
"scale("+c+")");g.appendChild(v);h.forEach(function(r){v.appendChild(r)});var p="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(g.outerHTML)));n=Ext.DomHelper.createDom({tag:"canvas",width:a,height:d});var q=n.getContext("2d");u=new Image;u.src=p;u.panel=this;u.onload=function(){q.drawImage(u,0,0);p=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,p)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=
0==this.isXType("voyantheader");Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+
...
{msg:Ext.isString(a)?a:a.msg,response:b}))},showError:function(a,b){if(a instanceof Voyant.util.ResponseError)a={message:a.getMsg()+"\x3cp class\x3d'error'\x3e\n"+a.getError()+" \u2026 \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+escape(a.getDetails())+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/p\x3e"};else{if(a instanceof Ext.data.operation.Operation)return this.showError(Ext.create("Voyant.util.ResponseError",a.getError()));if(Ext.isString(a))a=
{message:a};else if(Ext.isObject(a)&&(a.responseText||a.statusText))return this.showResponseError(a.statusText,a)}Ext.applyIf(a,{title:this.localize("error"),buttons:Ext.Msg.OK,icon:Ext.MessageBox.ERROR,autoScroll:!0});Ext.Msg.show(a)},getToolConfigFromToolXtype:function(a){cls=Ext.ClassManager.getByAlias("widget."+a);return{xtype:a,title:this._localizeClass(cls,"title"),tooltip:{text:this._localizeClass(cls,"helpTip")},glyph:cls&&cls.glyph?cls.glyph:"xf12e@FontAwesome"}},openUrl:function(a){window.open(a)||
Ext.Msg.show({title:"Popup Blocked",buttonText:{ok:"Close"},icon:Ext.MessageBox.INFO,message:"A popup window was blocked. \x3ca href\x3d'"+a+"' target\x3d'_blank' class\x3d'link'\x3eClick here\x3c/a\x3e to open the new window.",buttons:Ext.Msg.OK})},loadCategoryData:function(a){return this.getCategoriesManager().load(a,{trombone:Voyant.application.getTromboneUrl()}).then(function(){for(var b in this.getCategoriesManager().getCategories()){var c=this.getCategoriesManager().getCategoryFeature(b,"color");
if(void 0!==c){c=this.hexToRgb(c);for(var d=this.getCategoriesManager().getCategoryTerms(b),e=0;e<d.length;e++)this.setColorForTerm(d[e],c)}}}.bind(this))},saveCategoryData:function(a){return this.getCategoriesManager().save({},{trombone:Voyant.application.getTromboneUrl()})}});Ext.define("Voyant.VoyantCorpusApp",{extend:"Voyant.VoyantApp",name:"VoyantCorpusApp",requires:"Voyant.panel.CorpusSet Voyant.data.model.Corpus Voyant.panel.VoyantHeader Voyant.panel.VoyantFooter Voyant.panel.CorpusCreator Voyant.panel.Cirrus Voyant.panel.Summary Voyant.panel.DreamScape Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Documents Voyant.panel.Trends Voyant.panel.Contexts Voyant.panel.DocumentTerms Voyant.panel.CorpusCollocates Voyant.panel.CollocatesGraph Voyant.panel.Phrases Voyant.panel.ScatterPlot Voyant.panel.TopicContexts Voyant.panel.TermsRadio Voyant.panel.TermsBerry Voyant.panel.Embedder".split(" "),
...
var c=b.getViewport();c.mask(this.localize("fetchingCorpus"));a.archive&&(Ext.isString(a.archive)&&(a.archive=[a.archive]),a.archive=a.archive.map(function(d){return d.replace("/blogs.sub.uni-hamburg.de/hup/lhn/","/wikis.sub.uni-hamburg.de/lhn/index.php/").replace("/hup.sub.uni-hamburg.de/","/wikis.sub.uni-hamburg.de/")}));this.validateCorpusLoadParams(a);(new Voyant.data.model.Corpus(a)).then(function(d){c.unmask();b.setCorpus(d);b.validateCorpusAccess()&&b.dispatchEvent("loadedCorpus",this,d)}).otherwise(function(){b.errorLoadingCorpus=
!0;c.unmask()})},validateCorpusLoadParams:function(a){},validateCorpusAccess:function(){var a=this,b=a.getViewport(),c=this.getCorpus();if(c&&c.requiresPassword()&&!a.getViewport().query("panel").every(function(f){return!f.isConsumptive})){var d=c.getNoPasswordAccess(),e=Ext.create("Ext.window.Window",{title:a.localize("passwordRequiredTitle"),layout:"fit",items:{padding:10,flex:1,width:300,layout:{type:"vbox",align:"stretch"},items:[{html:"\x3cp\x3e"+a.localize("passwordRequiredMessage")+"\x3c/p\x3e"+
("NONCONSUMPTIVE"==d?"\x3cp\x3e"+a.localize("nonConsumptiveMessage")+"\x3c/p\x3e":"")+"\x3c/p\x3e"},{xtype:"textfield",fieldLabel:a.localize("password")}],bbar:{layout:{pack:"center"},items:[{text:a.localize("passwordValidateButton"),ui:"default",handler:function(){var f=e.query("textfield")[0].getValue().trim();0==f.length?a.showError({message:a.localize("noPasswordGiven")}):(e.mask(),Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSession:f},method:"POST",success:function(g,
h){e.unmask();g=g.responseText;"ADMIN"==g||"ACCESS"==g?(e.close(),b.unmask(),a.setCorpusAccess(g),a.dispatchEvent("loadedCorpus",this,c)):a.showError({message:a.localize("badPassword")})},failure:function(g,h){e.unmask();a.showError({message:a.localize("passwordValidationError")})}}))}},{text:a.localize("nonConsumptiveButton"),hidden:"NONE"==c.getNoPasswordAccess(),handler:function(){e.mask();Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSessionRemove:!0},method:"POST",
callback:function(f,g){e.unmask();e.close();b.unmask();a.dispatchEvent("loadedCorpus",a,c)}})}}]}}}).show();return!1}return!0},hasQueryToLoad:function(a){a||(a=Ext.Object.fromQueryString(document.location.search));return a.corpus||a.input||this.getCorpusId&&this.getCorpusId()},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.on("unhandledEvent",function(c,d,e){c=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var f=this.getModifiedApiParams()||{};delete f.view;if("termsClicked"==d)if(Ext.isArray(e)&&
"string"!==typeof e[0]&&"term"in e[0]&&"docIndex"in e[0]){var g={},h={};e.forEach(function(l){g[l.term]=!0;h[l.docIndex]=!0});f.query=Object.keys(g);f.docIndex=Object.keys(h)}else f.query=e;else if("documentsClicked"==d){var k=[];e.forEach&&e.forEach(function(l){k.push(l.getIndex())});f.docIndex=k}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(l){return l.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=e.map(function(l){return l.getTerm()}),f.docIndex=e.map(function(l){return l.getDocIndex()}));
else{console&&console.warn("Unhandled event: "+d,e);return}f.toolFlow&&(d=Ext.Array.from(f.toolFlow.split(",")),f.view=d.shift(),0<d.length?f.toolFlow=d.join(","):delete f.toolFlow);c+="\x26"+Ext.Object.toQueryString(f);this.openUrl(c)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});

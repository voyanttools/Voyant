...
n,u){m.dom.firstChild&&m.dom.firstChild.nodeValue.match(l)&&m.addCls("keyword").dom.setAttribute("style",h)})}},this))},nerSeviceHandler:function(a){a=a.itemId;var b=[],c=this.getLocationInfo();if(c)for(var d=c[0].docIndex;d<=c[1].docIndex;d++)b.push(d);else b.push(0);var e=this.down("entitieslist");e.clearEntities();this.clearEntityHighlights();var f=this;new Voyant.data.util.DocumentEntities({annotator:a,includeEntities:!0,docIndex:b},function(g){g&&(f.clearEntityHighlights(),f.setDocumentEntitiesStore(g),

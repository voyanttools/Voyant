...
c;d=d.offsetHeight*c;g=g.cloneNode(!0);g.setAttribute("version",1.1);g.setAttribute("xmlns","http://www.w3.org/2000/svg");g.setAttribute("width",a);g.setAttribute("height",d);for(k=[];0<g.children.length;)k.push(g.removeChild(g.children[0]));var r=document.createElement("g");r.setAttribute("style","transform-box: fill-box;");r.setAttribute("transform","scale("+c+")");g.appendChild(r);k.forEach(function(a){r.appendChild(a)});var q="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(g.outerHTML)));
...
addFeature:function(a){this.categoriesManager.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.categoriesManager.getCategories())c.push({category:d});var e=this.categoriesManager.getFeatures(),f=Ext.ClassManager.getClass(this).features,g;for(g in e){a.push(g);e=f[g];var k=Ext.applyIf({feature:g,listeners:{change:function(a,
b){if(a.rendered){var c=a.up("gridview").indexOf(a.el.up("table")),d=a.up("grid").getStore().getAt(c);d?d.set(a.feature,b):window.console&&console.warn("no record for",c,a)}},scope:this}},e);e.listeners&&Ext.applyIf(k.listeners,e.listeners);b.push({sortable:!1,hideable:!1,text:this.localize(g),dataIndex:g,flex:.5,xtype:"widgetcolumn",widget:k});for(d in this.categoriesManager.getCategories())for(e=this.categoriesManager.getCategoryFeature(d,g),k=0;k<c.length;k++)if(c[k].category==d){c[k][g]=e;break}}a=
...
tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0,sort:void 0,dtocIndexDoc:-1}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},
...
function(a,c){b.down("#buttons").setVisible(!1)});window.addEventListener("message",a);var c=this;this.setInitIntervalID(setInterval(function(){console.log("interval init");c._sendMessage({type:"command",command:"init"})},100))},this);this.on("removed",function(){window.removeEventListener("message",a)},this);this.callParent(arguments)},clear:function(){!1===this.isVisible()&&(console.log("clearing but not visible!",this),this.show());this._sendMessage({type:"command",command:"clear"})},run:function(a,
b){void 0===b&&(b=[]);this.setCachedResultsOutput("");this.setCachedResultsVariables([]);this.setHasRunError(!1);this.getEl().removeCls(["error","success"]);this.setRunPromise(new Ext.Deferred);var c=this.getRunPromise().promise;c.then(function(){this.getEl().addCls("success")},function(){this.setHasRunError(!0);this.getEl().addCls("error")},void 0,this);this.mask("Running code...");this._sendMessage({type:"code",value:a,variables:b});return c},mask:function(a){var b=this;this.setMaskTimeoutId(setTimeout(function(){b.superclass.mask.call(b,
a,"spyral-code-mask")},250))},unmask:function(){clearTimeout(this.getMaskTimeoutId());this.superclass.unmask.call(this)},updateHtml:function(a){this._sendMessage({type:"command",command:"update",html:a})},updateValue:function(a,b){this._sendMessage({type:"command",command:"update",name:a,value:b})},getValue:function(){return this.getCachedResultsValue()},getOutput:function(){return this.getCachedResultsOutput()},getVariables:function(){return this.getCachedResultsVariables()},getResultsEl:function(){var a=
...
this));break;case "clear":this._setHeight(0)}break;case "result":console.log("iframe result:",b),this.unmask(),this.getRunPromise().resolve(b)}b.value&&this.setCachedResultsValue(b.value);b.output&&this.setCachedResultsOutput(b.output);this.setCachedResultsVariables(b.variables);0<b.height&&this._setHeight(b.height)}else console.warn("unrecognized message!",a)},_doExpandContract:function(){var a=this.down("#expandButton");this.getExpandResults()?(this.setExpandResults(!1),a.setTooltip("Expand Results"),
a.setGlyph("xf065@FontAwesome")):(this.setExpandResults(!0),a.setTooltip("Contract Results"),a.setGlyph("xf066@FontAwesome"));this._setHeight()},_setHeight:function(a){if(void 0===this.getCachedPaddingHeight()){var b=window.getComputedStyle(this.getEl().dom);this.setCachedPaddingHeight(parseFloat(b.getPropertyValue("padding-top"))+parseFloat(b.getPropertyValue("padding-bottom"))+2)}void 0!==a?this.setCachedResultsHeight(a):(a=this.getCachedResultsHeight(),void 0===a&&(a=(b=this.getResultsEl())?b.getHeight():
this.getEmptyResultsHeight(),this.setCachedResultsHeight(a)));a+=this.getCachedPaddingHeight();if(b=this.getResultsEl())b=this.down("#expandWidget"),this.getExpandResults()?(b.hide(),this.setHeight(Math.max(a,this.getEmptyResultsHeight()))):(a=Math.min(Math.max(a,this.getEmptyResultsHeight()),this.getMinimumResultsHeight()),a<this.getMinimumResultsHeight()?b.hide():b.show(),this.setHeight(a))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization","Voyant.notebook.util.Embed"],embeddable:["Voyant.notebook.editor.CodeEditor"],cls:"notebook-code-editor",config:{theme:"ace/theme/chrome",mode:"ace/mode/javascript",content:"",docs:void 0,isChangeRegistered:!1,editor:void 0,editedTimeout:void 0,lines:0,maxLines:Infinity},statics:{i18n:{},api:{content:void 0}},MIN_LINES:6,constructor:function(a){this.callParent(arguments)},
listeners:{render:function(){var a=this,b=ace.edit(Ext.getDom(this.getEl()));b.$blockScrolling=Infinity;b.getSession().setUseWorker(!0);b.setTheme(this.getTheme());b.getSession().setMode(this.getMode());b.setOptions({minLines:a.MIN_LINES,maxLines:this.getMaxLines(),autoScrollEditorIntoView:!0,scrollPastEnd:!0,highlightActiveLine:!1});b.renderer.setOptions({showGutter:!0,showFoldWidgets:!1,showPrintMargin:!1});b.renderer.once("afterRender",function(){a.fireEvent("resize",a)});b.setValue(this.getContent()?
this.getContent():"");b.clearSelection();b.on("focus",function(){setTimeout(function(){a.getEditor().setHighlightGutterLine(!0)},100)},this);b.on("change",function(b,d){a.clearMarkers();b=d.getSession().getScreenLength();b>a.MIN_LINES&&b!==a.getLines()&&(a.setLines(b),Infinity===a.getMaxLines()&&(d=b*d.renderer.lineHeight+d.renderer.scrollBar.getWidth(),a.setSize({height:d})));0==a.getIsChangeRegistered()?(a.setIsChangeRegistered(!0),d=a.up("notebookrunnableeditorwrapper"),d.setIsRun(!1),d.up("notebook").setIsEdited(!0)):
a.getEditedTimeout()||a.setEditedTimeout(setTimeout(function(){a.setIsChangeRegistered(!1)},3E4))},this);b.on("blur",function(){a.getEditor().setHighlightGutterLine(!1)});b.commands.addCommand({name:"run",bindKey:{win:"Shift-Enter",mac:"Shift-Enter"},exec:function(b){a.up("notebookrunnableeditorwrapper").run()}});b.commands.addCommand({name:"rununtil",bindKey:{win:"Ctrl-Shift-Enter",mac:"Command-Shift-Enter"},exec:function(b){b=a.up("notebookrunnableeditorwrapper");b.up("notebook").runUntil(b)}});
this.setEditor(b);ace.config.loadModule("ace/ext/tern",function(b){a.getEditor().setOptions({enableTern:{defs:a.docs?["browser","ecma5",a.docs]:["ecma5","browser"],plugins:{doc_comment:{fullDocs:!0}},useWorker:!0},enableSnippets:!1,enableBasicAutocompletion:!1})})},removed:function(a,b){a.getEditor()&&a.getEditor().destroy()}},switchModes:function(a){this.setMode("ace/mode/"+a);this.rendered&&this.getEditor().getSession().setMode(this.getMode())},getValue:function(){return this.getEditor().getValue()},
addLineMarker:function(a,b){b=void 0===b?"error":b;a--;this.getEditor().getSession().addMarker(new ace.Range(a,0,a,1),"spyral-editor-"+b,"screenLine",!1)},clearMarkers:function(){var a=this.getEditor().getSession(),b=a.getMarkers(!1),c;for(c in b)-1!==b[c].clazz.indexOf("spyral-editor")&&a.removeMarker(c)}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run","Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{}},constructor:function(a){a.mode="javascript";this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:"ace/mode/"+a.mode});
this.results=Ext.create("Voyant.notebook.editor.SandboxWrapper",{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,listeners:{initialized:function(){this.fireEvent("initialized",this);void 0!==a.output&&this.results.updateHtml(a.output)},scope:this}});Ext.apply(this,{border:!1,dockedItems:[{xtype:"toolbar",dock:"left",defaults:{textAlign:"left"},items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun"},{xtype:"notebookwrapperrununtil"},{xtype:"notebookcodeconfig"}]},
...
Ext.define("Voyant.form.field.File",{extend:"Ext.form.field.File",alias:"widget.voyantfilefield",onFileChange:function(a,b,c){c=c.replace(/^.*(\\|\/|:)/,"");return this.callParent([a,b,c])}});Ext.define("Voyant.notebook.editor.DataWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.FileInput"],alias:"widget.notebookdatawrapper",cls:"notebook-code-wrapper",statics:{i18n:{dataNameAlphanum:"The data name must contain alphanumeric characters only",dataNameAlphastart:"The data name must not begin with a number"}},config:{dataName:void 0},constructor:function(a){a.mode=void 0!==a.mode?a.mode:"json";var b="file"===
a.mode;this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:"ace/mode/"+a.mode,maxLines:12,hidden:b});this.fileInput=Ext.create("Voyant.notebook.editor.FileInput",{resourceId:a.input,hidden:!b});this.results=Ext.create("Voyant.notebook.editor.SandboxWrapper",{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,listeners:{initialized:function(){this.fireEvent("initialized",this);void 0!==a.output&&this.results.updateHtml(a.output)},
scope:this}});Ext.apply(this,{border:!1,dockedItems:[{xtype:"toolbar",dock:"left",defaults:{textAlign:"left"},items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun"},{xtype:"notebookwrapperrununtil"},{xtype:"notebookcodeconfig"},{xtype:"notebookwrapperexport"}]},{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order,name:a.cellId},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],layout:"anchor",defaults:{anchor:"100%"},
items:[this.editor,this.fileInput,{xtype:"form",cls:"notebook-data-input",bodyPadding:6,bodyStyle:"background-color: rgb(252, 252, 252);",layout:{type:"hbox",pack:"center"},items:[{width:350,xtype:"textfield",fieldLabel:"Data Name",labelAlign:"right",name:"dataName",value:a.dataName,validator:function(a){return/^[a-zA-Z0-9_]+$/.test(a)?/^\D/.test(a)?!0:this.localize("dataNameAlphastart"):this.localize("dataNameAlphanum")}.bind(this),allowBlank:!1,listeners:{change:function(a,b,e){a.isValid()?this.setDataName(b):
this.setDataName(void 0)},scope:this}},{width:100,margin:"0 0 0 6",xtype:"button",text:"Assign",handler:function(a){this.up("notebook").setIsEdited(!0);this.run()},scope:this}]},this.results]});this.callParent(arguments)},switchModes:function(a){if("javascript"===a){a=this.up("notebook");var b=this.down("notebookwrappercounter").getOrder();a.addCode("",b,void 0,{mode:"javascript"});a.notebookWrapperRemove(this)}else this.setMode(a),"file"===a?(this.editor.hide(),this.fileInput.show()):(this.fileInput.hide(),
...
'`, "application/xml")';break;case "html":d=b+"\x3d new DOMParser().parseFromString(`"+d+'`, "text/html")'}a.resolve(d)}return a.promise},_run:function(a){var b=new Ext.Deferred,c=this;this._getCode().then(function(d){c.results.clear();"file"!==c.getMode()&&c.editor.clearMarkers();c.setIsRun(!0);c.results.run(d,a).then(function(a){b.resolve(a)},function(a){void 0!==a.error&&void 0!==a.error.row&&c.editor.addLineMarker(a.error.row,"error");b.reject(a)})},function(){b.reject("Error handling data")});
return b.promise},getInput:function(){return"file"!==this.getMode()?this.editor.getValue():this.fileInput.getResourceId()},getContent:function(){var a=this.callParent(arguments);a.dataName=this.getDataName();return a}});Ext.define("Voyant.notebook.github.OctokitWrapper",{extend:"Ext.Base",alias:"octokitwrapper",octokit:void 0,constructor:function(a){this.octokit=new Octokit({auth:a.authToken,userAgent:"https://github.com/sgsinclair/Voyant"})},getInfoForAuthenticatedUser:function(){return this.octokit.users.getAuthenticated()},getReposForAuthenticatedUser:function(a,b,c){return this.octokit.repos.listForAuthenticatedUser({affiliation:void 0===a?"owner":a,page:void 0===b?0:b,per_page:void 0===c?10:c})},getReposForUser:function(a,
...
Ext.define("Voyant.data.model.NotebookMetadata",{extend:"Ext.data.Model",fields:[{name:"title",type:"string"},{name:"author",type:"string"},{name:"description",type:"string"},{name:"keywords",type:"string"},{name:"language",type:"string",defaultValue:"English"},{name:"license",type:"string",defaultValue:"Creative Commons Attribution (CC BY)"},{name:"modified",type:"date"},{name:"created",type:"date"}]});Ext.define("Voyant.notebook.util.FormatConverter",{importFromHtml:function(a){var b=this,c=(new DOMParser).parseFromString(a,"text/html");b.setMetadata(new Spyral.Metadata(c));var d=!1,e=[];c.querySelectorAll("section.notebook-editor-wrapper").forEach(function(c){var f=c.classList;if(f.contains("notebooktexteditorwrapper"))f=c.querySelector(".notebook-text-editor").innerHTML,b.addText(f,void 0,c.id);else if(f.contains("notebookcodeeditorwrapper")||f.contains("notebookdatawrapper")){var k=c.querySelector(".notebook-code-editor-raw");
f=/\beditor-mode-(\w+)\b/.exec(k.className)[1];var h="notebookcodeeditorwrapper";"javascript"!==f&&(h="notebookdatawrapper");h=a.indexOf("\x3csection id\x3d'"+c.id+"' class\x3d'notebook-editor-wrapper "+h+"'\x3e");var l=a.indexOf("\x3cpre class\x3d'notebook-code-editor-raw editor-mode-",h);l=a.indexOf("\x3e",l)+1;var m=a.indexOf("\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results",l);-1===h||-1===l||-1===m?(d=!0,input="javascript"===f?k.innerText:k.innerHTML):input=a.substring(l,m);k=c.querySelector(".notebook-code-results").innerHTML;
h=!1===c.querySelector(".notebook-code-results").classList.contains("collapsed");if("javascript"===f){var n=b.addCode({input:input,output:k,expandResults:h,mode:f},void 0,c.id);e.push(n);n.on("initialized",function(){var a=e.indexOf(n);-1!==a?(e.splice(a,1),0===e.length&&b.fireEvent("notebookInitialized")):console.error("unknown cell initialized",n)})}else{l=c.querySelector(".notebook-code-results .spyral-dv-left").firstChild.data;l=l.split(":")[0];var p=b.addData({input:input,output:k,expandResults:h,
...
scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({listeners:{fileLoaded:function(a){},fileSaved:function(a,c){this.unmask();null!==c&&((a=this.getNotebookId())&&c==a||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1))},saveCancelled:function(){},
...
this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}});this.catalogueWindow=new Voyant.notebook.Catalogue({listeners:{notebookSelected:function(a,c){a.hideWindow();this.clear();this.loadFromId(c);this.setNotebookId(c)},scope:this}})},
init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json",callback:function(a,b,c){b&&(this.spyralTernDocs=Ext.JSON.decode(c.responseText),this.spyralTernDocs.Corpus=this.spyralTernDocs.Spyral.Corpus,this.spyralTernDocs.Table=this.spyralTernDocs.Spyral.Table,this.spyralTernDocs.loadCorpus=this.spyralTernDocs.Spyral.Corpus.load,this.spyralTernDocs.createTable=this.spyralTernDocs.Spyral.Table.create);
a=Ext.Object.fromQueryString(document.location.search,!0);b=Ext.isDefined(a.run);c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname);var d=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(a,b){0==a.trim().indexOf("\x3c")?0===b?this.setMetadata(new Spyral.Metadata({title:a})):this.addText(a):this.addCode(a)},this):a.input?0===a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?(this.loadFromId(c[1]),
this.setStorageSolution("voyant")):d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),this.setIsEdited(!1));if(b){var e=this;Ext.defer(function(){e.runAll()},100)}},scope:this})},clear:function(){this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),
d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()||void 0===this.voyantStorageDialogs.getAccessCode()?"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookId()):this.voyantStorageDialogs.doSave({notebookId:this.getNotebookId(),data:b,metadata:c,accessCode:this.voyantStorageDialogs.getAccessCode()})},getExportUrl:function(a){return location.href},loadFromString:function(a){a=a.trim();if(0===a.indexOf("http"))this.loadFromUrl(a);
else if(0===a.indexOf("{"))this.loadFromJson(a);else if(/^[\w-_]+$/.test(a))this.loadFromId(a);else{if(0!==a.indexOf("\x3c")||-1===a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});this.importFromHtml(a)}return!0},loadFromJson:function(a){try{var b=JSON.parse(a)}catch(d){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+
"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+d+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});this.setMetadata(new Spyral.Metadata(b.metadata));var c=[];b.cells.forEach(function(a){var b=void 0;switch(a.type){case "text":this.addText(a.content,void 0,a.cellId);break;case "code":b=this.addCode(a.content,
void 0,a.cellId);break;case "data":b=this.addData(a.content,void 0,a.cellId)}b&&(b.on("initialized",function(){var a=c.indexOf(b);-1!==a?(c.splice(a,1),0===c.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",b)}.bind(this)),c.push(b))},this)},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",
action:"load",id:a,noCache:1}).then(function(a){b.unmask();b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!==b.getNotebookId()&&b.setNotebookId(a.notebook.id);b.setIsEdited(!1)}).catch(function(a){b.unmask();Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){b.push(c);if(a&&a===c)return!1},
this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(!0,b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,
1);break}});b=b.concat(e);Ext.defer(d._run,100,d,[a,b])},function(a){})}},notebookInitialized:function(){},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&
a===c)return!1;b.push(c.getInput())});return b},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
this.addCode("")},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){d=d||{};d.docs=this.spyralTernDocs;return this._add(a,b,"notebookcodeeditorwrapper",c,d)},addData:function(a,b,c,d){return this._add(a,b,"notebookdatawrapper",c,d)},_add:function(a,b,c,d,e){Ext.isString(a)&&(a={input:a});var f=this.getComponent("cells");b="undefined"===typeof b?f.items.length:b;d="undefined"===typeof d?Spyral.Util.id():d;return f.insert(b,Ext.apply(a,{xtype:c,order:b,
cellId:d},e))},notebookWrapperMoveUp:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);a==b.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,
icon:Ext.MessageBox.WARNING}):(b.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){var b=this.getComponent("cells");b.remove(a);0==b.items.length&&this.addText("(Click to edit).");this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=-1!==a.getXTypes(a).indexOf("notebookrunnableeditorwrapper");(!a&&!b.hasModifier()||a&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),
null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)});this.setIsEdited(!0)},setIsEdited:function(a){this.getHeader()&&(this.getHeader().down("#saveItTool").setDisabled(!1===a),a||(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)})));this.callParent(arguments)},setNotebookId:function(a){if(a&&-1===location.pathname.indexOf("/spyral/"+

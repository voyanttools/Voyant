...
6;break;case "organization":a=2;break;case "misc":a=0;break;case "time":case "date":case "duration":a=4;break;case "money":a=1;break;default:a=8}a=this.getPalettes().d3_set3[a];b&&(a=this.rgbToHex(a));return a},getColorContrast:function(a,b){function c(g){return(0>g?-1:1)*Math.pow(Math.abs(g),2.4)}var d=$jscomp.makeIterator(b);b=d.next().value;var e=d.next().value;var f=d.next().value;d=.2126729*c(b)+.7151522*c(e)+.072175*c(f);a=$jscomp.makeIterator(a);b=a.next().value;e=a.next().value;f=a.next().value;
...
items:b}:void 0,gear:this.showOptionsClick||this.getOptions?{glyph:"xf205@FontAwesome",fn:this.showOptionsClick?this.showOptionsClick:function(g){g.isXType("voyanttabpanel")&&(g=g.getActiveTab());Ext.create("Ext.window.Window",{title:g.localize("optionsTitle"),modal:!0,panel:g,items:{xtype:"form",defaults:{margin:"10 10 10 0"},items:g.getOptions(),listeners:{afterrender:function(h){var k=g.getApiParams(h.getForm().getFields().collect("name"));h.getForm().setValues(k)}},buttons:[{text:g.localize("reset"),
glyph:"xf0e2@FontAwesome",flex:1,panel:g,ui:"default-toolbar",handler:function(h){this.mixins&&this.mixins["Voyant.util.Api"]&&(this.mixins["Voyant.util.Api"].constructor.apply(this),this.getCorpus&&this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));h.up("window").close()},scope:g},{xtype:"tbfill"},{text:g.localize("cancelTitle"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(h){h.up("window").close()}},{text:g.localize("confirmTitle"),glyph:"xf00c@FontAwesome",
flex:1,panel:g,handler:function(h){var k=h.up("form").getValues();this.setApiParams(k);var l=this.getApplication(),m=[];void 0!==k.stopList&&void 0!==k.stopListGlobal&&k.stopListGlobal&&m.push(["stopList",k.stopList]);void 0!==k.termColors&&void 0!==k.termColorsGlobal&&k.termColorsGlobal&&m.push(["termColors",k.termColors]);var n=new Ext.Deferred;k.categories&&""!==k.categories?l.loadCategoryData(k.categories).then(function(){},function(){k.categories=void 0}).finally(function(){m.push(["categories",
k.categories]);n.resolve()}):n.resolve();var u=new Ext.Deferred;void 0!==k.palette?(l.resetColorTermAssociations(),0===l.getColorPalette(k.palette).length?l.loadCustomColorPalette(k.palette).then(function(){},function(){k.palette="default"}).always(function(){m.push(["palette",k.palette]);u.resolve()}):(m.push(["palette",k.palette]),u.resolve())):u.resolve();Ext.Promise.all([n,u]).then(function(){var w=l.getCorpus();if(0<m.length){var p=l.getViewport().query("panel,chart");m.forEach(function(q){var r=
q[0];q=q[1];l.setApiParam&&l.setApiParam(r,q);for(var v=0;v<p.length;v++)p[v].setApiParam&&p[v].setApiParam(r,q)});w?l.dispatchEvent("loadedCorpus",this,w):l.dispatchEvent("apiParamsUpdated",this,k)}w?this.fireEvent("loadedCorpus",this,w):this.fireEvent("apiParamsUpdated",this,k);h.up("window").close()}.bind(this))},scope:g}]}}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}};c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);
...
confirmRemove:"Are you sure you want to remove the category?",save:"Save",features:"Features",category:"Category",increaseCategory:"Increase Category Priority",decreaseCategory:"Decrease Category Priority",setColorsFromPalette:"Set Colors From Palette",color:"Color",font:"Font",orientation:"Orientation"},api:{stopList:"auto",query:void 0},features:{color:{xtype:"colorfield",format:"#hex6"},font:{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",store:{fields:["name","value"],
data:Voyant.widget.FontFamilyOption.fonts}},orientation:{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",store:{fields:["name","value"],data:[{name:"Horizontal",value:0},{name:"Vertical",value:90}]}}}},config:{corpus:void 0,builderWin:void 0,addCategoryWin:void 0,categoriesId:void 0},closeAction:"hide",modal:!0,height:250,width:500,constructor:function(a){a=a||{};a.panel?(this.panel=a.panel,this.app=this.panel.getApplication(),this.categoriesManager=this.app.getCategoriesManager()):
console.warn("CategoriesBuilder cannot find panel!");a.height=.75*this.app.getViewport().getHeight();a.width=.75*this.app.getViewport().getWidth();this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(){Ext.apply(this,{header:!1,layout:"fit",onEsc:Ext.emptyFn,items:{xtype:"tabpanel",title:this.localize("title"),tabBarHeaderPosition:1,items:[{layout:"border",title:this.localize("categories"),items:[{title:this.localize("terms"),split:!0,
width:250,region:"west",layout:"fit",items:{itemId:"terms",xtype:"grid",store:Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",copy:!0,enableDrop:!1,dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});a=a.substr(0,a.length-2);20<a.length&&(a=a.substr(0,20)+"...");return a}}}},selModel:{mode:"MULTI"},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,
sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),dataIndex:"relativeFreq",renderer:function(a){return Ext.util.Format.number(1E6*a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);a=this.queryById("terms").getStore();a.removeAll();a.load()},scope:this}}},
{title:this.localize("categories"),itemId:"categories",region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"textfield",fieldLabel:"Category Filter",labelAlign:"right",enableKeyEvents:!0,listeners:{keyup:function(a,b){var c=a.getValue().trim();this.queryById("categories").query("grid").forEach(function(d){""===c?d.getStore().clearFilter():d.getStore().filter("term",c)},this)},scope:this}},
...
bins:2*parseInt(this.getApiParam("limit"))},callback:function(d,e,f){f&&d&&0<d.length&&(d=d.map(function(g){return g.getDistributions()}).reduce(function(g,h){return g.concat(h)}),this.down("#distLine").setValues(d),c.unmask())},scope:this})},scope:this}});this.addSection(this.localize("collocates"),this.getCollocatesStore(),this.getApiParams(),'\x3ctpl for\x3d"." between\x3d"; "\x3e\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"corpus-type keyword" voyant:recordId\x3d"{term}"\x3e{term}\x3c/a\x3e\x3cspan style\x3d"font-size: smaller"\x3e ({val})\x3c/span\x3e\x3c/tpl\x3e',
...
function(){this.getStore().getCorpus()&&this.getStore().load()},this);a.on("query",function(b,c){this.setApiParam("query",c);this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCreator",{extend:"Ext.form.Panel",requires:["Ext.form.field.File"],mixins:["Voyant.panel.Panel"],alias:"widget.corpuscreator",isConsumptive:!0,statics:{i18n:{corpusSortInitialOrder:"initial order",dtocIndexDoc:"DToC Index Document",groupByColumn:"Group By Column",groupByColumnText:"Specify a column (or columns) by which to group documents. Only applicable when extracting documents from cells in each row."},api:{inputFormat:void 0,language:void 0,xmlDocumentsXpath:void 0,
xmlGroupByXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0,xmlPubDateXpath:void 0,xmlPublisherXpath:void 0,xmlPubPlaceXpath:void 0,xmlKeywordXpath:void 0,xmlCollectionXpath:void 0,xmlExtraMetadataXpath:void 0,htmlGroupByQuery:void 0,htmlDocumentsQuery:void 0,htmlContentQuery:void 0,htmlTitleQuery:void 0,htmlAuthorQuery:void 0,htmlPubDateQuery:void 0,htmlPublisherQuery:void 0,htmlPubPlaceQuery:void 0,htmlKeywordsQuery:void 0,htmlCollectionQuery:void 0,htmlExtraMetadataQuery:void 0,
jsonDocumentsPointer:void 0,jsonContentPointer:void 0,jsonTitlePointer:void 0,jsonAuthorPointer:void 0,jsonPubDatePointer:void 0,jsonPublisherPointer:void 0,jsonPubPlacePointer:void 0,jsonKeywordsPointer:void 0,jsonCollectionPointer:void 0,jsonExtraMetadataPointer:void 0,tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableGroupBy:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,tablePubDate:void 0,tablePublisher:void 0,tablePubPlace:void 0,
tableKeywords:void 0,tableCollection:void 0,tableExtraMetadata:void 0,title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0,sort:void 0,dtocIndexDoc:-1}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),
width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,layout:{type:"vbox",align:"stretch"},dockedItems:[{xtype:"toolbar",overflowHandler:"scroller",dock:"bottom",buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,items:{xtype:"corpusselector",
margin:10},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:a.localize("SelectExisting"),message:a.localize("PleaseSelectExisting"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},flex:1},{text:a.localize("cancel"),glyph:"xf00d@FontAwesome",flex:1,handler:function(b){b.up("window").close()}}]}}).show()}},{xtype:"fileuploadfield",
glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:a.localize("Upload"),listeners:{render:function(b){b.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},beforedestroy:function(b){Ext.tip.QuickTipManager.unregister(b.getEl())},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){c=b.fileInputEl.dom.files;for(var e=/\.(png|gif|jpe?g|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,
...
"\x3c/p\x3e"}))});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"},c=this.getApiParams();this.getCorpus()?Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0}):delete c.corpus;delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(e,f){d.unmask();f.result&&(f.result.corpus||f.result.stepEnabledCorpusCreator)?
(e={corpus:f.result.corpus?f.result.corpus.metadata.id:f.result.stepEnabledCorpusCreator.storedId},Ext.applyIf(e,c),this.setCorpus(void 0),this.loadCorpus(e)):this.showResponseError("Unable to load corpus.",f.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){if(void 0===a.optionsWin){var b=["bo"].concat(Object.keys(Voyant.widget.StopListOption.stoplists).filter(function(c){return"mu"!==
c})).sort().map(function(c){return[c,a._localizeClass(Voyant.widget.StopListOption,c)]});b.unshift(["",a._localizeClass(Voyant.widget.StopListOption,"auto")]);a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,anchor:"100% 100%",items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-120,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",
fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(c){var d=this.getApiParam("inputFormat");d&&c.setValue(d)},scope:a},change:{fn:function(c,d,e){c=c.up("form").down("[name\x3ddtocIndexDoc]");"dtoc"===d?c.show():c.hide()},scope:a}}},
...
value:""},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableNoHeadersRowText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableNoHeadersRow"),xtype:"checkboxfield",name:"tableNoHeadersRow",inputValue:"true"},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableContentText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableContent"),validator:function(c){return a.validatePositiveNumbersCsv.call(a,c)},name:"tableContent"},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+
a.localize("groupByColumnText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("groupByColumn"),validator:function(c){return a.validatePositiveNumbersCsv.call(a,c)},name:"tableGroupBy"},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableMetadataText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableAuthor"),validator:function(c){return a.validatePositiveNumbersCsv.call(a,c)},name:"tableAuthor"},{fieldLabel:a.localize("tableTitle"),validator:function(c){return a.validatePositiveNumbersCsv.call(a,
c)},name:"tableTitle"},{xtype:"fieldset",title:a.localize("xmlAdditionalOptions"),collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{fieldLabel:a.localize("xpathPubDate"),name:"tablePubDate"},{fieldLabel:a.localize("xpathPublisher"),name:"tablePublisher"},{fieldLabel:a.localize("xpathPubPlace"),name:"tablePubPlace"},{fieldLabel:a.localize("xpathKeywords"),name:"tableKeywords"},{fieldLabel:a.localize("xpathCollection"),name:"tableCollection"},{xtype:"textareafield",grow:!0,fieldLabel:a.localize("xpathExtra"),
...
else this.on("afterrender",function(){this.store.load({params:this.getApiParams()})},this);e=this.getApplication();if(!1===this.hasCorpusAccess(f)||!1===e.getAllowDownload())this.queryById("modifyButton").hide(),this.queryById("downloadButton").hide()});this.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load({params:this.getApiParams()})},this);this.on("query",function(e,f){this.setApiParam("query",f);this.store.load({params:this.getApiParams()})});a.embedded&&("Voyant.data.model.Corpus"==
Ext.getClass(a.embedded).getName()?a.corpus=a.embedded:"Voyant.data.store.Documents"==Ext.getClass(a.embedded).getName()&&(this.store.setRecords(a.embedded.getData()),a.corpus=a.embedded.getCorpus()));a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus)},keepRemoveReorderHandler:function(a){var b=a.up("window").down("documents"),c=b.getSelection(),d=b.getStore().getCorpus().getDocumentsCount(),e=a.getItemId();if("reorder"==e){if(b.getStore().getCount()<d)return Ext.Msg.show({title:this.localize("error"),
...
removed:function(a,b){a.getEditor()&&a.setEditor(void 0)}},getHintForTool:function(a,b,c,d){},_getModeConfig:function(a){switch(a){case "json":a={name:"javascript",json:!0};break;case "xml":a="xml";break;default:a="javascript"}return a},_setModeOptions:function(a){var b={};switch(a){case "json":case "javascript":b.autoCloseBrackets=!0;b.matchBrackets=!0;break;default:b.autoCloseBrackets=!1,b.matchBrackets=!1}for(var c in b)this.getEditor().setOption(c,b[c])},switchModes:function(a){console.log("mode",
...
api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0}},config:{notebookId:void 0,notebookName:void 0,metadata:void 0,isEdited:!1,version:"3.0",storageSolution:"voyant"},NOTEBOOK_ID_SEPARATOR:"_",SPYRAL_ID_REGEX:/\/spyral\/(.*?@[a-z]{2})[\/_]([A-Za-z0-9-]+)\/?$/,SPYRAL_ID_REGEX_OLD:/\/spyral\/([\w-]+)\/?$/,metadataWindow:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0,catalogueWindow:void 0,docsWindow:void 0,spyralTernDocs:void 0,ecmaTernDocs:void 0,browserTernDocs:void 0,toolTernDocs:void 0,
...
Ext.Date.format(a,"F j, Y")+", "+b+'.\x3c/div\x3e\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eAPA\x3c/legend\x3e\x3cdiv class\x3d"x-selectable"\x3e'+d+". ("+Ext.Date.format(a,"Y")+"). "+c+". \x3ci\x3eSpyral - Voyant Tools\x3c/i\x3e, Development led by St\u00e9fan Sinclair and Geoffrey Rockwell. Retrieved "+Ext.Date.format(a,"F j, Y")+", from "+b+"\x3c/div\x3e\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},loadFromQueryParams:function(){var a=Ext.Object.fromQueryString(document.location.search,
...
[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(f){for(var g=0;g<b.length;g++)if(f.name===b[g].name){b.splice(g,1);break}});b=b.concat(e);Ext.defer(d._run,
...
"var "+c.name+" \x3d new "+c.isSpyralClass+"()"):Spyral.Util.blobToString(c.value).then(function(d){Voyant.notebook.editor.CodeEditor.ternServer.server.addFile(c.name,"var "+c.name+" \x3d "+d)})}))},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(d){for(var e=0;e<b.length;e++)if(d.name===b[e].name){b.splice(e,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=
[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});return b},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"Spyral Notebook",language:"English"}));this.addText(this.localize("newNotebookIntro"));this.addCode("")},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){d=d||{};d.docs=[this.ecmaTernDocs,this.browserTernDocs,this.spyralTernDocs];return this._add(a,b,"notebookcodeeditorwrapper",
...
this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=-1!==a.getXTypes(a).indexOf("notebookrunnableeditorwrapper");(!a&&!b.hasModifier()||a&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookeditorwrapper").forEach(function(a,b){a.setIndex(b)});this.setIsEdited(!0)},applyIsEdited:function(a){this.rendered&&!a&&(this.query("notebookcodeeditor").forEach(function(b){b.setIsChangeRegistered(!1)}),
this.query("notebooktexteditor").forEach(function(b){b.setIsEditRegistered(!1)}));return a},applyNotebookId:function(a){if(!1===this.isConfiguring){var b=this.getBaseUrl()+"spyral/";if(a){if(-1===a.indexOf(this.NOTEBOOK_ID_SEPARATOR))this.setNotebookName(a);else{var c=a.split(this.NOTEBOOK_ID_SEPARATOR)[1];this.setNotebookName(c)}b+=a.replace(this.NOTEBOOK_ID_SEPARATOR,"/")+"/"}window.history.pushState({url:b},"",b)}return a},applyMetadata:function(a){void 0!==a&&(a.title=a.title.replace(/<\/?\w+.*?>/g,
""),a.description=a.description.replace(/<\/?\w+.*?>/g,""),this.isAuthenticated()&&""===a.userId&&""===a.author&&(a.userId=this.accountInfo.id,a.author=this.accountInfo.name));return a},updateMetadata:function(){var a=this.getMetadata();document.title=a.title+" - Spyral";this.getComponent("spyralHeader").update(this.getInnerHeaderHtml());this.getComponent("spyralFooter").update(this.getInnerFooterHtml());this.metadataEditor&&this.metadataEditor.loadMetadata(a);this.setIsEdited(!0)},showMetadataEditor:function(){if(void 0===

...
NOTEBOOK_ID_SEPARATOR:"_",SPYRAL_ID_REGEX:/\/spyral\/(.*?@[a-z]{2})[\/_]([A-Za-z0-9-]+)\/?$/,SPYRAL_ID_REGEX_OLD:/\/spyral\/([\w-]+)\/?$/,metadataWindow:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0,catalogueWindow:void 0,docsWindow:void 0,spyralTernDocs:void 0,ecmaTernDocs:void 0,browserTernDocs:void 0,constructor:function(a){var b=function(){parent.setMetadata(parent.getMetadata().clone());parent.setIsEdited(!1);parent.toastInfo({html:parent.localize("signInSuccess"),anchor:"tr"})};Ext.apply(a,
{title:this.localize("title"),includeTools:{help:!0,gear:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",callback:function(c,d){d.toolMenu&&d.toolMenu.destroy();d.items=[];c.isAuthenticated(!0).then(function(e){d.items=e?[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:c.showSaveDialog.bind(c,!1),scope:c},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:c.showSaveDialog.bind(c,!0),scope:c}]:[c.getGitHubAuthButton(b)]},
function(){d.items=[c.getGitHubAuthButton(b)]}).always(function(){d.showToolMenu()})}},"new":{tooltip:this.localize("newTip"),callback:function(){var c=this.getBaseUrl()+"spyral/";this.getApplication().openUrl(c)},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),xtype:"toolmenu",glyph:"xf115@FontAwesome",callback:function(c,d){c=this.getStorageSolution();void 0!==c&&("github"===c?this.githubDialogs.showLoad():this.voyantStorageDialogs.showLoad())},scope:this},
runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),callback:this.showMetadataEditor,xtype:"toolmenu",glyph:"xf02c@FontAwesome",scope:this},catalogue:{tooltip:this.localize("catalogueTip"),callback:function(){this.catalogueWindow.showWindow()},xtype:"toolmenu",glyph:"xf00b@FontAwesome",scope:this},account:{xtype:"toolmenu",glyph:"xf007@FontAwesome",callback:function(c,d){d.toolMenu&&d.toolMenu.destroy();
d.items=[];c.isAuthenticated(!0).then(function(e){e?c.showAccountWindow():d.items=[c.getGitHubAuthButton(b)]},function(){d.items=[c.getGitHubAuthButton(b)]}).always(function(){d.showToolMenu()})}}},scrollable:!0,layout:{type:"vbox",align:"middle",padding:"50 0"},defaults:{width:"100%",maxWidth:1100},items:[{itemId:"spyralHeader",cls:"spyral-header",listeners:{afterrender:function(c){Ext.tip.QuickTipManager.register({target:c.getId(),text:this.localize("clickToEdit")});c.getTargetEl().on("click",function(d){this.showMetadataEditor();
c.removeCls("editable")},this);c.mon(c.getEl(),"mouseover",function(){c.addCls("editable")});c.mon(c.getEl(),"mouseout",function(){c.removeCls("editable")})},scope:this}},{xtype:"container",itemId:"cells",defaults:{margin:"10 0 10 0",padding:"0 50 0 50"}},{itemId:"spyralFooter",cls:"spyral-footer",listeners:{afterrender:function(c){Ext.tip.QuickTipManager.register({target:c.getId(),text:this.localize("clickToEdit")});c.getTargetEl().on("click",function(d){this.showMetadataEditor();c.removeCls("editable")},
this);c.mon(c.getEl(),"mouseover",function(){c.addCls("editable")});c.mon(c.getEl(),"mouseout",function(){c.removeCls("editable")})},scope:this}}],helpToolClick:this.showDocs.bind(this),listeners:{afterrender:this.init,notebookWrapperMoveUp:this.notebookWrapperMoveUp,notebookWrapperMoveDown:this.notebookWrapperMoveDown,notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,notebookInitialized:this.notebookInitialized,notebookSelected:this.handleNotebookSelected,
scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({notebookParent:this,listeners:{fileLoaded:function(c){this.checkIsEditedAndDoCallback(this,function(){this.loadFromString(c)})},fileSaved:function(c,d,e){this.unmask();null!==d?((c=this.getNotebookId())&&d==c||this.setNotebookId(d),this.toastInfo({html:this.localize("saved"),
anchor:"tr"}),this.setIsEdited(!1)):this.showError("There was an error saving your notebook:\n"+e)},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({parent:this,listeners:{fileLoaded:function(c,d){c=d.owner;var e=d.repo,f=d.path;d=d.file;this.githubDialogs.close();this.loadFromString(d);d=encodeURIComponent(c+"/"+e+"/"+f);-1===location.search.indexOf(d)&&(c=this.getBaseUrl()+"spyral/?githubId\x3d"+d,window.history.pushState({url:c},
"Spyral Notebook: "+d,c))},fileSaved:function(c,d){c=d.owner;var e=d.repo;d=d.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);d=encodeURIComponent(c+"/"+e+"/"+d);-1===location.search.indexOf(d)&&(c=this.getBaseUrl()+"spyral/?githubId\x3d"+d,window.history.pushState({url:c},"Spyral Notebook: "+d,c))},saveCancelled:function(c){this.unmask()},scope:this}});this.catalogueWindow=new Voyant.notebook.Catalogue({listeners:{notebookSelected:this.handleNotebookSelected,
scope:this}})},init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Promise.all([Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/ecmascript.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/browser.json"})]).then(function(a){this.spyralTernDocs=Ext.JSON.decode(a[0].responseText);this.ecmaTernDocs=
Ext.JSON.decode(a[1].responseText);this.browserTernDocs=Ext.JSON.decode(a[2].responseText);this.loadFromQueryParams()}.bind(this),function(){this.loadFromQueryParams()}.bind(this));this.retrieveAccountInfo()},reset:function(){this.getScrollable().scrollTo(0,0);this.getScrollable().trackingScrollTop=0;this.getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));
this.getMetadata().setDateNow("modified");this.getMetadata().set({userId:this.accountInfo.id});this.updateCachedOutput().then(function(b){},function(b){console.warn("Error updating cached results")}).finally(function(){var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()?"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookName()):this.voyantStorageDialogs.doSave({notebookName:this.getNotebookName(),
data:b,metadata:c})}.bind(this))},updateCachedOutput:function(){return Ext.Promise.all(this.query("notebookrunnableeditorwrapper").map(function(a){return a.results.updateCachedOutput()}))},exportToolClick:function(a){a.mask(a.localize("preparingExport"));a.updateCachedOutput().finally(function(){a.unmask();a.mixins["Voyant.util.Toolable"].exportToolClick.call(this,a)})},getExportUrl:function(a){return location.href},loadFromQueryParams:function(){var a=Ext.Object.fromQueryString(document.location.search,
!0),b=Ext.isDefined(a.run),c=this.SPYRAL_ID_REGEX.exec(location.pathname),d=this.SPYRAL_ID_REGEX_OLD.exec(location.pathname),e=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(g,h){0==g.trim().indexOf("\x3c")?0===h?this.setMetadata(new Spyral.Metadata({title:g})):this.addText(g):this.addCode(g)},this):c?(this.loadFromId(c[1]+this.NOTEBOOK_ID_SEPARATOR+c[2]),this.setStorageSolution("voyant")):d?(this.loadFromId(d[1]),
this.setStorageSolution("voyant")):e?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),this.setIsEdited(!1));if(b){var f=this;Ext.defer(function(){f.runAll()},100)}},loadFromString:function(a){a=a.trim();if(0===a.indexOf("{"))this.loadFromJson(a);else if(this.SPYRAL_ID_REGEX.test("/spyral/"+a)){var b=this.SPYRAL_ID_REGEX.exec("/spyral/"+a);this.loadFromId(b[1]+this.NOTEBOOK_ID_SEPARATOR+b[2])}else{if(0!==a.indexOf("\x3c")||-1===a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),
msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setNotebookId(void 0);try{this.importFromHtml(a)}catch(c){Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}},this)}return!0},loadFromJson:function(a){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+
"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setMetadata(new Spyral.Metadata(b.metadata));var c=[];b.cells.forEach(function(d){var e=void 0;switch(d.type){case "text":this.addText(d.content,void 0,
d.cellId);break;case "code":e=this.addCode(d.content,void 0,d.cellId);break;case "data":e=this.addData(d.content,void 0,d.cellId)}e&&(e.on("initialized",function(){var f=c.indexOf(e);-1!==f?(c.splice(f,1),0===c.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",e)}.bind(this)),c.push(e))},this)},this)},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(c){b.unmask();
c.notebook.success?(b.loadFromString(c.notebook.data),c.notebook.id&&c.notebook.id!==b.getNotebookId()&&b.setNotebookId(c.notebook.id),b.setIsEdited(!1)):Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:c.notebook.error,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}).catch(function(c){b.unmask();Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},checkIsEditedAndDoCallback:function(a,
b){this.getIsEdited()?Ext.Msg.show({title:this.localize("openTitle"),message:this.localize("notSavedWarning"),buttons:Ext.Msg.YESNO,icon:Ext.Msg.QUESTION,fn:function(c){"yes"===c&&b.call(a)},scope:this}):b.call(a)},handleNotebookSelected:function(a,b,c){this.checkIsEditedAndDoCallback(a,function(){c.call(a);this.loadFromId(b)}.bind(this))},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){b.push(c);if(a&&a===c)return!1},this);this._run(b)},runFrom:function(a){var b=
[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(!0,b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(f){for(var g=0;g<b.length;g++)if(f.name===b[g].name){b.splice(g,1);break}});b=b.concat(e);Ext.defer(d._run,
100,d,[a,b])},function(e){})}else this.updateTernServerVariables(this.getNotebookVariables()),this.fireEvent("notebookRun",this)},notebookInitialized:function(){},updateTernServerVariables:function(a,b){Voyant.notebook.editor.CodeEditor.ternServer&&(b&&b.forEach(function(c){Voyant.notebook.editor.CodeEditor.ternServer.server.delFile(c.name)}),void 0===a?console.warn("updateTernServerVariables: no varsToAdd!"):a.forEach(function(c){c.isSpyralClass&&Voyant.notebook.editor.CodeEditor.ternServer.server.addFile(c.name,
"var "+c.name+" \x3d new "+c.isSpyralClass+"()")}))},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(d){for(var e=0;e<b.length;e++)if(d.name===b[e].name){b.splice(e,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});return b},

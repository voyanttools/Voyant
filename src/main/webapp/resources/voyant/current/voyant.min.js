...
hexToRgb:function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,d,e){return c+c+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]:null},addColorPalette:function(a,b){this.getPalettes()[a]=b},getColorPalette:function(a,b){a=a||"default";a=this.getPalettes()[a];void 0===a&&(a=[]);if(b){b=[];for(var c=0;c<a.length;c++)b.push(this.rgbToHex(a[c]));return b}return a},getColor:function(a,b,c){a=a||"default";a=
this.getPalettes()[a];b>=a.length&&(b%=a.length);return c?this.rgbToHex(a[b]):a[b]},getColorForTerm:function(a,b,c){a=a||"default";a=this.getPalettes()[a];-1!=b.indexOf(":")&&(b=b.split(":")[1]);var d=this.getColorTermAssociations().get(b);null==d&&(d=this.getColorTermAssociations().getCount()%a.length,d=a[d],this.getColorTermAssociations().add(b,d));c&&(d=this.rgbToHex(d));return d},setColorForTerm:function(a,b){!1===Array.isArray(b)&&(b=this.hexToRgb(b));this.getColorTermAssociations().replace(a,
b)},getColorForEntityType:function(a,b){switch(a){case "person":a=5;break;case "location":a=6;break;case "organization":a=2;break;case "misc":a=0;break;case "time":case "date":case "duration":a=4;break;case "money":a=1;break;default:a=8}a=this.getPalettes().d3_set3[a];b&&(a=this.rgbToHex(a));return a}});Ext.define("Voyant.util.Deferrable",{deferredStack:[],releaseAllDeferred:function(){this.deferredStack=[]},getDeferredCount:function(){return this.deferredStack.length},getDeferred:function(a){var b=new Ext.Deferred;a&&a.transfer&&a.transfer(a,b.promise);!b.promise.show&&window.show&&(b.promise.show=show);this.deferredStack.push(b);var c=this;b.promise.always(function(){c.deferredStack.pop()});return b},getPromiseFromDeferred:function(a){return"object"===typeof a.promise?a.promise:a.promise()},getDeferredNestedPromise:function(a,
...
boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")},{xtype:"radio",name:"export",inputValue:"spyral",boxLabel:a.localize("exportViewSpyral")}];a.isXType("notebook")&&c.splice(2,1);a.getExtraExportItems&&a.getExtraExportItems().forEach(function(a){Ext.applyIf(a,{xtype:"radio",name:"export"});c.push(a)});b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+
a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:c});if(a.isXType("grid")){var d=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}];a.getExportGridAll&&
0==a.getExportGridAll()||d.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:d})}a.getExportVisualization&&!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))||
(d=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},{xtype:"slider",width:200,value:1,minValue:.5,maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),listeners:{change:function(b,c){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([c]))},changecomplete:function(a){a.previousSibling().setValue(!0)}}}],a.getTargetEl().dom.querySelector("svg")&&d.push({xtype:"radio",
...
icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(a,b){var c=1;b&&(b.mask(a.localize("loading")),(a=b.queryById("scale"))&&a.getValue&&(c=a.getValue()));var d=this.down("draw")||this.down("chart");if(d&&(d.isChart||d.isCanvas)){var e=d.innerElement.getSize();a=Array.prototype.slice.call(d.items.items);var f=d.surfaceZIndexes,g;for(g=1;g<a.length;g++){var h=a[g];var k=f[h.type];for(d=g-1;0<=d&&f[a[d].type]>k;)a[d+1]=a[d],d--;a[d+1]=h}var l=document.createElement("canvas");
f=Ext.getClassName(a[0]);c*=a[0].devicePixelRatio;var m=l.getContext("2d");l.width=Math.ceil(e.width*c);l.height=Math.ceil(e.height*c);for(d=0;d<a.length;d++)if(h=a[d],Ext.getClassName(h)===f)for(e=h.getRect(),surfaceSize=h.el.getSize(),g=0;g<h.canvases.length;g++){var n=h.canvases[g];k=n.getOffsetsTo(n.getParent());m.drawImage(n.dom,(e[0]+k[0])*c,(e[1]+k[1])*c,surfaceSize.width*c,surfaceSize.height*c)}b&&b.isVisible()&&b.unmask();return this.exportPngData(l.toDataURL())}d=this.getTargetEl().dom;
if(n=d.querySelector("canvas")){if(1==c)return c=n.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);l=document.createElement("canvas");m=l.getContext("2d");l.width=Math.ceil(n.width*c);l.height=Math.ceil(n.height*c);var p=new Image;p.src=n.toDataURL("image/png");p.panel=this;p.onload=function(){m.drawImage(p,0,0,l.width,l.height);q=l.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,q)}}else if(g=d.querySelector("svg")){a=d.offsetWidth*
c;d=d.offsetHeight*c;g=g.cloneNode(!0);g.setAttribute("version",1.1);g.setAttribute("xmlns","http://www.w3.org/2000/svg");g.setAttribute("width",a);g.setAttribute("height",d);for(h=[];0<g.children.length;)h.push(g.removeChild(g.children[0]));var r=document.createElement("g");r.setAttribute("style","transform-box: fill-box;");r.setAttribute("transform","scale("+c+")");g.appendChild(r);h.forEach(function(a){r.appendChild(a)});var q="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(g.outerHTML)));
n=Ext.DomHelper.createDom({tag:"canvas",width:a,height:d});var u=n.getContext("2d");p=new Image;p.src=q;p.panel=this;p.onload=function(){u.drawImage(p,0,0);q=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,q)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=0==this.isXType("voyantheader");Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,
icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+
...
buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){cells=[];e.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/\s+/g," "));cells.push(b)});f+=cells.join("\t")+"\n"}b=a.getStore();var d=b.getFields(),e=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(a){return a.dataIndex&&0<a.dataIndex.trim().length});d=[];e.forEach(function(a){d.push(a.text)});var f=d.join("\t")+"\n";
b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:f})},exportGridCurrentHtml:function(a,b){function c(a){d+="\t\t\x3ctr\x3e\n";e.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/>/g,"\x26lg;"));d+="\t\t\t\x3ctd\x3e"+b+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n"}b=a.getStore();b.getFields();
var d="\x3ctable\x3e\n\t\x3cthead\x3e\n\t\t\x3ctr\x3e\n",e=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(a){return a.dataIndex&&0<a.dataIndex.trim().length});e.forEach(function(a){d+="\t\t\t\x3ctd\x3e"+a.text+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";b.buffered?b.data.forEach(c):b.each(c);d+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,
icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d})},exportGridAllJson:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllJsonWarning"),function(b){"yes"==b&&(b={start:0},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},exportGridAllTsv:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllTsvWarning"),function(b){"yes"==b&&(b={start:0,template:this.getXType()+
"2tsv",outputFormat:"text"},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},getExportUrl:function(a){var b=this.getApplication().getModifiedApiParams(),c=Ext.getClassName(this).split(".").pop();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),a||(b.view=c));b.corpus||(b.corpus=this.getApplication().getCorpus().getAliasOrId());return this.getApplication().getBaseUrl()+(a?"tool/"+
...
function(a){return a.target.x}).attr("y2",function(a){return a.target.y});this.getNodes().attr("transform",function(a){var b=a.x,c=a.y;if(this.getNetworkMode()===this.DEFAULT_MODE||"keyword"!==a.type)b-=.5*a.bbox.width,c-=.5*a.bbox.height;return"translate("+b+","+c+")"}.bind(this));!this.getDragging()&&.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("id",
...
this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(a){return"keyword"===a.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",function(b){return a.getApplication().getCategoriesManager().getFeatureForTerm("font",b.term)}).attr("font-size",function(a){return Math.max(10,Math.sqrt(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor",
"pointer").style("user-select","none").attr("dominant-baseline","middle");this.setNodes(e.merge(d));this.getNetworkMode()===this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",function(a){return a.bbox.width+16}).attr("height",function(a){return a.bbox.height+8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",function(a){return Math.max(2,.2*a.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*
a.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(a){return Math.min(150,a.bbox.width)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",function(a){return"keyword"===a.type?.5*-a.bbox.width:8}).attr("dy",function(a){return"keyword"===a.type?0:.5*a.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},isOffCanvas:function(a,
...
b;a.style("fill",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].fill}.bind(this));a.style("stroke",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].stroke}.bind(this))},applyLinkStyle:function(a,b){var c=void 0===b?"normal":b;a.style("stroke",function(a){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(a){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},linkMouseOver:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));
...
b);f<d;)e.push(a.slice(f,f+=c));else if(c)for(;f<d;)c=Math.ceil((d-f)/b--),e.push(a.slice(f,f+=c));else{b--;c=Math.floor(d/b);for(0===d%c&&c--;f<c*b;)e.push(a.slice(f,f+=c));e.push(a.slice(c*b))}return e},initComponent:function(){this.callParent(arguments)}});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.rezoviz",statics:{i18n:{timedOut:"The entities call took too long and has timed out. Retry?",maxLinks:"Max. Links"},api:{query:void 0,mode:void 0,limit:50,type:["organization","location","person"],minEdgeCount:2,terms:void 0,stopList:"auto",docId:void 0},glyph:"xf1e0@FontAwesome"},config:{nodeData:void 0,linkData:void 0,visId:void 0,vis:void 0,visLayout:void 0,nodes:void 0,links:void 0,zoom:void 0,
dragging:!1,currentNode:void 0,graphStyle:{link:{normal:{stroke:"#000000",strokeOpacity:.1},highlight:{stroke:"#000000",strokeOpacity:.5}}},graphPhysics:{damping:.4,centralGravity:.1,nodeGravity:-50,springLength:100,springStrength:.1,collisionScale:1.25},options:[{xtype:"stoplistoption"}]},constructor:function(a){this.setNodeData([]);this.setLinkData([]);this.setVisId(Ext.id(null,"rezoviz_"));this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=
this,b={};["person","location","organization"].forEach(function(c){var d=a.getApplication().getColorForEntityType(c,!0),e=d3.hsl(d);e.s*=.85;e.l*=1.15;var f=d3.hsl(d);f.s*=.85;var g=d3.hsl(d);d=d3.hsl(d);d.l*=.75;b[c+"Node"]={normal:{fill:e.toString(),stroke:f.toString()},highlight:{fill:g.toString(),stroke:d.toString()}}});this.setGraphStyle(Ext.apply(this.getGraphStyle(),b));Ext.apply(a,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"corpusdocumentselector"},
{xtype:"button",text:this.localize("categories"),menu:{items:[{xtype:"menucheckitem",text:this.localize("people"),itemId:"person",checked:!0},{xtype:"menucheckitem",text:this.localize("locations"),itemId:"location",checked:!0},{xtype:"menucheckitem",text:this.localize("organizations"),itemId:"organization",checked:!0},{xtype:"button",text:this.localize("reload"),style:"margin: 5px;",handler:this.categoriesHandler,scope:this}]}},{xtype:"numberfield",itemId:"minEdgeCount",fieldLabel:this.localize("minEdgeCount"),
labelAlign:"right",labelWidth:120,width:170,maxValue:10,minValue:1,allowDecimals:!1,allowExponential:!1,allowOnlyWhitespace:!1,listeners:{render:function(a){a.setRawValue(this.getApiParam("minEdgeCount"))},change:function(a,b){a.isValid()&&(this.setApiParam("minEdgeCount",b),this.preloadEntities())},scope:this}},{xtype:"slider",fieldLabel:this.localize("maxLinks"),labelAlign:"right",labelWidth:100,width:170,minValue:10,maxValue:1E3,increment:10,listeners:{render:function(a){a.setValue(this.getApiParam("limit"))},
changecomplete:function(a,b){this.setApiParam("limit",b);this.preloadEntities()},scope:this}}]}]});this.on("loadedCorpus",function(a,b){this.isVisible()&&this.initLoad()},this);this.on("corpusSelected",function(a,b){this.setApiParam("docId",void 0);this.preloadEntities()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",b);this.preloadEntities()},this);this.on("activate",function(){this.getCorpus()&&0===this.getNodeData().length&&Ext.Function.defer(this.initLoad,100,this)},
this);this.on("query",function(a,b){this.loadFromQuery(b)},this);this.on("resize",function(a,b,e){if(a=Ext.get(this.getVisId()))e=this.body,b=e.getHeight(),e=e.getWidth(),a.el.dom.setAttribute("width",e),a.el.dom.setAttribute("height",b),this.getVisLayout().force("x",d3.forceX(e/2)).force("y",d3.forceY(b/2)),Ext.Function.defer(this.zoomToFit,100,this)},this);a.callParent(arguments)},initLoad:function(){this.initGraph();this.initPhysics();this.preloadEntities()},categoriesHandler:function(a){var b=
[];a.up("menu").items.each(function(a){a.checked&&b.push(a.itemId)});this.setApiParam("type",b);this.preloadEntities()},preloadEntities:function(){this.getEntities()},getEntities:function(){this.resetGraph();this.getCorpus().getId();var a=this.getLayout().getRenderTarget();a.mask(this.localize("loadingEntities"));Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),method:"POST",params:{tool:"corpus.EntityCollocationsGraph",type:this.getApiParam("type"),limit:this.getApiParam("limit"),minEdgeCount:this.getApiParam("minEdgeCount"),
corpus:this.getCorpus().getId(),docId:this.getApiParam("docId"),stopList:this.getApiParam("stopList"),noCache:!0},timeout:12E4,success:function(b){a.unmask();b=Ext.decode(b.responseText);0==b.entityCollocationsGraph.edges.length?(this.showError({msg:this.localize("noEntities")}),Ext.Msg.confirm(this.localize("error"),this.localize("noEntitiesForEdgeCount"),function(a){"yes"===a&&(a=Math.max(1,this.getApiParam("minEdgeCount")-1),this.queryById("minEdgeCount").setRawValue(a),this.setApiParam("minEdgeCount",
a),this.preloadEntities())},this)):this.processEntities(b.entityCollocationsGraph)},failure:function(b){a.unmask();Ext.Msg.confirm(this.localize("error"),this.localize("timedOut"),function(a){"yes"===a&&this.preloadEntities()},this)},scope:this})},processEntities:function(a){var b=a.nodes;a=a.edges;var c=this.getLayout().getRenderTarget(),d=c.getWidth()/2,e=c.getHeight()/2;c=[];for(var f=0;f<b.length;f++){var g=b[f];c.push({id:this.idGet(g),term:g.term,title:g.term+" ("+g.rawFreq+")",type:g.type,
value:g.rawFreq,fixed:!1,x:d,y:e})}d=[];for(f=0;f<a.length;f++){e=a[f].nodes;g=this.idGet(b[e[0]]);var h=this.idGet(b[e[1]]);d.push({source:g,target:h,value:b[e[1]].rawFreq,id:g+"-"+h})}this.setNodeData(c);this.setLinkData(d);this.refresh()},idGet:function(a){return a.type+"_"+a.term.replace(/\W/g,"_")},initPhysics:function(){if(this.getVisLayout()){var a=this.getGraphPhysics();this.getVisLayout().velocityDecay(a.damping).force("link",d3.forceLink().id(function(a){return a.id}).distance(a.springLength).strength(a.springStrength)).force("charge",
d3.forceManyBody().strength(a.nodeGravity)).force("collide",d3.forceCollide(function(b){return Math.sqrt(b.bbox.width*b.bbox.height)*a.collisionScale}));this.getVisLayout().force("x").strength(a.centralGravity);this.getVisLayout().force("y").strength(a.centralGravity)}},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("x",d3.forceX(b/2)).force("y",d3.forceY(c/2)).on("tick",function(){this.getLinks().attr("x1",
function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y});this.getNodes().attr("transform",function(a){var b=a.x,c=a.y;b-=.5*a.bbox.width;c-=.5*a.bbox.height;return"translate("+b+","+c+")"}.bind(this));!this.getDragging()&&.005>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("id",
this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c);var d=a.append("g");b=d3.zoom().scaleExtent([.25,4]).on("zoom",function(){d.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.refresh()},refresh:function(){var a=this,b=this.getNodeData(),
c=this.getLinkData(),d=this.getLinks().data(c,function(a){return a.id});d.exit().remove();var e=d.enter().append("line").attr("class","link").attr("id",function(a){return a.id}).on("mouseover",a.linkMouseOver.bind(a)).on("mouseout",a.linkMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,['"'+a.source.term+" "+a.target.term+'"~'+this.getApiParam("context")])}.bind(a)).style("cursor","pointer").style("stroke-width",
function(a){return Math.max(1,Math.min(10,Math.log(a.value)))});this.setLinks(e.merge(d));d=this.getNodes().data(b,function(a){return a.id});d.exit().remove();e=d.enter().append("g").attr("class",function(a){return"node "+a.type}).attr("id",function(a){return a.id}).on("mouseover",a.nodeMouseOver.bind(a)).on("mouseout",a.nodeMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,[a.term])}.bind(a)).on("dblclick",
function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault()}.bind(a)).on("contextmenu",function(a,b){d3.event.preventDefault()}).call(d3.drag().on("start",function(b){a.setDragging(!0);d3.event.active||a.getVisLayout().alpha(.3).restart();b.fx=b.x;b.fy=b.y;b.fixed=!0}).on("drag",function(b){a.getVisLayout().alpha(.3);b.fx=d3.event.x;b.fy=d3.event.y}).on("end",function(b){a.setDragging(!1);1!=b.fixed&&(b.fx=null,b.fy=null)}));e.append("title").text(function(a){return a.title});e.append("rect").style("stroke-width",
1).style("stroke-opacity",1);e.append("text").attr("font-family",function(b){return a.getApplication().getCategoriesManager().getFeatureForTerm("font",b.term)}).attr("font-size",function(a){return 10*Math.max(1,Math.log(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor","pointer").style("user-select","none").attr("dominant-baseline","middle");this.setNodes(e.merge(d));this.getVis().selectAll("rect").attr("width",function(a){return a.bbox.width+16}).attr("height",
function(a){return a.bbox.height+8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",function(a){return Math.max(2,.2*a.bbox.height)}).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*a.bbox.height+4});this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),
...
if(25>c.length)var f=4*c.length;else if(50>c.length)f=2*c.length;else if(100<c.length){var g=b.getWidth()-200;f=g<c.length?c.length:g}var h=this.localize("numberOfTerms");c.sort(function(a,b){return b.getLexicalTokensCount()-a.getLexicalTokensCount()});b.add(this.showSparklineSection(function(a){return a.getLexicalTokensCount()},this.localize("docsLength"),this.localize("longest"),this.localize("shortest"),c,d,e,f,h));c.sort(function(a,b){return b.getLexicalTypeTokenRatio()-a.getLexicalTypeTokenRatio()});
b.add(this.showSparklineSection(function(a){return Ext.util.Format.number(a.getLexicalTypeTokenRatio(),"0.000")},this.localize("docsDensity"),this.localize("highest"),this.localize("lowest"),c,d,e,f,h));c.sort(function(a,b){return b.getAverageWordsPerSentence()-a.getAverageWordsPerSentence()});b.add(this.showSparklineSection(function(a){return Ext.util.Format.number(a.getAverageWordsPerSentence(),"0.0")},this.localize("averageWordsPerSentence"),this.localize("highest"),this.localize("lowest"),c,d,
e,f,h))}else if(g=c[0])b.add({cls:"section",html:"\x3cb\x3e"+this.localize("docsDensity")+"\x3c/b\x3e "+Ext.util.Format.number(g.getLexicalTypeTokenRatio(),"0.000")}),b.add({cls:"section",html:"\x3cb\x3e"+this.localize("averageWordsPerSentence")+"\x3c/b\x3e "+Ext.util.Format.number(g.getAverageWordsPerSentence(),"0.0")});this.getCorpus().getReadability().then(function(g){c.forEach(function(a){var b=g.find(function(b){return b.docId===a.getId()});b&&a.set("readability",b.readability)});var k=b.items.length-
2;1<c.length?(c.sort(function(a,b){return b.get("readability")-a.get("readability")}),b.insert(k,a.showSparklineSection(function(a){return Ext.util.Format.number(a.get("readability"),"0.000")},a.localize("readabilityIndex"),a.localize("highest"),a.localize("lowest"),c,d,e,f,h))):b.insert(k,{cls:"section",html:"\x3cb\x3e"+a.localize("readabilityIndex")+"\x3c/b\x3e "+Ext.util.Format.number(c[0].get("readability"),"0.000")})});b.add({html:this.localize("mostFrequentWords"),cls:"section",listeners:{afterrender:function(b){b.mask(a.localize("loading"));
...
b),this.unmask(),this.getRunPromise().resolve(b)}b.value&&this.setCachedResultsValue(b.value);b.output&&this.setCachedResultsOutput(b.output);this.setCachedResultsVariables(b.variables);0<b.height&&this._setHeight(b.height);this.fireEvent("sandboxMessage",b)}else console.warn("unrecognized message!",a)},_doExpandContract:function(){var a=this.down("#expandButton");this.getExpandResults()?(this.setExpandResults(!1),a.setTooltip("Expand Results"),a.setGlyph("xf065@FontAwesome")):(this.setExpandResults(!0),
a.setTooltip("Contract Results"),a.setGlyph("xf066@FontAwesome"));this._setHeight()},_setHeight:function(a){if(void 0===this.getCachedPaddingHeight()){var b=window.getComputedStyle(this.getEl().dom);this.setCachedPaddingHeight(parseFloat(b.getPropertyValue("padding-top"))+parseFloat(b.getPropertyValue("padding-bottom"))+2)}void 0!==a?this.setCachedResultsHeight(a):(a=this.getCachedResultsHeight(),void 0===a&&(a=(b=this.getResultsEl())?b.getHeight():this.getEmptyResultsHeight(),this.setCachedResultsHeight(a)));
...
a.getEditedTimeout()||a.setEditedTimeout(setTimeout(function(){a.setIsChangeRegistered(!1)},3E4))},this);"javascript"===this.getMode()&&(void 0===Voyant.notebook.editor.CodeEditor.ternServer&&(b=this.getDocs(),d=this.up("notebook").getApplication().getBaseUrlFull(),Voyant.notebook.editor.CodeEditor.ternServer=new CodeMirror.TernServer({defs:b,useWorker:!0,workerScript:d+"resources/spyral/tern/worker.js",workerDeps:["tern_worker_deps.js"]})),Object.assign(c.getOption("extraKeys"),{"Ctrl-Space":function(a){Voyant.notebook.editor.CodeEditor.ternServer.complete(a)},
"Ctrl-O":function(a){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(a)}}),c.on("cursorActivity",function(a){Voyant.notebook.editor.CodeEditor.ternServer.updateArgHints(a)}));this.setEditor(c);this._setModeOptions(this.getMode());a.fireEvent("resize",a)},removed:function(a,b){a.getEditor()&&a.setEditor(void 0)}},_getModeConfig:function(a){switch(a){case "json":a={name:"javascript",json:!0};break;case "xml":a="xml";break;default:a="javascript"}return a},_setModeOptions:function(a){var b={};switch(a){case "json":case "javascript":b.autoCloseBrackets=
...
d.fireEvent("saveCancelled",d)}}," ",{text:"Save",handler:function(c){var f=c.up("window"),h=f.down("form").getForm();if(h.isValid()){var k=h.getValues();k.data=a;k.metadata=b;e&&""!==k.notebookId?d.doesNotebookIdExist(k.notebookId).then(function(a){a?h.findField("notebookId").markInvalid("That Notebook ID already exists."):(d.doSave(k),f.close())}):(c.setDisabled(!0),d.doSave(k).then(function(a){c.setDisabled(!1);a?f.close():h.findField("accessCode").markInvalid("Invalid access code.")}))}}}],listeners:{close:function(){d.fireEvent("close",
d)}}}).show()},doesNotebookIdExist:function(a){var b=new Ext.Deferred;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"exists",id:a,noCache:1}).then(function(a){b.resolve("true"===a.notebook.data)}).catch(function(a){console.log(a)});return b.promise},doSave:function(a){var b=a.notebookId,c=a.accessCode,d=a.email,e=a.data;a=a.metadata;var f=this;a.id=b;return Spyral.Load.trombone({method:"POST",tool:"notebook.GitNotebookManager",action:"save",id:b,accessCode:c,email:d,data:e,metadata:JSON.stringify(a)}).then(function(a){if("true"!==
a.notebook.data)return!1;f.setAccessCode(c);f.fireEvent("fileSaved",f,a.notebook.id);return!0}).catch(function(a){f.fireEvent("fileSaved",f,null);return!1})},generateAccessCode:function(){for(var a="abcdefghijklmnopqrstuvwxyz".split(""),b="";6>b.length;)if(.3>Math.random())b+=Math.floor(9*Math.random());else{var c=a[Math.floor(Math.random()*a.length)];.5>Math.random()&&(c=c.toUpperCase());b+=c}return b},reset:function(){this.setAccessCode(void 0)}});Ext.define("Voyant.notebook.metadata.MetadataEditor",{extend:"Ext.form.Panel",mixins:["Voyant.util.Localization"],alias:"widget.metadataeditor",statics:{i18n:{metadataTitle:"Title",metadataTip:"Edit notebook metadata.",metadataAuthor:"Author(s)",metadataKeywords:"Keywords",metadataDescription:"Description",metadataLicense:"Licence",metadataLanguage:"Language"}},constructor:function(a){Ext.apply(this,a,{trackResetOnLoad:!0,items:{bodyPadding:5,layout:"anchor",defaults:{anchor:"100%",labelAlign:"right"},
defaultType:"textfield",items:[{fieldLabel:this.localize("metadataTitle"),xtype:"htmleditor",name:"title",height:100,enableAlignments:!1,enableColors:!1,enableFont:!1,enableFontSize:!1,enableLinks:!1,enableLists:!1},{fieldLabel:this.localize("metadataAuthor"),name:"author"},{fieldLabel:this.localize("metadataKeywords"),name:"keywords",xtype:"tagfield",store:{xtype:"store.json",fields:[{name:"label"},{name:"count",type:"integer"}]},displayField:"label",valueField:"label",queryMode:"local",filterPickList:!0,
forceSelection:!1,delimiter:",",createNewOnEnter:!0,listeners:{afterrender:function(a){Spyral.Load.trombone({tool:"notebook.CatalogueFacets",facets:"facet.keywords",noCache:1}).then(function(b){a.getStore().loadRawData(b.catalogue.facets[0].results);a.setValue(a.getValue())})}}},{xtype:"htmleditor",fieldLabel:this.localize("metadataDescription"),name:"description",height:100,enableAlignments:!1,enableColors:!1,enableFont:!1},{xtype:"combo",fieldLabel:this.localize("metadataLicense"),name:"license",
store:{fields:["text"],data:[{text:"Apache License 2.0"},{text:'BSD 3-Clause "New" or "Revised" license'},{text:'BSD 2-Clause "Simplified" or "FreeBSD" license'},{text:"Creative Commons Attribution (CC BY)"},{text:"Creative Commons Attribution-ShareAlike (CC BY-SA)"},{text:"Creative Commons Zero (CC0)"},{text:"GNU General Public License (GPL)"},{text:'GNU Library or "Lesser" General Public License (LGPL)'},{text:"MIT license"},{text:"Mozilla Public License 2.0"},{text:"Common Development and Distribution License"},
...
return a},getInnerFooterHtml:function(){var a="",b=this.getMetadata();if(b.author||b.license)a="\x26copy;",b.author&&(a+=" "+b.author),b.license&&(a+=" ("+b.license+")"),a+=". ";if(b.created||b.modified){var c=b.shortDate("created");b=b.shortDate("modified");c&&(a+=this.localize("created")+" "+c+".");b&&c!=b&&(a+=" "+this.localize("modified")+" "+b+".")}return a},generateExportHtml:function(){var a="\x3c!DOCTYPE HTML\x3e\n\x3chtml\x3e\n\x3chead\x3e\n\t\x3cmeta charset\x3d'UTF-8'\x3e\n"+this.getMetadata().getHeaders(),
b=document.getElementById("ace-chrome");b&&(a+=b.outerHTML+"\n");(b=document.getElementById("voyant-notebooks-styles"))&&(a+=b.outerHTML+"\n");a+="\x3cscript\x3e // this script checks to see if embedded tools seem to be available\nwindow.addEventListener('load', function() {\nvar hostnames \x3d {}, warned \x3d false;\ndocument.querySelectorAll('iframe').forEach(function(iframeEl) {\nlet url \x3d new URL(iframeEl.src);\nif (!(url.hostname in hostnames) \x26\x26 !warned) {\nhostnames[url.hostname] \x3d true; // mark as fetched\nfetch(url).catch(response \x3d\x3e {\nwarned \x3d true;\nalert('This notebook seems to contain one ore more tools that may not be able to load. Possible reasons include a server no longer being accessible (especially if the notebook was generated from a local server), or because of security restrictions.'+url)\n})\n}\n})\n})\n\x3c/script\x3e\n\x3c/head\x3e\n\x3cbody class\x3d'exported-notebook'\x3e\n\x3cheader class\x3d'spyral-header'\x3e"+
this.getInnerHeaderHtml()+"\x3c/header\x3e\n\x3carticle class\x3d'spyralArticle'\x3e\n";this.getComponent("cells").items.each(function(b,d){d=b.getContent();var c=b.down("notebookwrappercounter");a+="\x3csection id\x3d'"+c.name+"' class\x3d'notebook-editor-wrapper "+b.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e"+c.getTargetEl().dom.innerHTML+"\x3c/div\x3e";b.isXType("notebooktexteditorwrapper")?a+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+d+"\x3c/div\x3e\n":(b=b.getTargetEl().query(".ace_text-layer")[0].cloneNode(!0),
b.style.setProperty("height","auto"),a+="\x3cdiv class\x3d'notebook-code-editor ace-chrome'\x3e\n"+b.outerHTML+"\n\x3c/div\x3e\n\x3cpre class\x3d'notebook-code-editor-raw editor-mode-"+d.mode+"'\x3e"+d.input+"\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results"+(d.expandResults?"":" collapsed")+"'\x3e\n"+d.output+"\n\x3c/div\x3e\n");a+="\x3c/section\x3e\n"});return a+="\x3c/article\x3e\n\x3cfooter class\x3d'spyral-footer'\x3e"+this.getInnerFooterHtml()+"\x3c/footer\x3e\n\x3c/body\x3e\n\x3c/html\x3e"},
generateExportMetadata:function(a){a=a.clone();a.title&&(a.title=a.title.replace(/<\/?\w+.*?>/g,""));a.description&&(a.description=a.description.replace(/<\/?\w+.*?>/g,""));a.keywords&&(!1===Array.isArray(a.keywords)&&(a.keywords=a.keywords.split(/[\s,]+/)),a.keywords=a.keywords.reduce(function(a,c){0<c.length&&a.push(c.toLowerCase());return a},[]));return a},generateExportJson:function(){var a=[];this.getComponent("cells").items.each(function(b,d){switch(b.xtype){case "notebookcodeeditorwrapper":d=
"code";break;case "notebookdatawrapper":d="data";break;default:d="text"}a.push({cellId:b.getCellId(),type:d,content:b.getContent()})});var b={metadata:this.getMetadata(),cells:a};return JSON.stringify(b)},getExtraExportItems:function(){return[{inputValue:"html",boxLabel:this.localize("exportHtml")},{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=(this.getNotebookId()||"spyral")+".html",c=this.generateExportHtml(),
d={type:"text/html"};try{var e=new File([c],b,d)}catch(f){e=new Blob([c],d)}c=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",b);a.setAttribute("href",c)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]},exportHtml:function(){var a=this.generateExportHtml(),b=window.open();b.document.write(a);b.document.close();b.focus()}});Ext.define("Voyant.notebook.Catalogue",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebookcatalogue",statics:{i18n:{title:"Spyral Notebooks Catalogue",browse:"Browse Notebooks",keywords:"Keywords",author:"Author",language:"Language",license:"License",search:"Search within notebooks",noResults:"No matching notebooks",suggested:"Suggested Notebooks",load:"Load Selected Notebook",cancel:"Cancel"}},window:void 0,store:void 0,template:void 0,gettingFacets:!1,constructor:function(){this.store=
Ext.create("Ext.data.JsonStore",{fields:[{name:"id"},{name:"author"},{name:"title"},{name:"description"},{name:"keywords"},{name:"language"},{name:"license"},{name:"created",type:"date"},{name:"modified",type:"date"},{name:"version"}]});this.template=new Ext.XTemplate('\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"catalogue-notebook"\x3e','\x3cdiv class\x3d"id"\x3e{id}\x3c/div\x3e','\x3cdiv class\x3d"title nowrap" title\x3d"{title}"\x3e{title}\x3c/div\x3e','\x3cdiv class\x3d"author nowrap"\x3e\x3ci class\x3d"fa fa-user" aria-hidden\x3d"true"\x3e\x3c/i\x3e {author}\x3c/div\x3e',
'\x3cdiv class\x3d"description"\x3e{description}\x3c/div\x3e','\x3ctpl if\x3d"keywords.length \x26gt; 0"\x3e','\x3cdiv class\x3d"keywords nowrap"\x3e','\x3ci class\x3d"fa fa-tags" aria-hidden\x3d"true"\x3e\x3c/i\x3e ','\x3ctpl for\x3d"keywords"\x3e',"\x3cspan\x3e{.}\x3c/span\x3e","\x3c/tpl\x3e","\x3c/div\x3e","\x3c/tpl\x3e",'\x3cdiv class\x3d"dates"\x3e\x3cspan class\x3d"date"\x3e\x3ci class\x3d"fa fa-clock-o" aria-hidden\x3d"true"\x3e\x3c/i\x3e {[Ext.Date.format(values.modified, "M j Y")]}\x3c/span\x3e\x3c/div\x3e',
"\x3c/div\x3e","\x3c/tpl\x3e");this.suggestedStore=Ext.create("Ext.data.JsonStore",{fields:[{name:"id"},{name:"author"},{name:"title"},{name:"description"},{name:"keywords"},{name:"language"},{name:"license"},{name:"created",type:"date"},{name:"modified",type:"date"},{name:"version"}]});this.suggestedTemplate=new Ext.XTemplate('\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"catalogue-notebook"\x3e','\x3cdiv class\x3d"title" title\x3d"{title}"\x3e{title}\x3c/div\x3e','\x3cdiv class\x3d"description"\x3e{description}\x3c/div\x3e',
"\x3c/div\x3e","\x3c/tpl\x3e");this.callParent(arguments)},initComponent:function(a){this.callParent(arguments)},showWindow:function(){void 0===this.window?(this.window=Ext.create("Ext.window.Window",{title:this.localize("title"),width:"80%",height:"80%",maximizable:!0,modal:!0,cls:"catalogue",layout:"border",items:[{xtype:"panel",region:"center",flex:2,border:!0,layout:{type:"vbox",align:"stretch"},items:[{xtype:"toolbar",height:30,layout:{type:"hbox",pack:"center"},items:[{xtype:"tbspacer",flex:.1},
{xtype:"textfield",itemId:"queryfield",emptyText:this.localize("search"),flex:.8,enableKeyEvents:!0,triggers:{cancel:{hidden:!0,cls:"fa-trigger form-fa-clear-trigger",handler:function(a){a.setValue("");a.getTriggers().cancel.hide();this.getNotebooks()},scope:this},search:{cls:"fa-trigger form-fa-search-trigger",handler:function(a){this.getNotebooks()},scope:this}},listeners:{keyup:function(a,b){13===b.getCharCode()&&this.getNotebooks();0<a.getValue().trim().length?a.getTriggers().cancel.show():a.getTriggers().cancel.hide()},
scope:this}},{xtype:"tbspacer",flex:.1}]},{xtype:"dataview",flex:1,width:"100%",padding:10,scrollable:"vertical",itemId:"catalogue",store:this.store,tpl:this.template,itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected",listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"))},scope:this}}]},{xtype:"panel",region:"west",collapsible:!0,title:this.localize("browse"),flex:1,itemId:"facets",cls:"facets",
layout:{type:"accordion",animate:!1,multi:!0,fill:!1,align:"stretch",titleCollapse:!0,hideCollapseTool:!0},defaults:{xtype:"grid",rowLines:!1,hideHeaders:!0,selType:"checkboxmodel",columns:[{renderer:function(a,b,c){return"("+c.get("count")+") "+c.get("label")},flex:1}],store:{xtype:"store.json",fields:[{name:"label"},{name:"count",type:"integer"}]}},items:[{title:this.localize("keywords"),facet:"facet.keywords",flex:3},{title:this.localize("author"),facet:"facet.author",flex:2},{title:this.localize("language"),
facet:"facet.language",flex:1},{title:this.localize("license"),facet:"facet.license",flex:1}]},{xtype:"panel",region:"east",collapsible:!0,collapsed:!1,title:this.localize("suggested"),width:250,layout:"fit",items:[{xtype:"dataview",padding:10,scrollable:"vertical",itemId:"suggestedNotebooks",store:this.suggestedStore,tpl:this.suggestedTemplate,itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected",listeners:{itemdblclick:function(a,
b,c){this.fireEvent("notebookSelected",this,b.get("id"))},scope:this}}]}],closeAction:"hide",buttons:[{text:this.localize("cancel"),ui:"default-toolbar",handler:function(a){this.window.close()},scope:this},{text:this.localize("load"),handler:function(a){a=this.window.down("#catalogue").getSelection()[0];void 0===a&&(a=this.window.down("#suggestedNotebooks").getSelection()[0]);a&&this.fireEvent("notebookSelected",this,a.get("id"))},scope:this}]}),this.window.query("#facets \x3e grid").forEach(function(a){a.getSelectionModel().on("selectionchange",
this._loadFacets,this)},this)):(this.window.query("#facets \x3e grid").forEach(function(a){a.getStore().clearFilter();a.getSelectionModel().deselectAll()}),this.window.down("#queryfield").setValue(""),this.window.down("#catalogue").getSelectionModel().deselectAll(),this.window.down("#suggestedNotebooks").getSelectionModel().deselectAll(),this.store.removeAll());!1===this.suggestedStore.isLoaded()&&this.getSuggestedNotebooks();this.window.show();this._loadFacets()},hideWindow:function(){void 0!==this.window&&
this.window.close()},_getSelectedFacets:function(){var a=[];this.window.query("#facets \x3e grid").forEach(function(b){b.getSelection().forEach(function(c){a.push([b.facet,c.get("label")])})});return a},_loadFacets:function(){if(!1===this.gettingFacets){this.window.down("#facets").mask("Loading");this.gettingFacets=!0;var a=this._getSelectedFacets().map(function(a){return a.join("\x3d")}),b=this;Spyral.Load.trombone({tool:"notebook.CatalogueFacets",query:a,noCache:1}).then(function(a){a.catalogue.facets.forEach(function(a){var c=
b.window.query("#facets \x3e grid[facet\x3d"+a.facet+"]")[0].getStore();c.clearFilter();if(0===c.getCount())c.loadRawData(a.results);else{var d=[];c.each(function(b){for(var c=b.get("label"),e=0;e<a.results.length;e++){var f=a.results[e];if(f.label===c){b.set("count",f.count);d.push(c);break}}});c.filterBy(function(a){return-1!==d.indexOf(a.get("label"))})}});b.window.down("#facets").unmask();b.gettingFacets=!1;b.getNotebooks()}).catch(function(a){b.window.down("#facets").unmask();b.gettingFacets=
!1})}},getNotebooks:function(a){if(!a){a=[];this._getSelectedFacets().forEach(function(b){a.push(b.join(":"))});var b=this.window.down("#queryfield").getValue();0<b.trim().length&&a.push(b);return this.getNotebooks(a)}if(0===a.length)this.window.down("#catalogue").getSelectionModel().deselectAll(),this.store.removeAll();else{this.window.down("#catalogue").mask("Loading");this.window.down("#catalogue").getSelectionModel().deselectAll();var c=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",
query:a,noCache:1}).then(function(a){c.window.down("#catalogue").unmask();c.store.loadRawData(a.catalogue.notebooks);c.store.sort("modified","DESC")}).catch(function(a){c.window.unmask()})}},getSuggestedNotebooks:function(){var a=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:"id:aboutspyral|id:homeALTA|id:startALTA|id:createALTA|id:smallerALTA|id:tableALTA",parse:!1,noCache:1}).then(function(b){a.suggestedStore.loadRawData(b.catalogue.notebooks);a.suggestedStore.sort("modified",
"DESC")}).catch(function(a){})}});Ext.define("Voyant.notebook.Notebook",{alternateClassName:["Notebook"],extend:"Ext.panel.Panel",requires:["Voyant.notebook.editor.CodeEditorWrapper","Voyant.notebook.editor.TextEditorWrapper","Voyant.notebook.metadata.MetadataEditor","Voyant.notebook.StorageDialogs","Voyant.notebook.github.GitHubDialogs"],mixins:["Voyant.panel.Panel","Voyant.notebook.util.FormatConverter"],alias:"widget.notebook",statics:{i18n:{title:"Spyral",created:"Created",modified:"Modified",clickToEdit:"Click to edit",errorLoadingNotebook:"Error loading Spyral notebook",
cannotLoadJson:"Unable to parse JSON input.",cannotLoadJsonUnrecognized:"Unable to recognize JSON input.",cannotLoadUnrecognized:"Unable to recognize input.",cannotLoadNotebookId:"Unable to load the Spyral Notebook. It may no longer exist.",openTitle:"Open",openMsg:"Paste in Notebook ID, a URL or a Spyral data file (in HTML).",exportHtmlDownload:"HTML (download)",errorParsingDomInput:"An error occurred while parsing the input of the document. The results might still work, except if the code contained HTML tags.",
metadataEditor:"Edit Metadata",metadataReset:"Reset",metadataSave:"Save",metadataCancel:"Cancel"},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0}},config:{notebookId:void 0,metadata:void 0,isEdited:!1,version:"3.0",storageSolution:"voyant"},metadataWindow:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0,catalogueWindow:void 0,spyralTernDocs:void 0,ecmaTernDocs:void 0,browserTernDocs:void 0,constructor:function(a){Ext.apply(a,{title:this.localize("title"),includeTools:{help:!0,gear:!0,
save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",disabled:!0,items:[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!1),scope:this},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!0),scope:this},"-",{text:"Storage",xtype:"menuitem",menu:{items:[{text:"Voyant",xtype:"menucheckitem",group:"storageSolution",checked:!0,handler:this.setStorageSolution.bind(this,
"voyant"),scope:this},{text:"GitHub",xtype:"menucheckitem",group:"storageSolution",checked:!1,handler:this.setStorageSolution.bind(this,"github"),scope:this}]}}]},"new":{tooltip:this.localize("newTip"),callback:function(){var a=this.getBaseUrl()+"spyral/";this.getApplication().openUrl(a)},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),xtype:"toolmenu",glyph:"xf115@FontAwesome",callback:function(a,c){a=this.getStorageSolution();void 0!==a&&(setTimeout(function(){c.toolMenu.hide()}),
"github"===a?this.githubDialogs.showLoad():Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,b){b=b.trim();"ok"==a&&this.loadFromString(b)},this,!0))},scope:this,items:[{text:"Load",xtype:"menuitem",glyph:"xf115@FontAwesome",handler:function(){Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,c){c=c.trim();"ok"==a&&this.loadFromString(c)},this,!0)},scope:this},{text:"Load from GitHub",xtype:"menuitem",glyph:"xf115@FontAwesome",handler:function(){this.githubDialogs.showLoad()},
scope:this}]},runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),callback:this.showMetadataEditor,xtype:"toolmenu",glyph:"xf02c@FontAwesome",scope:this},catalogue:{tooltip:"catalogue",callback:function(){this.catalogueWindow.showWindow()},xtype:"toolmenu",glyph:"xf00b@FontAwesome",scope:this}},scrollable:!0,layout:{type:"vbox",align:"middle",padding:"50 0"},defaults:{width:"100%",maxWidth:1100},
items:[{itemId:"spyralHeader",cls:"spyral-header",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(b){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}},{xtype:"container",itemId:"cells",defaults:{margin:"10 0 10 0",padding:"0 50 0 50"}},{itemId:"spyralFooter",
...
notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,notebookInitialized:this.notebookInitialized,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({listeners:{fileLoaded:function(a){},fileSaved:function(a,c){this.unmask();null!==c&&((a=this.getNotebookId())&&
c==a||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1))},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({listeners:{fileLoaded:function(a,c){a=c.owner;var b=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.loadFromString(c);c=encodeURIComponent(a+"/"+b+"/"+e);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},
"Spyral Notebook: "+c,a))},fileSaved:function(a,c){a=c.owner;var b=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}});this.catalogueWindow=new Voyant.notebook.Catalogue({listeners:{notebookSelected:function(a,
c){a.hideWindow();this.loadFromId(c);this.setNotebookId(c)},scope:this}})},init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Promise.all([Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/ecmascript.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/browser.json"})]).then(function(a){this.spyralTernDocs=
Ext.JSON.decode(a[0].responseText);this.spyralTernDocs.Corpus=this.spyralTernDocs.Spyral.Corpus;this.spyralTernDocs.Table=this.spyralTernDocs.Spyral.Table;this.spyralTernDocs.loadCorpus=this.spyralTernDocs.Spyral.Corpus.load;this.spyralTernDocs.createTable=this.spyralTernDocs.Spyral.Table.create;this.spyralTernDocs.show=this.spyralTernDocs.Spyral.Util.show;this.spyralTernDocs.showError=this.spyralTernDocs.Spyral.Util.showError;this.ecmaTernDocs=Ext.JSON.decode(a[1].responseText);this.browserTernDocs=
Ext.JSON.decode(a[2].responseText);this.loadFromQueryParams()}.bind(this),function(){this.loadFromQueryParams()}.bind(this))},reset:function(){this.getScrollable().scrollTo(0,0);this.getScrollable().trackingScrollTop=0;this.getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");Ext.Promise.all(this.query("notebookrunnableeditorwrapper").map(function(a){return a.results.updateCachedOutput()})).then(function(a){},
function(a){console.warn("Error updating cached results")}).finally(function(){var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()||void 0===this.voyantStorageDialogs.getAccessCode()?"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookId()):this.voyantStorageDialogs.doSave({notebookId:this.getNotebookId(),data:b,metadata:c,accessCode:this.voyantStorageDialogs.getAccessCode()})}.bind(this))},
getExportUrl:function(a){return location.href},loadFromQueryParams:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname),d=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(a,b){0==a.trim().indexOf("\x3c")?0===b?this.setMetadata(new Spyral.Metadata({title:a})):this.addText(a):this.addCode(a)},this):a.input?0===
a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?(this.loadFromId(c[1]),this.setStorageSolution("voyant")):d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),this.setIsEdited(!1));if(b){var e=this;Ext.defer(function(){e.runAll()},100)}},loadFromString:function(a){a=a.trim();if(0===a.indexOf("http"))this.loadFromUrl(a);else if(0===a.indexOf("{"))this.loadFromJson(a);else if(/^[\w-_]+$/.test(a))this.loadFromId(a);else{if(0!==a.indexOf("\x3c")||-1===
a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.importFromHtml(a)},this)}return!0},loadFromJson:function(a){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,
icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setMetadata(new Spyral.Metadata(b.metadata));var a=[];b.cells.forEach(function(b){var c=void 0;switch(b.type){case "text":this.addText(b.content,void 0,b.cellId);break;case "code":c=this.addCode(b.content,void 0,b.cellId);break;case "data":c=
this.addData(b.content,void 0,b.cellId)}c&&(c.on("initialized",function(){var b=a.indexOf(c);-1!==b?(a.splice(b,1),0===a.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",c)}.bind(this)),a.push(c))},this)},this)},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();
b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!==b.getNotebookId()&&b.setNotebookId(a.notebook.id);b.setIsEdited(!1)}).catch(function(a){b.unmask();Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){b.push(c);if(a&&a===c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;
Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(!0,b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}});b=b.concat(e);Ext.defer(d._run,
100,d,[a,b])},function(a){})}},notebookInitialized:function(){},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});
return b},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e",language:"English"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
this.addCode("")},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){d=d||{};d.docs=[this.spyralTernDocs,this.ecmaTernDocs,this.browserTernDocs];return this._add(a,b,"notebookcodeeditorwrapper",c,d)},addData:function(a,b,c,d){return this._add(a,b,"notebookdatawrapper",c,d)},_add:function(a,b,c,d,e){Ext.isString(a)&&(a={input:a});var f=this.getComponent("cells");b="undefined"===typeof b?f.items.length:b;d="undefined"===typeof d?Spyral.Util.id():d;
...
c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)});this.setIsEdited(!0)},setIsEdited:function(a){this.getHeader()&&(this.getHeader().down("#saveItTool").setDisabled(!1===a),a||(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)})));this.callParent(arguments)},setNotebookId:function(a){if(a&&
-1===location.pathname.indexOf("/spyral/"+a)){var b=this.getBaseUrl()+"spyral/"+a+"/";window.history.pushState({url:b},"",b)}this.callParent(arguments)},updateMetadata:function(){var a=this.getMetadata();document.title=a.title.replace(/<\/?\w+.*?>/g,"")+" - Spyral";this.getComponent("spyralHeader").update(this.getInnerHeaderHtml());this.getComponent("spyralFooter").update(this.getInnerFooterHtml());this.setIsEdited(!0)},showMetadataEditor:function(){if(void 0===this.metadataWindow){var a=this;this.metadataEditor=
Ext.create("widget.metadataeditor",{anchor:"100%"});this.metadataWindow=Ext.create("Ext.window.Window",{title:this.localize("metadataEditor"),autoScroll:!0,width:600,closeAction:"hide",layout:"anchor",items:this.metadataEditor,buttons:[{text:this.localize("metadataCancel"),ui:"default-toolbar",handler:function(){this.up("window").close()}},{text:this.localize("metadataReset"),ui:"default-toolbar",handler:function(){a.metadataEditor.reset()}}," ",{text:this.localize("metadataSave"),handler:function(){var b=
a.metadataEditor.getForm();a.getMetadata().set(b.getValues());a.updateMetadata();this.up("window").close()}}]})}var b=this.getMetadata();void 0===b&&(b=new Spyral.Metadata,this.setMetadata(b));this.metadataEditor.loadMetadata(b);this.metadataWindow.show()}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api","Voyant.util.Colors"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",categories:"auto",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0,categoriesManager:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=
...
scope:this})},loadCategoryData:function(a){return this.getCategoriesManager().load(a,{trombone:Voyant.application.getTromboneUrl()})},saveCategoryData:function(a){return this.getCategoriesManager().save({},{trombone:Voyant.application.getTromboneUrl()})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.getApiParam("categories")&&this.loadCategoryData(this.getApiParam("categories")).then(function(){for(var a in this.getCategoriesManager().getCategories()){var b=this.getCategoriesManager().getCategoryFeature(a,
"color");if(void 0!==b){b=this.hexToRgb(b);for(var e=this.getCategoriesManager().getCategoryTerms(a),f=0;f<e.length;f++)this.setColorForTerm(e[f],b)}}}.bind(this));this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var c=this.getModifiedApiParams()||{};delete c.view;if("termsClicked"==d)if(Ext.isArray(e)&&"string"!==typeof e[0]&&"term"in e[0]&&"docIndex"in e[0]){var g={},h={};e.forEach(function(a){g[a.term]=!0;h[a.docIndex]=!0});c.query=Object.keys(g);c.docIndex=
Object.keys(h)}else c.query=e;else if("documentsClicked"==d){var k=[];e.forEach&&e.forEach(function(a){k.push(a.getIndex())});c.docIndex=k}else if("corpusTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}),c.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}c.toolFlow&&(d=Ext.Array.from(c.toolFlow.split(",")),c.view=d.shift(),0<
d.length?c.toolFlow=d.join(","):delete c.toolFlow);a+="\x26"+Ext.Object.toQueryString(c);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});
...
"\x3c/div\x3e"+(-1==this.localize("translatedBy").indexOf("English")?"\x3cdiv\x3e"+this.localize("translatedBy")+"\x3c/div\x3e":"")+(this.getCorpusCreatorText&&0<this.getCorpusCreatorText().trim().length?"\x3cdiv id\x3d'corpusCreatorText'\x3e"+this.getCorpusCreatorText()+"\x3c/div\x3e":"")+"\x3c/div\x3e"}]},{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.callParent(arguments)}});Ext.define("Voyant.panel.MoreLikeThis",{extend:"Ext.panel.Panel",alias:"widget.morelikethis",title:"More Like this"});

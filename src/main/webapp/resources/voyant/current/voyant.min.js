...
this.localize("searchTip")+'"\x3e'+this.localize("search")+"\x3c/span\x3e",{xtype:"textfield",name:"searchField",hideLabel:!0,width:80,listeners:{change:{fn:b.onQuery,scope:b,buffer:500}}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("limitTermsTip")+'"\x3e'+this.localize("limitTerms")+"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("termsPerTopic")))},changecomplete:function(c,
d){this.setApiParams({termsPerTopic:d});this.runIterations()},scope:this}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("numTopicsTip")+'"\x3e'+this.localize("numTopics")+"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("topics")))},changecomplete:function(c,d){this.setApiParams({topics:d});this.runIterations()},scope:this}},{text:"Run",itemId:"iterations",glyph:"xf04b@FontAwesome",
tooltip:this.localize("runIterationsTip"),handler:this.runIterations,scope:this},{text:"Toggle diagnostics",itemId:"diagnostics",glyph:"xf129@FontAwesome",handler:function(c){b.down("#topicsView").toggleCls("showDiagnostics")}}]}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(c,d){this.setCorpus(d);if(this.rendered)this.initialize();else this.on("afterrender",function(){this.initialize()},this)})},runIterations:function(){var a=
this.getApiParams();a.tool="analysis.TopicModeling";a.corpus=this.getCorpus().getAliasOrId();a.noCache=1;var b=this.getApiParam("iterations"),c=Ext.MessageBox.progress({title:this.localize("runningIterations"),message:(new Ext.Template(this.localize("runningIterationsCount"))).apply([b])});Ext.Ajax.request({url:this.getTromboneUrl(),params:a,success:function(d,e){c.close();d=JSON.parse(d.responseText);this.down("#topicsView").getStore().loadData(d.topicModeling.topics.map(function(f,g){var h=f.words.map(function(k){return k.word});
f=Object.assign({},f);delete f.words;return[g,h,0,f]}));d.topicModeling.topicDocuments.sort(function(f,g){f=this.getCorpus().getDocument(f.docId).getIndex();g=this.getCorpus().getDocument(g.docId).getIndex();return f-g}.bind(this));this.down("#docsView").getStore().loadData(d.topicModeling.topicDocuments);this.down("#docsView").refresh()},scope:this})},getColorForTopic:function(a){return this.getApplication().getColor(a)},onQuery:function(a,b){a=this.down("#topicsView");a.getEl().query(".highlighted").forEach(function(g){g.classList.remove("highlighted")});

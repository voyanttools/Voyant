...
itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.getServerMessage();this.callParent(arguments)},getServerMessage:function(){$.get("trombone",{fetchData:"https://raw.githubusercontent.com/wiki/voyanttools/voyant/Announcements.md"},function(a){var b=new showdown.Converter;b.setOption("openLinksInNewWindow",!0);a=b.makeHtml(a);$("#voyantServerMessage").html(a)},"text").fail(function(){console.log("failed to fetch server message")})}});Ext.define("Voyant.panel.MoreLikeThis",{extend:"Ext.panel.Panel",alias:"widget.morelikethis",title:"More Like this"});

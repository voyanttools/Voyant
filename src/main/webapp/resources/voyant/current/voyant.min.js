...
l.loadCustomColorPalette(k.palette).then(function(){},function(){k.palette="default"}).always(function(){m.push(["palette",k.palette]);u.resolve()}):(m.push(["palette",k.palette]),u.resolve())):u.resolve();Ext.Promise.all([n,u]).then(function(){var w=l.getCorpus();if(0<m.length){var p=l.getViewport().query("panel,chart");m.forEach(function(q){var r=q[0];q=q[1];l.setApiParam&&l.setApiParam(r,q);for(var v=0;v<p.length;v++)p[v].setApiParam&&p[v].setApiParam(r,q)});w?l.dispatchEvent("loadedCorpus",this,
w):l.dispatchEvent("apiParamsUpdated",this,k)}w?this.fireEvent("loadedCorpus",this,w):this.fireEvent("apiParamsUpdated",this,k);h.up("window").close()}.bind(this))},scope:g}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}};c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",
...
Ext.Date.format(a,"Y")+"). "+(this.isXType("voyantheader")?"":this.localize("title")+". ")+"\x3ci\x3eVoyant Tools\x3c/i\x3e. Retrieved "+Ext.Date.format(a,"F j, Y")+", from "+b+'\x3c/div\x3e\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eBibTeX\x3c/legend\x3e\x3cdiv class\x3d"x-selectable"\x3e'+this.getExportBibTex()+"\x3c/div\x3e\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO}).getEl().query("fieldset \x3e div",!1).forEach(function(c){c.on("click",function(d,e){var f=window.document;
window.getSelection&&f.createRange?(d=window.getSelection(),f=f.createRange(),f.selectNodeContents(e),d.removeAllRanges(),d.addRange(f)):f.body.createTextRange&&(f=f.body.createTextRange(),f.moveToElementText(e),f.select())})})},exportSpyral:function(){var a=Ext.getClassName(this).split(".").pop(),b=this.getApplication().getModifiedApiParams();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),delete b.corpus);var c=b&&"debug"in b;delete b.view;delete b.debug;
a="['\x3ch1\x3eSpyral Notebook Imported from Voyant Tools\x3c/h1\x3e','\x3cp\x3eThe proceeding code loads your corpus and tool. You can use this as a base to create your own notebook. Don\\'t forget to save your changes by clicking on the cloud icon!\x3c/p\x3e','loadCorpus(\""+this.getApplication().getCorpus().getAliasOrId()+'").tool("'+("VoyantHeader"==a?"":a)+'"'+(0<Object.keys(b).length?","+Ext.encode(b):"")+");']";this.openUrl(this.getApplication().getBaseUrl()+"spyral/?run\x3dtrue\x26"+(c?"debug\x3dtrue\x26":
"")+"inputJsonArrayOfEncodedBase64\x3d"+btoa(encodeURIComponent(a)).replace(/=/g,"%3D"))},exportGridCurrentJson:function(a,b){function c(e){var f={};d.forEach(function(g){f[g.text]=e.get(g.dataIndex)});values.push(f)}b=a.getStore();b.getFields();var d=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(e){return e.dataIndex&&0<e.dataIndex.trim().length});values=[];b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataJsonMessage"),
...
this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(c)))},this)},getExportUrl:function(a){var b=this.getApplication().getModifiedApiParams(),c=Ext.getClassName(this).split(".").pop();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),a||(b.view=c));b.corpus||(b.corpus=this.getApplication().getCorpus().getAliasOrId());return this.getApplication().getBaseUrl()+(a?"tool/"+c+"/":"")+"?"+Ext.Object.toQueryString(b)},getExportBibTex:function(){var a=this.getExportUrl(),
b=this.getApplication().getCorpus(),c="Voyant Tools";!1===this.isXType("voyantheader")&&(c+=" "+this.localize("title"));var d="Voyant Tools analysis of ";d=""===b.getTitle()?d+"a corpus":d+('the corpus "'+b.getTitle()+'"');!1===this.isXType("voyantheader")&&(d+=" using the "+this.localize("title")+" tool");var e=new Date;b=Ext.Date.format(e,"Y-m-d");var f=new Date(this.getApplication().getCorpus().getCreatedTime()),g=this.getApiParam("lang")||"en";e=["@misc{voyanttools_"+e.getTime()+","];e.push("title \x3d {"+
c+"},");e.push("author \x3d {Sinclair, St\u00e9fan and Rockwell, Geoffrey},");e.push("year \x3d "+f.getFullYear()+",");e.push("url \x3d {"+a+"},");e.push("urldate \x3d {"+b+"},");e.push("publisher \x3d {Voyant Tools},");e.push("copyright \x3d {CC BY 4.0},");e.push("abstract \x3d {"+d+"},");e.push("language \x3d {"+g+"},");return e.join("\x3cbr/\x3e\x26nbsp;\x26nbsp;")+"\x3cbr/\x3e}"},helpToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b=a.localize("help",{"default":!1})||
...
this.setLocationMarker(Ext.DomHelper.append(this.getEl(),{tag:"div",style:"background-color: "+this.locationMarkerColor+"; height: 100%; width: 2px; position: absolute; top: 0; left: 0;"}))})},updateCorpus:function(a){a=a.getDocuments();this.setDocumentsStore(a);this.setIsDetailedGraph(a.getTotalCount()<this.DETAILED_GRAPH_DOC_LIMIT);this.generateChart()},populateChart:function(a){var b={},c=0;a.forEach(function(m){var n=[],u=m.get("distributions"),w=m.get("docId"),p=m.get("docIndex");m=m.get("term");
for(var q=0;q<u.length;q++){var r=q,v=u[q];v>c&&(c=v);n.push([w,p,r,v,m])}void 0===b[p]&&(b[p]={});b[p][m]=n});if(this.getIsDetailedGraph()){a=this.query("cartesian");for(var d=0;d<a.length;d++){var e=a[d],f=b[d];if(void 0!==f){var g=[],h;for(h in f){var k=f[h],l=this.getParentPanel().getApplication().getColorForTerm(h,!0);this.getCorpus();g.push({type:"line",xField:"bin",yField:"distribution",style:{lineWidth:1,strokeStyle:l},store:Ext.create("Ext.data.ArrayStore",{fields:["docId","docIndex","bin",
...
yField:"count",style:{minGapWidth:0,minBarWidth:1,lineWidth:0,strokeStyle:"none"},renderer:function(m,n,u,w){return{fillStyle:this.getColor.call(this,w,.3)}}.bind(this)}],store:Ext.create("Ext.data.JsonStore",{fields:[{name:"index",type:"int"},{name:"count",type:"int"},{name:"fraction",type:"float"}],data:e}),listeners:{itemclick:function(m,n,u){m=Ext.get(u.getTarget());u=u.getX();m=m.getBox();var w=m.width/this.getCorpus().getDocuments().getCount();u=(u-m.x)%w/w;n=n.record.data;n=this.getDocumentsStore().getAt(n.index).getIndex();
...
this.queryById("sendToVoyant").setDisabled(!0);this.queryById("export").setDisabled(!0);if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(e,f,g){this.unmask();if(e&&0<e.length){this.queryById("status").setHtml(e.length);var h="\x3cul\x3e",k=[];e.forEach(function(m){m.getDocIds().forEach(function(n){k.push(n);var u=d.getCorpus().getDocument(n),w="\x3cli id\x3d'"+c.getId()+"_"+n+"' class\x3d'cataloguedoc'\x3e";
w+="\x3ca href\x3d'#' class\x3d'cataloguedoctitle' data\x3d'"+n+"'\x3e"+u.getTitle()+"\x3c/a\x3e";for(facet in b)if(0!=b[facet].length){var p="";if("facet.title"!=facet){var q=facet.replace(/^.+?\./,"");if(n=u.get(q)){var r=Ext.isArray(n);r?p+="\x3cli\x3e"+q+"\x3cul\x3e":n=[n];n.forEach(function(v){var x=!1;b[facet].forEach(function(z){z.label==v?x=!0:-1==z.facet.indexOf("facet")&&z.label.split(/\W+/).forEach(function(L){0<L.trim().length&&-1<v.toLowerCase().indexOf(L.toLowerCase())&&(x=!0)})});p+=
"\x3cli\x3e"+(r?"":q.replace("extra.","")+": ")+(x?'\x3cspan class\x3d"keyword"\x3e'+v+"\x3c/span\x3e":v)+"\x3c/li\x3e"});r&&(p+="\x3c/ul\x3e\x3c/li\x3e")}}p&&(w+="\x3cul\x3e"+p+"\x3c/ul\x3e")}h+=w+"\x3c/li\x3e"})});h+="\x3c/ul\x3e";c.update(h);var l=this;e=c.query(".cataloguedoctitle");e.forEach(function(m){Ext.get(m).on("click",function(n,u){this.dispatchEvent("documentSelected",l,u.getAttribute("data"))},l)});1==e.length&&this.dispatchEvent("documentSelected",l,e[0].getAttribute("data"));this.queryById("status").update((new Ext.XTemplate(this.localize("queryMatches"))).apply([k.length,
...
d3.event.active||a.getVisLayout().alpha(.3).restart();f.fx=f.x;f.fy=f.y;f.fixed=!0}).on("drag",function(f){a.getVisLayout().alpha(.3);f.fx=d3.event.x;f.fy=d3.event.y;a.isMasked()?a.isOffCanvas(d3.event.x,d3.event.y)||a.unmask():a.isOffCanvas(d3.event.x,d3.event.y)&&a.mask(a.localize("releaseToRemove"))}).on("end",function(f){a.setDragging(!1);1!=f.fixed&&(f.fx=null,f.fy=null);a.isOffCanvas(d3.event.x,d3.event.y)&&(a.unmask(),a.mask(a.localize("cleaning")),a.removeNode(f.id),a.unmask())}));e.append("title");
this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(f){return"keyword"===f.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",function(f){return a.getApplication().getCategoriesManager().getFeatureForTerm("font",f.term)}).text(function(f){return f.term}).style("cursor","pointer").style("user-select","none").attr("dominant-baseline","middle");d=e.merge(d);d.selectAll("title").text(function(f){return f.title});
d.selectAll("text").attr("font-size",function(f){return Math.max(10,Math.sqrt(f.value))}).each(function(f){f.bbox=this.getBBox()});this.setNodes(d);this.getNetworkMode()===this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",function(f){return f.bbox.width+16}).attr("height",function(f){return f.bbox.height+8}).attr("rx",function(f){return Math.max(2,.2*f.bbox.height)}).attr("ry",function(f){return Math.max(2,.2*f.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",
8).attr("dy",function(f){return.5*f.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(f){return Math.min(150,f.bbox.width)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",function(f){return"keyword"===f.type?.5*-f.bbox.width:8}).attr("dy",function(f){return"keyword"===f.type?0:.5*f.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},
isOffCanvas:function(a,b){var c=Ext.get(this.getVisId());return 0>a||0>b||a>c.getWidth()||b>c.getHeight()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2;c=this.getVis().node().parentElement;var h=c.getBoundingClientRect(),k=h.width;h=h.height;a=(a||.8)/Math.max(d/k,e/h);f=[k/2-a*f,h/2-a*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(a))},applyNodeStyle:function(a,b){var c=
void 0===b?"normal":b;a.style("fill",function(d){d=d.type+"Node";return this.getGraphStyle()[d][c].fill}.bind(this));a.style("stroke",function(d){d=d.type+"Node";return this.getGraphStyle()[d][c].stroke}.bind(this))},applyLinkStyle:function(a,b){var c=void 0===b?"normal":b;a.style("stroke",function(d){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(d){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},linkMouseOver:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));
...
name:"withDistributions",inputValue:"raw"},{boxLabel:"relative",name:"withDistributions",inputValue:"relative",style:"margin-left: 1em;"}],listeners:{afterrender:function(a){var b=this.up("window").panel;this.setFieldLabel("frequencies");var c=b.getApiParam("withDistributions");a.getBoxes().forEach(function(d){d.setBoxLabel(b.localize(d.inputValue));d.checked=d.inputValue==c});this.setValue({withDistributions:c})}}},{xtype:"colorpaletteoption"}]},statics:{i18n:{displayTip:"Chart display options",
labelsTip:"Toggle term labels",areaTip:"Area chart",barTip:"Columns chart",lineTip:"Line chart",stackedTip:"Stacked bar chart",barlineTip:"Line and stacked bar chart"},api:{limit:5,stopList:"auto",query:void 0,withDistributions:"relative",bins:10,docIndex:void 0,docId:void 0,mode:"corpus",chartType:"barline",labels:!1},glyph:"xf201@FontAwesome"},layout:"fit",documentTermsStore:void 0,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},
initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{itemId:"reset",text:this.localize("reset"),tooltip:this.localize("resetTip"),handler:function(a){this.setApiParams({docIndex:void 0,mode:void 0,query:void 0});this.loadCorpusTerms()},scope:this},{text:this.localize("display"),tooltip:this.localize("displayTip"),
glyph:"xf013@FontAwesome",menu:{listeners:{afterrender:function(a){var b=this.getApiParam("chartType");a.items.each(function(c){c.getItemId()==b&&c.addCls(c.activeCls)})},scope:this},defaults:{xtype:"menuitem",handler:function(a,b){"menucheckitem"==a.xtype?this.setApiParam("labels",a.checked):this.setApiParam("chartType",a.getItemId());this.loadCorpusTerms()},scope:this},items:[{xtype:"menucheckitem",text:this.localize("labels"),tooltip:this.localize("labelsTip"),checked:!0===this.getApiParam("labels")||
"true"==this.getApiParam("labels")},"-",{itemId:"area",text:this.localize("area"),tooltip:this.localize("areaTip"),glyph:"xe76b@Sencha-Examples"},{itemId:"bar",text:this.localize("bar"),tooltip:this.localize("barTip"),glyph:"xe768@Sencha-Examples"},{itemId:"line",text:this.localize("line"),tooltip:this.localize("lineTip"),glyph:"xe773@Sencha-Examples"},{itemId:"stacked",text:this.localize("stacked"),tooltip:this.localize("stackedTip"),glyph:"xe6c8@Sencha-Examples"},{itemId:"barline",text:this.localize("barline"),
tooltip:this.localize("barlineTip"),glyph:"xe779@Sencha-Examples"}]}}]}]});this.callParent(arguments)},listeners:{loadedCorpus:function(a,b){this.loadCorpusTerms()},termsClicked:function(a,b){var c=[];b.forEach(function(d){Ext.isString(d)?c.push(d):d.term?c.push(d.term):d.getTerm&&c.push(d.getTerm())});this.setApiParam("query",c&&0<c.length?c:void 0);this.loadCorpusTerms()},corpusTermsClicked:function(a,b){this.setApiParam("query",b.map(function(c){return c.getTerm()}));this.loadCorpusTerms()},documentSelected:function(a,
b){this.setApiParam("docIndex",this.getCorpus().getDocument(b).getIndex());this.loadDocumentTerms()},documentsClicked:function(a,b){1==b.length&&this.fireEvent("documentSelected",this,b[0])},query:function(a,b){this.fireEvent("termsClicked",this,b)}},loadCorpusTerms:function(a){if(2>this.getCorpus().getDocumentsCount()||"document"==this.getApiParam("mode")||0<Array.from(this.getApiParam("docIndex")||"").length)return this.loadDocumentTerms();if(this.getApiParam("query")){a=a||{};var b=this.getApiParam("withDistributions");
Ext.applyIf(a,{bins:this.getCorpus().getDocumentsCount(),limit:100,stopList:""});var c=[],d=[];this.getCorpus().each(function(e){c.push(e.getTinyTitle());d.push(e.getTitle())});Ext.Array.unique(c).length<c.length&&(c=c.map(function(e,f){return f+1+")"+e}));Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms().load({params:a,callback:function(e,f,g){var h=[],k=[],l=this.getApiParam("chartType");e.forEach(function(m,n){var u=m.get("term"),w=this.getApplication().getColorForTerm(u,!0);
m.get("distributions").forEach(function(p,q){h[q]||(h[q]={index:c[q],docTitle:d[q]});h[q]["_"+n]="relative"==b?p.toFixed(7):p;h[q]["term"+n]=u},this);"bar"!=l&&("barline"==l?["bar","line"]:[l]).forEach(function(p){k.push({type:"stacked"==p?"bar":p,title:u,xField:"index",yField:"_"+n,term:u,colors:[w],label:"barline"==l&&"bar"==p?{display:"none"}:{field:"term"+n}})},this)},this);f=e.map(function(m){return m.getTerm()});g=f.map(function(m){return this.getApplication().getColorForTerm(m,!0)},this);"bar"==
l&&k.push({type:"bar",title:f,colors:g,xField:"index",yField:0<h.length?Object.keys(h[0]).filter(function(m){return"_"==m.charAt(0)}):void 0,label:{field:e.map(function(m,n){return"term"+n})}});e=Ext.create("Ext.data.JsonStore",{fields:0<h.length?Object.keys(h[0]):void 0,data:h});this.buildChart({store:e,series:k,axes:[{type:"numeric",position:"left",increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("corpusTitle")}}]})},
scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:this.getApiParam("limit"),stopList:this.getApiParam("stopList")},callback:function(e,f,g){0==e.length?f&&f.error?this.showError(this.localize("noResults")+"\x3cp style\x3d'color: red'\x3e"+f.error+"\x3c/p\x3e"):this.showError(this.localize("noResults")):(this.setApiParam("query",e.map(function(h){return h.getTerm()})),this.loadCorpusTerms())},scope:this})},loadDocumentTerms:function(a){if(this.getApiParam("query")){this.setApiParam("mode",
"document");a=a||{};var b=this.getApiParam("withDistributions");Ext.applyIf(a,{limit:0,sort:"termasc",stopList:void 0});var c=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,callback:function(d,e,f){var g=[],h=[],k=this.getApiParam("chartType");c||d.sort(function(m,n){return m.getTerm()==n.getTerm()?m.getDocIndex()-n.getDocIndex():
m.getTerm().localeCompare(n.getTerm())});d.forEach(function(m,n){var u=m.get("term"),w=m.get("docIndex"),p=c?this.getApplication().getColorForTerm(u,!0):this.getApplication().getColor(w,!0);m.get("distributions").forEach(function(q,r){g[r]||(g[r]={index:r+1});g[r]["_"+n+"_"+w]="relative"==b?q.toFixed(7):q;g[r]["term"+n]=u},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(q){h.push({type:"stacked"==q?"bar":q,title:c?u:w+1+") "+u,xField:"index",yField:"_"+n+"_"+w,term:u,colors:[p],
label:"barline"==k&&"bar"==q?{display:"none"}:{field:"term"+n}})},this)},this);if("bar"==k){var l=Ext.Array.unique(d.map(function(m){return m.getTerm()})).length;e=d.map(function(m){return 1+m.get("docIndex")+") "+m.getTerm()});d=d.map(function(m){return l?this.getApplication().getColor(m.get("docIndex"),!0):this.getApplication().getColorForTerm(m.getTerm(),!0)},this);h.push({type:"bar",title:0<e.length?e:this.localize("noResults"),colors:d,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(m){return"_"==
m.charAt(0)}):void 0,label:{field:e}})}d=Ext.create("Ext.data.JsonStore",{fields:0<g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:d,series:h,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+(c?" ("+c.getTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:this.getApiParam("limit"),stopList:this.getApiParam("stopList")},
...
{},d=this.getTargetEl().down(".x-table-layout"),e=d.getSize(!1);d=d.dom.rows;for(var f=0;f<d.length;f++)for(var g=d[f].cells,h=0;h<g.length;h++){var k=Ext.get(g[h]),l=k.down(".x-panel"),m=l.id;if(void 0!==a&&void 0!==b)k=l.getSize(!1),k.width*=a,k.height*=b;else{l=k.getSize(!1);var n=Ext.getCmp(m),u=n.initialConfig.cellWidth;n=n.initialConfig.cellHeight;void 0!==u&&(l.width=u/100*e.width,k.setWidth(l.width));void 0!==n&&(l.height=n/100*e.height,k.setHeight(l.height));k=l}c[m]=k}for(var w in c)k=c[w],
Ext.getCmp(w).setSize(k);this.updateLayout()}});Ext.define("Voyant.panel.Veliza",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],xtype:"veliza",autoScroll:!0,statics:{i18n:{},api:{script:"",message:void 0},glyph:"xf0e6@FontAwesome"},config:{previous:[]},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);var a=this;Ext.apply(this,{title:this.localize("title"),glyph:"xf0e6@FontAwesome",layout:{type:"border",align:"stretch"},items:[{itemId:"chat",html:"\x3cform class\x3d'chat'\x3e\x3c/form\x3e",
...
var h=c.clientWidth,k=c.clientHeight;a=(a||.8)/Math.max(d/h,e/k);f=[h/2-a*f,k/2-a*g];d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(a))},idGet:function(a){return a.replace(/\W/g,"_")}});Ext.define("Voyant.panel.Topics",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.topics",statics:{i18n:{topics:"Topics",documents:"Documents"},api:{stopList:"auto",topics:10,termsPerTopic:10,iterations:100,perDocLimit:1E3,seed:0},glyph:"xf1ea@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"numberfield",name:"perDocLimit",fieldLabel:"maximum words per document",labelAlign:"right",value:1E3,minValue:1,step:100,listeners:{afterrender:function(a){var b=a.up("window");
b&&b.panel&&(a.setValue(parseInt(b.panel.getApiParam("perDocLimit"))),a.setFieldLabel(b.panel.localize("perDocLimit")))},change:function(a,b){a=a.up("window");5E3<b&&a&&a.panel&&a.panel.toastInfo({html:a.panel.localize("perDocLimitHigh"),anchor:a.getTargetEl(),align:"tr",maxWidth:400})}}},{xtype:"numberfield",name:"iterations",fieldLabel:"iterations per run",labelAlign:"right",value:100,minValue:50,maxValue:1E3,step:50,listeners:{afterrender:function(a){var b=a.up("window");b&&b.panel&&(a.setValue(parseInt(b.panel.getApiParam("iterations"))),
a.setFieldLabel(b.panel.localize("iterations")))}}},{xtype:"textfield",name:"seed",fieldLabel:"Random Seed",labelAlign:"right",value:0}],currentTopics:[],currentDocument:void 0,corpus:void 0},constructor:function(a){var b=this;Ext.apply(this,{title:this.localize("title"),layout:{type:"hbox",pack:"start",align:"begin",padding:"10px"},defaultType:"dataview",items:[{itemId:"topicsView",flex:2,padding:"0 5px 0 0",margin:"0 5px 0 0",height:"100%",scrollable:"y",store:Ext.create("Ext.data.ArrayStore",{fields:["index",
"terms","weight"]}),selectionModel:{type:"dataviewmodel",mode:"MULTI"},itemSelector:"div.topicItem",tpl:new Ext.XTemplate('\x3cdiv\x3e{[this.localize("topics")]}\x3c/div\x3e\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"topicItem" style\x3d"background-color: {[this.getColor(values.index)]}"\x3e','\x3cdiv class\x3d"data weight"\x3e{[fm.number(values.weight*100, "00.0")]}%\x3c/div\x3e','\x3cspan class\x3d"term"\x3e{[values.terms.join("\x3c/span\x3e \x3cspan class\x3d\\"term\\"\x3e")]}\x3c/span\x3e',"\x3c/div\x3e",
"\x3c/tpl\x3e",{getColor:function(c){return"rgba("+b.getColorForTopic(c).join(",")+",.33);"},localize:function(c){return b.localize(c)}}),listeners:{selectionchange:function(c,d){c.view.removeCls("showWeight");b.setCurrentDocument(void 0);b.setCurrentTopics(d.map(function(e){return e.get("index")}));b.down("#docsView").getSelectionModel().deselectAll(!0);b.down("#docsView").refresh()}}},{itemId:"docsView",flex:1,height:"100%",scrollable:"y",store:Ext.create("Ext.data.JsonStore",{fields:["docId","weights"]}),
selectionModel:{type:"dataviewmodel",mode:"SINGLE",allowDeselect:!0,toggleOnClick:!0},itemSelector:"div.topicItem",tpl:new Ext.XTemplate('\x3cdiv\x3e{[this.localize("documents")]}\x3c/div\x3e\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"topicItem"\x3e',"{[this.getDocTitle(values.docId)]}",'\x3cdiv class\x3d"chart"\x3e{[this.getChart(values.docId, values.weights)]}\x3c/div\x3e',"\x3c/div\x3e","\x3c/tpl\x3e",{getDocTitle:function(c){return b.getCorpus().getDocument(c).getTitle()},getChart:function(c,d){var e=
"";b.down("#topicsView").getStore().each(function(f){var g=f.get("index");f=d[g];var h=b.getColorForTopic(g);g=b.getCurrentDocument()===c?"1":0===b.getCurrentTopics().length?".33":-1!==b.getCurrentTopics().indexOf(g)?"1":".15";h="rgba("+h.join(",")+","+g+")";e+='\x3cdiv style\x3d"width: '+100*f+"%; background-color: "+h+'"\x3e \x3c/div\x3e'});return e},localize:function(c){return b.localize(c)}}),listeners:{selectionchange:function(c,d){b.setCurrentTopics([]);d=d[0]?d[0].get("docId"):void 0;b.setCurrentDocument(d);
var e=b.down("#topicsView").getStore();d?(b.down("#topicsView").addCls("showWeight").getSelectionModel().deselectAll(!0),e.beginUpdate(),c.view.getStore().query("docId",d).each(function(f){f.get("weights").forEach(function(g,h){e.findRecord("index",h).set("weight",g)})}),e.endUpdate(),e.sort("weight","DESC")):(b.down("#topicsView").removeCls("showWeight").getSelectionModel().deselectAll(!0),e.sort("index","ASC"));c.view.refresh()}}}],dockedItems:{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:['\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("searchTip")+'"\x3e'+this.localize("search")+"\x3c/span\x3e",{xtype:"textfield",name:"searchField",hideLabel:!0,width:80,listeners:{change:{fn:b.onQuery,scope:b,buffer:500}}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("limitTermsTip")+'"\x3e'+this.localize("limitTerms")+"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("termsPerTopic")))},
changecomplete:function(c,d){this.setApiParams({termsPerTopic:d});this.runIterations()},scope:this}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("numTopicsTip")+'"\x3e'+this.localize("numTopics")+"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("topics")))},changecomplete:function(c,d){this.setApiParams({topics:d});this.runIterations()},scope:this}},{text:"Run",itemId:"iterations",
glyph:"xf04b@FontAwesome",tooltip:this.localize("runIterationsTip"),handler:this.runIterations,scope:this}]}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(c,d){this.setCorpus(d);if(this.rendered)this.initialize();else this.on("afterrender",function(){this.initialize()},this)})},runIterations:function(){var a=this.getApiParams();a.tool="analysis.TopicModeling";a.corpus=this.getCorpus().getAliasOrId();var b=this.getApiParam("iterations"),
c=Ext.MessageBox.progress({title:this.localize("runningIterations"),message:(new Ext.Template(this.localize("runningIterationsCount"))).apply([b])});Ext.Ajax.request({url:this.getTromboneUrl(),params:a,success:function(d,e){c.close();d=JSON.parse(d.responseText);this.down("#topicsView").getStore().loadData(d.topicModeling.topicWords.map(function(f,g){return[g,f,0]}));d.topicModeling.topicDocuments.sort(function(f,g){f=this.getCorpus().getDocument(f.docId).getIndex();g=this.getCorpus().getDocument(g.docId).getIndex();
return f-g}.bind(this));this.down("#docsView").getStore().loadData(d.topicModeling.topicDocuments);this.down("#docsView").refresh()},scope:this})},getColorForTopic:function(a){return this.getApplication().getColor(a)},onQuery:function(a,b){a=this.down("#topicsView");a.getEl().query(".highlighted").forEach(function(g){g.classList.remove("highlighted")});if(""!==b.trim()){var c=new RegExp(b,"gi"),d=a.getStore(),e=[],f=[];d.each(function(g){for(var h=g.get("terms"),k=[],l=0;l<h.length;l++)-1!==h[l].search(c)&&
k.push(l);0<k.length&&e.push(g.get("index"));f.push(k)});0<e.length?(a.setSelection(e.map(function(g){return d.findRecord("index",g)})),a.getNodes().forEach(function(g,h){h=f[h];if(0<h.length){var k=g.querySelectorAll(".term");h.forEach(function(l){k[l].classList.add("highlighted")})}})):(this.setCurrentTopics([]),a.getSelectionModel().deselectAll(!0),this.down("#docsView").refresh())}else this.setCurrentTopics([]),a.getSelectionModel().deselectAll(!0),this.down("#docsView").refresh()},initialize:function(){this.runIterations()},
getExtraDataExportItems:function(){return[{name:"export",inputValue:"dataAsTsv",boxLabel:this.localize("exportGridCurrentTsv")}]},exportDataAsTsv:function(a,b){var c="Topic\t",d="Document Title",e=[];this.down("#topicsView").getStore().getData().each(function(f,g){0===g&&(c+=f.get("terms").map(function(h,k){return"Term "+k}).join("\t"));e.push(f.get("index"));c+="\nTopic "+f.get("index")+"\t"+f.get("terms").join("\t");d+="\tTopic "+f.get("index")+" Weight"});this.down("#docsView").getStore().getData().each(function(f){var g=
this.getCorpus().getDocument(f.get("docId")).getTitle(),h=e.map(function(k){k=f.get("weights")[k];return Ext.util.Format.number(100*k,"00.######")}).join("\t");d+="\n"+g+"\t"+h},this);Ext.create("Ext.window.Window",{title:a.localize("exportDataTitle"),height:290,width:450,bodyPadding:10,layout:{type:"vbox",pack:"start",align:"stretch"},modal:!0,defaults:{margin:"0 0 5px 0"},items:[{html:a.localize("exportDataTsvMessage")},{html:'\x3ctextarea class\x3d"x-form-text-default x-form-textarea" style\x3d"height: 76px; width: 100%"\x3e'+
c+"\x3c/textarea\x3e"},{html:'\x3ctextarea class\x3d"x-form-text-default x-form-textarea" style\x3d"height: 76px; width: 100%"\x3e'+d+"\x3c/textarea\x3e"}],buttonAlign:"center",buttons:[{text:"OK",handler:function(f){f.up("window").close()}}]}).show()}});Ext.define("Voyant.panel.Via",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.via",statics:{i18n:{},api:{stopList:"auto",limit:100,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"listeditor",name:"whiteList"},{xtype:"categoriesoption"}]},layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),
...
handler:function(f){f.up("window").close()}}]}));var b=Voyant.notebook.editor.EditorWrapper.currentEditor,c=b.up("notebook").getNotebookId()||"spyral",d=b.getMode(),e=new Ext.Deferred;a=null;a="file"===d||"corpus"===d?b.cachedInput.getBlob():b.results.updateCachedOutput().then(function(){return Ext.Promise.resolve(b.getOutput())});a.then(function(f){var g=b.getInput(),h=this.exportWin.down("#corpus"),k=this.exportWin.down("#open");h.setHidden(!0);k.setHidden(!1);if("file"===d||"corpus"===d){k.setHidden(!0);
var l="file"===d?g.fileName:"SpyralCorpus-"+g.corpusId;h=f.type;var m=f}else"javascript"===d?(Spyral.Util.isObject(f)&&f.hasOwnProperty("corpusid")&&Spyral.Util.isString(f.corpusid)&&(h.setHidden(!1),h.setHandler(function(u){u=Voyant.application.getBaseUrlFull()+"?corpus\x3d"+f.corpusid;window.open(u)})),Spyral.Util.isUndefined(f)&&(f=b.getContent().output),Spyral.Util.isObject(f)||Spyral.Util.isArray(f)?(l=c+"_"+b.getCellId()+".json",h="application/json",m=JSON.stringify(f)):Spyral.Util.isNode(f)||
Spyral.Util.isString(f)&&null!==f.match(/<\/?\w+.*?>/g)?(l=c+"_"+b.getCellId()+".html",h="text/html",m=Spyral.Util.isString(f)?f:(new XMLSerializer).serializeToString(f)):(l=c+"_"+b.getCellId()+".txt",h="text/plain",m=f)):(l=c+"_"+b.getDataName()+"."+d,h="text/"+d,m=g,"json"===d?h="application/json":"text"===d&&(l=c+"_"+b.getDataName()+".txt",h="text/plain"));var n=new File([m],l,{lastModified:(new Date).getTime(),type:h});this.exportWin.down("#open").setHandler(function(u){var w=window.open();w.document.write(m);
w.document.close();w.focus();u.up("window").close()});this.exportWin.addListener("show",function(){var u=URL.createObjectURL(n);this.exportWin.down("#download").getEl().set({download:l,href:u})},this,{single:!0});e.resolve(this.exportWin)}.bind(this),function(f){e.reject(f)});return e.promise}},constructor:function(a){Ext.apply(a,{text:this.localize("text")});this.callParent(arguments)},glyph:"xf08e@FontAwesome",handler:function(a){Voyant.notebook.editor.button.Export.getExportWindow(a).then(function(b){b.show()},
...
this)},this);this.callParent(arguments)},getContent:function(){throw Error("Subclass must override!");},applyIsEditing:function(a){this.rendered&&(a?this.body.addCls("notebook-editor-wrapper-editing"):this.body.removeCls("notebook-editor-wrapper-editing"));return a}});Ext.define("Voyant.notebook.editor.RunnableEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",mixins:["Voyant.util.Localization"],alias:"widget.notebookrunnableeditorwrapper",config:{isRun:!1,mode:"javascript"},editor:void 0,results:void 0,constructor:function(a){this.results.addListener("initialized",this.updateLayout,this);this.callParent(arguments)},run:function(a){return this.results.getIsInitialized()?(void 0===a&&(console.log("fetching prior vars"),a=this.up("notebook").getNotebookVariables(this)),
...
'\x3cspan class\x3d"spyral-dv-content"\x3e...\x3c/span\x3e')}};c(b,10);return b.outerHTML.replace(/spyral-dv-collapsed/g,"spyral-dv-expanded")}return a},expand:function(){this.editor.expand();this.setIsCollapsed(!1)},collapse:function(){this.editor.collapse();this.setIsCollapsed(!0)},getContent:function(){var a=this._reduceDataViewerOutput(this.results.getOutput());return{input:this.getInput(),output:a,mode:this.getMode(),expandResults:this.results.getExpandResults()}}});Ext.define("Voyant.notebook.editor.SandboxWrapper",{extend:"Ext.Container",mixins:["Voyant.util.Localization"],alias:"widget.sandboxwrapper",statics:{i18n:{expandResults:"Expand Results",collapseResults:"Collapse Results",viewWarnings:"View Warning(s)",generalWarning:"Warning: {warningInfo}",serializationWarning:'The variable "{warningInfo}" cannot be passed between cells.',loadVariableWarning:'The variable "{warningInfo}" could not be loaded.'}},config:{isInitialized:!1,cachedPaddingHeight:void 0,
cachedResultsHeight:void 0,cachedResultsValue:void 0,cachedResultsOutput:"",cachedResultsVariables:[],runPromise:void 0,hasRunError:!1,initIntervalID:void 0,maskTimeoutId:void 0,emptyResultsHeight:40,minimumResultsHeight:120,expandResults:!0},constructor:function(a){a.expandResults=void 0!==a.expandResults?a.expandResults:!0;var b=a.expandResults,c=a.sandboxSrcUrl;Ext.apply(this,{itemId:"parent",cls:"notebook-code-results",height:this.getEmptyResultsHeight(),layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",
flex:1,layout:{type:"absolute"},items:[{xtype:"uxiframe",itemId:"resultsFrame",x:0,y:0,anchor:"100%",height:"100%",src:c,renderTpl:['\x3ciframe allow\x3d"midi; geolocation; microphone; camera; display-capture; encrypted-media;" sandbox\x3d"allow-same-origin allow-scripts allow-modals allow-popups allow-forms allow-top-navigation-by-user-activation allow-downloads" src\x3d"{src}" id\x3d"{id}-iframeEl" data-ref\x3d"iframeEl" name\x3d"{frameName}" width\x3d"100%" height\x3d"100%" frameborder\x3d"0" style\x3d"min-height: 40px"\x3e\x3c/iframe\x3e']},
{xtype:"toolbar",itemId:"buttons",hidden:!0,x:0,y:0,style:{background:"none",paddingTop:"6px",pointerEvents:"none"},defaults:{style:{pointerEvents:"auto"}},items:["-\x3e",{itemId:"warnings",glyph:"xf12a@FontAwesome",hidden:!0,tooltip:this.localize("viewWarnings"),warnings:[],handler:function(d){0<d.warnings.length&&Ext.Msg.show({title:"Warning",message:d.warnings,buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})}},{itemId:"expandButton",glyph:b?"xf066@FontAwesome":"xf065@FontAwesome",tooltip:b?this.localize("collapseResults"):
this.localize("expandResults"),handler:function(){this._doExpandCollapse()},scope:this},{glyph:"xf014@FontAwesome",tooltip:"Remove Results",handler:function(){this.clear();this.hide()},scope:this}]}]},{xtype:"component",itemId:"expandWidget",height:20,hidden:b?!0:!1,style:{textAlign:"center",fontSize:"26px",cursor:"pointer",borderTop:"1px solid #DDD",color:"#000"},html:"\x26#8943;",listeners:{afterrender:function(d){var e=this;d.getEl().on("click",function(){e._doExpandCollapse()})},scope:this}}]});
this.callParent(arguments)},initComponent:function(){var a=this._handleResults.bind(this);this.on("afterrender",function(b){b.getEl().on("mouseover",function(d,e){b.down("#buttons").setVisible(!0)});b.getEl().on("mouseout",function(d,e){b.down("#buttons").setVisible(!1)});window.addEventListener("message",a);var c=this;this.setInitIntervalID(setInterval(function(){c._sendMessage({type:"command",command:"init"})},100))},this);this.on("removed",function(){window.removeEventListener("message",a)},this);
this.callParent(arguments)},clear:function(){!1===this.isVisible()&&(console.log("clearing but not visible!",this),this.show());this.down("#warnings").hide().warnings=[];this._sendMessage({type:"command",command:"clear"})},resetResults:function(){this.setCachedResultsValue(void 0);this.setCachedResultsOutput("");this.setCachedResultsVariables([])},run:function(a,b){void 0===b&&(b=[]);this.down("#warnings").hide().warnings=[];this.show();this.setHasRunError(!1);this.getEl().removeCls(["error","success",
"warning"]);this.setRunPromise(new Ext.Deferred);var c=this.getRunPromise().promise;c.then(function(d){d.warnings&&0<d.warnings.length?(this._handleWarnings(d.warnings),this.getEl().addCls("warning")):this.getEl().addCls("success")},function(){this.setHasRunError(!0);this.getEl().addCls("error")},void 0,this);this.mask("Running code...");this._sendMessage({type:"code",value:a,variables:b});return c},mask:function(a){var b=this;this.setMaskTimeoutId(setTimeout(function(){b.superclass.mask.call(b,a,
"spyral-code-mask")},250))},unmask:function(){clearTimeout(this.getMaskTimeoutId());this.superclass.unmask.call(this)},updateHtml:function(a){this._sendMessage({type:"command",command:"update",html:a})},updateValue:function(a,b){this._sendMessage({type:"command",command:"update",name:a,value:b})},getValue:function(){return this.getCachedResultsValue()},updateCachedOutput:function(){var a=this;return new Ext.Promise(function(b,c){a._sendMessage({type:"command",command:"getContents"});a.on("sandboxMessage",
function(d){"getContents"===d.command?a.setCachedResultsOutput(d.value):console.warn("getOutput: received unexpected message",d);b(a.getCachedResultsOutput())},a,{single:!0})})},getOutput:function(){return this.getCachedResultsOutput()},getVariables:function(){return this.getCachedResultsVariables()},applyCachedResultsVariables:function(a,b){var c=this.up("notebook");c&&c.updateTernServerVariables(a,b);return a},getResultsEl:function(){var a=this.down("#resultsFrame");return a?a:null},_sendMessage:function(a){this.down("#resultsFrame").getWin().postMessage(a,
...
hintDelay:5E3})}c.on("keypress",function(e,f){"."===f.key?Voyant.notebook.editor.CodeEditor.ternServer.complete(e):"{"===f.key&&(f=e.getCursor(),e.getRange({line:f.line,ch:0},f).match(/\(\s*$/)&&setTimeout(function(){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},50))});Object.assign(c.getOption("extraKeys"),{"Ctrl-Space":function(e){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},"Ctrl-D":function(e){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(e,void 0,a._showDocsCallback.bind(a))},
"Cmd-Space":function(e){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},"Cmd-D":function(e){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(e,void 0,a._showDocsCallback.bind(a))}});c.on("cursorActivity",function(e){Voyant.notebook.editor.CodeEditor.ternServer.updateArgHints(e)})}this.setEditor(c);this._setModeOptions(this.getMode());this.expand();a.fireEvent("resize",a)},removed:function(a,b){a.getEditor()&&a.setEditor(void 0)}},_getModeConfig:function(a){switch(a){case "json":a={name:"javascript",
json:!0};break;case "xml":a="xml";break;default:a="javascript"}return a},_setModeOptions:function(a){var b={};switch(a){case "json":case "javascript":b.autoCloseBrackets=!0;b.matchBrackets=!0;break;default:b.autoCloseBrackets=!1,b.matchBrackets=!1}for(var c in b)this.getEditor().setOption(c,b[c])},switchModes:function(a){console.log("mode",a);this.setMode(a);this.rendered&&(this.getEditor().setOption("mode",this._getModeConfig(a)),this._setModeOptions(a))},getValue:function(){return this.getEditor().getValue()},
...
b.where,b.cls):b.clear()});this.setMarkers([])},_showDocsCallback:function(){var a=this.getEditor().state.ternTooltip.querySelector("a");a&&a.addEventListener("click",function(b){b.preventDefault();b.stopPropagation();b=a.getAttribute("href");this.up("notebook").handleDocLink(b)}.bind(this))},expand:function(){var a=this.getEditor(),b=(this.MIN_LINES+1)*a.defaultTextHeight()+"px",c=a.getWrapperElement();c.style.setProperty("min-height",b);a.getScrollerElement().style.setProperty("min-height",b);a.setSize(null,
"auto");Ext.fly(c).unmask();this.setSize({height:a.getWrapperElement().offsetHeight});this.setIsCollapsed(!1)},collapse:function(){var a=this.getEditor(),b=a.defaultTextHeight()+8,c=a.getWrapperElement();c.style.removeProperty("min-height");a.getScrollerElement().style.removeProperty("min-height");a.setSize(null,b);c.querySelector(".CodeMirror-vscrollbar").style.setProperty("display","none");b=Ext.fly(c).mask();b.setStyle({cursor:"pointer",background:"none"});b.down(".x-mask-msg").hide();b.on("click",
function(d){this.up("notebookrunnableeditorwrapper").expand();this.getEditor().focus()}.bind(this));this.setSize({height:a.getWrapperElement().offsetHeight});this.setIsCollapsed(!0);setTimeout(function(){a.display.input.blur()},0)}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run","Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{}},constructor:function(a){a.mode="javascript";this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode,parentWrapper:this});
...
scope:this}},{xtype:"container",layout:"card",defaultType:"container",itemId:"cards",flex:1,margin:"5px 5px 5px 0",items:[{itemId:"text",items:[{xtype:"textfield",width:"75%",name:"text",fieldLabel:"",listeners:{change:function(){this.setCorpusId(void 0)},scope:this}}]},{itemId:"variable",items:[{xtype:"combo",name:"variable",fieldLabel:"",triggerAction:"all",queryMode:"local",editable:!1,forceSelection:!0,emptyText:this.localize("notebookVariables"),store:{fields:["text"]}}],listeners:{activate:function(b){this.populateVariables()},
change:function(){this.setCorpusId(void 0)},scope:this}},{itemId:"file",xtype:"notebookfileinput",flex:1,listeners:{change:function(){this.setCorpusId(void 0)},scope:this}},{itemId:"id",items:[{xtype:"textfield",width:"75%",name:"id",fieldLabel:"",listeners:{change:function(){this.setCorpusId(void 0)},scope:this}}]}]},{itemId:"corpusOptions",xtype:"button",width:60,margin:"5px 5px 5px 0",text:"Options",handler:function(b){void 0===this.corpusCreator&&(this.corpusCreator=Ext.create("Voyant.panel.CorpusCreator"));
this.corpusCreator.showOptionsClick(this.corpusCreator);this.corpusCreator.optionsWin.query("fieldset:last")[0].hide();this.corpusCreator.optionsWin.query("button:first")[0].on("click",function(c){this.setCorpusId(void 0)},this,{single:!0})},scope:this}],listeners:{boxready:function(b){a.type&&b.down("#type").setValue(a.type);if(a.value){var c=b.down("#"+a.type).child();c.setRawValue?c.setRawValue(a.value):c.setValue(a.value)}a.corpusId&&b.setCorpusId(a.corpusId);b.up("notebookdatawrapper").results.on("sandboxMessage",
function(d){if("result"===d.type){var e=b.up("notebookdatawrapper").getDataName();d=d.variables.find(function(f){return f.name===e});Spyral.Util.blobToString(d.value).then(function(f){f=JSON.parse(f);b.setCorpusId(f.corpusid)})}});b.up("notebook").on("notebookRun",b.populateVariables,b)}}});this.callParent(arguments)},populateVariables:function(){var a=this.up("notebookdatawrapper"),b=[];null!==a.previousSibling()&&(b=a.up("notebook").getNotebookVariables(a).map(function(e){return[e.name]}));a=this.down("#variable combo");
a.getStore().loadRawData(b);var c=!0,d=a.getRawValue();b.forEach(function(e){-1!==e.indexOf(d)&&(c=!1)});c&&a.setValue(void 0)},getCode:function(a){var b=new Ext.Deferred;if(this.getCorpusId()){var c=a+'\x3dnew Spyral.Corpus("'+this.getCorpusId()+'")';b.resolve(c)}else{c=this.down("#cards").getLayout().getActiveItem();var d=c.getItemId();this.setType(d);var e={};this.corpusCreator&&Ext.apply(e,this.corpusCreator.getApiParams());var f=JSON.stringify(e);"variable"===d?(c=c.down("combo").getRawValue(),
this.setValue(c),""!==c?b.resolve("Spyral.Corpus.load("+c+","+f+").then(function(){"+a+"\x3darguments[0];return "+a+".metadata()})"):b.reject("No variable specified!")):"file"===d?(d=c.getFile(),this.setValue(c.getFileName()),Spyral.Util.blobToDataUrl(d).then(function(g){b.resolve("Spyral.Corpus.load(Spyral.Util.dataUrlToBlob(`"+g+"`),"+f+").then(function(){"+a+"\x3darguments[0];return "+a+".metadata()})")},function(){b.reject()})):"text"===d?(c=c.down("textfield").getValue().replace('"','"'),this.setValue(c),
""!==c?b.resolve('Spyral.Corpus.load({input:"'+c+'"},'+f+").then(function(){"+a+"\x3darguments[0];return "+a+".metadata()})"):b.reject("No text entered!")):"id"===d&&(c=c.down("textfield").getValue().replace('"','"'),this.setValue(c),""!==c?b.resolve('Spyral.Corpus.load({corpus:"'+c+'"}).then(function(){'+a+"\x3darguments[0];return "+a+".metadata()})"):b.reject("No ID entered!"))}return b.promise},getInput:function(){return{corpusId:this.getCorpusId(),type:this.getType(),value:this.getValue()}},getBlob:function(){var a=
new Ext.Deferred,b=this.getCorpusId();void 0===b?a.reject():Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),binary:!0,params:{tool:"corpus.CorpusExporter",corpus:b,outputFormat:"zip"}}).then(function(c){c=new Blob([c.responseBytes],{type:"application/zip"});a.resolve(c)},function(c){a.reject(c)});return a.promise}});Ext.define("Voyant.notebook.editor.DataWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.FileInput","Voyant.notebook.editor.CorpusInput"],alias:"widget.notebookdatawrapper",cls:"notebook-data-wrapper",statics:{i18n:{dataNameAlphanum:"The data name must contain alphanumeric characters only",dataNameAlphastart:"The data name must not begin with a number"}},config:{dataName:void 0},constructor:function(a){a.mode=void 0!==
a.mode?a.mode:"json";var b="file"===a.mode||"corpus"===a.mode;this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode,hidden:b,parentWrapper:this});this.cachedInput="corpus"===a.mode?Ext.create("Voyant.notebook.editor.CorpusInput",a.input):Ext.create("Voyant.notebook.editor.FileInput",Ext.apply(b&&""!==a.input?a.input:{},{hidden:!b,margin:"5px"}));b=!a.output||-1!==a.output.indexOf("\x3eundefined\x3c");this.results=Ext.create("Voyant.notebook.editor.SandboxWrapper",
{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,hidden:b,listeners:{initialized:function(){this.fireEvent("initialized",this);void 0!==a.output&&this.results.updateHtml(a.output)},scope:this}});Ext.apply(this,{border:!1,layout:"anchor",defaults:{anchor:"100%"},items:[this.editor,this.cachedInput,{xtype:"form",cls:"notebook-data-input",bodyPadding:6,bodyStyle:"background-color: rgb(252, 252, 252);",layout:{type:"hbox",pack:"center"},items:[{width:350,xtype:"textfield",
fieldLabel:"Data Name",labelAlign:"right",name:"dataName",value:a.dataName,validator:function(c){return/^[a-zA-Z0-9_]+$/.test(c)?/^\D/.test(c)?!0:this.localize("dataNameAlphastart"):this.localize("dataNameAlphanum")}.bind(this),allowBlank:!1,listeners:{change:function(c,d,e){c.isValid()?this.setDataName(d):this.setDataName(void 0)},scope:this}},{width:100,margin:"0 0 0 6",xtype:"button",text:"Assign",handler:function(){this.down("textfield[name\x3ddataName]").validate()&&(this.up("notebook").setIsEdited(!0),
this.run())},scope:this}]},this.results]});this.callParent(arguments)},switchModes:function(a){"javascript"===a?(a=this.up("notebook"),a.addCode("",this.getIndex(),void 0,{mode:"javascript"}),a.notebookWrapperRemove(this)):(this.setMode(a),"file"===a?(this.editor.hide(),this.cachedInput.isXType("notebookcorpusinput")&&(this.cachedInput.destroy(),this.cachedInput=Ext.create("Voyant.notebook.editor.FileInput",{margin:"5px"}),this.insert(1,this.cachedInput)),this.cachedInput.show()):"corpus"===a?(this.editor.hide(),
this.cachedInput.isXType("notebookfileinput")&&(this.cachedInput.destroy(),this.cachedInput=Ext.create("Voyant.notebook.editor.CorpusInput",{}),this.insert(1,this.cachedInput)),this.cachedInput.show()):(this.cachedInput.hide(),this.editor.switchModes(a),this.editor.show()),this.updateLayout())},_getCode:function(){var a=new Ext.Deferred,b=this.getDataName(),c=this.down("textfield[name\x3ddataName]");if(void 0===b||!1===c.isValid())return c.markInvalid(c.getErrors(c.getValue())),a.reject(),a.promise;
c=this.getMode();if("file"===c||"corpus"===c)this.cachedInput.getCode(b).then(function(e){a.resolve(e)},function(){a.reject()});else{var d=this.editor.getValue();switch(c){case "text":d=b+"\x3d`"+d+"`";break;case "json":d=b+"\x3d JSON.parse(`"+d+"`)";break;case "xml":d=b+"\x3d new DOMParser().parseFromString(`"+d+'`, "application/xml")';break;case "html":d=b+"\x3d new DOMParser().parseFromString(`"+d+'`, "application/xml")'}a.resolve(d)}return a.promise},_run:function(a){var b=new Ext.Deferred,c=
this;this._getCode().then(function(d){c.results.clear();"file"!==c.getMode()&&"corpus"!==c.getMode()&&c.editor.clearMarkers();c.setIsRun(!0);c.results.run(d,a).then(function(e){b.resolve(e)},function(e){if(void 0!==e.error){var f=e.error.location;void 0!==f&&(c.editor.addMarker(f,"error"),c.editor.addLineMarker(f,"error"))}b.reject(e)})},function(){b.reject("Error handling data")});return b.promise},getInput:function(){var a=this.getMode();return"file"===a||"corpus"===a?this.cachedInput.getInput():
this.editor.getValue()},getContent:function(){var a=this.callParent(arguments);a.dataName=this.getDataName();return a}});Ext.define("Voyant.notebook.github.OctokitWrapper",{extend:"Ext.Base",alias:"octokitwrapper",octokit:void 0,constructor:function(a){this.octokit=new Octokit({auth:a.authToken,userAgent:"https://github.com/voyanttools/Voyant"})},getInfoForAuthenticatedUser:function(){return this.octokit.users.getAuthenticated()},getReposForAuthenticatedUser:function(a,b,c){return this.octokit.repos.listForAuthenticatedUser({affiliation:void 0===a?"owner":a,page:void 0===b?0:b,per_page:void 0===c?10:c})},getReposForUser:function(a,
...
"error");q.jumpTo(0);break}b.setStatus("Checking file");n="master";u=b.saveData;w={owner:e,repo:f,branch:n,path:k};return q.yield(b.octokit.getLatestFileSHA(w),7);case 7:p=q.yieldResult,void 0!==p?b.octokit.saveFile(e,f,k,u,n,"File updated by Spyral",p).then(function(r){this.setStatus("File updated");setTimeout(function(){this.fireEvent("fileSaved",this,w)}.bind(this),500)}.bind(b),function(r){this.setStatus("Error: "+r.message,"error")}):b.octokit.saveFile(e,f,k,u,n,"File created by Spyral").then(function(r){this.setStatus("File created");
...
notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,notebookInitialized:this.notebookInitialized,notebookSelected:this.handleNotebookSelected,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({notebookParent:this,listeners:{fileLoaded:function(c){this.checkIsEditedAndDoCallback(this,
function(){this.loadFromString(c)})},fileSaved:function(c,d,e){this.unmask();null!==d?((c=this.getNotebookId())&&d==c||this.setNotebookId(d),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1)):this.showError("There was an error saving your notebook:\n"+e)},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({parent:this,listeners:{fileLoaded:function(c,d){c=d.owner;var e=d.repo,f=d.path;d=
d.file;this.githubDialogs.close();this.loadFromString(d);d=encodeURIComponent(c+"/"+e+"/"+f);-1===location.search.indexOf(d)&&(c=this.getBaseUrl()+"spyral/?githubId\x3d"+d,window.history.pushState({url:c},"Spyral Notebook: "+d,c))},fileSaved:function(c,d){c=d.owner;var e=d.repo;d=d.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);d=encodeURIComponent(c+"/"+e+"/"+d);-1===location.search.indexOf(d)&&(c=this.getBaseUrl()+"spyral/?githubId\x3d"+
d,window.history.pushState({url:c},"Spyral Notebook: "+d,c))},saveCancelled:function(c){this.unmask()},scope:this}});this.catalogueWindow=new Voyant.notebook.Catalogue({listeners:{notebookSelected:this.handleNotebookSelected,scope:this}})},init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Promise.all([Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+
...
0;this.getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");this.getMetadata().set({userId:this.accountInfo.id});this.updateCachedOutput().then(function(b){},function(b){console.warn("Error updating cached results")}).finally(function(){var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),
...
d+". ("+Ext.Date.format(a,"Y")+"). "+c+". \x3ci\x3eSpyral - Voyant Tools\x3c/i\x3e, Development led by St\u00e9fan Sinclair and Geoffrey Rockwell. Retrieved "+Ext.Date.format(a,"F j, Y")+", from "+b+"\x3c/div\x3e\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},loadFromQueryParams:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=this.SPYRAL_ID_REGEX.exec(location.pathname),d=this.SPYRAL_ID_REGEX_OLD.exec(location.pathname),e=Ext.isDefined(a.githubId);
"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(g,h){0==g.trim().indexOf("\x3c")?0===h?this.setMetadata(new Spyral.Metadata({title:g})):this.addText(g):this.addCode(g)},this):c?(this.loadFromId(c[1]+this.NOTEBOOK_ID_SEPARATOR+c[2]),this.setStorageSolution("voyant")):d?(this.loadFromId(d[1]),this.setStorageSolution("voyant")):e?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),
this.setIsEdited(!1));if(b){var f=this;Ext.defer(function(){f.runAll()},100)}},loadFromString:function(a){a=a.trim();if(0===a.indexOf("{"))this.loadFromJson(a);else if(this.SPYRAL_ID_REGEX.test("/spyral/"+a)){var b=this.SPYRAL_ID_REGEX.exec("/spyral/"+a);this.loadFromId(b[1]+this.NOTEBOOK_ID_SEPARATOR+b[2])}else{if(0!==a.indexOf("\x3c")||-1===a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});
Ext.batchLayouts(function(){this.reset();this.setNotebookId(void 0);try{this.importFromHtml(a)}catch(c){Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}},this)}return!0},loadFromJson:function(a){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,
icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setMetadata(new Spyral.Metadata(b.metadata));var c=[];b.cells.forEach(function(d){var e=void 0;switch(d.type){case "text":this.addText(d.content,void 0,d.cellId);break;case "code":e=this.addCode(d.content,void 0,d.cellId);break;case "data":e=
this.addData(d.content,void 0,d.cellId)}e&&(e.on("initialized",function(){var f=c.indexOf(e);-1!==f?(c.splice(f,1),0===c.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",e)}.bind(this)),c.push(e))},this)},this)},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(c){b.unmask();c.notebook.success?(b.loadFromString(c.notebook.data),c.notebook.id&&
c.notebook.id!==b.getNotebookId()&&b.setNotebookId(c.notebook.id),b.setIsEdited(!1)):Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:c.notebook.error,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}).catch(function(c){b.unmask();Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},checkIsEditedAndDoCallback:function(a,b){this.getIsEdited()?Ext.Msg.show({title:this.localize("openTitle"),
message:this.localize("notSavedWarning"),buttons:Ext.Msg.YESNO,icon:Ext.Msg.QUESTION,fn:function(c){"yes"===c&&b.call(a)},scope:this}):b.call(a)},handleNotebookSelected:function(a,b,c){this.checkIsEditedAndDoCallback(a,function(){c.call(a);this.loadFromId(b)}.bind(this))},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){b.push(c);if(a&&a===c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),
function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(f){for(var g=0;g<b.length;g++)if(f.name===b[g].name){b.splice(g,1);break}});b=b.concat(e);Ext.defer(d._run,100,d,[a,b])},function(e){})}else this.updateTernServerVariables(this.getNotebookVariables()),
this.fireEvent("notebookRun",this)},notebookInitialized:function(){},updateTernServerVariables:function(a,b){Voyant.notebook.editor.CodeEditor.ternServer&&(b&&b.forEach(function(c){Voyant.notebook.editor.CodeEditor.ternServer.server.delFile(c.name)}),void 0===a?console.warn("updateTernServerVariables: no varsToAdd!"):a.forEach(function(c){c.isSpyralClass?Voyant.notebook.editor.CodeEditor.ternServer.server.addFile(c.name,"var "+c.name+" \x3d new "+c.isSpyralClass+"()"):Spyral.Util.blobToString(c.value).then(function(d){Voyant.notebook.editor.CodeEditor.ternServer.server.addFile(c.name,
"var "+c.name+" \x3d "+d)})}))},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(d){for(var e=0;e<b.length;e++)if(d.name===b[e].name){b.splice(e,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});return b},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"Spyral Notebook",
language:"English"}));this.addText(this.localize("newNotebookIntro"));this.addCode("")},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){d=d||{};d.docs=[this.ecmaTernDocs,this.browserTernDocs,this.spyralTernDocs];return this._add(a,b,"notebookcodeeditorwrapper",c,d)},addData:function(a,b,c,d){return this._add(a,b,"notebookdatawrapper",c,d)},_add:function(a,b,c,d,e){Ext.isString(a)&&(a={input:a});var f=this.getComponent("cells");b="undefined"===
typeof b?f.items.length:b;d="undefined"===typeof d?Spyral.Util.id():d;return f.insert(b,Ext.apply(a,{xtype:c,index:b,cellId:d},e))},notebookWrapperMoveUp:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);
a==b.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){var b=this.getComponent("cells");b.remove(a);0==b.items.length&&this.addText("(Click to edit).");this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=-1!==a.getXTypes(a).indexOf("notebookrunnableeditorwrapper");(!a&&
!b.hasModifier()||a&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookeditorwrapper").forEach(function(a,b){a.setIndex(b)});this.setIsEdited(!0)},applyIsEdited:function(a){this.rendered&&!a&&(this.query("notebookcodeeditor").forEach(function(b){b.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(b){b.setIsEditRegistered(!1)}));return a},applyNotebookId:function(a){if(!1===
this.isConfiguring){var b=this.getBaseUrl()+"spyral/";if(a){if(-1===a.indexOf(this.NOTEBOOK_ID_SEPARATOR))this.setNotebookName(a);else{var c=a.split(this.NOTEBOOK_ID_SEPARATOR)[1];this.setNotebookName(c)}b+=a.replace(this.NOTEBOOK_ID_SEPARATOR,"/")+"/"}window.history.pushState({url:b},"",b)}return a},applyMetadata:function(a){void 0!==a&&(a.title=a.title.replace(/<\/?\w+.*?>/g,""),a.description=a.description.replace(/<\/?\w+.*?>/g,""),this.isAuthenticated()&&""===a.userId&&""===a.author&&(a.userId=
this.accountInfo.id,a.author=this.accountInfo.name));return a},updateMetadata:function(){var a=this.getMetadata();document.title=a.title+" - Spyral";this.getComponent("spyralHeader").update(this.getInnerHeaderHtml());this.getComponent("spyralFooter").update(this.getInnerFooterHtml());this.metadataEditor&&this.metadataEditor.loadMetadata(a);this.setIsEdited(!0)},showMetadataEditor:function(){if(void 0===this.metadataWindow){var a=this;this.metadataEditor=Ext.create("widget.metadataeditor",{anchor:"100%"});
this.metadataWindow=Ext.create("Ext.window.Window",{title:this.localize("metadataEditor"),autoScroll:!0,width:600,closeAction:"hide",layout:"anchor",items:this.metadataEditor,buttons:[{text:this.localize("metadataCancel"),ui:"default-toolbar",handler:function(){this.up("window").close()}},{text:this.localize("metadataReset"),ui:"default-toolbar",handler:function(){a.metadataEditor.reset()}},{text:this.localize("metadataSave"),handler:function(){var c=a.metadataEditor.getForm().getValues();c.catalogue=
"true"===c.catalogue;a.getMetadata().set(c);a.updateMetadata();this.up("window").close()}}]})}var b=this.getMetadata();void 0===b&&(b=new Spyral.Metadata,this.setMetadata(b));this.metadataEditor.loadMetadata(b);this.metadataWindow.show()},showDocs:function(){void 0===this.docsWindow&&(this.docsWindow=Ext.create("Voyant.notebook.util.DocsWindow"));this.docsWindow.showDocs()},showDocsForClassMethod:function(a,b){void 0===this.docsWindow&&(this.docsWindow=Ext.create("Voyant.notebook.util.DocsWindow"));
this.docsWindow.showDocsForClassMethod(a,b)},handleDocLink:function(a){void 0===this.docsWindow&&(this.docsWindow=Ext.create("Voyant.notebook.util.DocsWindow"));this.docsWindow.handleDocLink(a)}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Colors"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",categories:"auto",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0,categoriesManager:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,

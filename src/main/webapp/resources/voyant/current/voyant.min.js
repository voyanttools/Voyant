...
this.getApplication();b.getAllowInput&&"false"==b.getAllowInput()&&(b.getNoAllowInputText&&0<b.getNoAllowInputText().trim().length?Ext.defer(function(){var c=a.up("container");c.removeAll();c.add({frame:!1,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},html:b.getNoAllowInputText()})},100):(a.hide(),Ext.create("Ext.window.Window",{layout:"fit",header:!1,modal:!0,bodyPadding:10,items:{html:"\x3cp style\x3d'color: red;'\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}}).show()))});a.callParent(arguments)},
loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)?(a={corpus:b.result.corpus?
b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId},Ext.applyIf(a,c),this.setCorpus(void 0),this.loadCorpus(a)):this.showResponseError("Unable to load corpus.",b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",
{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,anchor:"100% 100%",items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-120,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],
["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(a){var b=this.getApiParam("inputFormat");b&&a.setValue(b)},scope:a},change:{fn:function(a,c,d){a=a.up("form").down("[name\x3ddtocIndexDoc]");"dtoc"===c?a.show():a.hide()},scope:a}}},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",
title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("corpusTitle"),name:"title"},{fieldLabel:a.localize("corpusSubTitle"),name:"subTitle"},{fieldLabel:a.localize("corpusSort"),name:"sort",xtype:"combo",queryMode:"local",store:[["",a.localize("corpusSortAuto")],
["TITLEASC",a.localize("corpusSortTitle")],["AUTHORASC",a.localize("corpusSortAuthor")],["PUBDATEASC",a.localize("corpusSortPubDate")],["NOCHANGE",a.localize("corpusSortInitialOrder")]],value:"",listeners:{afterrender:{fn:function(a){var b=this.getApiParam("sort");b&&a.setValue(b)},scope:a}}},{fieldLabel:a.localize("dtocIndexDoc"),name:"dtocIndexDoc",xtype:"numberfield",value:-1,minValue:-1,maxValue:99,width:180,hidden:!0}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-text' target\x3d'voyantdocs'\x3e"+
...
handler:function(a){a.up("window").close()}}]}));a=a.up("notebookrunnableeditorwrapper");var b=a.up("notebook").getNotebookId()||"spyral",c=a.getInput(),d=a.getOutput(),e=a.getMode(),f=this.exportWin.down("#corpus"),g=this.exportWin.down("#open");f.setHidden(!0);g.setHidden(!1);if("file"===e){g.setHidden(!0);var h=c.fileName;f=d.type;var k=d}else"javascript"===e?(Spyral.Util.isObject(d)&&d.hasOwnProperty("corpusid")&&Spyral.Util.isString(d.corpusid)&&(f.setHidden(!1),f.setHandler(function(a){a=Voyant.application.getBaseUrlFull()+
"?corpus\x3d"+d.corpusid;window.open(a)})),Spyral.Util.isUndefined(d)&&(d=a.getContent().output),Spyral.Util.isObject(d)||Spyral.Util.isArray(d)?(h=b+"_"+a.getCellId()+".json",f="application/json",k=JSON.stringify(d)):Spyral.Util.isNode(d)||Spyral.Util.isString(d)&&null!==d.match(/<\/?\w+.*?>/g)?(h=b+"_"+a.getCellId()+".html",f="text/html",k=Spyral.Util.isString(d)?d:(new XMLSerializer).serializeToString(d)):(h=b+"_"+a.getCellId()+".txt",f="text/plain",k=d)):(h=b+"_"+a.getDataName()+"."+e,f="text/"+
e,k=c,"json"===e?f="application/json":"text"===e&&(h=b+"_"+a.getDataName()+".txt",f="text/plain"));var l=new File([k],h,{lastModified:(new Date).getTime(),type:f});this.exportWin.down("#open").setHandler(function(a){var b=window.open();b.document.write(k);b.document.close();b.focus();a.up("window").close()});this.exportWin.addListener("show",function(){var a=URL.createObjectURL(l);this.exportWin.down("#download").getEl().set({download:h,href:a})},this,{single:!0});return this.exportWin}},constructor:function(a){Ext.apply(a,
{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf08e@FontAwesome",listeners:{click:function(a){a.up("notebookrunnableeditorwrapper").results.updateCachedOutput().then(function(b){Voyant.notebook.editor.button.Export.getExportWindow(a).show()})}}});Ext.define("Voyant.notebook.editor.button.Counter",{extend:"Ext.toolbar.TextItem",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappercounter",statics:{i18n:{}},config:{order:0,name:void 0},cls:"notebookwrappercounter",constructor:function(a){Ext.apply(this,{toolTip:this.localize("tip")});this.callParent(arguments)},setOrder:function(a){this.callParent(arguments);this.updateHtml()},updateHtml:function(){var a=this.getOrder()+1,b=this.getName();this.setHtml('\x3ca name\x3d"'+b+'" href\x3d"#'+
...
this.serverStorage=Ext.create("Voyant.util.ServerStorage");this.callParent(arguments)},getDataUrl:function(){var a=new Ext.Deferred,b=this.callParent();void 0===b?this.getResourceId()?this.loadStoredFile().then(function(b){a.resolve(b)},function(){a.reject()}):this.getFile()?this.storeFile().then(function(b){a.resolve(b[1])},function(){a.reject()}):a.reject():a.resolve(b);return a.promise},storeFile:function(){var a=new Ext.Deferred,b=this.getFile();if(void 0===b)a.reject();else{var c=this;Spyral.Util.blobToDataUrl(b).then(function(b){var d=
Spyral.Util.id(32);c.serverStorage.storeResource(d,b).then(function(){c.setResourceId(d);c.setDataUrl(b);a.resolve([d,b])},function(){a.reject()})},function(b){a.reject(b)})}return a.promise},loadStoredFile:function(){var a=new Ext.Deferred,b=this.getResourceId();if(void 0===b)a.reject();else{var c=this;this.serverStorage.getStoredResource(b).then(function(b){void 0!==b?(c.setDataUrl(b),a.resolve(b)):a.reject()},function(){a.reject()})}return a.promise}});

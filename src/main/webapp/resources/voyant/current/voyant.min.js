...
if(c){var d=c[0],e=c[1];c=this.getCorpus();var f=!1;0!==d.position&&(f=!0);for(var g={},h=0,k=this.getApplication().getEntitiesEnabled?this.getApplication().getEntitiesEnabled():!1,l=d.docIndex;l<=e.docIndex;){var m=c.getDocument(l).get("tokensCount-lexical");m>this.MAX_TOKENS_FOR_NER&&(k=!1);l===e.docIndex&&(m=e.position);l===d.docIndex&&(m-=d.position);h+=m;g[l]=m;l++}l=this.down("#nerServiceParent");k?l.show():l.hide();h=Math.round(h*a);k=a=0;for(l=d.docIndex;l<=e.docIndex&&!(a=l,k+=g[l],k>=h);l++);

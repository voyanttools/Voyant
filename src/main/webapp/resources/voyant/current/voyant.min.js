...
hintDelay:5E3})}c.on("keypress",function(e,f){if("."===f.key)Voyant.notebook.editor.CodeEditor.ternServer.complete(e);else if("{"===f.key||","===f.key)if(f=e.getCursor(),f=e.getRange({line:f.line,ch:0},f),f.match(/\(\s*$/))setTimeout(function(){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},50);else{var g=f.match(/\.tool\(\s*['"]{1}(\w+)['"]{1}\s*,\s*/);null!==g&&setTimeout(function(){var h=g[1];(h=a.up("notebook").toolTernDocs[h])&&Voyant.notebook.editor.CodeEditor.ternServer.showCorpusToolHint(e,
h)},50)}else if("'"===f.key||'"'===f.key)f=e.getCursor(),f=e.getRange({line:f.line,ch:0},f),null!==f.match(/\.tool\(\s*$/)&&setTimeout(function(){e.showHint({hint:function(){var h=a.up("notebook");h=Object.keys(h.toolTernDocs).filter(function(l){return"!"!==l.charAt(0)});var k=e.getCursor();return{list:h,from:{line:k.line,ch:k.ch},to:{line:k.line,ch:k.ch}}}})},50)});Object.assign(c.getOption("extraKeys"),{"Ctrl-Space":function(e){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},"Ctrl-D":function(e){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(e,
void 0,a._showDocsCallback.bind(a))},"Cmd-Space":function(e){Voyant.notebook.editor.CodeEditor.ternServer.complete(e)},"Cmd-D":function(e){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(e,void 0,a._showDocsCallback.bind(a))}});c.on("cursorActivity",function(e){console.log("cursorActivity");Voyant.notebook.editor.CodeEditor.ternServer.updateArgHints(e)})}this.setEditor(c);this._setModeOptions(this.getMode());this.expand();a.fireEvent("resize",a)},removed:function(a,b){a.getEditor()&&a.setEditor(void 0)}},
getHintForTool:function(a,b,c,d){},_getModeConfig:function(a){switch(a){case "json":a={name:"javascript",json:!0};break;case "xml":a="xml";break;default:a="javascript"}return a},_setModeOptions:function(a){var b={};switch(a){case "json":case "javascript":b.autoCloseBrackets=!0;b.matchBrackets=!0;break;default:b.autoCloseBrackets=!1,b.matchBrackets=!1}for(var c in b)this.getEditor().setOption(c,b[c])},switchModes:function(a){console.log("mode",a);this.setMode(a);this.rendered&&(this.getEditor().setOption("mode",
this._getModeConfig(a)),this._setModeOptions(a))},getValue:function(){return this.getEditor().getValue()},addMarker:function(a,b){b="spyral-editor-"+(void 0===b?"error":b);var c=a[0];a=a[1];a--;c--;a=this.getEditor().getDoc().markText({line:c,ch:a},{line:c,ch:a+1},{className:b});this.getMarkers().push(a)},addLineMarker:function(a,b){b="spyral-editor-"+(void 0===b?"error":b);a=a[0];a--;a=this.getEditor().getDoc().addLineClass(a,"gutter",b);this.getMarkers().push({marker:a,where:"gutter",cls:b})},clearMarkers:function(){var a=
this.getEditor();this.getMarkers().forEach(function(b){b.marker?a.getDoc().removeLineClass(b.marker,b.where,b.cls):b.clear()});this.setMarkers([])},_showDocsCallback:function(){var a=this.getEditor().state.ternTooltip.querySelector("a");a&&a.addEventListener("click",function(b){b.preventDefault();b.stopPropagation();b=a.getAttribute("href");this.up("notebook").handleDocLink(b)}.bind(this))},expand:function(){var a=this.getEditor(),b=(this.MIN_LINES+1)*a.defaultTextHeight()+"px",c=a.getWrapperElement();
c.style.setProperty("min-height",b);a.getScrollerElement().style.setProperty("min-height",b);a.setSize(null,"auto");Ext.fly(c).unmask();this.setSize({height:a.getWrapperElement().offsetHeight});this.setIsCollapsed(!1)},collapse:function(){var a=this.getEditor(),b=a.defaultTextHeight()+8,c=a.getWrapperElement();c.style.removeProperty("min-height");a.getScrollerElement().style.removeProperty("min-height");a.setSize(null,b);c.querySelector(".CodeMirror-vscrollbar").style.setProperty("display","none");
b=Ext.fly(c).mask();b.setStyle({cursor:"pointer",background:"none"});b.down(".x-mask-msg").hide();b.on("click",function(d){this.up("notebookrunnableeditorwrapper").expand();this.getEditor().focus()}.bind(this));this.setSize({height:a.getWrapperElement().offsetHeight});this.setIsCollapsed(!0);setTimeout(function(){a.display.input.blur()},0)}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run","Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{}},constructor:function(a){a.mode="javascript";this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode,parentWrapper:this});

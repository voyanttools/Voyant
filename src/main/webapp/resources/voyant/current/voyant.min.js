...
n;for(n in k)if(-1!==this.termsFilter.indexOf(n)){var p=k[n];if(p){m++;this.SEPARATE_LINES_FOR_TERMS&&c();var r=0,q=p.color.join(",");this.ctx.strokeStyle="rgba("+q+", 1)";this.ctx.fillStyle="rgba("+q+", 0.35)";this.ctx.lineWidth=.25;h+=p.rawFreq;r+=p.rawFreq;for(var u=l&&this.lastClickedBubbles[b][n],v=0;v<p.pos.length;v++){var C=p.pos[v];if(0<C.radius){var w=!1;u&&this.lastClickedBubbles[b][n]==C.id&&(this.ctx.strokeStyle="rgba(0, 0, 0, 0.75)",this.ctx.fillStyle="rgba("+q+", 0.5)",this.ctx.lineWidth=
...
(d=90,c.ty=0):(d=-90,c.ty=c.height,c.tx=c.width));c.size=Math.max(c.height,c.width);c.rotation=Math.PI/180*d;g.context.fillStyle=g.canvas.style.backgroundColor;g.context.fillRect(0,0,g.canvas.width,g.canvas.height);c.draw(g.context);d=g.context.getImageData(c.x,c.y,c.width,c.height);e=[];for(var h=0;h<c.width;h++){var k=Math.floor(h/f.COARSENESS)*f.COARSENESS;null==e[k]&&(e[k]={});for(var l=0;l<c.height;l++){var m=Math.floor(l/f.COARSENESS)*f.COARSENESS;var n=4*(h+l*d.width);n=[d.data[n],d.data[n+
1],d.data[n+2],d.data[n+3]];"rgb("+n[0]+", "+n[1]+", "+n[2]+")"!=g.canvas.style.backgroundColor&&(e[k][m]=!0);e[k][m]&&(l=m+f.COARSENESS)}}c.mask=e}}function e(){g.clear();for(var a=q.length;a--;){var b=q[a];b.alpha=1;b.live&&b.draw(g.context)}a=$(g.canvas);if(null!=n){a.css("cursor","pointer");g.context.save();g.context.textBaseline="alphabetic";g.context.font="12px Arial";b=g.context.measureText(n.text).width;var c=g.context.measureText(n.value).width;b=(b>c?b:c)+20;c=p+15;var d=r+25,e=a.width();
a=a.height();c+b>=e&&(c-=b);d+40>=a&&(d-=40);g.context.fillStyle="rgba(255,255,255,0.9)";g.context.strokeStyle="rgba(100,100,100,0.9)";g.context.translate(c,d);g.context.fillRect(0,0,b,40);g.context.strokeRect(0,0,b,40);g.context.fillStyle="rgba(0,0,0,0.9)";g.context.fillText(n.text+":",8,18);g.context.fillText(n.value,8,30);g.context.restore()}else a.css("cursor","default")}var f=this,g=a;this.CIRCLE=0;this.ratio=1;var h=this.CIRCLE;this.getLayout=function(){return h};this.setLayout=function(a){h=
a};this.HORIZONTAL=0;var k=this.MIXED=1;this.getWordOrientation=function(){return k};this.setWordOrientation=function(a){k=a};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var n=null,p=0,r=0,q=[];this.getWords=function(){return q};this.setWords=function(a){q=a};this.sizeAdjustment=100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var u={};this.addWords=function(a){for(var b=!1,e=0;e<a.length;e++){var h=a[e];var k=null==
h.color||""==h.color?g.colors[Math.floor(Math.random()*g.colors.length)]:h.color;var l=null==h.size||""==h.size?Math.floor(40*Math.random()):parseFloat(h.size);var m=h.word,n=h.label,p=h.value;h=!1;null==u[m]&&(u[m]=!0,l>f.largestWordSize&&(f.largestWordSize=l,h=!0),l<f.smallestWordSize&&(f.smallestWordSize=.8*l,h=!0),m=new Word(m,l,k,n,p),q.push(m));b=h||b}c();this.setRelativeSizes();this.calculateSizeAdjustment();b?this.resizeWords():d()};this.resetWordCoordinates=function(){g.clear();clearTimeout(m);
...
this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f=function(){var a=this.wordsToArrange-1,f=g.canvas.width,h=g.canvas.height,k=.5*f,n=.5*h;do{var u=q[l];if(void 0!==u){for(var p=Math.random()*Math.PI,v=.25*Math.random()*u.size,r=.5*(Math.random()-.5),C=.5*u.width,x=.5*u.height;;){var w=Math.floor((k+Math.cos(p)*v*this.ratio-C)/this.COARSENESS)*this.COARSENESS;var E=Math.floor((n+Math.sin(p)*v-x)/this.COARSENESS)*this.COARSENESS;var I=w+C>=f||E+x>=h?!0:d(w,E,u.height,u.width,u.mask);if(!I)break;
...
(function(){function a(d,f,g){if(d.children){g&&(d.info.origIDs?(d.info.ids={},c(d.info.ids,d.info.origIDs),d.info.count=Object.keys(d.info.ids).length):(d.info.origIDs={},c(d.info.origIDs,d.info.ids),d.info.origCount=Object.keys(d.info.origIDs).length));var e=Object.keys(f);g=0;for(var k=e.length;g<k;g++)delete d.info.ids[e[g]];d.info.count=Object.keys(d.info.ids).length;k=d.children.length;for(g=0;g<k;g++)e=d.children[g],b(e.info.ids,f)?d.children[g]=null:a(e,f,!1);d.children=d.children.filter(function(a){return null!=
...
return b};b.redraw=function(){void 0!==z&&void 0!==F&&b.setupFromTries(z,F);return b};b.setupFromTries=function(d,e){z=d.getUniqRoot();F=e.getUniqRoot();var k=z.toTree(l.left),x=F.toTree(l.right);d=!0;0<Object.keys(x.pruned).length&&(a(x,x.pruned,d),a(k,x.pruned,d),d=!1);0<Object.keys(k.pruned).length&&(a(k,k.pruned,d),a(x,k.pruned,d));d={};for(var G in x.info)"continuations"!=G&&"ids"!=G&&"count"!=G&&(d[G]=x.info[G]);d["right continuations"]=x.info.continuations;d["left continuations"]=k.info.continuations;
d.ids={};c(d.ids,x.info.ids);c(d.ids,k.info.ids);d.count=Object.keys(d.ids).length;J=Object.keys(d.ids);if(x.info.origIDs||k.info.origIDs)d.origIDs={},c(d.origIDs,x.info.origIDs),c(d.origIDs,k.info.origIDs),d.origCount=Object.keys(d.origIDs).length;x.info=d;k.info=d;G=Math.max(k.maxChildren,x.maxChildren);if(isNaN(G)||0==G)return L=!1,b;p?D=d3.scaleLog().range([8,14]):(D=function(){return 14},D.domain=function(){});D.domain([Math.min(k.minCount,x.minCount),k.info.count]);var K=g-20-20,I=h-20-20;f.forEach(function(a,
...
g,h,k,!0,r,M,D,n,q,u,v,C,w,E);B=new doubletree.Tree(b.select("g"),g,h,x,!1,r,M,D,n,q,u,v,C,w,E)});A.handleAltPress=m.alt;B.handleAltPress=m.alt;A.handleShiftPress=m.shift;B.handleShiftPress=m.shift;A.handleClick=m.click;B.handleClick=m.click;L=!0;return b};b.setupFromArrays=function(a,c,d,e,f,g,h,l){void 0==f&&z&&(f=z.caseSensitive());void 0==g&&z&&(g=z.fieldNames());void 0==h&&z&&(h=z.fieldDelim());void 0==l&&z&&(l=z.distinguishingFieldsArray());z=new doubletree.Trie(f,g,h,l);F=new doubletree.Trie(f,
g,h,l);f=c.length;for(g=0;g<f;g++){h=e?e[g]:g;l=c[g];var m=a[g].slice(),n=d[g].slice();m.push(l);m.reverse();n.unshift(l);k?(F.addNgram(m,h),z.addNgram(n,h)):(z.addNgram(m,h),F.addNgram(n,h))}b.setupFromTries(z,F);return b};b.filteredIDs=function(){return J};b.search=function(a){A.search(a);B.search(a);a=d3.select(f[0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText").node()&&b--;return b};b.clearSearch=function(){A.clearSearch();
...
b.rectBorderColor=function(a){if(!arguments.length)return C;C=a;return b};b.continuationColor=function(a){if(!arguments.length)return w;w=a;return b};b.basicStyles=function(a){if(!arguments.length)return E;Object.keys(E).forEach(function(b){b in a&&Object.keys(E[b]).forEach(function(c){c in a[b]&&(E[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,l,m,n,p,r,q,u,v,C,w){function e(a){a.children&&(a._children=a.children,a._children.forEach(e),a.children=null)}function f(a){a.parent&&
a.parent.children.forEach(function(b){b!=a&&e(b)})}function g(a,b){d3.event.altKey?H.handleAltPress(a,b):d3.event.shiftKey?H.handleShiftPress(a,b):(H.handleClick(a,b),a.parent&&(H.continuationIDs!=a.data.info.ids&&(H.setIds(a.data.info.ids),H.clickedNode=a.id,m.call("idsUpdated",H)),f(a),h(a,!0)))}function h(a,b){a.children?(a.children&&1==a.children.length&&h(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&h(a.children[0],
!1));b&&H.update(a)}function F(a){return k?-a:a}var A=p,B=u;b=b-20-20;c=c-20-20;var J=0,D;l||(l=doubletree.sortByStrFld("token"));J=0;var G=d3.tree().size([c,b]).nodeSize([40,40]),N=d3.linkHorizontal().x(function(a){return F(a.y)}).y(function(a){return a.x});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){D=d3.hierarchy(a);D.x0=0;D.y0=0;D.children.forEach(e);this.update(D)};this.update=function(b){var c=G(D).descendants();c.forEach(function(a){var b=a.textSize;if(void 0==
b){b=0;for(var c=a.parent;null!=c;){var d=Ext.draw.TextMeasurer.measureText(c.data.name,"arial").width;b+=d;c=c.parent}a.textSize=b}a.y=25*a.depth+b});var d=a.selectAll("g.node_"+k).data(c,function(a){return a.id||(a.id=++J)}),e=d.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(a){return"translate("+F(b.y0)+","+b.x0+")"}).on("click",g);e.append("title").text(function(a){return doubletree.infoToText(a.data.info)});e.append("circle").attr("r",1E-6).style("fill",
function(a){return a._children?"#fff":w.node.fill}).style("stroke",function(a){return w.node.stroke});var f=e.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:k?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?k?"end":"start":k?"start":"end":"middle"}).style("font-size",function(a){return n(a.data.info.count)+"pt"});f.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return r(a.data.info,
...
e.selectAll("tspan").style("fill-opacity",1);d=d.exit().transition().duration(200).attr("transform",function(a){return"translate("+F(b.y)+","+b.x+")"}).remove();d.select("circle").attr("r",1E-6);d.selectAll("tspan").style("fill-opacity",1E-6);d=a.selectAll("path.link_"+k).data(D.links(),function(a){return a.source.id+"-"+a.target.id});d.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(a){a={x:b.x0,y:b.y0};return N({source:a,target:a})}).style("fill","none").style("stroke",
w.branch.stroke).style("stroke-width",w.branch["stroke-width"]).merge(d).transition().duration(200).attr("d",N);d.exit().transition().duration(200).attr("d",function(a){a={x:b.x0,y:b.y0};return N({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.drawRects=function(){var b=A?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);b=a.selectAll("g.node_"+k);b.selectAll("rect").remove();b.insert("rect","text").attr("class","nodeRect").attr("height",
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(a,b,c){this.id=b;this.count=c;this.info={count:c,ids:{}};if(null==a)this.item=k;else{this.item=a;this.info.ids={};this.info.ids[b]=!0;a=a.split(n);for(var d in a)this.info[m[d]]=[a[d]]}this.nodes={};this.addNgram=function(a,b,c){c||(c=1);if(0<a.length){var d=a.shift();var e=d.split(n);var g=r&&this.item==k?"":e.filter(function(a,b){return-1<p.indexOf(m[b])}).map(function(a){return l?a.toLocaleLowerCase():a}).join(n)}else g=d=h;if(g in this.nodes&&
this.nodes[g]instanceof f){var q=this.nodes[g];q.info.count+=c;q.info.ids[b]=!0;for(var u in e)g=e[u],-1==q.info[m[u]].indexOf(g)&&q.info[m[u]].push(g)}else q=new f(d,b,c),this.nodes[g]=q;d!=h&&q.addNgram(a,b,c)};this.getUniqRoot=function(){if(this.item==k){var a=Object.keys(this.nodes);if(1==a.length)return this.nodes[a[0]]}return this};this.toTree=function(a){function b(a,c,d){var e={children:[]};e.name=d.item;e.info={};for(var f in d.info)if("Object"===typeof d.info[f]){e.info[f]={};for(var h in d.info[f])e.info[f][h]=
...
[],c=this.absMaxFreq,d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,h=this.allData[e].allDataInternal.length;g<h;g++)for(var k=0,l=this.allData[e].allDataInternal[g].frequencyArray.length;k<l;k++)if(this.allData[e].allDataInternal[g].frequencyArray[k].wordString===a){var m=this.allData[e].allDataInternal[g].frequencyArray[k].freq;b.push({x:e,y:m});m<c&&(c=m);m>d&&(d=m);foundB=1}0===foundB&&(g=this.minFreq,b.push({x:e,y:g}),g<c&&(c=g),g>d&&(d=g))}return{path:b,min:c,max:d}},
...
Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:Ext.encode(a)},success:function(c,d){c=Ext.util.JSON.decode(c.responseText).storedResource.id;this.addColorPalette(c,a);b.resolve(c,a)},failure:function(a){b.reject()},scope:this});return b.promise},loadCustomColorPalette:function(a){var b=new Ext.Deferred;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a},success:function(c,d){c=Ext.util.JSON.decode(c.responseText).storedResource.resource;
c=Ext.decode(c);this.addColorPalette(a,c);b.resolve(a,c)},failure:function(a){this.setApiParam("palette",void 0);b.reject()},scope:this});return b.promise},getColor:function(a,b,c){a=a||"default";a=this.getPalettes()[a];b>=a.length&&(b%=a.length);return c?this.rgbToHex(a[b]):a[b]},getColorForTerm:function(a,b,c){var d=a||"default";d=this.getPalettes()[d];void 0===d&&(console.warn("no palette found for",a),d=this.getPalettes()["default"]);-1!=b.indexOf(":")&&(b=b.split(":")[1]);a=this.getColorTermAssociations().get(b);
null==a&&(a=this.getColorTermAssociations().getCount()%d.length,a=d[a],this.getColorTermAssociations().add(b,a));c&&(a=this.rgbToHex(a));return a},setColorForTerm:function(a,b){!1===Array.isArray(b)&&(b=this.hexToRgb(b));this.getColorTermAssociations().replace(a,b)},getColorForEntityType:function(a,b){switch(a){case "person":a=5;break;case "location":a=6;break;case "organization":a=2;break;case "misc":a=0;break;case "time":case "date":case "duration":a=4;break;case "money":a=1;break;default:a=8}a=
this.getPalettes().d3_set3[a];b&&(a=this.rgbToHex(a));return a}});Ext.define("Voyant.util.Deferrable",{deferredStack:[],releaseAllDeferred:function(){this.deferredStack=[]},getDeferredCount:function(){return this.deferredStack.length},getDeferred:function(a){var b=new Ext.Deferred;a&&a.transfer&&a.transfer(a,b.promise);!b.promise.show&&window.show&&(b.promise.show=show);this.deferredStack.push(b);var c=this;b.promise.always(function(){c.deferredStack.pop()});return b},getPromiseFromDeferred:function(a){return"object"===typeof a.promise?a.promise:a.promise()},getDeferredNestedPromise:function(a,
...
a.up("form").getValues();this.setApiParams(b);var c=this.getApplication(),d=[];void 0!==b.stopList&&void 0!==b.stopListGlobal&&b.stopListGlobal&&d.push(["stopList",b.stopList]);void 0!==b.categories&&d.push(["categories",b.categories]);var e=new Ext.Deferred;void 0!==b.palette?(c.resetColorTermAssociations(),0===c.getColorPalette(b.palette).length?c.loadCustomColorPalette(b.palette).then(function(){},function(){b.palette="default"}).always(function(){d.push(["palette",b.palette]);e.resolve()}):(d.push(["palette",
b.palette]),e.resolve())):e.resolve();e.promise.always(function(){var e=c.getCorpus();if(0<d.length){var f=c.getViewport().query("panel,chart");d.forEach(function(a){var b=a[0];a=a[1];c.setApiParam&&c.setApiParam(b,a);for(var d=0;d<f.length;d++)f[d].setApiParam&&f[d].setApiParam(b,a)});e?c.dispatchEvent("loadedCorpus",this,e):c.dispatchEvent("apiParamsUpdated",this,b)}e?this.fireEvent("loadedCorpus",this,e):this.fireEvent("apiParamsUpdated",this,b);a.up("window").close()}.bind(this))},scope:a}]},
bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}};c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a&&"Desktop"==Ext.os.deviceType&&!this.isXType("corpuscreator")&&
!this.isXType("notebook")){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){var b=a.config.type||a.type;b&&"help"!=b&&-1==b.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.config.type&&a.hide()})}},this)}},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),
...
a.isXType("notebook")&&c.splice(2,1);a.getExtraViewExportItems&&a.getExtraViewExportItems().forEach(function(a){Ext.applyIf(a,{xtype:"radio",name:"export"});c.push(a)});b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,
...
(c?"debug\x3dtrue\x26":"")+"inputJsonArrayOfEncodedBase64\x3d"+btoa(encodeURIComponent(a)).replace(/=/g,"%3D"))},exportGridCurrentJson:function(a,b){function c(a){var b={};d.forEach(function(c){b[c.text]=a.get(c.dataIndex)});values.push(b)}b=a.getStore();b.getFields();var d=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(a){return a.dataIndex&&0<a.dataIndex.trim().length});values=[];b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataJsonMessage"),
buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){var b=[];d.forEach(function(c){c=a.get(c.dataIndex);Ext.isString(c)&&(c=c.replace(/\s+/g," "));b.push(c)});f+=b.join("\t")+"\n"}b=a.getStore();var d=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(a){return a.dataIndex&&0<a.dataIndex.trim().length}),e=[];d.forEach(function(a){e.push(a.text)});var f=e.join("\t")+"\n";b.buffered?b.data.forEach(c):
...
e=a.getColumnManager().headerCt.getVisibleGridColumns().filter(function(a){return a.dataIndex&&0<a.dataIndex.trim().length});e.forEach(function(a){d+="\t\t\t\x3ctd\x3e"+a.text+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";b.buffered?b.data.forEach(c):b.each(c);d+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d})},exportGridAllJson:function(a,
b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllJsonWarning"),function(b){"yes"==b&&(b={start:0},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},exportGridAllTsv:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllTsvWarning"),function(b){"yes"==b&&(b={start:0,template:this.getXType()+"2tsv",outputFormat:"text"},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),
...
arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getDocumentTerms();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},loadTokens:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getTokens({});c.load({params:a,callback:function(a,
...
getTarget:function(){return this.get("target")},show:function(a){show(this.getString(a))},getString:function(){return this.getSource()+"-"+this.getTarget()}});Ext.define("Voyant.data.store.VoyantStore",{mixins:["Voyant.util.Localization","Voyant.notebook.util.Embed"],config:{corpus:void 0,parentPanel:void 0},statics:{i18n:{maxTime:"This tool has exceeded the maximum run time and has returned partial results."}},constructor:function(a,b){var c=this;a=a||{};Ext.applyIf(a,{remoteSort:!0,autoLoad:!1,pagePurgeCount:0,pageSize:100,leadingBufferZone:200});a.proxy=a.proxy||{};Ext.applyIf(a.proxy,{type:"ajax",url:Voyant.application.getTromboneUrl(),actionMethods:{read:"POST"},
timeout:b["proxy.timeout"]||3E4,reader:{type:"json",rootProperty:b["proxy.reader.rootProperty"],totalProperty:b["proxy.reader.totalProperty"],metaProperty:b["proxy.reader.metaProperty"]||"metaData"},simpleSortMode:!0,listeners:{exception:function(a,b,f){c.parentPanel&&c.parentPanel.showError&&c.parentPanel.showError(f)},endprocessresponse:function(a,b,f){f.wasSuccessful()&&(a=a.getReader().initialConfig.rootProperty.split(".")[0],(b=JSON.parse(b.responseText)[a])&&b.messages&&(b=b.messages[0],b="maxTime"===
b.code?c.localize("maxTime"):b.message,c.parentPanel&&c.parentPanel.toastInfo?c.parentPanel.toastInfo(b):console.warn("VoyantStore server message: "+b)))}}});a.proxy.extraParams=a.proxy.extraParams||{};Ext.applyIf(a.proxy.extraParams,{tool:b["proxy.extraParams.tool"]});void 0!==a.parentPanel&&(Ext.applyIf(a.proxy.extraParams,{forTool:a.parentPanel.xtype}),this.setParentPanel(a.parentPanel),a.parentPanel.on("loadedCorpus",function(a,b){this.setCorpus(b)},this),a.listeners=a.listeners||{},a.listeners.beforeload=
...
Ext.define("Voyant.data.store.NotebookFacetsBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.NotebookFacetsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.NotebookFacetsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.table.Table",{alternateClassName:["VoyantTable"],mixins:["Voyant.notebook.util.Embed"],embeddable:["Voyant.widget.VoyantTableTransform","Voyant.widget.VoyantChart","Voyant.widget.CodeEditor"],config:{rows:[],headers:[],rowsMap:{},headersMap:{},rowKey:void 0,model:void 0},clone:function(){var a=new VoyantTable;a.setRows(Ext.clone(this.getRows()));a.setHeaders(Ext.clone(this.getHeaders()));a.setRowsMap(Ext.clone(this.getRowsMap()));a.setHeadersMap(Ext.clone(this.getHeadersMap()));
...
b){for(var d=0,e=c.length;d<e;d++){var h=c[d].index;if(a[h]!=b[h])return"asc"==c[d].direction?a[h]>b[h]?1:-1:a[h]>b[h]?-1:1}});this.reMapRows();return this},loadCorrespondenceAnalysis:function(a){return this._doAnalysisLoad("table.CA","Voyant.data.store.CAAnalysis",a)},loadPrincipalComponentAnalysis:function(a){return this._doAnalysisLoad("table.PCA","Voyant.data.store.PCAAnalysis",a)},loadTSNEAnalysis:function(a){return this._doAnalysisLoad("table.TSNE","Voyant.data.store.TSNEAnalysis",a)},_doAnalysisLoad:function(a,
...
f.close(),b.call(d,e.entities)):(d.updateProgress(e.status,f),g?(f=d.getProgressWindow(),f.down("#identifyingMessage").getEl().down("div.x-mask-msg-text").setStyle("backgroundImage","none"),f.down("#doneButton").setHidden(!1),h&&!k?f.down("#retryButton").setHidden(!1).setDisabled(!1).setHandler(function(c){d.load(Ext.apply({retryFailures:!0},a),b);c.setDisabled(!0)},d):(f.down("#retryButton").setHidden(!0),c&&f.close()),b.call(d,e.entities)):(delete a.retryFailures,d.setTimeoutId(Ext.defer(d.doLoad,
d.getUpdateDelay(),d,[a,b,!1]))))},function(a){Voyant.application.showError(d.localize("error"));console.warn(a);b.call(d,null)})},_getProgressFromStatus:function(a){var b=a.length,c=0,d=!1,e=[];a.forEach(function(a){"done"===a[1]?c++:0===a[1].indexOf("failed")&&(c++,d=!0,a=a[1].match(/\d\d\d$/),null!==a&&e.push(a[0]))});return[c,b,d,e]},updateProgress:function(a,b){void 0===this.getProgressWindow()&&this.setProgressWindow(Ext.create("Ext.window.Window",{title:this.localize("identifyingDocEnts"),
...
{fields:["docTitle","statusIcon","statusText"]}),itemSelector:".doc",tpl:'\x3ctpl for\x3d"."\x3e,\x3cdiv class\x3d"doc"\x3e,\x3ci class\x3d"fa {statusIcon}" style\x3d"margin-right: 5px;"\x3e\x3c/i\x3e,\x3cspan class\x3d"" style\x3d""\x3e{docTitle}\x3c/span\x3e,\x3cspan style\x3d"float: right"\x3e{statusText}\x3c/span\x3e,\x3c/div\x3e,\x3c/tpl\x3e'.split(",")}],tools:[{type:"restore",itemId:"restoreButton",hidden:!0,handler:function(a,b,c,d){a=c.up("window");a.expand();a.anchorTo(Ext.getBody(),"c-c",
[0,-a.getBox().height],{duration:250});d.hide()}}],buttons:[{itemId:"retryButton",xtype:"button",text:this.localize("retry"),hidden:!0},{itemId:"doneButton",xtype:"button",text:this.localize("done"),hidden:!0,handler:function(a){a.up("window").close()}}],listeners:{minimize:function(a){a.collapse(Ext.Component.DIRECTION_BOTTOM,!1);a.anchorTo(Ext.getBody(),"br-br",[0,0],{duration:250});a.down("#restoreButton").show()},destroy:function(a){clearTimeout(this.getTimeoutId());this.setProgressWindow(void 0)},
scope:this}}));var c=b[0];b=b[1];var d=this.getProgressWindow();d.down("#progressBar").updateProgress(c/b,c+" / "+b);var e=Voyant.application.getCorpus().getDocuments();a=a.map(function(a,b){b=e.getById(a[0]).getShortTitle();a=a[1];var c="fa-spinner",d="";0===a.indexOf("failed")?(c="fa-exclamation-triangle",d=-1!==a.indexOf("413")?this.localize("status413"):this.localize("statusFailed"),console.log("ner: "+b+", "+a)):"done"===a?(c="fa-check",d=""):"queued"===a&&(c="fa-clock-o",d="");return[b,c,d]},
this);d.down("#documentStatus").getStore().loadData(a);d.setTitle(this.localize("identifyingDocEnts")+" "+c+" / "+b);d.show()}});Ext.define("Voyant.data.model.Corpus",{alternateClassName:["Corpus"],mixins:["Voyant.notebook.util.Embed","Voyant.util.Transferable","Voyant.util.Localization"],transferable:"loadCorpusTerms loadTokens getPlainText getText getWords getString getLemmasArray".split(" "),embeddable:"Voyant.panel.Summary Voyant.panel.Cirrus Voyant.panel.Documents Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Trends Voyant.panel.TermsRadio Voyant.panel.DocumentTerms Voyant.panel.TermsBerry Voyant.panel.CollocatesGraph Voyant.panel.Contexts Voyant.panel.WordTree Voyant.panel.Veliza Voyant.panel.ScatterPlot Voyant.panel.Topics".split(" "),
...
a)}).then(function(a){0==a.getDocumentsCount()&&Voyant.application.showError(d.localize("thisCorpus")+" "+d.localize("isEmpty")+".");!("docsLimit"in b)||!1!==b.docsLimit&&0<b.docsLimit?d.getDocuments().load({params:{limit:"docsLimit"in b?b.docsLimit:d.getDocumentsCount()},callback:function(b,e,h){h?(d.setDocumentsStore(this),c.resolve(a)):c.reject(e)}}):c.resolve(a)})}else Voyant.application.showError(this.localize("badDataTypeCorpus")+": ("+typeof b+") "+b),Ext.defer(function(){c.reject(this.localize("badDataTypeCorpus")+
...
a||{};if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);Ext.applyIf(a,{template:"docTokens2lemmas",withPosLemmas:!0,noOthers:!0});this.getWords(a).then(function(a){a=a.split(" ").map(function(a){return a.substring(0,a.indexOf("/"))});b.resolve(a)});return b.promise},getReadability:function(a,b){b=b||{};var c="corpus.";switch(void 0===a?"coleman-liau":a){case "automated":c+="DocumentAutomatedReadabilityIndex";break;case "coleman-liau":c+=
"DocumentColemanLiauIndex";break;case "dale-chall":c+="DocumentDaleChallIndex";break;case "fog":c+="DocumentFOGIndex";break;case "lix":c+="DocumentLIXIndex";break;case "smog":c+="DocumentSMOGIndex"}Ext.apply(b,{corpus:this.getId(),tool:c});var d=Voyant.application.getDeferred(this);this.getId();Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:b}).then(function(a){a=Ext.JSON.decode(a.responseText);var b;for(b in a)if(0===b.indexOf("document")){var c=b;break}if(c){var e;for(e in a[c]){var k=
e;break}var l=k.substring(0,k.length-2);c=a[c][k].map(function(a){return{docIndex:a.docIndex,docId:a.docId,text:a.text,readability:a[l]}});d.resolve(c)}else d.reject()},function(a){d.reject()});return d.promise},getString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+".";else{c+=" ";c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):c+this.localize("has1document");c+=" "+(new Ext.XTemplate(this.localize("widthNwordsAndNTypes"))).apply({words:Ext.util.Format.number(this.getWordTokensCount(),
...
Ext.Msg.show({title:this.localize("editStopListTitle"),message:this.localize("editStopListMessage"),buttons:Ext.Msg.OKCANCEL,buttonText:{ok:this.localize("ok"),cancel:this.localize("cancel")},icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:b,original:b,fn:function(b,d,g){d=d.toLowerCase();"ok"==b&&g.original!=d&&(b=this.down("combo"),0==Ext.String.trim(d).length?b.setValue("empty"):Ext.Ajax.request({url:a.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:d,corpus:c},combo:b,success:function(a,
b){var c=Ext.util.JSON.decode(a.responseText);a=b.combo.getStore();c="keywords-"+c.storedResource.id;a.add({name:c,value:c});b.combo.setValue(c);b.combo.updateLayout()},scope:this}))},scope:this})},scope:this}):Ext.Msg.show({title:this.localize("noEditAutoTitle"),message:this.localize("noEditAutoMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}});Ext.define("Voyant.widget.QuerySearchField",{extend:"Ext.form.field.Tag",mixins:["Voyant.util.Localization"],alias:"widget.querysearchfield",statics:{i18n:{}},config:{corpus:void 0,tokenType:"lexical",isDocsMode:!1,inDocumentsCountOnly:void 0,stopList:void 0,showAggregateInDocumentsCount:!1,clearOnQuery:!1,parentPanel:void 0,currentOriginalRawQueryPlan:void 0},hasCorpusLoadedListener:!1,isClearing:!1,constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,maxWidth:200,matchFieldWidth:!1,minChars:2,
...
(a.cancel=a.query.length<(/\W/.test(a.query.charAt(1))?5:4));try{new RegExp(a.query)}catch(k){a.cancel=!0}-1<a.query.indexOf('"')&&(-1==a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||[]).length&&(a.cancel=!0));-1<a.query.indexOf("*")?-1==a.query.indexOf(" ")&&-1==a.query.indexOf("|")&&(a.query+=",^"+a.query):a.query=a.query+"*"+(-1==a.query.indexOf(" ")&&-1==a.query.indexOf("|")?",^"+a.query+"*":"")}else"@"==a.query&&(a.cancel=!0);var d=b.getParentPanel();if(0==a.cancel&&d){var g="@"==
c.charAt(0)?c.substring(1):c,h;for(h in d.getApplication().getCategoriesManager().getCategories())-1<h.toLowerCase().indexOf(g)&&(a.query="@"+h+("@"==c.charAt(0)?"":","+a.query))}}},this);b.on("change",function(a,c){b.isClearing?b.isClearing=!1:(c=c.map(function(a){return a.replace(/^(\^?)\*/,"$1.*")}),b.up("panel").fireEvent("query",b,c),b.getClearOnQuery()&&(b.isClearing=!0,b.removeValue(b.getValueRecords())),b.triggers.count&&(b.triggers.count.show(),b.triggers.count.getEl().setHtml("0"),0<c.length?
...
if(void 0!==c)for(var d=0;d<c.length;d++)b.push({term:c[d]});var e=this.queryById("categories").add({xtype:"grid",category:a,title:a,frame:!0,width:150,margin:"10 0 10 10",layout:"fit",tools:[{type:"close",tooltip:this.localize("removeCategory"),callback:function(b){Ext.Msg.confirm(this.localize("removeCategory"),this.localize("confirmRemove"),function(b){"yes"===b&&this.removeCategory(a)},this)},scope:this}],bbar:[{xtype:"button",text:"",tooltip:this.localize("increaseCategory"),glyph:"xf067@FontAwesome",
handler:function(a){a=a.findParentByType("grid");var b=this.queryById("categories"),c=b.prevChild(a);null!==c&&(b.moveBefore(a,c),this.app.getCategoriesManager().setCategoryRanking(a.getTitle(),b.items.indexOf(a)))},scope:this},"-\x3e",{xtype:"button",text:"",tooltip:this.localize("decreaseCategory"),glyph:"xf068@FontAwesome",handler:function(a){a=a.findParentByType("grid");var b=this.queryById("categories"),c=b.nextChild(a);null!==c&&(b.moveAfter(a,c),this.app.getCategoriesManager().setCategoryRanking(a.getTitle(),
b.items.indexOf(a)))},scope:this}],store:Ext.create("Ext.data.JsonStore",{data:b,fields:["term"]}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});return a.substr(0,a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{dataIndex:"term",flex:1,sortable:!0}],listeners:{beforedrop:function(a,b){a=this.up("categoriesbuilder").categoriesManager;var c=b.view.up("grid");if(void 0!==c.category)for(var d=
b.records.length-1;0<=d;d--){var e=b.records[d].get("term");a.removeTerm(c.category,e)}},drop:function(b,c){c.view.getSelectionModel().deselectAll();this.getSelectionModel().deselectAll();b=this.up("categoriesbuilder").categoriesManager;for(var d=[],e=0;e<c.records.length;e++){var f=c.records[e].get("term");d.push(f)}b.addTerms(a,d)}}}),f=new Ext.Editor({updateEl:!0,alignment:"l-l",autoSize:{width:"boundEl"},field:{xtype:"textfield",allowBlank:!1,validator:function(a){return void 0===this.categoriesManager.getCategoryTerms(a)||
a===e.getTitle()?!0:this.localize("exists")}.bind(this)},listeners:{complete:function(a,b,c){this.categoriesManager.renameCategory(c,b);this.buildFeatures()},scope:this}});e.header.getTitle().textEl.on("dblclick",function(a,b){f.startEdit(b)})},removeCategory:function(a){var b=this.queryById("categories"),c=b.queryBy(function(b){return b.category&&b.category==a?!0:!1});b.remove(c[0]);b=this.queryById("features").getStore();b.removeAt(b.findExact("category",a));this.categoriesManager.removeCategory(a)},
addFeature:function(a){this.categoriesManager.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.categoriesManager.getCategories())c.push({category:d});var e=this.categoriesManager.getFeatures(),f=Ext.ClassManager.getClass(this).features,g;for(g in e){a.push(g);e=f[g];var h=Ext.applyIf({feature:g,listeners:{change:function(a,
...
8],dragging:!1,nodeScaling:{minSize:8,maxSize:36,scalingFunction:void 0},edgeScaling:{minSize:1,maxSize:10,scalingFunction:void 0},graphStyle:{node:{normal:{fill:"#c6dbef",fillOpacity:1,stroke:"#6baed6",strokeOpacity:1,strokeWidth:1},highlight:{fill:"#9ecae1",fillOpacity:1,stroke:"#3182bd",strokeOpacity:1,strokeWidth:3}},edge:{normal:{stroke:"#000000",strokeOpacity:.25,strokeWidth:1},highlight:{stroke:"#000000",strokeOpacity:.5,strokeWidth:3}}},graphPhysics:{damping:.4,centralGravity:.1,nodeGravity:-50,
...
b[a.term]&&(a.id=this.idGet(a.term),c.push(a))},this);a.edges.forEach(function(a){for(var b=this.idGet(a.source),c=this.idGet(a.target),e=this.getEdgeData(),k=!1,l=0;l<e.length;l++){var m=e[l];if(m.source.id==b&&m.target.id==c||m.target.id==b&&m.source.id==c){k=!0;break}}k||(a.source=b,a.target=c,a.id=b+"-"+c,d.push(a))},this);this.setNodeData(this.getNodeData().concat(c));this.setEdgeData(this.getEdgeData().concat(d));this.refreshGraph()},processJson:function(a){a&&a.edges||(a&&a.links&&(a.edges=
a.links,delete a.links),a&&a.edges||(a=a||{},a.edges=[]));a.nodes||(a.nodes=[]);if(0===a.nodes.length){var b={};a.edges.forEach(function(c){["source","target"].forEach(function(d){d=c[d];0==d in b?(b[d]=1,a.nodes.push({term:d})):b[d]++;c.value=1})},this);a.nodes.forEach(function(a){Ext.applyIf(a,{value:void 0===b[a.term]?1:b[a.term]})})}else a.nodes.forEach(function(a){Ext.applyIf(a,{value:1})});return a},idGet:function(a){return"vng_"+a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=
...
function(a){return"translate("+(a.x-.5*a.bbox.width)+","+(a.y-.5*a.bbox.height)+")"});.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("width",b).attr("height",c);var e=a.append("g");b=d3.zoom().scaleExtent(this.getZoomExtent()).on("zoom",function(){e.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);this.setEdgeSelection(e.append("g").attr("class",
"edges").selectAll(".edge"));this.setNodeSelection(e.append("g").attr("class","nodes").selectAll(".node"));this.setVis(e)},resetGraph:function(){this.setNodeData([]);this.setEdgeData([]);this.refreshGraph()},refreshGraph:function(){if(void 0!==this.getVisLayout()){var a=this.getEdgeData(),b=this.getNodeData(),c=d3.extent(b,function(a){return a.value}),d=d3.extent(a,function(a){return a.value}),e=this.getEdgeScaling();void 0===e.scalingFunction&&(e.scalingFunction=d3.scaleLinear().domain(d).range([e.minSize,
e.maxSize]));var f=this.getNodeScaling();void 0===f.scalingFunction&&(f.scalingFunction=d3.scaleLog().domain(c).range([f.minSize,f.maxSize]));c=this.getEdgeSelection().data(a,function(a){return a.id});c.exit().remove();d=c.enter().append("line").attr("class","edge").attr("id",function(a){return a.id}).style("cursor","pointer").style("stroke-width",function(a){return e.scalingFunction(a.value)}).on("mouseover",this.edgeMouseOver.bind(this)).on("mouseout",this.edgeMouseOut.bind(this)).on("click",function(a){d3.event.stopImmediatePropagation();
d3.event.preventDefault();this.setCurrentEdge(a);this.fireEvent("edgeclicked",this,a)}.bind(this));this.setEdgeSelection(d.merge(c));c=this.getNodeSelection().data(b,function(a){return a.id});c.exit().remove();d=c.enter().append("g").attr("class","node").attr("id",function(a){return a.id}).style("cursor","pointer").on("mouseover",this.nodeMouseOver.bind(this)).on("mouseout",this.nodeMouseOut.bind(this)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.setCurrentNode(a);
this.fireEvent("nodeclicked",this,a)}.bind(this)).on("dblclick",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.fireEvent("nodedblclicked",this,a)}.bind(this)).on("contextmenu",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.fireEvent("nodecontextclicked",this,a)}.bind(this)).call(d3.drag().on("start",function(a){this.setDragging(!0);d3.event.active||this.getVisLayout().alpha(.3).restart();a.fx=a.x;a.fy=a.y;a.fixed=!0;this.fireEvent("nodedragstart",
this,a)}.bind(this)).on("drag",function(a){this.getVisLayout().alpha(.3);a.fx=d3.event.x;a.fy=d3.event.y;this.fireEvent("nodedrag",this,a)}.bind(this)).on("end",function(a){this.setDragging(!1);1!=a.fixed&&(a.fx=null,a.fy=null);this.fireEvent("nodedragend",this,a)}.bind(this)));d.append("rect");d.append("text").text(function(a){return a.term}).attr("font-family",function(a){return Voyant.application.getCategoriesManager().getFeatureForTerm("font",a.term)}).attr("font-size",function(a){return f.scalingFunction(a.value)+
...
this.queryById("sendToVoyant").setDisabled(!0);this.queryById("export").setDisabled(!0);if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(a,f,g){this.unmask();if(a&&0<a.length){this.queryById("status").setHtml(a.length);var e="\x3cul\x3e",k=[];a.forEach(function(a){a.getDocIds().forEach(function(a){k.push(a);var f=d.getCorpus().getDocument(a),g="\x3cli id\x3d'"+c.getId()+"_"+a+"' class\x3d'cataloguedoc'\x3e";
g+="\x3ca href\x3d'#' class\x3d'cataloguedoctitle' data\x3d'"+a+"'\x3e"+f.getTitle()+"\x3c/a\x3e";for(facet in b)if(0!=b[facet].length){var h="";if("facet.title"!=facet){var l=facet.replace(/^.+?\./,"");if(a=f.get(l)){var m=Ext.isArray(a);m?h+="\x3cli\x3e"+l+"\x3cul\x3e":a=[a];a.forEach(function(a){var c=!1;b[facet].forEach(function(b){b.label==a?c=!0:-1==b.facet.indexOf("facet")&&b.label.split(/\W+/).forEach(function(b){0<b.trim().length&&-1<a.toLowerCase().indexOf(b.toLowerCase())&&(c=!0)})});h+=
"\x3cli\x3e"+(m?"":l.replace("extra.","")+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+a+"\x3c/span\x3e":a)+"\x3c/li\x3e"});m&&(h+="\x3c/ul\x3e\x3c/li\x3e")}}h&&(g+="\x3cul\x3e"+h+"\x3c/ul\x3e")}e+=g+"\x3c/li\x3e"})});e+="\x3c/ul\x3e";c.update(e);var l=this;a=c.query(".cataloguedoctitle");a.forEach(function(a){Ext.get(a).on("click",function(a,b){this.dispatchEvent("documentSelected",l,b.getAttribute("data"))},l)});1==a.length&&this.dispatchEvent("documentSelected",l,a[0].getAttribute("data"));this.queryById("status").update((new Ext.XTemplate(this.localize("queryMatches"))).apply([k.length,
...
function(a){return{phrase:a.getTerm()}})},addSection:function(a,b,c,d,e){return this.getComponent("main").add({xtype:"container",html:'\x3cdiv class\x3d"header"\x3e'+a+"\x3c/div\x3e",cls:"section",listeners:{afterrender:function(a){a.mask(this.localize("loading"));b.load({params:c,callback:function(b,c,f){a.unmask();f&&b&&0<b.length&&Ext.dom.Helper.append(a.getTargetEl().first().first(),(new Ext.XTemplate('\x3cdiv class\x3d"contents"\x3e'+d+"\x3c/div\x3e")).apply(b.map(e)))}})},scope:this}})}});Ext.define("Voyant.panel.Correlations",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.correlations",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",minInDocumentsCountRatio:100},glyph:"xf0ce@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}]},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),
...
icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<g.length?"\x3cli\x3e"+a.localize("badFiles")+g.slice(0,5).join(", ")+(5<g.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<h.length?"\x3cli\x3e"+a.localize("unknownFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},
...
a.localize("errorNotXmlContinue"),function(b){"yes"==b&&a.loadCorpus(Ext.apply(d,{input:c}))},a):a.loadCorpus(Ext.apply(d,{input:c}))}else Ext.Msg.show({title:a.localize("noTextProvided"),message:a.localize("pleaseProvideText"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:[{html:this.getInitialConfig().addTextLabel,hidden:void 0==this.getInitialConfig().addTextLabel},{height:100,xtype:"textareafield",itemId:"input",emptyText:this.localize("emptyInput")}]});a.on("boxready",function(a){var b=
this.getApplication();b.getAllowInput&&"false"==b.getAllowInput()&&(a.getDockedItems().forEach(function(b){a.removeDocked(b)}),a.removeAll(),a.add({xtype:"container",html:"\x3cp\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}))});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,
c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)?(a={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId},Ext.applyIf(a,c),this.setCorpus(void 0),this.loadCorpus(a)):this.showResponseError("Unable to load corpus.",b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&
...
c=b.down("form");c.isValid()?(c=c.getValues(),a.setApiParams(c),b.hide()):a.showError({message:a.localize("invalidForm")})}},{text:a.localize("cancel"),handler:function(a,c){a.findParentByType("window").hide()}}]}));a.optionsWin.showAt(a.getApplication().getViewport().getWidth()/2-200,10)},validatePositiveNumbersCsv:function(a){a=a.trim();if(0<a.length){if(/[^\d,+ ]/.test(a))return this.localize("numbersCommasOnly");if(/\d\s+\d/.test(a))return this.localize("numbersNeedCommas");a=a.split(/\s*[,+]\s*/);
...
[];b.forEach(function(a){c.push(Ext.isString(a)?a:a.get("term"))});this.setApiParams({query:c,docId:void 0,docIndex:void 0});this.isVisible()&&this.getStore().load({params:this.getApiParams()})}});this.on("documentsClicked",function(a,b){var c=[];b.forEach(function(a){c.push(a.get("id"))});this.setApiParams({docId:c,query:void 0});this.isVisible()&&this.getStore().load({params:this.getApiParams()})});this.on("documentsSelected",function(a,b){this.setApiParams({docId:b,query:void 0});this.isVisible()&&
this.getStore().load({params:this.getApiParams()})});this.on("corpusSelected",function(a,b){this.setApiParams({docId:void 0,docIndex:void 0});this.isVisible()&&this.getStore().load({params:this.getApiParams()})});this.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load({params:this.getApiParams()})},this)},initComponent:function(){var a=Ext.create("Voyant.data.store.DocumentTermsBuffered",{parentPanel:this});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),
store:a,selModel:Ext.create("Ext.selection.CheckboxModel",{listeners:{selectionchange:{fn:function(a,c){this.getApplication().dispatchEvent("documentTermsClicked",this,c)},scope:this}},pruneRemoved:!1,mode:"SIMPLE"}),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},{xtype:"corpusdocumentselector"}]}],columns:[{text:"#",width:30,dataIndex:"docIndex",sortable:!0,renderer:function(a){return a+1}},{text:this.localize("term"),
...
handler:function(){d.downloadFromCorpusId(d.getStore().getCorpus().getId())}});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),columns:[{xtype:"rownumberer",renderer:function(a,b,c){return c.getIndex()+1},sortable:!1},{text:this.localize("documentTitle"),dataIndex:"title",sortable:!0,renderer:function(a,b,c){return c.getTitle()},flex:3},{text:this.localize("documentAuthor"),dataIndex:"author",sortable:!0,hidden:!0,renderer:function(a,b,c){return c.getAuthor()},flex:2},
{text:this.localize("documentPubDate"),dataIndex:"pubDate",sortable:!0,hidden:!0,renderer:function(a,b,c){return c.getPubDate()},flex:2},{text:this.localize("documentPublisher"),dataIndex:"publisher",sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getPublisher()},flex:2},{text:this.localize("documentPubPlace"),dataIndex:"pubPlace",sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getPubPlace()},flex:2},{text:this.localize("documentKeyword"),dataIndex:"keyword",sortable:!1,hidden:!0,
renderer:function(a,b,c){return c.getKeyword()},flex:2},{text:this.localize("documentCollection"),dataIndex:"collection",sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getCollection()},flex:2},{text:this.localize("tokensCountLexical"),dataIndex:"tokensCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),sortable:!0,width:"autoSize"},{text:this.localize("typesCountLexical"),dataIndex:"typesCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),width:"autoSize"},{text:this.localize("typeTokenRatioLexical"),
dataIndex:"typeTokenRatio-lexical",renderer:function(a){return Ext.util.Format.percent(a)},width:"autoSize"},{text:this.localize("averageWordsPerSentence"),dataIndex:"averageWordsPerSentence",renderer:Ext.util.Format.numberRenderer("0,000.0"),tooltip:this.localize("averageWordsPerSentenceTip"),width:"autoSize"},{text:this.localize("language"),dataIndex:"language",hidden:!0,renderer:function(a,b,c,d,k,l,m){return m.ownerCt.getLanguage(a)},width:"autoSize"}],store:b,selModel:{type:"rowmodel",mode:"MULTI",
...
c]).range([.5,1]);for(var f in e)e[f]=c(e[f]);a.setGroups({length:{color:a.getApplication().getColorForTerm("length"),terms:e}})}f=a.getComponent("fountain").getTargetEl();c=f.down("svg");c.set({width:f.getWidth(),height:f.getHeight()});var g=c.dom;d3.select(g).selectAll("*").remove();var h={},k=a.getGroups();a.setWords(b.slice(0,1E3).map(function(b){b=new a.FountainWord(b.toLowerCase());b.word in h?h[b.word]++:h[b.word]=1;b.min=parseInt(Math.random()*g.clientHeight*.05);var c=Math.sqrt(10*Math.random());
b.yshift=1>2*Math.random()?-c:c;b.jump=g.clientHeight/10;b.groupVals={};for(var d in k)b.word in k[d].terms&&(b.groupVals[d]=k[d].terms[b.word]);return b}));Math.max.apply(this,Object.values(h));var l=d3.scaleLog().domain([1,Math.max.apply(this,Object.values(h))]).range([4,12]);a.getWords().forEach(function(a){a.fontSize=l(h[a.word])});a.moveWords()})},FountainWord:function(a){this.word=a;this.direction=-1},moveWords:function(a){var b=this.getWords(),c=this.getComponent("fountain").getTargetEl().down("svg").dom,
d=c.clientHeight,e=c.clientWidth;this.getGroups();for(var f=d3.scaleLinear().domain([0,d]).range([1,0]),g=[],h=0,k=0;k<b.length;k++)if(h++,0==Object.keys(b[k].groupVals).length?g.push(0):Object.values(b[k].groupVals).forEach(function(a){g.push(a)}),0>b[k].direction)if(b[k].svg){var l=parseInt(b[k].svg.attr("y"));b[k].svg.attr("y",l-(l-b[k].min)/5);b[k].svg.attr("x",parseInt(b[k].svg.attr("x"))+b[k].yshift);l=parseInt(b[k].svg.attr("y"));b[k].ys.push(l);l<=b[k].min&&(b[k].direction=1)}else{if(l=d3.select(c).append("text").text(b[k].word).attr("font-size",
...
highlight:{fill:g.toString(),stroke:d.toString()}}});this.setGraphStyle(Ext.apply(this.getGraphStyle(),b));Ext.apply(a,{title:this.localize("title"),layout:"fit",items:{xtype:"voyantnetworkgraph",applyNodeStyle:function(b,d){var c=void 0===d?"normal":d;this.getGraphStyle();b.selectAll("rect").style("fill",function(b){b=b.type+"Node";return a.getGraphStyle()[b][c].fill}).style("stroke",function(b){b=b.type+"Node";return a.getGraphStyle()[b][c].stroke})},listeners:{nodeclicked:function(b,d){a.dispatchEvent("termsClicked",
a,[d.term])},edgeclicked:function(b,d){a.dispatchEvent("termsClicked",a,['"'+d.source.term+" "+d.target.term+'"~'+a.getApiParam("context")])}}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"corpusdocumentselector"},{xtype:"button",text:this.localize("categories"),menu:{items:[{xtype:"menucheckitem",text:this.localize("people"),itemId:"person",checked:!0},{xtype:"menucheckitem",text:this.localize("locations"),itemId:"location",checked:!0},{xtype:"menucheckitem",
...
itemId:"minEdgeCount",fieldLabel:this.localize("minEdgeCount"),labelAlign:"right",labelWidth:120,width:170,maxValue:10,minValue:1,allowDecimals:!1,allowExponential:!1,allowOnlyWhitespace:!1,listeners:{render:function(a){a.setRawValue(this.getApiParam("minEdgeCount"))},change:function(a,b){a.isValid()&&(this.setApiParam("minEdgeCount",b),this.preloadEntities())},scope:this}},{xtype:"slider",fieldLabel:this.localize("maxLinks"),labelAlign:"right",labelWidth:100,width:170,minValue:10,maxValue:1E3,increment:10,
listeners:{render:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,b){this.setApiParam("limit",b);this.preloadEntities()},scope:this}}]}]});this.on("loadedCorpus",function(a,b){this.isVisible()&&this.preloadEntities()},this);this.on("corpusSelected",function(a,b){this.setApiParam("docId",void 0);this.preloadEntities()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",b);this.preloadEntities()},this);this.on("activate",function(){this.getCorpus()&&
0===this.down("voyantnetworkgraph").getNodeData().length&&Ext.Function.defer(this.preloadEntities,100,this)},this);this.on("query",function(a,b){this.loadFromQuery(b)},this);a.callParent(arguments)},categoriesHandler:function(a){var b=[];a.up("menu").items.each(function(a){a.checked&&b.push(a.itemId)});this.setApiParam("type",b);this.preloadEntities()},serviceHandler:function(a){this.setApiParam("nerService",a.itemId);this.preloadEntities()},preloadEntities:function(){var a=this;new Voyant.data.util.DocumentEntities({annotator:this.getApiParam("nerService")},
...
docId:this.getApiParam("docId"),stopList:this.getApiParam("stopList"),noCache:!0},timeout:12E4,success:function(b){a.unmask();b=Ext.decode(b.responseText);if(0==b.entityCollocationsGraph.edges.length){this.showError({msg:this.localize("noEntities")});var c=this.getApiParam("minEdgeCount");1<c&&Ext.Msg.confirm(this.localize("error"),this.localize("noEntitiesForEdgeCount"),function(a){"yes"===a&&(a=Math.max(1,c-1),this.queryById("minEdgeCount").setRawValue(a),this.setApiParam("minEdgeCount",a),this.preloadEntities())},
this)}else this.processEntities(b.entityCollocationsGraph)},failure:function(b){a.unmask();Ext.Msg.confirm(this.localize("error"),this.localize("timedOut"),function(a){"yes"===a&&this.preloadEntities()},this)},scope:this})},processEntities:function(a){var b=a.nodes;a=a.edges;var c=this.getLayout().getRenderTarget(),d=c.getWidth()/2,e=c.getHeight()/2;c=[];for(var f=0;f<b.length;f++){var g=b[f];c.push({term:g.term,title:g.term+" ("+g.rawFreq+")",type:g.type,value:g.rawFreq,fixed:!1,x:d,y:e})}d=[];for(f=
...
e:-e)}else{e=d=0;var h=a.matches.map(function(a){return this.magnets[a].record.getDistributions()[c]},this),k=Ext.Array.min(h),l=Ext.Array.max(h),m=0;a.matches.forEach(function(a,b){weight=l==k?1:(h[b]-k+k)/(l-k+k);m+=weight;d+=this.magnets[a].x*weight;e+=this.magnets[a].y*weight},this);a.targetX=d/m;a.targetY=e/m}},this);a=0;for(var c=b.length;a<c;a++)Ext.apply(this.documents[a],{targetX:rad+(rad-this.gutter)*Math.cos(2*Math.PI*a/c),targetY:rad+(rad-this.gutter)*Math.sin(2*Math.PI*a/c)})}},draw:function(a,
...
b.fillStyle="rgba(0,0,0,.8)",b.arc(a.x,a.y,h,0,2*Math.PI),b.fill(),b.stroke();c=Math.abs(a.x-a.targetX);g=Math.abs(a.y-a.targetY);if(0!=c||0!=g)1>c?a.x=a.targetX:(c/=2,a.x=a.x>a.targetX?a.x-c:a.x+c),1>g?a.y=a.targetY:(g/=2,a.y=a.y>a.targetY?a.y-g:a.y+g),e=!0},this);a=0;k=parseInt(this.textFont)+4;b.textAlign="center";b.textBaseline="middle";for(var l in this.magnets)d||l in g||this.magnets[l].isHovering?(a=this.magnets[l].width+4,b.fillStyle=l in g||this.magnets[l].isHovering||!0===f?"white":"rgba(255,255,255,.05)",
...
proxy:{extraParams:{forTool:"reader"}}}),c=this;b.on("beforeload",function(a){return c.hasCorpusAccess(a.getCorpus())});b.on("load",function(a,b,c){if(c){var d="",e=this.localize("documentFrequency"),f=!1,l=-1,m=!1;b.forEach(function(a){0==a.getPosition()&&(d+="\x3ch3\x3e"+this.getDocumentsStore().getById(a.getDocId()).getFullLabel()+"\x3c/h3\x3e");a.getDocIndex()!=l&&(f=this.getDocumentsStore().getById(a.getDocId()).isPlainText(),l=a.getDocIndex());if(a.isWord())m=!1,d+="\x3cspan class\x3d'word' id\x3d'"+
a.getId()+"' data-qtip\x3d'\x3cdiv class\x3d\"freq\"\x3e"+e+" "+a.getDocumentRawFreq()+"\x3c/div\x3e'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(f);var b=0==a.indexOf("\x3cbr /\x3e");if(!m||!b&&0!=a.trim().length)d+=a,m=b}},this);this.updateText(d);this.down("querysearchfield").getValue();void 0!==this.getDocumentEntitiesStore()&&this.highlightEntities()}},this);this.setTokensStore(b);this.on("query",function(a,b){this.loadQueryTerms(b)},this);this.setDocumentTermsStore(Ext.create("Ext.data.Store",
{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",withDistributions:!0,withPositions:!0,bins:25,forTool:"reader"},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(a,b,c,g){a.sort("docIndex","ASC");var d;a.each(function(a){d=a.get("term")},this);this.highlightKeywords(d)},scope:this}}));this.on("afterrender",
function(){var a=this.down('panel[region\x3d"center"]');this.setInnerContainer(a.getLayout().getRenderTarget());a.body.on("scroll",function(a,b){a=this.getLastScrollTop()<b.scrollTop?this.SCROLL_DOWN:this.getLastScrollTop()>b.scrollTop?this.SCROLL_UP:this.SCROLL_EQ;if(a==this.SCROLL_UP&&1>b.scrollTop)this.fetchPrevious(!0);else if(a==this.SCROLL_DOWN&&b.scrollHeight-b.scrollTop<1.5*b.offsetHeight)this.fetchNext(!1);else{var c=0==b.scrollTop?0:b.scrollHeight-b.scrollTop==b.clientHeight?1:(b.scrollTop+
.5*b.clientHeight)/b.scrollHeight;(new Date-this.getLastLocationUpdate()>this.LOCATION_UPDATE_FREQ||0==c||1==c)&&this.updateLocationMarker(c,a)}this.setLastScrollTop(b.scrollTop)},this);a.body.on("click",function(a,b){b=Ext.get(b);b.hasCls("word")&&(a=Voyant.data.model.Token.getInfoFromElement(b),b=b.getHtml(),a=[{term:b,docIndex:a.docIndex}],this.loadQueryTerms([b]),this.getApplication().dispatchEvent("termsClicked",this,a))},this);this.getCorpus()&&(this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?
[a]:a));this.on("loadedCorpus",function(){this.load(!0);var a=this.getApiParam("query");a&&this.loadQueryTerms(Ext.isString(a)?[a]:a)},this)},this);Ext.apply(this,{title:this.localize("title"),cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{xtype:"readergraph",region:"south",height:40,split:{size:2},splitterResize:!0,border:!1,listeners:{documentRelativePositionSelected:function(a,
b){a=this.getDocumentsStore().getAt(b.docIndex);var c=a.get("tokensCount-lexical");b=Math.floor(c*b.fraction)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:a.getId(),start:0>b?0:b});this.load(!0)},scope:this}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"},
"-\x3e",{glyph:"xf0eb@FontAwesome",tooltip:this.localize("highlightEntities"),itemId:"nerServiceParent",menu:{items:[{xtype:"menucheckitem",group:"nerService",text:this.localize("nerNssi"),itemId:"nssi",checked:!0,handler:this.nerSeviceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:this.localize("nerVoyant"),itemId:"stanford",checked:!1,handler:this.nerSeviceHandler,scope:this}]}}]}],listeners:{loadedCorpus:function(a,b){this.getTokensStore().setCorpus(b);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",
b.getId());a=b.getDocuments();this.setDocumentsStore(a);this.rendered&&(this.load(),0==this.hasCorpusAccess(b)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(b=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(b)?[b]:b))},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});0<c.length&&this.loadQueryTerms(c)},corpusTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});
this.loadQueryTerms(c)},documentTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentSelected:function(a,b){a=this.getTokensStore().getCorpus().getDocument(b);this.setApiParams({skipToDocId:a.getId(),start:0});this.load(!0)},documentsClicked:function(a,b,c){0<b.length&&(this.setApiParams({skipToDocId:b[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,b){if(void 0!==b[0]){var c=b[0],d=c.get("docIndex"),e=c.get("position");
a=e-this.getApiParam("limit")/2;b=this.getCorpus().getDocument(d);this.setApiParams({skipToDocId:b.getId(),start:0>a?0:a});this.load(!0,{callback:function(){var a=this.body.dom.querySelector("#_"+d+"_"+e);a&&a.scrollIntoView();this.highlightKeywords(c.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,b){void 0!==b[0]&&(a=Ext.create("Voyant.data.model.Token",b[0]),this.fireEvent("termLocationClicked",this,[a]))},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&
0<a.length&&(this.getDocumentTermsStore().load({params:{query:a}}),this.down("readergraph").loadQueryTerms(a))},highlightKeywords:function(a,b){Ext.isArray(a)||(a=[a]);this.getInnerContainer().first().select("span[class*\x3dkeyword]").removeCls("keyword");var c=[],d=new RegExp("^"+a[0]+"$","i");this.getInnerContainer().first().select("span.word").each(function(a,b,g){a.dom.firstChild&&a.dom.firstChild.nodeValue.match(d)&&(a.addCls("keyword"),c.push(a.dom))})},nerSeviceHandler:function(a){a=a.itemId;
var b=[],c=this.getLocationInfo();if(c)for(var d=c[0].docIndex;d<=c[1].docIndex;d++)b.push(d);else b.push(0);this.clearEntityHighlights();var e=this;new Voyant.data.util.DocumentEntities({annotator:a,includeEntities:!0,docIndex:b},function(a){a&&(e.clearEntityHighlights(),e.setDocumentEntitiesStore(a),e.highlightEntities())})},clearEntityHighlights:function(){this.getInnerContainer().first().select(".entity").each(function(a){a.removeCls("entity start middle end location person organization misc money time percent date duration set unknown");
a.dom.setAttribute("data-qtip",a.dom.getAttribute("data-qtip").replace(/<div class="entity">.*?<\/div>/g,""))})},highlightEntities:function(){var a=this.getInnerContainer().first(),b=this.getDocumentEntitiesStore(),c=this.localize("entityType");b.forEach(function(b){var d=b.positions;d?d.forEach(function(d){var e=2===d.length;if(e&&1<d[1]-d[0])for(var f=d[1],k=d[0]+1,l=1;k<f;)d.splice(l,0,k),k++,l++;f=0;for(k=d.length;f<k;f++)if(l=d[f],-1===l)console.warn("missing position for: "+b.term);else if(l=
a.selectNode("#_"+b.docIndex+"_"+l,!1)){var m="";e&&(m=0===f?"start ":f===k-1?"end ":"middle ");l.addCls("entity "+m+b.type);l.dom.setAttribute("data-qtip",l.dom.getAttribute("data-qtip")+'\x3cdiv class\x3d"entity"\x3e'+c+": "+b.type+"\x3c/div\x3e")}}):console.warn("no positions for: "+b.term)})},fetchPrevious:function(a){var b=this.getInnerContainer().first(),c=b.first(".word");if(null!=c&&!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){b=Voyant.data.model.Token.getInfoFromElement(c);var d=
b.docIndex;b=b.position;var e=this.getDocumentsStore().getAt(d),f=this.getApiParam("limit"),g=!1;if(0===d&&0===b){a=this.down('panel[region\x3d"center"]').body;0!=c.getScrollIntoViewXY(a,a.dom.scrollTop,a.dom.scrollLeft).y&&c.dom.scrollIntoView();c.frame("red");break}0<d&&0===b?(g=!0,d--,e=this.getDocumentsStore().getAt(d),d=e.get("tokensCount-lexical"),b=d-f,0>b&&(b=0,this.setApiParam("limit",d))):(f--,b-=f);0>b&&(b=0);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+this.localize("loading")+"\x3c/div\x3e",
"before",!1).mask();g||c.destroy();c=e.getId();this.setApiParams({skipToDocId:c,start:b});this.setInsertWhere("afterBegin");this.setScrollIntoView(a);this.load();this.setApiParam("limit",this.INITIAL_LIMIT);break}c.destroy();c=b.first()}},fetchNext:function(a){var b=this.getInnerContainer().first(),c=b.last();if(!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){b=Voyant.data.model.Token.getInfoFromElement(c);var d=b.docIndex,e=b.position,f=this.getDocumentsStore().getAt(b.docIndex),g=f.getId();
f=f.get("tokensCount-lexical");if(e+this.getApiParam("limit")>=f&&d==this.getCorpus().getDocumentsCount()-1)if(d=f-e,1>=d){c.dom.scrollIntoView();c.frame("red");break}else this.setApiParam("limit",d);for(d=c.dom.nextSibling;d;)e=d,d=d.nextSibling,e.parentNode.removeChild(e);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+this.localize("loading")+"\x3c/div\x3e","after",!1).mask();c.destroy();this.setApiParams({skipToDocId:g,start:b.position});this.setInsertWhere("beforeEnd");this.setScrollIntoView(a);
...
if(this.getMode()===this.MODE_DOCUMENT)var d=this.getApiParam("bins");else{d=this.getApiParam("bins");var e=this.getCorpus().getDocumentsCount();d=d<e?d:e}this.getVisLayout().keys(c);e=this.getVisLayout()(a);a=this.body.down("svg").getWidth()-this.graphMargin.left-this.graphMargin.right;var f=d3.scaleLinear().domain([0,d-1]).range([0,a]),g=d3.min(e,function(a){return d3.min(a,function(a){return a[0]})}),h=d3.max(e,function(a){return d3.max(a,function(a){return a[1]})});d=this.body.down("svg").getHeight()-
this.graphMargin.top-this.graphMargin.bottom;var k=d3.scaleLinear().domain([g,h]).range([d,0]),l=d3.area().x(function(a,b){return f(b)}).y0(function(a){return k(a[0])}).y1(function(a){return k(a[1])}).curve(d3.curveCatmullRom);if(this.getMode()===this.MODE_CORPUS){var m=[];this.getCorpus().getDocuments().each(function(a){m.push(a.getTinyLabel())});g=d3.scalePoint().domain(m).range([0,a]);h=d3.axisBottom(g)}else h=d3.axisBottom(f);g=d3.axisLeft(k);e=this.getVis().selectAll("path").data(e,function(a){return a});
e.attr("d",function(a){return l(a)}).style("fill",function(a){return b.getApplication().getColorForTerm(a.key,!0)}).select("title").text(function(a){return a.key});e.enter().append("path").attr("d",function(a){return l(a)}).style("fill",function(a){return b.getApplication().getColorForTerm(a.key,!0)}).append("title").text(function(a){return a.key});e.exit().remove();this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+d+")").call(h);
...
2*c.length;else if(100<c.length){var g=b.getWidth()-200;f=g<c.length?c.length:g}this.localize("numberOfTerms");c.sort(function(a,b){return b.getLexicalTokensCount()-a.getLexicalTokensCount()});b.add(this.showSparklineSection(function(a){return a.getLexicalTokensCount()},this.localize("docsLength"),this.localize("longest"),this.localize("shortest"),c,d,e,f,this.localize("numberOfTerms")));c.sort(function(a,b){return b.getLexicalTypeTokenRatio()-a.getLexicalTypeTokenRatio()});b.add(this.showSparklineSection(function(a){return Ext.util.Format.number(a.getLexicalTypeTokenRatio(),
"0.000")},this.localize("docsDensity"),this.localize("highest"),this.localize("lowest"),c,d,e,f,this.localize("docsDensityTip")));c.sort(function(a,b){return b.getAverageWordsPerSentence()-a.getAverageWordsPerSentence()});b.add(this.showSparklineSection(function(a){return Ext.util.Format.number(a.getAverageWordsPerSentence(),"0.0")},this.localize("averageWordsPerSentence"),this.localize("highest"),this.localize("lowest"),c,d,e,f,this.localize("avgWordsPerSentenceTip")))}else if(g=c[0])b.add({cls:"section",
html:"\x3cb\x3e"+this.localize("docsDensity")+"\x3c/b\x3e "+Ext.util.Format.number(g.getLexicalTypeTokenRatio(),"0.000")}),b.add({cls:"section",html:"\x3cb\x3e"+this.localize("averageWordsPerSentence")+"\x3c/b\x3e "+Ext.util.Format.number(g.getAverageWordsPerSentence(),"0.0")});this.getCorpus().getReadability().then(function(g){c.forEach(function(a){var b=g.find(function(b){return b.docId===a.getId()});b&&a.set("readability",b.readability)});var h=b.items.length-2;1<c.length?(c.sort(function(a,b){return b.get("readability")-
a.get("readability")}),b.insert(h,a.showSparklineSection(function(a){return Ext.util.Format.number(a.get("readability"),"0.000")},a.localize("readabilityIndex"),a.localize("highest"),a.localize("lowest"),c,d,e,f,a.localize("readabilityTip")))):b.insert(h,{cls:"section",html:"\x3cb\x3e"+a.localize("readabilityIndex")+"\x3c/b\x3e "+Ext.util.Format.number(c[0].get("readability"),"0.000")})});b.add({html:this.localize("mostFrequentWords"),cls:"section",listeners:{afterrender:function(b){b.mask(a.localize("loading"));
a.getCorpus().getCorpusTerms().load({params:{limit:a.getApiParam("limit"),stopList:a.getApiParam("stopList"),forTool:"summary"},callback:function(a,c,d){d&&a&&0<a.length&&(b.unmask(),Ext.dom.Helper.append(b.getTargetEl().first().first(),(new Ext.XTemplate('\x3ctpl for\x3d"." between\x3d"; "\x3e\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"corpus-type keyword" voyant:recordId\x3d"{id}"\x3e{term}\x3c/a\x3e\x3cspan style\x3d"font-size: smaller"\x3e ({val})\x3c/span\x3e\x3c/tpl\x3e')).apply(a.map(function(a){return{id:a.getId(),
term:a.getTerm(),val:a.getRawFreq()}}))))}})}},scope:this});1<c.length&&b.add({html:this.localize("distinctiveWords")+"\x3col\x3e\x3c/ol\x3e",cls:"section",itemId:"distinctiveWords",listeners:{afterrender:function(b){a.showMoreDistinctiveWords()}},scope:this})},showSparklineSection:function(a,b,c,d,e,f,g,h,k){var l=this;return{cls:"section",items:[{layout:"hbox",align:"bottom",items:[{html:b,cls:"header"},{xtype:"sparklineline",values:this.getCorpus().getDocuments().getRange().map(function(b){return a.call(l,
b)}),tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return"("+b+") "+this.panel.getCorpus().getDocument(a).getTitle()},panel:l}),height:16,width:h}]},{html:"\x3cul\x3e\x3cli\x3e"+c+" "+g.apply(e.slice(0,e.length>f?f:parseInt(e.length/2)).map(function(b){return{id:b.getId(),shortTitle:b.getShortTitle(),title:b.getTitle(),val:a.call(l,b),valTip:k}}))+"\x3c/li\x3e\x3cli\x3e"+d+" "+g.apply(e.slice(-(e.length>f?f:parseInt(e.length/2))).reverse().map(function(b){return{id:b.getId(),
shortTitle:b.getShortTitle(),title:b.getTitle(),val:a.call(l,b),valTip:k}}))+"\x3c/li\x3e"}]}},showMoreDistinctiveWords:function(){var a=this.queryById("distinctiveWords"),b=a.getTargetEl().selectNode("ol"),c=Ext.dom.Query.select("li:not(.more)",b).length,d=parseInt(this.getApiParam("numberOfDocumentsForDistinctiveWords")),e=this.getCorpus().getDocuments().getRange(c,c+d-1);if(e&&Ext.isArray(e)){var f=[];e.forEach(function(a){f.push(a.getIndex())});0<f.length&&this.getCorpus().getDocumentTerms().load({addRecords:!0,
params:{docIndex:f,perDocLimit:parseInt(this.getApiParam("limit")),limit:d*parseInt(this.getApiParam("limit")),stopList:this.getApiParam("stopList"),sort:"TFIDF",dir:"DESC",forTool:"summary"},scope:this,callback:function(e,h,k){var g={};if(k&&e&&Ext.isArray(e)){e.forEach(function(a,b,c){b=a.getDocIndex();b in g||(g[b]=[]);g[b].push({id:a.getId(),docIndex:a.getDocIndex(),type:a.getTerm(),val:Ext.util.Format.number(a.get("rawFreq"),"0,000"),docId:a.get("docId")})});f.forEach(function(a){if(g[a]){var c=
this.getCorpus().getDocument(a);m=g[a].length;Ext.dom.Helper.append(b,{tag:"li","voyant:index":String(a),html:'\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"document-id document-id-distinctive" voyant:val\x3d"'+c.get("id")+'"\x3e'+c.getShortTitle()+"\x3c/a\x3e"+this.localize("colon")+" "+(new Ext.XTemplate(this.localize("documentType"))).apply({types:g[a]})+"."})}},this);a.updateLayout();var m=d;remaining=this.getCorpus().getDocuments().getTotalCount()-c-f.length;if(0<remaining){e=new Ext.Template(this.localize("moreDistinctiveWords"));
...
c.length&&(c=c.map(function(a,b){return b+1+")"+a}));Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms().load({params:a,callback:function(a,e,f){var d=[],h=[],k=this.getApiParam("chartType");a.forEach(function(a,e){var f=a.get("term");a.get("docIndex");var g=this.getApplication().getColorForTerm(f,!0);a.get("distributions").forEach(function(a,g){d[g]||(d[g]={index:c[g]});d[g]["_"+e]="relative"==b?a.toFixed(7):a;d[g]["term"+e]=f},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(a){h.push({type:"stacked"==
a?"bar":a,title:f,xField:"index",yField:"_"+e,term:f,colors:[g],label:"barline"==k&&"bar"==a?{display:"none"}:{field:"term"+e}})},this)},this);e=a.map(function(a){return a.getTerm()});f=e.map(function(a){return this.getApplication().getColorForTerm(a,!0)},this);"bar"==k&&h.push({type:"bar",title:e,colors:f,xField:"index",yField:0<d.length?Object.keys(d[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,label:{field:a.map(function(a,b){return"term"+b})}});a=Ext.create("Ext.data.JsonStore",{fields:0<
d.length?Object.keys(d[0]):void 0,data:d});this.buildChart({store:a,series:h,axes:[{type:"numeric",position:"left",increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("corpusTitle")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:5,stopList:this.getApiParam("stopList")},callback:function(a,b,c){0==a.length?b&&b.error?this.showError(this.localize("noResults")+"\x3cp style\x3d'color: red'\x3e"+
...
this.getCorpus().map(function(a){return a.getTinyTitle()});var c=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,callback:function(a,e,f){var d=[],h=[],k=this.getApiParam("chartType");c||a.sort(function(a,b){return a.getTerm()==b.getTerm()?a.getDocIndex()-b.getDocIndex():a.getTerm().localeCompare(b.getTerm())});a.forEach(function(a,
e){var f=a.get("term"),g=a.get("docIndex"),l=c?this.getApplication().getColorForTerm(f,!0):this.getApplication().getColor(g,!0);g=a.get("docIndex");a.get("distributions").forEach(function(a,c){d[c]||(d[c]={docIndex:g,index:c+1});d[c]["_"+e+"_"+g]="relative"==b?a.toFixed(7):a;d[c]["term"+e]=f},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(a){h.push({type:"stacked"==a?"bar":a,title:c?f:g+1+") "+f,xField:"index",yField:"_"+e+"_"+g,term:f,colors:[l],label:"barline"==k&&"bar"==a?{display:"none"}:
{field:"term"+e}})},this)},this);if("bar"==k){var l=Ext.Array.unique(a.map(function(a){return a.getTerm()})).length;e=a.map(function(a){return 1+a.get("docIndex")+") "+a.getTerm()});a=a.map(function(a){return l?this.getApplication().getColor(a.get("docIndex"),!0):this.getApplication().getColorForTerm(a.getTerm(),!0)},this);h.push({type:"bar",title:0<e.length?e:this.localize("noResults"),colors:a,xField:"index",yField:0<d.length?Object.keys(d[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,
label:{field:e}})}a=Ext.create("Ext.data.JsonStore",{fields:0<d.length?Object.keys(d[0]):void 0,data:d});this.buildChart({store:a,series:h,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+(c?" ("+c.getShortTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:2>this.getCorpus().getDocumentsCount()?5:2,stopList:this.getApiParam("stopList")},
...
a.get("index")});c.length>this.getTargetEl().getWidth()/9&&Ext.applyIf(b.label,{rotate:{degrees:-30}});Ext.applyIf(b,{labelInSpan:!0})}},this);this.query("chart").forEach(function(a){this.remove(a,!0)},this);var d=Ext.create("Ext.chart.CartesianChart",a);this.add(d)},reloadFromChart:function(){var a=this.down("chart");if(a){var b=[];a.series.forEach(function(a){b.push(a.getTitle())});this.fireEvent("termsClicked",this,b)}},getExtraDataExportItems:function(){return[{name:"export",inputValue:"dataAsTsv",
boxLabel:this.localize("exportGridCurrentTsv")}]},exportDataAsTsv:function(a,b){var c="";b=a.down("chart").getStore();var d=b.first().getData(),e=["Index"],f=[];Object.keys(d).filter(function(a){return 0===a.indexOf("term")}).sort().forEach(function(a){f.push(d[a])});e=e.concat(f);c+=e.join("\t")+"\n";var g=Object.keys(d).filter(function(a){return 0===a.indexOf("_")}).sort();b.each(function(a){d=a.getData();var b=[d.index];g.forEach(function(a){b.push(d[a])});c+=b.join("\t")+"\n"},a);Ext.Msg.show({title:a.localize("exportDataTitle"),
...
{},d=this.getTargetEl().down(".x-table-layout"),e=d.getSize(!1);d=d.dom.rows;for(var f=0;f<d.length;f++)for(var g=d[f].cells,h=0;h<g.length;h++){var k=Ext.get(g[h]),l=k.down(".x-panel"),m=l.id;if(void 0!==a&&void 0!==b)k=l.getSize(!1),k.width*=a,k.height*=b;else{l=k.getSize(!1);var n=Ext.getCmp(m),p=n.initialConfig.cellWidth;n=n.initialConfig.cellHeight;void 0!==p&&(l.width=p/100*e.width,k.setWidth(l.width));void 0!==n&&(l.height=n/100*e.height,k.setHeight(l.height));k=l}c[m]=k}for(var r in c)k=c[r],
Ext.getCmp(r).setSize(k);this.updateLayout()}});Ext.define("Voyant.panel.Veliza",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],xtype:"veliza",autoScroll:!0,statics:{i18n:{},api:{script:"",message:void 0},glyph:"xf0e6@FontAwesome"},config:{previous:[]},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);var a=this;Ext.apply(this,{title:this.localize("title"),glyph:"xf0e6@FontAwesome",layout:{type:"border",align:"stretch"},items:[{itemId:"chat",html:"\x3cform class\x3d'chat'\x3e\x3c/form\x3e",
...
d.prefix[d.prefix.length-1];d=d.suffix[0];e[g]?e[g]++:e[g]=1;f[d]?f[d]++:f[d]=1}a=[];for(c=0;c<b.length;c++)d=b[c],g=d.prefix[d.prefix.length-1],d=d.suffix[0],a.push({suffix:d,suffixCount:f[d],prefix:g,prefixCount:e[g]});a.sort(function(a,b){var c=a.suffixCount,d=b.suffixCount;a=a.prefixCount;b=b.prefixCount;return a>b?-1:a<b?1:c>d?-1:c<d?1:0});f=Math.min(this.getNumBranches(),a.length);d=[];e=[];for(c=0;c<f;c++)d.push(a[c].suffix),e.push(a[c].prefix);a=[];f=[];g=[];var h=[];for(c=0;c<b.length;c++){var k=
b[c];if(-1!=d.indexOf(k.suffix[0])||-1!=e.indexOf(k.suffix[0]))a.push(k.prefix),f.push(k.hit),g.push(k.suffix),h.push(k.id)}this.getTree().setupFromArrays(a,f,g,h,!1,["token","POS"],"/",["token","POS"]);this.getTree().succeeded()||this.toastInfo({html:this.localize("emptyText"),align:"bl"})},initGraph:function(){var a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),d=new doubletree.DoubleTree;d.init("#"+a.getId()).visWidth(b).visHeight(c).handlers({click:this.clickHandler.bind(this)});
...
flex:1,sortable:!0},{text:this.localize("start"),dataIndex:"start",width:"autoSize",sortable:!1},{text:this.localize("end"),dataIndex:"end",width:"autoSize",sortable:!1}]});this.on("loadedCorpus",function(){var b=this;this.isVisible()&&this.load().then(function(c){var d=[];c.documents.forEach(function(a){var c=b.getCorpus().getDocument(a.id).getIndex();a.entities.forEach(function(a){d.push(Object.assign({docIndex:c},a))})});a.loadRawData(d)},function(a){console.log(a)})},this);this.callParent(arguments)},
load:function(a,b){b=b||Voyant.application.getDeferred(this);var c=this;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{corpus:this.getCorpus().getAliasOrId(),tool:"corpus.NSSI",useCache:!1,noCache:!0},scope:this}).then(function(d){(d=Ext.JSON.decode(d.responseText))&&d.nssi&&d.nssi.progress&&new Voyant.widget.ProgressMonitor({progress:d.nssi.progress,delay:1E4,maxMillisSinceStart:36E5,success:function(){console.log("NSSI progress monitor success");c.load.call(c,a,b)},failure:function(a){Voyant.application.showResponseError(c.localize("failedToFetchGeonames"),
a)},scope:c});d&&d.nssi&&!d.nssi.progress&&b.resolve(d.nssi)},function(a){Voyant.application.showResponseError(c.localize("failedToFetchGeonames"),a)});return b.promise}});Ext.define("Voyant.notebook.editor.button.Add",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperadd",statics:{i18n:{}},constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)},glyph:"xf067@FontAwesome",handler:function(a,b){a.findParentByType("notebook").fireEvent("notebookWrapperAdd",a.findParentByType("notebookeditorwrapper"),b)}});Ext.define("Voyant.notebook.editor.button.CodeConfig",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookcodeconfig",statics:{i18n:{tip:"Configuration Options",title:"Cell Mode",modeCode:"Code",modeJavascript:"Javascript (default)",modeData:"Data",modeFile:"File",modeJson:"JSON",modeText:"Text",modeXml:"XML",modeHtml:"HTML",ok:"OK",cancel:"Cancel"},configWin:void 0,initWindow:function(a){void 0===Voyant.notebook.editor.button.CodeConfig.configWin&&(Voyant.notebook.editor.button.CodeConfig.configWin=
...
handler:function(a){a.up("window").close()}}]}));var b=a.up("notebookrunnableeditorwrapper"),c=b.up("notebook").getNotebookId()||"spyral",d=b.getMode(),e=new Ext.Deferred;a=null;a="file"===d?b.fileInput.getBlob():b.results.updateCachedOutput();a.then(function(a){var f=b.getInput(),h=this.exportWin.down("#corpus"),k=this.exportWin.down("#open");h.setHidden(!0);k.setHidden(!1);if("file"===d){k.setHidden(!0);var l=f.fileName;h=a.type;var m=a}else"javascript"===d?(Spyral.Util.isObject(a)&&a.hasOwnProperty("corpusid")&&
Spyral.Util.isString(a.corpusid)&&(h.setHidden(!1),h.setHandler(function(b){b=Voyant.application.getBaseUrlFull()+"?corpus\x3d"+a.corpusid;window.open(b)})),Spyral.Util.isUndefined(a)&&(a=b.getContent().output),Spyral.Util.isObject(a)||Spyral.Util.isArray(a)?(l=c+"_"+b.getCellId()+".json",h="application/json",m=JSON.stringify(a)):Spyral.Util.isNode(a)||Spyral.Util.isString(a)&&null!==a.match(/<\/?\w+.*?>/g)?(l=c+"_"+b.getCellId()+".html",h="text/html",m=Spyral.Util.isString(a)?a:(new XMLSerializer).serializeToString(a)):
(l=c+"_"+b.getCellId()+".txt",h="text/plain",m=a)):(l=c+"_"+b.getDataName()+"."+d,h="text/"+d,m=f,"json"===d?h="application/json":"text"===d&&(l=c+"_"+b.getDataName()+".txt",h="text/plain"));var n=new File([m],l,{lastModified:(new Date).getTime(),type:h});this.exportWin.down("#open").setHandler(function(a){var b=window.open();b.document.write(m);b.document.close();b.focus();a.up("window").close()});this.exportWin.addListener("show",function(){var a=URL.createObjectURL(n);this.exportWin.down("#download").getEl().set({download:l,
href:a})},this,{single:!0});e.resolve(this.exportWin)}.bind(this),function(a){e.reject(a)});return e.promise}},constructor:function(a){Ext.apply(a,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf08e@FontAwesome",listeners:{click:function(a){Voyant.notebook.editor.button.Export.getExportWindow(a).then(function(a){a.show()},function(a){Ext.Msg.show({title:"Export Error",msg:"There was an error exporting the cell contents.\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+a+"\x3c/pre\x3e",
buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})}}});Ext.define("Voyant.notebook.editor.button.Counter",{extend:"Ext.toolbar.TextItem",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappercounter",statics:{i18n:{}},config:{order:0,name:void 0},cls:"notebookwrappercounter",constructor:function(a){Ext.apply(this,{toolTip:this.localize("tip")});this.callParent(arguments)},setOrder:function(a){this.callParent(arguments);this.updateHtml()},updateHtml:function(){var a=this.getOrder()+1,b=this.getName();this.setHtml('\x3ca name\x3d"'+b+'" href\x3d"#'+
...
a&&this.findParentByType("notebook").fireEvent("notebookWrapperRemove",this.findParentByType("notebookeditorwrapper"))},scope:this})}}});Ext.define("Voyant.notebook.editor.button.Run",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrun",statics:{i18n:{}},glyph:"xf04b@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)},listeners:{click:function(a,b){a=a.findParentByType("notebookrunnableeditorwrapper");a.run.call(a)}}});Ext.define("Voyant.notebook.editor.button.RunAll",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrunall",statics:{i18n:{}},glyph:"xf04e@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)}});Ext.define("Voyant.notebook.editor.button.RunUntil",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrununtil",statics:{i18n:{tip:"Run multiple cells",runUntil:"Run up to here",runUntilTip:"Run previous code blocks and this one.",runFrom:"Run from here onwards",runFromTip:"Run this and following code blocks."}},glyph:"xf050@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");var b=this;this.runMenu=Ext.create("Ext.menu.Menu",{items:[{text:this.localize("runUntil"),
tooltip:this.localize("runUntilTip"),glyph:"xf049@FontAwesome",handler:function(){var a=b.findParentByType("notebookrunnableeditorwrapper");b.up("notebook").runUntil(a)}},{text:this.localize("runFrom"),tooltip:this.localize("runFromTip"),glyph:"xf050@FontAwesome",handler:function(){var a=b.findParentByType("notebookrunnableeditorwrapper");b.up("notebook").runFrom(a)}}]});this.callParent(arguments)},handler:function(a,b){a.runMenu.showAt(b.pageX,b.pageY)}});Ext.define("Voyant.notebook.editor.EditorWrapper",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization"],alias:"widget.notebookeditorwrapper",cls:"notebook-editor-wrapper",config:{cellId:void 0,content:"",isEditing:!1},border:!1,bodyBorder:!1,initComponent:function(){this.setCellId(this.config.cellId);this.on("afterrender",function(){this.getDockedItems().forEach(function(a){a.getTargetEl().setVisibilityMode(Ext.dom.Element.VISIBILITY)});this.setActiveMode(!1);this.body.on("click",function(){this.removeCls("notebook-editor-wrapper-hover");
this.setActiveMode(!0)},this);this.mon(this.getEl(),"mouseover",function(){this.setActiveMode(!0)},this);this.mon(this.getEl(),"mouseout",function(){this.setActiveMode(!1)},this)},this);this.callParent(arguments)},setActiveMode:function(a){this.getDockedItems().forEach(function(b){"right"==b.dock?b.items.each(function(b){0==b.hasCls("notebookwrappercounter")&&b.getTargetEl().setVisibility(a)}):b.getTargetEl().setVisibility(a)},this);this.getIsEditing()||(a?this.body.addCls("notebook-editor-wrapper-hover"):
this.body.removeCls("notebook-editor-wrapper-hover"))},getContent:function(){throw Error("Subclass must override!");}});Ext.define("Voyant.notebook.editor.RunnableEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",mixins:["Voyant.util.Localization"],alias:"widget.notebookrunnableeditorwrapper",config:{isRun:!1,mode:"javascript"},editor:void 0,results:void 0,constructor:function(a){this.results.addListener("initialized",this.updateLayout,this);this.callParent(arguments)},run:function(a,b){return this.results.getIsInitialized()?(void 0===b&&(console.log("fetching prior vars"),b=this.up("notebook").getNotebookVariables(this)),
this._run(b)):Ext.Promise.reject("Editor is not initialized")},_run:function(a){this.results.clear();this.editor.clearMarkers();var b=this.editor.getValue();this.setIsRun(!0);a=this.results.run(b,a);a.otherwise(function(a){void 0!==a.error&&(a=a.error.location,void 0!==a&&(this.editor.addMarker(a,"error"),this.editor.addLineMarker(a,"error")))},this);return a},getInput:function(){return this.editor.getValue()},getVariables:function(){return this.results.getHasRunError()?[]:this.results.getVariables()},
getOutput:function(){if(!this.results.getHasRunError())return this.results.getCachedResultsValue()},_reduceDataViewerOutput:function(a){var b=(new DOMParser).parseFromString(a,"text/html").querySelector(".spyral-dv-container");if(null!==b){var c=function(a,b){var d=a.querySelector(".spyral-dv-content .spyral-dv-right");if(null!==d){a=[];for(var e=!1,h=0;h<d.children.length;h++)h>=b?(a.push(d.children[h]),e=!0):c(d.children[h],b);a.forEach(function(a){d.removeChild(a)});e&&d.insertAdjacentHTML("beforeend",
...
itemId:"expandWidget",height:20,hidden:b?!0:!1,style:{textAlign:"center",fontSize:"26px",cursor:"pointer",borderTop:"1px solid #DDD",color:"#000"},html:"\x26#8943;",listeners:{afterrender:function(a){var b=this;a.getEl().on("click",function(){b._doExpandContract()})},scope:this}}]});this.callParent(arguments)},initComponent:function(){var a=this._handleResults.bind(this);this.on("afterrender",function(b){b.getEl().on("mouseover",function(a,c){b.down("#buttons").setVisible(!0)});b.getEl().on("mouseout",
function(a,c){b.down("#buttons").setVisible(!1)});window.addEventListener("message",a);var c=this;this.setInitIntervalID(setInterval(function(){c._sendMessage({type:"command",command:"init"})},100))},this);this.on("removed",function(){window.removeEventListener("message",a)},this);this.callParent(arguments)},clear:function(){!1===this.isVisible()&&(console.log("clearing but not visible!",this),this.show());this._sendMessage({type:"command",command:"clear"})},resetResults:function(){this.setCachedResultsValue(void 0);
...
this));break;case "clear":this._setHeight(0)}break;case "result":console.log("iframe result:",b),this.unmask(),this.getRunPromise().resolve(b)}b.value&&this.setCachedResultsValue(b.value);b.output&&this.setCachedResultsOutput(b.output);"getContents"!==b.command&&this.setCachedResultsVariables(b.variables);0<b.height&&this._setHeight(b.height);this.fireEvent("sandboxMessage",b)}else console.warn("unrecognized message!",a)},_doExpandContract:function(){var a=this.down("#expandButton");this.getExpandResults()?
...
void 0===a&&(a=(b=this.getResultsEl())?b.getHeight():this.getEmptyResultsHeight(),this.setCachedResultsHeight(a)));a+=this.getCachedPaddingHeight();if(b=this.getResultsEl())b=this.down("#expandWidget"),this.getExpandResults()?(b.hide(),this.setHeight(Math.max(a,this.getEmptyResultsHeight()))):(a=Math.min(Math.max(a,this.getEmptyResultsHeight()),this.getMinimumResultsHeight()),a<this.getMinimumResultsHeight()?b.hide():b.show(),this.setHeight(a))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization","Voyant.notebook.util.Embed"],embeddable:["Voyant.notebook.editor.CodeEditor"],cls:"notebook-code-editor",config:{mode:"javascript",content:"",docs:void 0,isChangeRegistered:!1,editor:void 0,editedTimeout:void 0,lines:1,markers:[]},statics:{i18n:{},api:{content:void 0},ternServer:void 0},MIN_LINES:6,constructor:function(a){this.callParent(arguments)},listeners:{render:function(){var a=
this,b=Ext.getDom(this.getEl()),c=CodeMirror(b,{mode:this._getModeConfig(this.getMode()),value:this.getContent(),lineNumbers:!0,lineWrapping:!0,styleActiveLine:!0,viewportMargin:50,extraKeys:{"Shift-Enter":function(){a.up("notebookrunnableeditorwrapper").run()},"Shift-Ctrl-Enter":function(){var b=a.up("notebookrunnableeditorwrapper");b.up("notebook").runUntil(b)},"Shift-Cmd-Enter":function(){var b=a.up("notebookrunnableeditorwrapper");b.up("notebook").runUntil(b)},"Ctrl-/":function(){c.toggleComment()},
"Cmd-/":function(){c.toggleComment()}}});b=(this.MIN_LINES+1)*c.defaultTextHeight()+"px";var d=c.getWrapperElement();d.style.height="auto";d.style.minHeight=b;c.getScrollerElement().style.minHeight=b;c.on("change",function(b,c){a.clearMarkers();c=b.lineCount();c!==a.getLines()&&(a.setLines(c),setTimeout(function(){var c=b.getWrapperElement().offsetHeight;a.setSize({height:c})},0));!1===a.getIsChangeRegistered()?(a.setIsChangeRegistered(!0),c=a.up("notebookrunnableeditorwrapper"),c.setIsRun(!1),c.up("notebook").setIsEdited(!0)):
a.getEditedTimeout()||a.setEditedTimeout(setTimeout(function(){a.setIsChangeRegistered(!1)},3E4))},this);"javascript"===this.getMode()&&(void 0===Voyant.notebook.editor.CodeEditor.ternServer&&(b=this.getDocs(),d=Voyant.application.getBaseUrlFull(),Voyant.notebook.editor.CodeEditor.ternServer=new CodeMirror.TernServer({defs:b,useWorker:!0,workerScript:d+"resources/spyral/tern/worker.js",workerDeps:["tern_worker_deps.js"],hintDelay:5E3})),c.on("keypress",function(a,b){"."===b.key?Voyant.notebook.editor.CodeEditor.ternServer.complete(a):
"{"===b.key&&(b=a.getCursor(),a.getRange({line:b.line,ch:0},b).match(/\(\s*$/)&&setTimeout(function(){Voyant.notebook.editor.CodeEditor.ternServer.complete(a)},50))}),Object.assign(c.getOption("extraKeys"),{"Ctrl-Space":function(a){Voyant.notebook.editor.CodeEditor.ternServer.complete(a)},"Ctrl-D":function(b){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(b,void 0,a._showDocsCallback.bind(a))},"Cmd-Space":function(a){Voyant.notebook.editor.CodeEditor.ternServer.complete(a)},"Cmd-D":function(b){Voyant.notebook.editor.CodeEditor.ternServer.showDocs(b,
void 0,a._showDocsCallback.bind(a))}}),c.on("cursorActivity",function(a){Voyant.notebook.editor.CodeEditor.ternServer.updateArgHints(a)}));this.setEditor(c);this._setModeOptions(this.getMode());a.fireEvent("resize",a)},removed:function(a,b){a.getEditor()&&a.setEditor(void 0)}},_getModeConfig:function(a){switch(a){case "json":a={name:"javascript",json:!0};break;case "xml":a="xml";break;default:a="javascript"}return a},_setModeOptions:function(a){var b={};switch(a){case "json":case "javascript":b.autoCloseBrackets=
!0;b.matchBrackets=!0;break;default:b.autoCloseBrackets=!1,b.matchBrackets=!1}for(var c in b)this.getEditor().setOption(c,b[c])},switchModes:function(a){console.log("mode",a);this.setMode(a);this.rendered&&(this.getEditor().setOption("mode",this._getModeConfig(a)),this._setModeOptions(a))},getValue:function(){return this.getEditor().getValue()},addMarker:function(a,b){b="spyral-editor-"+(void 0===b?"error":b);var c=a[0];a=a[1];a--;c--;a=this.getEditor().getDoc().markText({line:c,ch:a},{line:c,ch:a+
1},{className:b});this.getMarkers().push(a)},addLineMarker:function(a,b){b="spyral-editor-"+(void 0===b?"error":b);a=a[0];a--;a=this.getEditor().getDoc().addLineClass(a,"gutter",b);this.getMarkers().push({marker:a,where:"gutter",cls:b})},clearMarkers:function(){var a=this.getEditor();this.getMarkers().forEach(function(b){b.marker?a.getDoc().removeLineClass(b.marker,b.where,b.cls):b.clear()});this.setMarkers([])},_showDocsCallback:function(){var a=this.getEditor().state.ternTooltip.querySelector("a");
a&&a.addEventListener("click",function(b){b.preventDefault();b.stopPropagation();b=a.getAttribute("href");this.up("notebook").handleDocLink(b)}.bind(this))}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run","Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{}},constructor:function(a){a.mode="javascript";this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode});this.results=
Ext.create("Voyant.notebook.editor.SandboxWrapper",{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,listeners:{initialized:function(){this.fireEvent("initialized",this);void 0!==a.output&&this.results.updateHtml(a.output)},scope:this}});Ext.apply(this,{border:!1,dockedItems:[{xtype:"toolbar",dock:"left",defaults:{textAlign:"left"},items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun"},{xtype:"notebookwrapperrununtil"},{xtype:"notebookcodeconfig"}]},{xtype:"toolbar",
dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order,name:a.cellId},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],layout:"anchor",defaults:{anchor:"100%"},items:[this.editor,this.results]});this.callParent(arguments)},switchModes:function(a){if("javascript"!==a){var b=this.up("notebook"),c=this.down("notebookwrappercounter").getOrder();b.addData("",c,void 0,{mode:a});b.notebookWrapperRemove(this)}else console.log("unhandled mode switch:",
a)}});Ext.define("Voyant.notebook.editor.TextEditor",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebooktexteditor",cls:"notebook-text-editor",config:{editor:void 0,isEditRegistered:!1,currentHeight:0,isFresh:void 0,isEnabled:!1},statics:{i18n:{}},border:!1,constructor:function(a){a.isFresh=a.content?!1:!0;Ext.apply(this,{html:a.content?a.content:'\x3cp style\x3d"text-align: center;"\x3e'+this.localize("emptyText")+"\x3c/p\x3e"});this.callParent(arguments)},listeners:{boxready:function(a){this.ownerCt.getTargetEl().on("click",
function(a,c){"A"!==c.tagName&&this.handleClick()},this)},removed:function(a,b){this.getEditor()&&(this.getEditor().focusManager.blur(!0),this.getEditor().destroy())}},handleClick:function(){this.getEditor()?!1===this.getIsEnabled()&&this._enable():this._initEditor()},getContent:function(){return this.getTargetEl().dom.innerHTML},_initEditor:function(){var a=this.getTargetEl(),b=CKEDITOR.inline(a.dom,{toolbar:[{name:"basicstyles",items:["Bold","Italic","-","RemoveFormat"]},{name:"paragraph",items:"NumberedList BulletedList - Justify Outdent Indent Blockquote JustifyLeft JustifyCenter JustifyRight".split(" ")},
{name:"colors",items:["TextColor","BGColor"]},{name:"styles",items:["Styles","Format"]},{name:"links",items:["Link","Unlink","Anchor"]},{name:"insert",items:["Image","Table"]},{name:"document",items:["Sourcedialog"]}],extraPlugins:"sourcedialog,justify,colorbutton",allowedContent:!0,disableNativeSpellChecker:!1,toolbarCanCollapse:!1,startupFocus:"end"});b.on("contentDom",function(){this._enable();var a=b.editable();a.attachListener(a,"click",function(a){a.stop()},null,null,0)},this);b.on("focus",
function(a){this.getIsFresh()&&(this.setIsFresh(!1),this.getTargetEl().update("\x3cp\x3e\x3c/p\x3e"))},this);b.on("blur",function(a){this._disable()},this);b.on("change",function(){var a=b.container.$.clientHeight;a!==this.getCurrentHeight()&&(this.findParentByType("notebookeditorwrapper").setHeight(a),this.setCurrentHeight(b.container.$.clientHeight));if(this.getIsEditRegistered()){var d=this;setTimeout(function(){d.setIsEditRegistered(!1)},3E4)}else this.findParentByType("notebook").setIsEdited(!0),
this.setIsEditRegistered(!0)},this);this.setEditor(b)},_enable:function(){this.getEditor().setReadOnly(!1);this.getEditor().focus();this.findParentByType("notebookeditorwrapper").setIsEditing(!0);this.setIsEnabled(!0)},_disable:function(){this.getEditor().setReadOnly(!0);this.findParentByType("notebookeditorwrapper").setIsEditing(!1);this.setIsEnabled(!1)}});Ext.define("Voyant.notebook.editor.TextEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",requires:["Voyant.notebook.editor.TextEditor"],alias:"widget.notebooktexteditorwrapper",cls:"notebook-text-wrapper",config:{},minHeight:85,constructor:function(a){Ext.apply(this,{items:[{xtype:"notebooktexteditor",content:Ext.Array.from(a.input).join("")}],dockedItems:[{xtype:"toolbar",dock:"left",items:[{xtype:"notebookwrapperadd"}]},{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",
...
items:[{xtype:"voyantfilefield",itemId:"file",fieldLabel:this.localize("fileUpload"),labelAlign:"right",buttonText:this.localize("buttonLabel"),width:350,listeners:{render:function(b){a.fileName&&(b.inputEl.dom.value=a.fileName)},change:function(a,c){this.setFile(a.fileInputEl.dom.files[0]);this.setFileName(c);this.setDataUrl(void 0);this.setResourceId(void 0)},scope:this}}]});"undefined"===typeof Voyant.util.ServerStorage&&Ext.define("Voyant.util.ServerStorage",{extend:"Voyant.util.Storage",getTromboneUrl:function(){return Voyant.application.getTromboneUrl()}});
this.serverStorage=Ext.create("Voyant.util.ServerStorage");this.callParent(arguments)},getDataUrl:function(){var a=new Ext.Deferred,b=this.callParent();void 0===b?this.getResourceId()?this.loadStoredFile().then(function(b){a.resolve(b)},function(){a.reject()}):this.getFile()?this.storeFile().then(function(b){a.resolve(b[1])},function(){a.reject()}):a.reject():a.resolve(b);return a.promise},getBlob:function(){var a=new Ext.Deferred;this.getDataUrl().then(function(b){a.resolve(Spyral.Util.dataUrlToBlob(b))},
function(b){a.reject(b)});return a.promise},storeFile:function(){var a=new Ext.Deferred,b=this.getFile();if(void 0===b)a.reject();else{var c=this;Spyral.Util.blobToDataUrl(b).then(function(b){var d=Spyral.Util.id(32);c.serverStorage.storeResource(d,b).then(function(){c.setResourceId(d);c.setDataUrl(b);a.resolve([d,b])},function(){a.reject()})},function(b){a.reject(b)})}return a.promise},loadStoredFile:function(){var a=new Ext.Deferred,b=this.getResourceId();if(void 0===b)a.reject();else{var c=this;
this.serverStorage.getStoredResource(b).then(function(b){void 0!==b?(c.setDataUrl(b),a.resolve(b)):a.reject()},function(){a.reject()})}return a.promise}});Ext.define("Voyant.form.field.File",{extend:"Ext.form.field.File",alias:"widget.voyantfilefield",onFileChange:function(a,b,c){c=c.replace(/^.*(\\|\/|:)/,"");return this.callParent([a,b,c])}});Ext.define("Voyant.notebook.editor.DataWrapper",{extend:"Voyant.notebook.editor.RunnableEditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.FileInput"],alias:"widget.notebookdatawrapper",cls:"notebook-data-wrapper",statics:{i18n:{dataNameAlphanum:"The data name must contain alphanumeric characters only",dataNameAlphastart:"The data name must not begin with a number"}},config:{dataName:void 0},constructor:function(a){a.mode=void 0!==a.mode?a.mode:"json";var b="file"===
a.mode,c=void 0,d=void 0;b&&(c=a.input.resourceId,d=a.input.fileName);this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:a.mode,hidden:b});this.fileInput=Ext.create("Voyant.notebook.editor.FileInput",{resourceId:c,fileName:d,hidden:!b});this.results=Ext.create("Voyant.notebook.editor.SandboxWrapper",{sandboxSrcUrl:Spyral.Load.baseUrl+"spyral/sandbox.jsp",expandResults:a.expandResults,listeners:{initialized:function(){this.fireEvent("initialized",
this);void 0!==a.output&&this.results.updateHtml(a.output)},scope:this}});Ext.apply(this,{border:!1,dockedItems:[{xtype:"toolbar",dock:"left",defaults:{textAlign:"left"},items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun"},{xtype:"notebookwrapperrununtil"},{xtype:"notebookcodeconfig"},{xtype:"notebookwrapperexport"}]},{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order,name:a.cellId},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],
layout:"anchor",defaults:{anchor:"100%"},items:[this.editor,this.fileInput,{xtype:"form",cls:"notebook-data-input",bodyPadding:6,bodyStyle:"background-color: rgb(252, 252, 252);",layout:{type:"hbox",pack:"center"},items:[{width:350,xtype:"textfield",fieldLabel:"Data Name",labelAlign:"right",name:"dataName",value:a.dataName,validator:function(a){return/^[a-zA-Z0-9_]+$/.test(a)?/^\D/.test(a)?!0:this.localize("dataNameAlphastart"):this.localize("dataNameAlphanum")}.bind(this),allowBlank:!1,listeners:{change:function(a,
b,c){a.isValid()?this.setDataName(b):this.setDataName(void 0)},scope:this}},{width:100,margin:"0 0 0 6",xtype:"button",text:"Assign",handler:function(a){this.up("notebook").setIsEdited(!0);this.run()},scope:this}]},this.results]});this.callParent(arguments)},switchModes:function(a){if("javascript"===a){a=this.up("notebook");var b=this.down("notebookwrappercounter").getOrder();a.addCode("",b,void 0,{mode:"javascript"});a.notebookWrapperRemove(this)}else this.setMode(a),"file"===a?(this.editor.hide(),
this.fileInput.show()):(this.fileInput.hide(),this.editor.switchModes(a),this.editor.show()),this.updateLayout()},_getCode:function(){var a=new Ext.Deferred,b=this.getDataName();void 0===b&&a.reject();var c=this.getMode();if("file"===c)this.fileInput.getDataUrl().then(function(c){a.resolve(b+"\x3d Spyral.Util.dataUrlToBlob(`"+c+"`)")},function(){a.reject()});else{var d=this.editor.getValue();switch(c){case "text":d=b+"\x3d`"+d+"`";break;case "json":d=b+"\x3d JSON.parse(`"+d+"`)";break;case "xml":d=
b+"\x3d new DOMParser().parseFromString(`"+d+'`, "application/xml")';break;case "html":d=b+"\x3d new DOMParser().parseFromString(`"+d+'`, "application/xml")'}a.resolve(d)}return a.promise},_run:function(a){var b=new Ext.Deferred,c=this;this._getCode().then(function(d){c.results.clear();"file"!==c.getMode()&&c.editor.clearMarkers();c.setIsRun(!0);c.results.run(d,a).then(function(a){b.resolve(a)},function(a){if(void 0!==a.error){var d=a.error.location;void 0!==d&&(c.editor.addMarker(d,"error"),c.editor.addLineMarker(d,
"error"))}b.reject(a)})},function(){b.reject("Error handling data")});return b.promise},getInput:function(){return"file"!==this.getMode()?this.editor.getValue():{resourceId:this.fileInput.getResourceId(),fileName:this.fileInput.getFileName()}},getContent:function(){var a=this.callParent(arguments);a.dataName=this.getDataName();return a}});Ext.define("Voyant.notebook.github.OctokitWrapper",{extend:"Ext.Base",alias:"octokitwrapper",octokit:void 0,constructor:function(a){this.octokit=new Octokit({auth:a.authToken,userAgent:"https://github.com/voyanttools/Voyant"})},getInfoForAuthenticatedUser:function(){return this.octokit.users.getAuthenticated()},getReposForAuthenticatedUser:function(a,b,c){return this.octokit.repos.listForAuthenticatedUser({affiliation:void 0===a?"owner":a,page:void 0===b?0:b,per_page:void 0===c?10:c})},getReposForUser:function(a,
...
(this.currentWindow.close(),this.currentWindow=void 0)},showLoad:function(){var a=this;if(this.parent.isAuthenticated){void 0===this.octokitWrapper&&this.initOctokitWrapper(this.parent.githubAuthToken);var b=void 0;b=Ext.create("Ext.window.Window",{title:"Load from GitHub",width:750,height:550,closable:!1,maximizable:!0,layout:"fit",items:{xtype:"githubreposbrowser",octokit:this.octokitWrapper,itemId:"repoBrowser",listeners:{nodeSelected:function(a,d,e){"file"===d?b.queryById("load").setDisabled(!1):
b.queryById("load").setDisabled(!0)},nodeDeselected:function(a){b.queryById("load").setDisabled(!0)}}},buttons:[{text:"Load Selected",itemId:"load",disabled:!0,handler:function(){var a=b.queryById("repoBrowser");this.loadFile(a.getRepoId(),a.getPath())},scope:this},{text:"Cancel",handler:function(){a.close()}}]});b.show();this.currentWindow=b}else this.parent.showGitHubAuthentication(this.showLoad.bind(this))},showSave:function(a){var b=this;if(this.parent.isAuthenticated){void 0===this.octokitWrapper&&
...
(void 0===this.octokitWrapper&&this.initOctokitWrapper(this.parent.githubAuthToken),this.octokitWrapper.loadFile(a,b).then(function(a){c.setCurrentFile(a);c.fireEvent("fileLoaded",c,a)})):this.parent.showGitHubAuthentication(this.loadFile.bind(this))}});Ext.define("Voyant.notebook.StorageDialogs",{extend:"Ext.Component",requires:[],alias:"",notebookParent:void 0,constructor:function(a){a=a||{};this.callParent(arguments);this.notebookParent=a.notebookParent},initComponent:function(){this.callParent(arguments)},showSave:function(a,b,c){c=void 0===c?"":c;var d=this,e=""===c;Ext.create("Ext.window.Window",{title:e?"Save New Notebook":"Overwrite Existing Notebook",items:[{xtype:"form",width:450,bodyPadding:5,plugins:["datatip"],listeners:{beforeshowtip:function(a,
b,c){return!b.currentTarget.el.hasCls("x-form-invalid")}},layout:"anchor",defaults:{labelAlign:"right",labelWidth:160,width:360,inputAttrTpl:'spellcheck\x3d"false"',xtype:"textfield"},items:[{fieldLabel:"Notebook ID"+(e?" (optional)":""),name:"notebookName",value:c,allowBlank:!0,readOnly:!e,tooltip:"An ID used to identify this notebook. If left blank, one will be generated for you.",validator:function(a){return""==a?!0:null===a.match(/^[A-Za-z0-9-]{4,32}$/)?"The ID must be between 4 and 32 characters. You may use alphanumeric characters and dash.":
!0}}]}],buttons:[{text:"Cancel",ui:"default-toolbar",handler:function(){this.up("window").close();d.fireEvent("saveCancelled",d)}}," ",{text:"Save",handler:function(c){var f=c.up("window"),h=f.down("form").getForm();if(h.isValid()){var k=h.getValues();k.data=a;k.metadata=b;e&&""!==k.notebookName?d.doesNotebookExist(d.notebookParent.accountInfo.id,k.notebookName).then(function(a){a?h.findField("notebookName").markInvalid("That Notebook ID already exists."):(d.doSave(k),f.close())}):(c.setDisabled(!0),
d.doSave(k).then(function(a){c.setDisabled(!1);a&&f.close()}))}}}],listeners:{close:function(){d.fireEvent("close",d)}}}).show()},doesNotebookExist:function(a,b){var c=new Ext.Deferred;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"exists",id:a+this.notebookParent.NOTEBOOK_ID_SEPARATOR+b,noCache:1}).then(function(a){a.notebook.success?c.resolve("true"===a.notebook.data):(console.warn(a.notebook.error),c.resolve(!1))}).catch(function(a){console.warn(a)});return c.promise},doSave:function(a){var b=
a.notebookName,c=a.data;a=a.metadata;var d=this,e=new Ext.Deferred;-1!==b.indexOf(this.notebookParent.NOTEBOOK_ID_SEPARATOR)&&(console.warn("doSave: was sent notebookId instead of name"),b=b.split(this.notebookParent.NOTEBOOK_ID_SEPARATOR)[1]);Ext.Ajax.request({method:"POST",url:Voyant.application.getBaseUrlFull()+"spyral/account/save",params:{name:b,data:c,metadata:JSON.stringify(a)},success:function(a){a=JSON.parse(a.responseText);a.notebook.success?(d.fireEvent("fileSaved",d,a.notebook.id),e.resolve(!0)):
(d.fireEvent("fileSaved",d,null,a.notebook.error),e.reject(!1))},failure:function(a){d.fireEvent("fileSaved",d,null,a.responseText);e.reject(!1)}});return e.promise},reset:function(){}});Ext.define("Voyant.notebook.metadata.MetadataEditor",{extend:"Ext.form.Panel",mixins:["Voyant.util.Localization"],alias:"widget.metadataeditor",statics:{i18n:{metadataAuthor:"Author(s)",metadataTitle:"Title",metadataTip:"Edit notebook metadata.",metadataKeywords:"Keywords",metadataDescription:"Description",metadataLicense:"Licence",metadataLanguage:"Language"}},constructor:function(a){Ext.apply(this,a,{trackResetOnLoad:!0,items:{bodyPadding:5,layout:"anchor",defaults:{anchor:"100%",labelAlign:"right"},
defaultType:"textfield",items:[{fieldLabel:this.localize("metadataAuthor"),name:"author"},{fieldLabel:this.localize("metadataTitle"),name:"title"},{fieldLabel:this.localize("metadataKeywords"),name:"keywords",xtype:"tagfield",store:{xtype:"store.json",fields:[{name:"label"},{name:"count",type:"integer"}]},displayField:"label",valueField:"label",queryMode:"local",filterPickList:!0,forceSelection:!1,delimiter:",",createNewOnEnter:!0,listeners:{afterrender:function(a){Spyral.Load.trombone({tool:"notebook.CatalogueFacets",
facets:"facet.keywords",noCache:1}).then(function(b){a.getStore().loadRawData(b.catalogue.facets[0].results);a.setValue(a.getValue())})}}},{xtype:"textarea",fieldLabel:this.localize("metadataDescription"),name:"description"},{xtype:"combo",fieldLabel:this.localize("metadataLicense"),name:"license",store:{fields:["text"],data:[{text:"Apache License 2.0"},{text:'BSD 3-Clause "New" or "Revised" license'},{text:'BSD 2-Clause "Simplified" or "FreeBSD" license'},{text:"Creative Commons Attribution (CC BY)"},
{text:"Creative Commons Attribution-ShareAlike (CC BY-SA)"},{text:"Creative Commons Zero (CC0)"},{text:"GNU General Public License (GPL)"},{text:'GNU Library or "Lesser" General Public License (LGPL)'},{text:"MIT license"},{text:"Mozilla Public License 2.0"},{text:"Common Development and Distribution License"},{text:"Eclipse Public License"}]}},{xtype:"combo",name:"language",fieldLabel:this.localize("metadataLanguage"),store:{fields:["text"],data:[{text:"Bengali"},{text:"Bhojpuri"},{text:"Egyptian Arabic"},
{text:"English"},{text:"French"},{text:"German"},{text:"Gujarati"},{text:"Hausa"},{text:"Hindi"},{text:"Indonesian"},{text:"Italian"},{text:"Japanese"},{text:"Javanese"},{text:"Kannada"},{text:"Korean"},{text:"Mandarin"},{text:"Marathi"},{text:"Persian"},{text:"Portuguese"},{text:"Russian"},{text:"Southern Min"},{text:"Spanish"},{text:"Standard Arabic"},{text:"Swahili"},{text:"Tamil"},{text:"Telugu"},{text:"Thai"},{text:"Turkish"},{text:"Urdu"},{text:"Vietnamese"},{text:"Western Punjabi"},{text:"Wu Chinese"},
{text:"Yue Chinese"}]}}]}});this.callParent(arguments)},loadMetadata:function(a){a instanceof Spyral.Metadata&&this.loadRecord(Ext.create("Voyant.data.model.NotebookMetadata",{title:a.title,userId:a.userId,author:a.author,description:a.description,keywords:a.keywords,language:a.language,license:a.license}))}});
Ext.define("Voyant.data.model.NotebookMetadata",{extend:"Ext.data.Model",fields:[{name:"title",type:"string"},{name:"userId",type:"string"},{name:"author",type:"string"},{name:"description",type:"string"},{name:"keywords",type:"string"},{name:"language",type:"string",defaultValue:"English"},{name:"license",type:"string",defaultValue:"Creative Commons Attribution (CC BY)"},{name:"modified",type:"date"},{name:"created",type:"date"}]});Ext.define("Voyant.notebook.util.FormatConverter",{importFromHtml:function(a){var b=this,c=(new DOMParser).parseFromString(a,"text/html");b.setMetadata(new Spyral.Metadata(c));var d=!1,e=[];c.querySelectorAll("section.notebook-editor-wrapper").forEach(function(c){var f=c.classList;if(f.contains("notebooktexteditorwrapper"))f=c.querySelector(".notebook-text-editor").innerHTML,b.addText(f,void 0,c.id);else if(f.contains("notebookcodeeditorwrapper")||f.contains("notebookdatawrapper")){var h=c.querySelector(".notebook-code-editor-raw");
f=/\beditor-mode-(\w+)\b/.exec(h.className)[1];var k="notebookcodeeditorwrapper";"javascript"!==f&&(k="notebookdatawrapper");k=a.indexOf("\x3csection id\x3d'"+c.id+"' class\x3d'notebook-editor-wrapper "+k+"'\x3e");var l=a.indexOf("\x3cpre class\x3d'notebook-code-editor-raw editor-mode-",k);l=a.indexOf("\x3e",l)+1;var m=a.indexOf("\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results",l);-1===k||-1===l||-1===m?(d=!0,input="javascript"===f?h.innerText:h.innerHTML):input=a.substring(l,m);h=c.querySelector(".notebook-code-results").innerHTML;
k=!1===c.querySelector(".notebook-code-results").classList.contains("collapsed");if("javascript"===f){var n=b.addCode({input:input,output:h,expandResults:k,mode:f},void 0,c.id);e.push(n);n.on("initialized",function(){var a=e.indexOf(n);-1!==a?(e.splice(a,1),0===e.length&&b.fireEvent("notebookInitialized")):console.error("unknown cell initialized",n)})}else{l=c.querySelector(".notebook-code-results .spyral-dv-left").firstChild.data;l=l.split(":")[0];var p=b.addData({input:input,output:h,expandResults:k,
dataName:l,mode:f},void 0,c.id);e.push(p);p.on("initialized",function(){var a=e.indexOf(p);-1!==a?(e.splice(a,1),0===e.length&&b.fireEvent("notebookInitialized")):console.error("unknown cell initialized",p)})}}});d&&b.showError(b.localize("errorParsingDomInput"))},getInnerHeaderHtml:function(){var a="";this.getMetadata().title&&(a+="\x3cdiv class\x3d'title'\x3e"+this.getMetadata().title+"\x3c/div\x3e");this.getMetadata().author&&(a+="\x3cdiv class\x3d'author'\x3e"+this.getMetadata().author+"\x3c/div\x3e");
...
a+="\x3c/head\x3e\n\x3cbody class\x3d'exported-notebook'\x3e\n\x3cheader class\x3d'spyral-header'\x3e"+this.getInnerHeaderHtml()+"\x3c/header\x3e\n\x3carticle class\x3d'spyralArticle'\x3e\n";this.getComponent("cells").items.each(function(b,d){d=b.getContent();var c=b.down("notebookwrappercounter");a+="\x3csection id\x3d'"+c.name+"' class\x3d'notebook-editor-wrapper "+b.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e"+c.getTargetEl().dom.innerHTML+"\x3c/div\x3e";b.isXType("notebooktexteditorwrapper")?
a+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+d+"\x3c/div\x3e\n":(c=b.getTargetEl().query(".CodeMirror-wrap")[0].cloneNode(!0),a+="\x3cdiv class\x3d'notebook-code-editor'\x3e\n"+c.outerHTML+"\n\x3c/div\x3e\n\x3cpre class\x3d'notebook-code-editor-raw editor-mode-"+d.mode+"'\x3e"+d.input+"\x3c/pre\x3e\n",""===d.output&&b.results.getResultsEl(),a+="\x3cdiv class\x3d'notebook-code-results"+(d.expandResults?"":" collapsed")+"'\x3e\n"+d.output+"\n\x3c/div\x3e\n");a+="\x3c/section\x3e\n"});return a+=
"\x3c/article\x3e\n\x3cfooter class\x3d'spyral-footer'\x3e"+this.getInnerFooterHtml()+"\x3c/footer\x3e\n\x3c/body\x3e\n\x3c/html\x3e"},generateExportMetadata:function(a){a=a.clone();a.title&&(a.title=a.title.replace(/<\/?\w+.*?>/g,""));a.description&&(a.description=a.description.replace(/<\/?\w+.*?>/g,""));a.keywords&&(!1===Array.isArray(a.keywords)&&(a.keywords=a.keywords.split(/[\s,]+/)),a.keywords=a.keywords.reduce(function(a,c){0<c.length&&a.push(c.toLowerCase());return a},[]));return a},generateExportJson:function(){var a=
[];this.getComponent("cells").items.each(function(b,d){switch(b.xtype){case "notebookcodeeditorwrapper":d="code";break;case "notebookdatawrapper":d="data";break;default:d="text"}a.push({cellId:b.getCellId(),type:d,content:b.getContent()})});var b={metadata:this.getMetadata(),cells:a};return JSON.stringify(b)},getExtraViewExportItems:function(){return[{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=
(this.getNotebookId()||"spyral")+".html",c=this.generateExportHtml(),d={type:"text/html"};try{var e=new File([c],b,d)}catch(f){e=new Blob([c],d)}c=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",b);a.setAttribute("href",c)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]}});Ext.define("Voyant.notebook.util.NotebooksList",{extend:"Ext.view.View",alias:"widget.notebookslist",constructor:function(a){Ext.apply(a,{width:"100%",padding:10,scrollable:"vertical",store:Ext.create("Ext.data.JsonStore",{fields:[{name:"id"},{name:"author"},{name:"title"},{name:"description"},{name:"keywords"},{name:"language"},{name:"license"},{name:"created",type:"date"},{name:"modified",type:"date"},{name:"version"}]}),tpl:new Ext.XTemplate('\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"catalogue-notebook"\x3e',
'\x3cdiv class\x3d"id"\x3e{id}\x3c/div\x3e','\x3cdiv class\x3d"title nowrap" title\x3d"{title}"\x3e{title}\x3c/div\x3e','\x3cdiv class\x3d"author nowrap"\x3e\x3ci class\x3d"fa fa-user" aria-hidden\x3d"true"\x3e\x3c/i\x3e {author}\x3c/div\x3e','\x3cdiv class\x3d"description"\x3e{description}\x3c/div\x3e','\x3ctpl if\x3d"keywords.length \x26gt; 0"\x3e','\x3cdiv class\x3d"keywords nowrap"\x3e','\x3ci class\x3d"fa fa-tags" aria-hidden\x3d"true"\x3e\x3c/i\x3e ','\x3ctpl for\x3d"keywords"\x3e',"\x3cspan\x3e{.}\x3c/span\x3e",
"\x3c/tpl\x3e","\x3c/div\x3e","\x3c/tpl\x3e",'\x3cdiv class\x3d"dates"\x3e\x3cspan class\x3d"date"\x3e\x3ci class\x3d"fa fa-clock-o" aria-hidden\x3d"true"\x3e\x3c/i\x3e {[Ext.Date.format(values.modified, "M j Y")]}\x3c/span\x3e\x3c/div\x3e',"\x3c/div\x3e","\x3c/tpl\x3e"),itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected"});this.callParent(arguments)}});Ext.define("Voyant.notebook.util.DocsWindow",{extend:"Ext.window.Window",mixins:["Voyant.util.Localization"],statics:{i18n:{home:"Home",overview:"Overview",configs:"Configs",methods:"Methods",docs:"Docs",openFull:"Open Full Documentation",outlineIntro:'This is an inline version of the API documentation for \x3ca href\x3d"#!/guide/notebook"\x3eSpyral Notebooks\x3c/a\x3e. You can also \x3ca href\x3d"#!/api"\x3eview the full documentation\x3c/a\x3e in a new window.',outlineApi:"Here is a list of the Spyral classes that can be used in your notebook:"}},
lastDocEntryClass:void 0,lastDocEntryMethod:void 0,outlineTemplate:new Ext.XTemplate("\x3cul\x3e",'\x3ctpl for\x3d"groups"\x3e','\x3ctpl for\x3d"classes"\x3e','\x3cli\x3e\x3ca href\x3d"#!/api/{.}"\x3e{.}\x3c/a\x3e\x3c/li\x3e',"\x3c/tpl\x3e","\x3c/tpl\x3e","\x3c/ul\x3e"),membersTemplate:new Ext.XTemplate('\x3cdiv class\x3d"members"\x3e','\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"member"\x3e','\x3ctpl if\x3d"meta.static"\x3e','\x3cspan class\x3d"static" title\x3d"static"\x3es\x3c/span\x3e',"\x3c/tpl\x3e",
'\x3ca href\x3d"#!/api/{owner}-{id}"\x3e{name}\x3c/a\x3e',"\x3c/div\x3e","\x3c/tpl\x3e","\x3c/div\x3e"),constructor:function(a){this.mixins["Voyant.util.Localization"].constructor.apply(this,arguments);a=a||{};Ext.apply(a,{title:this.localize("docs"),width:500,height:500,minimizable:!0,closeAction:"hide",tbar:[{text:this.localize("home"),itemId:"homeBtn",glyph:"xf015@FontAwesome",handler:function(a){this.showDocs()}.bind(this)},{text:this.localize("overview"),itemId:"overviewBtn",glyph:"xf05a@FontAwesome",
handler:function(a){this._showDocEntry()}.bind(this)},{text:this.localize("configs"),itemId:"configsBtn",glyph:"xf013@FontAwesome",handler:function(a){a.up("window").getLayout().setActiveItem(1)}},{text:this.localize("methods"),itemId:"methodsBtn",glyph:"xf1b2@FontAwesome",handler:function(a){a.up("window").getLayout().setActiveItem(2)}}],layout:"card",items:[{itemId:"main",cls:"docsWindowContent",scrollable:"y",html:""},{itemId:"configs",cls:"docsWindowContent",scrollable:"x",layout:"fit",html:""},
{itemId:"methods",cls:"docsWindowContent",scrollable:"x",layout:"fit",html:""}],tools:[{type:"help",tooltip:this.localize("openFull"),callback:function(a,c,d){a="";this.lastDocEntryClass&&(a+="/"+this.lastDocEntryClass);this.lastDocEntryMethod&&(a+="-"+this.lastDocEntryMethod);window.open(Voyant.application.getBaseUrlFull()+"docs/#!/api"+a,"_spyral_docs")}.bind(this)},{type:"restore",itemId:"restoreButton",hidden:!0,handler:function(a,c,d,e){e.hide();var b=d.up("window");b.expand(!1);setTimeout(function(){b.anchorTo(Ext.getBody(),
"br-br")},10)}}],listeners:{boxready:function(a){a.body.addListener("click",function(a){"a"===a.target.tagName.toLowerCase()&&(a.preventDefault(),a.stopPropagation(),a=a.target.getAttribute("href"),this.handleDocLink(a))},this)},minimize:function(a){a.collapse(Ext.Component.DIRECTION_BOTTOM,!1).anchorTo(Ext.getBody(),"br-br");a.down("#restoreButton").show()},scope:this}});this.callParent([a])},showDocs:function(){Ext.Ajax.request({url:Voyant.application.getBaseUrlFull()+"resources/docs/en/categories.json"}).then(function(a){try{var b=
JSON.parse(a.responseText)}catch(c){console.warn("error parsing api doc json",c)}b&&this._loadExtOutline(b[0])}.bind(this),function(){this._loadExtOutline({name:"Spyral",groups:[{name:"Base",classes:"Spyral.Corpus Spyral.Table Spyral.Chart Spyral.Load Spyral.Util Spyral.Categories".split(" ")},{name:"Notebook",classes:["Spyral.Metadata","Spyral.Notebook","Spyral.Util.Storage"]},{name:"Global",classes:["window"]}]})}.bind(this))},handleDocLink:function(a){var b=a.match(/.*?\/api\/([\w.]+)-?(.*)?/);
b?(a=b[1],b=b[2],a!==this.lastDocEntryClass?this.showDocsForClassMethod(a,b):this._showDocEntry(b)):0===a.indexOf("#!")?window.open(Voyant.application.getBaseUrlFull()+"docs/"+a,"_spyral_docs"):window.open(a,"_external")},showDocsForClassMethod:function(a,b){Ext.Ajax.request({url:Voyant.application.getBaseUrlFull()+"docs/output/"+a+".js"}).then(function(c){c=c.responseText;try{var d=JSON.parse(c.substring(c.indexOf("{"),c.length-2))}catch(e){console.warn("error parsing api doc json",e)}d&&this._loadExtDocs(d,
a,b)}.bind(this))},_showDocEntry:function(a){var b=this.down("#main").getEl().dom;b.querySelectorAll(".doc-contents, .members-section \x3e .subsection \x3e div").forEach(function(a){a.hidden=!0});(this.lastDocEntryMethod=a)?b.querySelector("#"+a).hidden=!1:b.querySelector(".doc-contents").hidden=!1;this.getLayout().setActiveItem(0);setTimeout(function(){this.down("#main").body.scrollTo("top",0,!1)}.bind(this),0)},_loadExtOutline:function(a){this.lastDocEntryMethod=this.lastDocEntryClass=void 0;this.setTitle(this.localize("docs")+
" "+this.localize("home"));this.show().anchorTo(Ext.getBody(),"br-br");this.down("#restoreButton").hide();var b="\x3cp\x3e"+this.localize("outlineIntro")+"\x3c/p\x3e\x3cp\x3e"+this.localize("outlineApi")+"\x3c/p\x3e";b+=this.outlineTemplate.apply(a);this._setHtmlForCard("main",b);this.body.scrollTo("top",0,!1);this.getLayout().setActiveItem(0);this.down("#overviewBtn").hide();this.down("#configsBtn").hide();this.down("#methodsBtn").hide();this.getCollapsed()&&(this.expand(!1),setTimeout(function(){this.anchorTo(Ext.getBody(),
"br-br")}.bind(this),10))},_loadExtDocs:function(a,b,c){this.lastDocEntryClass=b;this.lastDocEntryMethod=c;this.setTitle(this.localize("docs")+": "+a.name);this.show().anchorTo(Ext.getBody(),"br-br");this.down("#restoreButton").hide();this._setHtmlForCard("main",a.html);this._showDocEntry(c);this.down("#overviewBtn").show();var d=[],e=[];a.members.forEach(function(a){"cfg"===a.tagname?d.push(a):"method"===a.tagname&&e.push(a)});this._setHtmlForCard("configs",this.membersTemplate.apply(d));this.down("#configsBtn").setVisible(0<
d.length);this._setHtmlForCard("methods",this.membersTemplate.apply(e));this.down("#methodsBtn").setVisible(0<e.length);this.getCollapsed()&&(this.expand(!1),setTimeout(function(){this.anchorTo(Ext.getBody(),"br-br")}.bind(this),10))},_setHtmlForCard:function(a,b){this.down("#"+a).setHtml(b);a=this.down("#"+a).getEl().dom;Ext.fly(a).selectable()}});Ext.define("Voyant.notebook.Catalogue",{extend:"Ext.Component",mixins:["Voyant.util.Localization","Voyant.notebook.util.NotebooksList"],alias:"widget.notebookcatalogue",statics:{i18n:{title:"Spyral Notebooks Catalogue",browse:"Browse Notebooks",keywords:"Keywords",author:"Author",language:"Language",license:"License",search:"Search within notebooks",noResults:"No matching notebooks",suggested:"Suggested Notebooks",load:"Load Selected Notebook",cancel:"Cancel"}},window:void 0,gettingFacets:!1,constructor:function(){this.suggestedStore=
...
{xtype:"tbspacer",flex:.1}]},{xtype:"notebookslist",itemId:"notebookslist",flex:1,listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"),this.hideWindow)},scope:this}}]},{xtype:"panel",region:"west",collapsible:!0,title:this.localize("browse"),flex:1,itemId:"facets",cls:"facets",layout:{type:"accordion",animate:!1,multi:!0,fill:!1,align:"stretch",titleCollapse:!0,hideCollapseTool:!0},defaults:{xtype:"grid",rowLines:!1,hideHeaders:!0,selType:"checkboxmodel",columns:[{renderer:function(a,
b,c){return"("+c.get("count")+") "+c.get("label")},flex:1}],store:{xtype:"store.json",fields:[{name:"label"},{name:"count",type:"integer"}]}},items:[{title:this.localize("keywords"),facet:"facet.keywords",flex:3},{title:this.localize("author"),facet:"facet.author",flex:2},{title:this.localize("language"),facet:"facet.language",flex:1},{title:this.localize("license"),facet:"facet.license",flex:1}]},{xtype:"panel",region:"east",collapsible:!0,collapsed:!1,title:this.localize("suggested"),width:250,
layout:"fit",items:[{xtype:"dataview",padding:10,scrollable:"vertical",itemId:"suggestedNotebooks",store:this.suggestedStore,tpl:this.suggestedTemplate,itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected",listeners:{itemdblclick:function(a,b,c){this.fireEvent("notebookSelected",this,b.get("id"),this.hideWindow)},scope:this}}]}],closeAction:"hide",buttons:[{text:this.localize("cancel"),ui:"default-toolbar",handler:function(a){this.window.close()},
scope:this},{text:this.localize("load"),handler:function(a){a=this.window.down("#notebookslist").getSelection()[0];void 0===a&&(a=this.window.down("#suggestedNotebooks").getSelection()[0]);a&&this.fireEvent("notebookSelected",this,a.get("id"),this.hideWindow)},scope:this}]}),this.window.query("#facets \x3e grid").forEach(function(a){a.getSelectionModel().on("selectionchange",this._loadFacets,this)},this)):(this.window.query("#facets \x3e grid").forEach(function(a){a.getStore().clearFilter();a.getSelectionModel().deselectAll()}),
this.window.down("#queryfield").setValue(""),this.window.down("#notebookslist").getSelectionModel().deselectAll(),this.window.down("#suggestedNotebooks").getSelectionModel().deselectAll(),this.window.down("#notebookslist").getStore().removeAll());!1===this.suggestedStore.isLoaded()&&this.getSuggestedNotebooks();this.window.show();this._loadFacets()},hideWindow:function(){void 0!==this.window&&this.window.close()},_getSelectedFacets:function(){var a=[];this.window.query("#facets \x3e grid").forEach(function(b){b.getSelection().forEach(function(c){a.push([b.facet,
c.get("label")])})});return a},_loadFacets:function(){if(!1===this.gettingFacets){this.window.down("#facets").mask("Loading");this.gettingFacets=!0;var a=this._getSelectedFacets().map(function(a){return a.join("\x3d")}),b=this;Spyral.Load.trombone({tool:"notebook.CatalogueFacets",query:a,noCache:1}).then(function(a){a.catalogue.facets.forEach(function(a){var c=b.window.query("#facets \x3e grid[facet\x3d"+a.facet+"]")[0];if(c)if(c=c.getStore(),c.clearFilter(),0===c.getCount())c.loadRawData(a.results);
else{var d=[];c.each(function(b){for(var c=b.get("label"),e=0;e<a.results.length;e++){var f=a.results[e];if(f.label===c){b.set("count",f.count);d.push(c);break}}});c.filterBy(function(a){return-1!==d.indexOf(a.get("label"))})}});b.window.down("#facets").unmask();b.gettingFacets=!1;b.getNotebooks()}).catch(function(a){b.window.down("#facets").unmask();b.gettingFacets=!1})}},getNotebooks:function(a){if(!a){a=[];this._getSelectedFacets().forEach(function(b){a.push(b.join(":"))});var b=this.window.down("#queryfield").getValue();
0<b.trim().length&&a.push(b);return this.getNotebooks(a)}if(0===a.length)this.window.down("#notebookslist").getSelectionModel().deselectAll(),this.window.down("#notebookslist").getStore().removeAll();else{this.window.down("#notebookslist").mask("Loading");this.window.down("#notebookslist").getSelectionModel().deselectAll();var c=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:a,noCache:1}).then(function(a){c.window.down("#notebookslist").unmask();c.window.down("#notebookslist").getStore().loadRawData(a.catalogue.notebooks);
c.window.down("#notebookslist").getStore().sort("modified","DESC")}).catch(function(a){c.window.unmask()})}},getSuggestedNotebooks:function(){var a=this;Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:"id:Tutorials|id:aboutspyral|id:DialogicaWelcome",parse:!1,noCache:1}).then(function(b){a.suggestedStore.loadRawData(b.catalogue.notebooks);a.suggestedStore.sort("modified","DESC")}).catch(function(a){})}});Ext.define("Voyant.notebook.Authenticator",{statics:{i18n:{account:"Account",signInWithGithub:"Sign in with GitHub",signInWithGoogle:"Sign in with Google",logout:"Logout",yourNotebooks:"Your Notebooks",authenticateWithGithub:"Authenticate with GitHub",authorizeSpyralGithub:"You must authorize Spyral to use GitHub on your behalf.",signInSuccess:"Sign in successful!"}},accountInfo:void 0,getGitHubAuthButton:function(a){var b=this;return{xtype:"button",glyph:"xf09b@FontAwesome",text:b.localize("signInWithGithub"),
margin:"5 15",handler:function(c){function d(c){c.origin===window.location.origin&&"oauth_cookie_set"===c.data?(window.removeEventListener("message",d,!1),c.source.close(),b.retrieveAccountInfo().then(function(c){a.call(b,c)})):console.warn("Error authenticating with GitHub")}window.open(Voyant.application.getBaseUrlFull()+"spyral/oauth","_blank");window.addEventListener("message",d,!1)}}},getGoogleAuthButton:function(a){google.accounts.id.initialize({client_id:"foobar",ux_mode:"redirect",login_uri:"http://localhost:8080/voyant/spyral/oauth/callback"});
return{xtype:"component",html:'\x3cdiv id\x3d"signInWithGoogleButton"\x3e\x3c/div\x3e',margin:5,listeners:{afterrender:function(){google.accounts.id.renderButton(document.getElementById("signInWithGoogleButton"),{theme:"outline",size:"medium"})}}}},showGitHubAuthentication:function(a){var b=this;Ext.create("Ext.window.Window",{title:b.localize("authenticateWithGithub"),width:750,height:550,closable:!1,layout:{type:"vbox",align:"middle",pack:"center"},items:[{html:'\x3cdiv style\x3d"margin-bottom: 10px;"\x3e'+
b.localize("authorizeSpyralGithub")+"\x3c/div\x3e"},b.getGitHubAuthButton(a)],buttons:[{text:"Cancel",handler:function(){b.close()}}]}).show()},showAccountWindow:function(){var a=this;if(this.isAuthenticated()){var b=this.accountInfo.id.split("@"),c=b[0];b=b[1];var d=Ext.create("Ext.window.Window",{title:a.localize("account"),width:750,height:550,modal:!0,maximizable:!0,closable:!0,layout:{type:"hbox",align:"stretch",pack:"center"},items:[{width:200,layout:{type:"vbox",align:"middle",pack:"start"},
items:[{html:'\x3cdiv style\x3d"padding: 10px"\x3e\n\t\x3cimg src\x3d"'+a.accountInfo.avatar+'" width\x3d"100" height\x3d"100" style\x3d"display: block; margin-bottom: 5px" /\x3e\n\t\x3cdiv style\x3d"margin-bottom: 5px"\x3e'+a.accountInfo.name+'\x3c/div\x3e\n\t\x3cdiv\x3e\x3ci class\x3d"fa fa-'+("gh"===b?"github":"google")+'"\x3e\x3c/i\x3e '+c+"\x3c/div\x3e\n\x3c/div\x3e"},{xtype:"button",glyph:"xf08b@FontAwesome",text:a.localize("logout"),handler:function(b){Ext.Ajax.request({url:a.getApplication().getBaseUrlFull()+
"spyral/account/logout"});a.accountInfo=void 0;b.up("window").close()}}]},{flex:1,layout:{type:"vbox",align:"middle",pack:"start"},items:[{html:"\x3ch3\x3e"+a.localize("yourNotebooks")+"\x3c/h3\x3e"},{flex:1,itemId:"notebookslist",xtype:"notebookslist",listeners:{itemdblclick:function(b,c,d){c=c.get("id");a.fireEvent("notebookSelected",a,c,function(){b.up("window").close()})}}}]}],buttons:[{text:"Close",handler:function(a){a.up("window").close()}}]});d.show();d.down("#notebookslist").mask("Loading");
Spyral.Load.trombone({tool:"notebook.NotebookFinder",query:"facet.userId:"+this.accountInfo.id,noCache:1}).then(function(a){d.down("#notebookslist").unmask();d.down("#notebookslist").getStore().loadRawData(a.catalogue.notebooks);d.down("#notebookslist").getStore().sort("modified","DESC")}).catch(function(a){d.unmask()})}},retrieveAccountInfo:function(){var a=this,b=new Ext.Deferred;Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"spyral/account",success:function(c){""===c.responseText?
b.resolve(void 0):(c=JSON.parse(c.responseText),a.accountInfo=c,b.resolve(c))},failure:function(){b.reject()}});return b.promise},isAuthenticated:function(a){return a?this.retrieveAccountInfo().then(function(a){return void 0!==a},function(){return!1}):void 0!==this.accountInfo},getCookie:function(a){var b=(" "+document.cookie).match(new RegExp("[; ]"+a+"\x3d([^\\s;]*)"));return a&&b?unescape(b[1]):""},deleteCookie:function(a,b){document.cookie=a+"\x3d; Path\x3d"+(void 0===b?"/":b)+"; Expires\x3dThu, 01 Jan 1970 00:00:01 GMT;"}});Ext.define("Voyant.notebook.Notebook",{alternateClassName:["Notebook"],extend:"Ext.panel.Panel",requires:["Voyant.notebook.editor.CodeEditorWrapper","Voyant.notebook.editor.TextEditorWrapper","Voyant.notebook.metadata.MetadataEditor","Voyant.notebook.StorageDialogs","Voyant.notebook.github.GitHubDialogs"],mixins:["Voyant.panel.Panel","Voyant.notebook.Authenticator","Voyant.notebook.util.FormatConverter"],alias:"widget.notebook",statics:{i18n:{title:"Spyral",created:"Notebook Created",modified:"Notebook Modified",
...
metadataTip:"View and Edit the notebook metadata.",metadataEditor:"Edit Metadata",metadataReset:"Reset",metadataSave:"Save",metadataCancel:"Cancel",catalogueTip:"Search a catalogue of available notebooks.",preparingExport:"Preparing Export",notSavedWarning:"Changes to your notebook have not been saved. Are you sure you want to continue?"},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0}},config:{notebookId:void 0,notebookName:void 0,metadata:void 0,isEdited:!1,version:"3.0",storageSolution:"voyant"},
...
callback:function(a,c){c.toolMenu&&c.toolMenu.destroy();c.items=[];a.isAuthenticated(!0).then(function(b){c.items=b?[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:a.showSaveDialog.bind(a,!1),scope:a},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:a.showSaveDialog.bind(a,!0),scope:a}]:[{xtype:"component",padding:5,html:"Please sign in to save"}]},function(){c.items=[{xtype:"component",padding:5,html:"Please sign in to save"}]}).always(function(){c.showToolMenu()})}},
"new":{tooltip:this.localize("newTip"),callback:function(){var a=this.getBaseUrl()+"spyral/";this.getApplication().openUrl(a)},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),xtype:"toolmenu",glyph:"xf115@FontAwesome",callback:function(a,c){a=this.getStorageSolution();void 0!==a&&("github"===a?this.githubDialogs.showLoad():Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,b){b=b.trim();"ok"==a&&this.checkIsEditedAndDoCallback(this,
function(){this.loadFromString(b)})},this,!0))},scope:this},runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),callback:this.showMetadataEditor,xtype:"toolmenu",glyph:"xf02c@FontAwesome",scope:this},catalogue:{tooltip:this.localize("catalogueTip"),callback:function(){this.catalogueWindow.showWindow()},xtype:"toolmenu",glyph:"xf00b@FontAwesome",scope:this},account:{xtype:"toolmenu",glyph:"xf007@FontAwesome",
callback:function(a,c){c.toolMenu&&c.toolMenu.destroy();c.items=[];a.isAuthenticated(!0).then(function(b){b?a.showAccountWindow():c.items=[a.getGitHubAuthButton(function(){a.setMetadata(a.getMetadata().clone());a.toastInfo({html:a.localize("signInSuccess"),anchor:"tr"})})]},function(){c.items=[a.getGitHubAuthButton(function(){a.setMetadata(a.getMetadata().clone());a.toastInfo({html:a.localize("signInSuccess"),anchor:"tr"})})]}).always(function(){c.showToolMenu()})}}},scrollable:!0,layout:{type:"vbox",
align:"middle",padding:"50 0"},defaults:{width:"100%",maxWidth:1100},items:[{itemId:"spyralHeader",cls:"spyral-header",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(b){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}},{xtype:"container",itemId:"cells",
defaults:{margin:"10 0 10 0",padding:"0 50 0 50"}},{itemId:"spyralFooter",cls:"spyral-footer",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(b){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}}],helpToolClick:this.showDocs.bind(this),listeners:{afterrender:this.init,
notebookWrapperMoveUp:this.notebookWrapperMoveUp,notebookWrapperMoveDown:this.notebookWrapperMoveDown,notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,notebookInitialized:this.notebookInitialized,notebookSelected:this.handleNotebookSelected,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.mixins["Voyant.notebook.util.FormatConverter"].constructor.apply(this,arguments);this.voyantStorageDialogs=
new Voyant.notebook.StorageDialogs({notebookParent:this,listeners:{fileLoaded:function(a){},fileSaved:function(a,c,d){this.unmask();null!==c?((a=this.getNotebookId())&&c==a||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1)):this.showError("There was an error saving your notebook:\n"+d)},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({parent:this,listeners:{fileLoaded:function(a,
c){a=c.owner;var b=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.loadFromString(c);c=encodeURIComponent(a+"/"+b+"/"+e);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},fileSaved:function(a,c){a=c.owner;var b=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&
(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}});this.catalogueWindow=new Voyant.notebook.Catalogue({listeners:{notebookSelected:this.handleNotebookSelected,scope:this}})},init:function(){window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Promise.all([Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/spyral.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+
"resources/spyral/docs/ecmascript.json"}),Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+"resources/spyral/docs/browser.json"})]).then(function(a){this.spyralTernDocs=Ext.JSON.decode(a[0].responseText);this.ecmaTernDocs=Ext.JSON.decode(a[1].responseText);this.browserTernDocs=Ext.JSON.decode(a[2].responseText);this.loadFromQueryParams()}.bind(this),function(){this.loadFromQueryParams()}.bind(this));this.retrieveAccountInfo()},reset:function(){this.getScrollable().scrollTo(0,0);this.getScrollable().trackingScrollTop=
0;this.getScrollable().trackingScrollLeft=0;this.setMetadata(new Spyral.Metadata);this.voyantStorageDialogs.reset();this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");this.getMetadata().set({userId:this.accountInfo.id});this.updateCachedOutput().then(function(a){},function(a){console.warn("Error updating cached results")}).finally(function(){var b=this.generateExportJson(),c=this.generateExportMetadata(this.getMetadata()),
d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()?"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookName()):this.voyantStorageDialogs.doSave({notebookName:this.getNotebookName(),data:b,metadata:c})}.bind(this))},updateCachedOutput:function(){return Ext.Promise.all(this.query("notebookrunnableeditorwrapper").map(function(a){return a.results.updateCachedOutput()}))},exportToolClick:function(a){a.mask(a.localize("preparingExport"));
a.updateCachedOutput().finally(function(){a.unmask();a.mixins["Voyant.util.Toolable"].exportToolClick.call(this,a)})},getExportUrl:function(a){return location.href},loadFromQueryParams:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=this.SPYRAL_ID_REGEX.exec(location.pathname),d=this.SPYRAL_ID_REGEX_OLD.exec(location.pathname),e=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(decodeURIComponent(atob(a.inputJsonArrayOfEncodedBase64))).forEach(function(a,
b){0==a.trim().indexOf("\x3c")?0===b?this.setMetadata(new Spyral.Metadata({title:a})):this.addText(a):this.addCode(a)},this):c?(this.loadFromId(c[1]+this.NOTEBOOK_ID_SEPARATOR+c[2]),this.setStorageSolution("voyant")):d?(this.loadFromId(d[1]),this.setStorageSolution("voyant")):e?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):(this.addNew(),this.setIsEdited(!1));if(b){var f=this;Ext.defer(function(){f.runAll()},100)}},loadFromString:function(a){a=a.trim();if(0===a.indexOf("{"))this.loadFromJson(a);
else if(this.SPYRAL_ID_REGEX.test("/spyral/"+a)){var b=this.SPYRAL_ID_REGEX.exec("/spyral/"+a);this.loadFromId(b[1]+this.NOTEBOOK_ID_SEPARATOR+b[2])}else{if(0!==a.indexOf("\x3c")||-1===a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setNotebookId(void 0);this.importFromHtml(a)},this)}return!0},loadFromJson:function(a){try{var b=
JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.cells||!b.metadata)return Ext.Msg.show({title:this.localize("errorLoadingNotebook"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});Ext.batchLayouts(function(){this.reset();this.setMetadata(new Spyral.Metadata(b.metadata));
var a=[];b.cells.forEach(function(b){var c=void 0;switch(b.type){case "text":this.addText(b.content,void 0,b.cellId);break;case "code":c=this.addCode(b.content,void 0,b.cellId);break;case "data":c=this.addData(b.content,void 0,b.cellId)}c&&(c.on("initialized",function(){var b=a.indexOf(c);-1!==b?(a.splice(b,1),0===a.length&&this.fireEvent("notebookInitialized",this)):console.error("unknown cell initialized",c)}.bind(this)),a.push(c))},this)},this)},loadFromId:function(a){this.mask(this.localize("loading"));
var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();a.notebook.success?(b.loadFromString(a.notebook.data),a.notebook.id&&a.notebook.id!==b.getNotebookId()&&b.setNotebookId(a.notebook.id),b.setIsEdited(!1)):Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:a.notebook.error,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}).catch(function(a){b.unmask();Ext.Msg.show({title:b.localize("errorLoadingNotebook"),msg:b.localize("cannotLoadNotebookId"),
buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})})},checkIsEditedAndDoCallback:function(a,b){this.getIsEdited()?Ext.Msg.show({title:this.localize("openTitle"),message:this.localize("notSavedWarning"),buttons:Ext.Msg.YESNO,icon:Ext.Msg.QUESTION,fn:function(c){"yes"===c&&b.call(a)},scope:this}):b.call(a)},handleNotebookSelected:function(a,b,c){this.checkIsEditedAndDoCallback(a,function(){c.call(a);this.loadFromId(b)}.bind(this))},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),
function(c){b.push(c);if(a&&a===c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(d){a&&a===d&&(c=!0);c&&b.push(d)},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(b){a.push(b)},this);this._run(a)},_run:function(a,b){if(0<a.length){var c=a.shift(),d=this;c.run(!0,b).then(function(e){e=c.getVariables();void 0===b&&(b=[]);e.forEach(function(a){for(var c=
0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}});b=b.concat(e);Ext.defer(d._run,100,d,[a,b])},function(a){})}else this.updateTernServerVariables(this.getNotebookVariables()),this.fireEvent("notebookRun",this)},notebookInitialized:function(){},updateTernServerVariables:function(a,b){Voyant.notebook.editor.CodeEditor.ternServer&&(b&&b.forEach(function(a){Voyant.notebook.editor.CodeEditor.ternServer.server.delFile(a.name)}),a.forEach(function(a){a.isSpyralClass&&Voyant.notebook.editor.CodeEditor.ternServer.server.addFile(a.name,
"var "+a.name+" \x3d new "+a.isSpyralClass+"()")}))},getNotebookVariables:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;c.getIsRun()&&(c=c.getVariables(),c.forEach(function(a){for(var c=0;c<b.length;c++)if(a.name===b[c].name){b.splice(c,1);break}}),b=b.concat(c))});return b},getNotebookBlocks:function(a){var b=[];Ext.Array.each(this.query("notebookrunnableeditorwrapper"),function(c){if(a&&a===c)return!1;b.push(c.getInput())});return b},
addNew:function(){this.setMetadata(new Spyral.Metadata({title:"Spyral Notebook",language:"English"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can click on the blocks to edit them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
...
c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)});this.setIsEdited(!0)},applyIsEdited:function(a){this.rendered&&!a&&(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)}));return a},applyNotebookId:function(a){if(!1===this.isConfiguring){var b=this.getBaseUrl()+
...
"\x3cp class\x3d'error'\x3e\n"+a.getError()+" \u2026 \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+escape(a.getDetails())+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/p\x3e"};else{if(a instanceof Ext.data.operation.Operation)return this.showError(Ext.create("Voyant.util.ResponseError",a.getError()));if(Ext.isString(a))a={message:a};else if(Ext.isObject(a)&&(a.responseText||a.statusText))return this.showResponseError(a.statusText,a)}Ext.applyIf(a,{title:this.localize("error"),
buttons:Ext.Msg.OK,icon:Ext.MessageBox.ERROR,autoScroll:!0});Ext.Msg.show(a)},getToolConfigFromToolXtype:function(a){cls=Ext.ClassManager.getByAlias("widget."+a);return{xtype:a,title:this._localizeClass(cls,"title"),tooltip:{text:this._localizeClass(cls,"helpTip")},glyph:cls&&cls.glyph?cls.glyph:"xf12e@FontAwesome"}},openUrl:function(a){window.open(a)||Ext.Msg.show({title:"Popup Blocked",buttonText:{ok:"Close"},icon:Ext.MessageBox.INFO,message:"A popup window was blocked. \x3ca href\x3d'"+a+"' target\x3d'_blank' class\x3d'link'\x3eClick here\x3c/a\x3e to open the new window.",
...
glyph:"xf066@FontAwesome",items:"bubbles cirrus contexts documentterms reader textualarc trends knots topics".split(" ")},{i18n:"moreToolsTypeViz",glyph:"xf06e@FontAwesome",items:"cirrus bubblelines bubbles collocatesgraph dreamscape loom knots mandala microsearch rezoviz streamgraph scatterplot textualarc trends termsberry termsradio wordtree".split(" ")},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates correlations phrases contexts documentterms documents topics".split(" ")},
...
this.getViewport())&&(b=b.down("corpuscreator"))&&b.toastInfo({html:this.localize("didYouKnowText"),title:this.localize("didYouKnow"),anchor:b.down("textareafield"),align:"tr",listeners:{beforeclose:{fn:function(){this.getHeader().getTools().forEach(function(a){"gear"!=a.type&&"help"!=a.type||a.getEl().frame("#ff0000",1,{duration:3E3})})},scope:b}}})},loadCorpusFromParams:function(a){var b=this,c=b.getViewport();c.mask(this.localize("fetchingCorpus"));a.archive&&(Ext.isString(a.archive)&&(a.archive=
[a.archive]),a.archive=a.archive.map(function(a){return a.replace("/blogs.sub.uni-hamburg.de/hup/lhn/","/wikis.sub.uni-hamburg.de/lhn/index.php/").replace("/hup.sub.uni-hamburg.de/","/wikis.sub.uni-hamburg.de/")}));this.validateCorpusLoadParams(a);(new Voyant.data.model.Corpus(a)).then(function(a){c.unmask();b.setCorpus(a);b.validateCorpusAccess()&&b.dispatchEvent("loadedCorpus",this,a)}).otherwise(function(){c.unmask()})},validateCorpusLoadParams:function(a){},validateCorpusAccess:function(){var a=
...
return!1}return!0},hasQueryToLoad:function(a){a||(a=Ext.Object.fromQueryString(document.location.search));return a.corpus||a.input||this.getCorpusId&&this.getCorpusId()},loadCategoryData:function(a){return this.getCategoriesManager().load(a,{trombone:Voyant.application.getTromboneUrl()})},saveCategoryData:function(a){return this.getCategoriesManager().save({},{trombone:Voyant.application.getTromboneUrl()})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.getApiParam("categories")&&this.loadCategoryData(this.getApiParam("categories")).then(function(){for(var a in this.getCategoriesManager().getCategories()){var b=
this.getCategoriesManager().getCategoryFeature(a,"color");if(void 0!==b){b=this.hexToRgb(b);for(var e=this.getCategoriesManager().getCategoryTerms(a),f=0;f<e.length;f++)this.setColorForTerm(e[f],b)}}}.bind(this));this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var c=this.getModifiedApiParams()||{};delete c.view;if("termsClicked"==d)if(Ext.isArray(e)&&"string"!==typeof e[0]&&"term"in e[0]&&"docIndex"in e[0]){var g={},h={};e.forEach(function(a){g[a.term]=
!0;h[a.docIndex]=!0});c.query=Object.keys(g);c.docIndex=Object.keys(h)}else c.query=e;else if("documentsClicked"==d){var k=[];e.forEach&&e.forEach(function(a){k.push(a.getIndex())});c.docIndex=k}else if("corpusTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}),c.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}c.toolFlow&&(d=
Ext.Array.from(c.toolFlow.split(",")),c.view=d.shift(),0<d.length?c.toolFlow=d.join(","):delete c.toolFlow);a+="\x26"+Ext.Object.toQueryString(c);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});
